...
void physical_design::exact(nanobind::module_& m)
{
    ...
    py::enum_<fiction::physical_design::technology_constraints>(m, "technology_constraints",
                                                                DOC(fiction_technology_constraints))
        .value("NONE", fiction::physical_design::technology_constraints::NONE, DOC(fiction_technology_constraints_NONE))
        .value("TOPOLINANO", fiction::physical_design::technology_constraints::TOPOLINANO,
               DOC(fiction_technology_constraints_TOPOLINANO));

    py::class_<fiction::physical_design::exact_physical_design_params>(m, "exact_params",
                                                                       DOC(fiction_exact_physical_design_params))
    ...
    py::class_<fiction::physical_design::exact_physical_design_stats>(m, "exact_stats",
                                                                      DOC(fiction_exact_physical_design_stats))
        .def(py::init<>(), "Default constructor.")
        .def(
            "__repr__",
        ...
        .def("report", &fiction::physical_design::exact_physical_design_stats::report,
             DOC(fiction_exact_physical_design_stats_report))
        .def_ro("time_total", &fiction::physical_design::exact_physical_design_stats::time_total,
                DOC(fiction_exact_physical_design_stats_time_total))
