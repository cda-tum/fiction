...
void design_sidb_gates(nanobind::module_& m)
{
     ...
     */
    py::enum_<typename fiction::design_sidb_gates_params<fiction::layouts::coords::offset>::design_sidb_gates_mode>(
        m, "design_sidb_gates_mode", DOC(fiction_design_sidb_gates_params_design_sidb_gates_mode))
        .value("QUICKCELL",
               fiction::design_sidb_gates_params<fiction::layouts::coords::offset>::design_sidb_gates_mode::QUICKCELL,
        ...
        .value("RANDOM",
               fiction::design_sidb_gates_params<fiction::layouts::coords::offset>::design_sidb_gates_mode::RANDOM,
               DOC(fiction_design_sidb_gates_params_design_sidb_gates_mode_RANDOM))
        .value(
            "PRUNING_ONLY",
            fiction::design_sidb_gates_params<fiction::layouts::coords::offset>::design_sidb_gates_mode::PRUNING_ONLY,
            DOC(fiction_design_sidb_gates_params_design_sidb_gates_mode_PRUNING_ONLY));
    /**
     * Termination condition selector type.
     */
    py::enum_<typename fiction::design_sidb_gates_params<fiction::layouts::coords::offset>::termination_condition>(
     ...
     * Parameters.
     */
    py::class_<fiction::design_sidb_gates_params<fiction::layouts::coords::offset>>(
        m, "design_sidb_gates_params", DOC(fiction_design_sidb_gates_params))
        .def(py::init<>(), "Default constructor.")
        .def_rw("operational_params",
                &fiction::design_sidb_gates_params<fiction::layouts::coords::offset>::operational_params,
                DOC(fiction_design_sidb_gates_params_operational_params))
        .def_rw("design_mode", &fiction::design_sidb_gates_params<fiction::layouts::coords::offset>::design_mode,
                DOC(fiction_design_sidb_gates_params_design_mode))
        .def_rw("canvas", &fiction::design_sidb_gates_params<fiction::layouts::coords::offset>::canvas,
                DOC(fiction_design_sidb_gates_params_canvas))
        .def_rw("number_of_canvas_sidbs",
                &fiction::design_sidb_gates_params<fiction::layouts::coords::offset>::number_of_canvas_sidbs,
                DOC(fiction_design_sidb_gates_params_number_of_canvas_sidbs))
        .def_rw("termination_cond",
                &fiction::design_sidb_gates_params<fiction::layouts::coords::offset>::termination_cond,
