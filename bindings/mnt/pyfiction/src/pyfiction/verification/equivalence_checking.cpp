...
void equivalence_checking(nanobind::module_& m)
{
     ...
     */
    py::enum_<fiction::verification::eq_type>(m, "eq_type", DOC(fiction_eq_type))
        .value("NO", fiction::verification::eq_type::NO, DOC(fiction_eq_type_NO))
        .value("WEAK", fiction::verification::eq_type::WEAK, DOC(fiction_eq_type_WEAK))
        .value("STRONG", fiction::verification::eq_type::STRONG, DOC(fiction_eq_type_STRONG))
    ...
    py::class_<fiction::verification::equivalence_checking_stats>(m, "equivalence_checking_stats",
        ...
        .def_ro("eq", &fiction::verification::equivalence_checking_stats::eq,
                DOC(fiction_equivalence_checking_stats_eq))
