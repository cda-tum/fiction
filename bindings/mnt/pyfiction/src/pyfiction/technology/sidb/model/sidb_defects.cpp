...
void sidb_defects(nanobind::module_& m)
{
    ...
    py::enum_<fiction::sidb::model::defect_type>(m, "sidb_defect_type", DOC(fiction_sidb_defect_type))
        .value("NONE", fiction::sidb::model::defect_type::NONE, DOC(fiction_sidb_defect_type_NONE))
        .value("DB", fiction::sidb::model::defect_type::DB, DOC(fiction_sidb_defect_type_DB))
        .value("SI_VACANCY", fiction::sidb::model::defect_type::SI_VACANCY, DOC(fiction_sidb_defect_type_SI_VACANCY))
        ...
        .value("ONE_BY_ONE", fiction::sidb::model::defect_type::ONE_BY_ONE, DOC(fiction_sidb_defect_type_ONE_BY_ONE))
        .value("THREE_BY_ONE", fiction::sidb::model::defect_type::THREE_BY_ONE,
               DOC(fiction_sidb_defect_type_THREE_BY_ONE))
        .value("SILOXANE", fiction::sidb::model::defect_type::SILOXANE, DOC(fiction_sidb_defect_type_SILOXANE))
        .value("RAISED_SI", fiction::sidb::model::defect_type::RAISED_SI, DOC(fiction_sidb_defect_type_RAISED_SI))
        .value("MISSING_DIMER", fiction::sidb::model::defect_type::MISSING_DIMER,
               DOC(fiction_sidb_defect_type_MISSING_DIMER))
        .value("ETCH_PIT", fiction::sidb::model::defect_type::ETCH_PIT, DOC(fiction_sidb_defect_type_ETCH_PIT))
        .value("STEP_EDGE", fiction::sidb::model::defect_type::STEP_EDGE, DOC(fiction_sidb_defect_type_STEP_EDGE))
        .value("GUNK", fiction::sidb::model::defect_type::GUNK, DOC(fiction_sidb_defect_type_GUNK))
        .value("UNKNOWN", fiction::sidb::model::defect_type::UNKNOWN, DOC(fiction_sidb_defect_type_UNKNOWN))

        ;

    py::class_<fiction::sidb::model::defect>(m, "sidb_defect", DOC(fiction_sidb_defect))
        ...
        .def_ro("type", &fiction::sidb::model::defect::type, DOC(fiction_sidb_defect_type))
        .def_ro("charge", &fiction::sidb::model::defect::charge, DOC(fiction_sidb_defect_charge))
        .def_ro("epsilon_r", &fiction::sidb::model::defect::epsilon_r, DOC(fiction_sidb_defect_epsilon_r))
        .def_ro("lambda_tf", &fiction::sidb::model::defect::lambda_tf, DOC(fiction_sidb_defect_lambda_tf))
