...
void shifted_cartesian_layout(nanobind::module_& m)
{
    ...
    py::class_<py_shifted_cartesian_layout>(m, "shifted_cartesian_layout",
        ...
        .def(
            "x", [](const py_shifted_cartesian_layout& lyt) { return lyt.x(); },
            DOC(fiction_layouts_cartesian_layout_x))
        .def(
            "y", [](const py_shifted_cartesian_layout& lyt) { return lyt.y(); },
            DOC(fiction_layouts_cartesian_layout_y))
        .def(
            "z", [](const py_shifted_cartesian_layout& lyt) { return lyt.z(); },
            DOC(fiction_layouts_cartesian_layout_z))
        .def(
            "area", [](const py_shifted_cartesian_layout& lyt) { return lyt.area(); },
            DOC(fiction_layouts_cartesian_layout_area))
        .def(
            "resize", [](py_shifted_cartesian_layout& lyt, const py_offset_coordinate& dimension)
            { lyt.resize(dimension); }, py::arg("dimension"), DOC(fiction_layouts_cartesian_layout_resize))
        .def(
            "north", [](const py_shifted_cartesian_layout& lyt, const py_offset_coordinate& c) { return lyt.north(c); },
            py::arg("c"), DOC(fiction_layouts_cartesian_layout_north))
        .def(
            "north_east", [](const py_shifted_cartesian_layout& lyt, const py_offset_coordinate& c)
            { return lyt.north_east(c); }, py::arg("c"), DOC(fiction_layouts_cartesian_layout_north_east))
        .def(
            "east", [](const py_shifted_cartesian_layout& lyt, const py_offset_coordinate& c) { return lyt.east(c); },
            py::arg("c"), DOC(fiction_layouts_cartesian_layout_east))
        .def(
            "south_east", [](const py_shifted_cartesian_layout& lyt, const py_offset_coordinate& c)
            { return lyt.south_east(c); }, py::arg("c"), DOC(fiction_layouts_cartesian_layout_south_east))
        .def(
            "south", [](const py_shifted_cartesian_layout& lyt, const py_offset_coordinate& c) { return lyt.south(c); },
            py::arg("c"), DOC(fiction_layouts_cartesian_layout_south))
        .def(
            "south_west", [](const py_shifted_cartesian_layout& lyt, const py_offset_coordinate& c)
            { return lyt.south_west(c); }, py::arg("c"), DOC(fiction_layouts_cartesian_layout_south_west))
        .def(
            "west", [](const py_shifted_cartesian_layout& lyt, const py_offset_coordinate& c) { return lyt.west(c); },
            py::arg("c"), DOC(fiction_layouts_cartesian_layout_west))
        .def(
            "north_west", [](const py_shifted_cartesian_layout& lyt, const py_offset_coordinate& c)
            { return lyt.north_west(c); }, py::arg("c"), DOC(fiction_layouts_cartesian_layout_north_west))
        .def(
            "above", [](const py_shifted_cartesian_layout& lyt, const py_offset_coordinate& c) { return lyt.above(c); },
            py::arg("c"), DOC(fiction_layouts_cartesian_layout_above))
        .def(
            "below", [](const py_shifted_cartesian_layout& lyt, const py_offset_coordinate& c) { return lyt.below(c); },
            py::arg("c"), DOC(fiction_layouts_cartesian_layout_below))
        ...
        .def(
            ...
            { return lyt.is_at_northern_border(c); }, py::arg("c"),
        ...
        .def(
            ...
            { return lyt.is_at_eastern_border(c); }, py::arg("c"),
        ...
        .def(
            ...
            { return lyt.is_at_southern_border(c); }, py::arg("c"),
        ...
        .def(
            ...
            { return lyt.is_at_western_border(c); }, py::arg("c"),
        ...
        .def(
            ...
            { return lyt.is_at_any_border(c); }, py::arg("c"), DOC(fiction_layouts_cartesian_layout_is_at_any_border))

        .def(
            "northern_border_of", [](const py_shifted_cartesian_layout& lyt, const py_offset_coordinate& c)
            { return lyt.northern_border_of(c); }, py::arg("c"),
        ...
        .def(
            ...
            { return lyt.eastern_border_of(c); }, py::arg("c"), DOC(fiction_layouts_cartesian_layout_eastern_border_of))
        .def(
            "southern_border_of", [](const py_shifted_cartesian_layout& lyt, const py_offset_coordinate& c)
            { return lyt.southern_border_of(c); }, py::arg("c"),
        ...
        .def(
            ...
            { return lyt.western_border_of(c); }, py::arg("c"), DOC(fiction_layouts_cartesian_layout_western_border_of))

        .def(
            "is_ground_layer", [](const py_shifted_cartesian_layout& lyt, const py_offset_coordinate& c)
            { return lyt.is_ground_layer(c); }, py::arg("c"), DOC(fiction_layouts_cartesian_layout_is_ground_layer))
        .def(
            "is_crossing_layer", [](const py_shifted_cartesian_layout& lyt, const py_offset_coordinate& c)
            { return lyt.is_crossing_layer(c); }, py::arg("c"), DOC(fiction_layouts_cartesian_layout_is_crossing_layer))
        ...
        .def(
            ...
            { return lyt.adjacent_coordinates(c); }, py::arg("c"),
