...
void hexagonal_layout(nanobind::module_& m, const char* name)
{
    ...
    py::class_<Lyt>(m, name, DOC(fiction_hexagonal_layout_overridden))
        ...
        .def("east", &Lyt::east, py::arg("c"), DOC(fiction_layouts_hexagonal_layout_east))
        .def("south_east", &Lyt::south_east, py::arg("c"), DOC(fiction_layouts_hexagonal_layout_south_east))
        .def("south", &Lyt::south, py::arg("c"), DOC(fiction_layouts_hexagonal_layout_south))
        .def("south_west", &Lyt::south_west, py::arg("c"), DOC(fiction_layouts_hexagonal_layout_south_west))
        .def("west", &Lyt::west, py::arg("c"), DOC(fiction_layouts_hexagonal_layout_west))
        .def("north_west", &Lyt::north_west, py::arg("c"), DOC(fiction_layouts_hexagonal_layout_north_west))
        .def("above", &Lyt::above, py::arg("c"), DOC(fiction_layouts_hexagonal_layout_above))
        .def("below", &Lyt::below, py::arg("c"), DOC(fiction_layouts_hexagonal_layout_below))
        ...
        .def("is_above", &Lyt::is_above, py::arg("c1"), py::arg("c2"), DOC(fiction_layouts_hexagonal_layout_is_above))
        .def("is_below", &Lyt::is_below, py::arg("c1"), py::arg("c2"), DOC(fiction_layouts_hexagonal_layout_is_below))
