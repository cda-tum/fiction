...
Retrieves the truth table from the source network's cache and creates
a new node with the same function but connected to the provided
children signals in this network. This is used for network conversion
and copying.
