...
static const char *mkd_doc_fiction_detail_critical_temperature_impl_physical_simulation_of_bdl_iterator =
...
Args:
    bdl_iterator: A reference to a BDL input iterator representing the
                  gate layout at a given input combination. The
                  simulation is performed based on the configuration
...
static const char *mkd_doc_fiction_detail_defect_influence_impl_num_threads = R"doc(Number of available hardware threads.)doc";
...
static const char *mkd_doc_fiction_detail_operational_domain_impl_number_of_threads = R"doc(Number of available hardware threads.)doc";
