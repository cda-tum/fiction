...
static const char*
    __doc_fiction_assess_physical_population_stability_params_precision_for_distance_corresponding_to_potential =
        R"doc(The precision level for the conversion from the minimum potential
difference to the corresponding distance.)doc";

static const char* __doc_fiction_assess_physical_population_stability_params_simulation_parameters =
...
static const char* __doc_fiction_bdl_input_iterator_last_bdl_for_each_wire =
...
static const char* __doc_fiction_bdl_wire_selection =
...
static const char* __doc_fiction_bdl_wire_selection_INPUT =
    R"doc(Select only BDL wires that start with input cells.)doc";

static const char* __doc_fiction_bdl_wire_selection_OUTPUT =
    R"doc(Select only BDL wires that end with output cells.)doc";

static const char* __doc_fiction_bdl_wire_update_direction =
...
static const char* __doc_fiction_bounding_box_2d_min =
...
static const char* __doc_fiction_bounding_box_2d_x_size =
    R"doc(The horizontal size of the bounding box in layout coordinates.)doc";

static const char* __doc_fiction_bounding_box_2d_y_size =
...
static const char* __doc_fiction_cds_configuration =
...
static const char* __doc_fiction_cell_level_layout_is_outgoing_clocked =
    R"doc(Function is deleted for cell-level layouts.)doc";
...
static const char* __doc_fiction_charge_distribution_history_CONSIDER =
...
static const char* __doc_fiction_charge_index_recomputation_FROM_SCRATCH =
...
static const char* __doc_fiction_clocking_scheme_max_out_degree =
...
static const char* __doc_fiction_color_routing_params_partial_sat =
...
static const char* __doc_fiction_color_routing_stats_epg_stats =
...
static const char* __doc_fiction_compute_operational_ratio_params_op_domain_params =
...
static const char* __doc_fiction_critical_temperature_stats_num_valid_lyt =
...
static const char* __doc_fiction_design_sidb_gates_params_design_sidb_gates_mode =
    R"doc(Selector for the available design approaches.)doc";

static const char* __doc_fiction_design_sidb_gates_params_design_sidb_gates_mode_AUTOMATIC_EXHAUSTIVE_GATE_DESIGNER =
...
static const char* __doc_fiction_design_sidb_gates_params_number_of_sidbs =
...
static const char* __doc_fiction_design_sidb_gates_stats_duration =
    R"doc(The total runtime of SiDB gate design process.)doc";

static const char* __doc_fiction_design_sidb_gates_stats_number_of_layouts =
...
static const char* __doc_fiction_detail_a_star_impl_closed_list =
...
static const char*
    __doc_fiction_detail_assess_physical_population_stability_impl_assess_physical_population_stability_impl =
...
static const char* __doc_fiction_detail_assess_physical_population_stability_impl_energy_and_charge_index_charge_index =
    R"doc(Charge index of the charge distribution.)doc";

static const char* __doc_fiction_detail_assess_physical_population_stability_impl_energy_and_charge_index_energy =
    R"doc(Electrostatic energy of the charge distribution.)doc";
...
static const char* __doc_fiction_detail_assess_physical_population_stability_impl_params =
    R"doc(Parameters required to assess the population stability.)doc";
...
static const char* __doc_fiction_detail_contains_parameter_point =
    R"doc(Forward-declaration for `operational_domain`.)doc";
...
static const char*
    __doc_fiction_detail_critical_path_length_and_throughput_impl_critical_path_length_and_throughput_impl =
        R"doc()doc";
...
static const char* __doc_fiction_detail_critical_temperature_impl_bii =
    R"doc(Iterator that iterates over all possible input states.)doc";

static const char* __doc_fiction_detail_critical_temperature_impl_critical_temperature =
...
static const char* __doc_fiction_detail_critical_temperature_impl_params =
...
static const char* __doc_fiction_detail_design_sidb_gates_impl_all_canvas_layouts =
    R"doc(All Canvas SiDB layout (without I/O pins).)doc";

static const char* __doc_fiction_detail_design_sidb_gates_impl_all_sidbs_in_canvas =
...
static const char* __doc_fiction_detail_design_sidb_gates_impl_num_threads =
    R"doc(Number of threads to be used for parallel execution.)doc";

static const char* __doc_fiction_detail_design_sidb_gates_impl_number_of_discarded_layouts_at_first_pruning =
    R"doc(Number of discarded layouts at first pruning.)doc";

static const char* __doc_fiction_detail_design_sidb_gates_impl_number_of_discarded_layouts_at_second_pruning =
    R"doc(Number of discarded layouts at second pruning.)doc";

static const char* __doc_fiction_detail_design_sidb_gates_impl_number_of_discarded_layouts_at_third_pruning =
    R"doc(Number of discarded layouts at third pruning.)doc";

static const char* __doc_fiction_detail_design_sidb_gates_impl_number_of_input_wires =
    R"doc(Number of input BDL wires.)doc";

static const char* __doc_fiction_detail_design_sidb_gates_impl_number_of_output_wires =
...
static const char*
    __doc_fiction_detail_design_sidb_gates_impl_set_charge_distribution_of_input_wires_based_on_input_pattern =
...
static const char*
    __doc_fiction_detail_design_sidb_gates_impl_set_charge_distribution_of_output_wires_based_on_output_index =
        R"doc(This function assigns the charge states of the input wires in the
layout according to the provided input pattern index. It performs the
following steps: - For `NORTH-SOUTH` port wires, if the corresponding
bit in the input pattern is set, assigns `NEUTRAL` charge to the upper
...
static const char*
    __doc_fiction_detail_design_sidb_gates_impl_set_charge_distribution_of_output_wires_based_on_truth_table =
...
static const char* __doc_fiction_detail_determine_clocking_impl_layout =
...
static const char*
    __doc_fiction_detail_displacement_robustness_domain_impl_calculate_all_possible_displacements_for_each_sidb =
...
static const char*
    __doc_fiction_detail_displacement_robustness_domain_impl_determine_probability_of_fabricating_operational_gate =
...
static const char* __doc_fiction_detail_displacement_robustness_domain_impl_params =
...
static const char* __doc_fiction_detail_displacement_robustness_domain_impl_sidbs_of_the_original_layout =
    R"doc(SiDB positions of the originally given SiDB layout.)doc";

static const char* __doc_fiction_detail_displacement_robustness_domain_impl_stats =
    R"doc(The statistics of the displacement robustness computation.)doc";

static const char* __doc_fiction_detail_displacement_robustness_domain_impl_truth_table =
...
static const char* __doc_fiction_detail_enumerate_all_paths_impl_collection =
...
static const char* __doc_fiction_detail_exact_impl_ari =
...
static const char* __doc_fiction_detail_exact_impl_result_aspect_ratio =
...
static const char* __doc_fiction_detail_exact_impl_smt_handler_check_point =
...
static const char* __doc_fiction_detail_exact_impl_smt_handler_depth_ntk =
...
static const char* __doc_fiction_detail_exact_impl_smt_handler_inv_levels =
...
static const char* __doc_fiction_detail_exact_impl_smt_handler_solver_check_point_state =
...
static const char* __doc_fiction_detail_exact_impl_smt_handler_solver_state_solver =
...
static const char* __doc_fiction_detail_exact_impl_thread_info_worker_aspect_ratio =
...
static const char* __doc_fiction_detail_generate_edge_intersection_graph_impl_generate_edge_intersection_graph_impl =
    R"doc()doc";

static const char* __doc_fiction_detail_generate_edge_intersection_graph_impl_graph =
...
static const char*
    __doc_fiction_detail_generate_edge_intersection_graph_impl_labeled_layout_coordinate_lookup_path_append =
...
static const char*
    __doc_fiction_detail_generate_edge_intersection_graph_impl_labeled_layout_coordinate_lookup_path_path_elements =
        R"doc(Uniquely identify path elements in a set to make them searchable in
O(1).)doc";

static const char* __doc_fiction_detail_generate_edge_intersection_graph_impl_layout =
    R"doc(Reference to the layout.)doc";

static const char* __doc_fiction_detail_generate_edge_intersection_graph_impl_node_id =
    R"doc(IDs for nodes and edges.)doc";

static const char* __doc_fiction_detail_generate_edge_intersection_graph_impl_objectives =
...
static const char* __doc_fiction_detail_graph_oriented_layout_design_impl_best_optimized_solution =
...
static const char* __doc_fiction_detail_graph_oriented_layout_design_impl_custom_cost_objective =
...
static const char* __doc_fiction_detail_graph_oriented_layout_design_impl_max_placed_nodes =
    R"doc(Keep track of the maximum number of placed nodes.)doc";

static const char* __doc_fiction_detail_graph_oriented_layout_design_impl_ntk =
    R"doc(The network to be placed and routed.)doc";

static const char* __doc_fiction_detail_graph_oriented_layout_design_impl_num_search_space_graphs =
    R"doc(Number of search space graphs.)doc";

static const char* __doc_fiction_detail_graph_oriented_layout_design_impl_num_search_space_graphs_high_efficiency =
...
static const char*
    __doc_fiction_detail_graph_oriented_layout_design_impl_num_search_space_graphs_highest_effort_custom =
...
static const char* __doc_fiction_detail_graph_oriented_layout_design_impl_ssg_vec =
...
static const char* __doc_fiction_detail_graph_oriented_layout_design_impl_timeout_limit_reached =
...
static const char*
    __doc_fiction_detail_is_operational_impl_determine_non_operational_input_patterns_and_non_operationality_reason =
...
static const char* __doc_fiction_detail_is_operational_impl_parameters =
...
static const char* __doc_fiction_detail_jump_point_search_impl_closed_list =
    R"doc(Closed list that acts as a set of already visited coordinates.)doc";

static const char* __doc_fiction_detail_jump_point_search_impl_coordinate_f =
    R"doc(Stores a coordinate and its f-value.)doc";
...
static const char* __doc_fiction_detail_maximum_defect_influence_position_and_distance_impl_defect_cells =
    R"doc(All allowed defect positions.)doc";

static const char* __doc_fiction_detail_maximum_defect_influence_position_and_distance_impl_layout =
    R"doc(SiDB cell-level layout to simulate.)doc";

static const char*
    __doc_fiction_detail_maximum_defect_influence_position_and_distance_impl_maximum_defect_influence_position_and_distance_impl =
        R"doc()doc";

static const char* __doc_fiction_detail_maximum_defect_influence_position_and_distance_impl_params =
    R"doc(Parameters used for the simulation.)doc";
...
static const char* __doc_fiction_detail_non_operationality_reason_KINKS =
    R"doc(Kinks induced the layout to become non-operational.)doc";

static const char* __doc_fiction_detail_non_operationality_reason_LOGIC_MISMATCH =
    R"doc(The layout is non-operational because of logic mismatch.)doc";

static const char* __doc_fiction_detail_non_operationality_reason_NONE =
...
static const char* __doc_fiction_detail_on_the_fly_circuit_design_impl_design_circuit_on_defective_surface =
    R"doc()doc";
...
static const char* __doc_fiction_detail_on_the_fly_circuit_design_impl_params =
    R"doc(Parameters for the on-the-fly circuit design.)doc";

static const char* __doc_fiction_detail_on_the_fly_circuit_design_impl_stats =
    R"doc(Statistics for the on-the-fly circuit design.)doc";
...
static const char* __doc_fiction_detail_operational_domain_impl_num_simulator_invocations =
    R"doc(Number of simulator invocations.)doc";
...
static const char* __doc_fiction_detail_operational_domain_impl_num_threads =
    R"doc(Number of available hardware threads.)doc";
...
static const char* __doc_fiction_detail_operational_domain_impl_params =
...
static const char* __doc_fiction_detail_pi_locations_LEFT =
    R"doc(Flag indicating if primary inputs (PIs) can be placed at the left.)doc";

static const char* __doc_fiction_detail_pi_locations_TOP =
...
static const char* __doc_fiction_detail_placement_info_current_node =
...
static const char* __doc_fiction_detail_placement_info_node2pos =
...
static const char* __doc_fiction_detail_post_layout_optimization_impl_max_gate_relocations =
    R"doc(Maximum number of relocations to try for each gate.)doc";

static const char* __doc_fiction_detail_post_layout_optimization_impl_max_non_po =
...
static const char* __doc_fiction_detail_post_layout_optimization_impl_timeout_limit_reached =
    R"doc(Timeout limit reached.)doc";
...
static const char* __doc_fiction_detail_post_layout_optimization_impl_wiring_reduction_params =
    R"doc(Wiring reduction parameters.)doc";

static const char* __doc_fiction_detail_post_layout_optimization_impl_wiring_reduction_stats =
...
static const char* __doc_fiction_detail_priority_queue_counter =
...
static const char* __doc_fiction_detail_quickexact_impl_all_sidbs_in_lyt_without_negative_preassigned_ones =
...
static const char* __doc_fiction_detail_quickexact_impl_number_of_sidbs =
...
static const char* __doc_fiction_detail_quickexact_impl_required_simulation_base_number =
...
static const char* __doc_fiction_detail_quickexact_impl_required_simulation_base_number_TWO =
...
static const char* __doc_fiction_detail_read_fgl_layout_impl_gate_storage_incoming =
    R"doc(List of incoming connections to the gate.)doc";

static const char* __doc_fiction_detail_read_fgl_layout_impl_gate_storage_loc =
    R"doc(Location of the gate represented its x-, y- and z-coordinate.)doc";

static const char* __doc_fiction_detail_read_fgl_layout_impl_gate_storage_name =
...
static const char* __doc_fiction_detail_read_fgl_layout_impl_is =
    R"doc(The input stream from which the gate-level layout is read.)doc";

static const char* __doc_fiction_detail_read_fgl_layout_impl_lyt =
...
static const char* __doc_fiction_detail_read_sqd_layout_impl_lyt =
    R"doc(The layout to which the parsed cells are added.)doc";

static const char* __doc_fiction_detail_read_sqd_layout_impl_max_cell_pos =
...
static const char* __doc_fiction_detail_sat_clocking_handler_number_of_clocks =
...
static const char* __doc_fiction_detail_sat_clocking_handler_solver =
...
static const char* __doc_fiction_detail_sat_coloring_handler_determine_min_coloring_with_linearly_ascending_search =
    R"doc()doc";

static const char* __doc_fiction_detail_sat_coloring_handler_determine_min_coloring_with_linearly_descending_search =
    R"doc()doc";
...
static const char* __doc_fiction_detail_sat_coloring_handler_largest_clique =
...
static const char* __doc_fiction_detail_sat_coloring_handler_solver_instance_variables =
...
static const char* __doc_fiction_detail_search_space_graph_cost =
    R"doc(The cost objective used to expand a vertex in the search space graph.)doc";

static const char* __doc_fiction_detail_search_space_graph_current_vertex =
    R"doc(The current vertex in the search space graph.)doc";

static const char* __doc_fiction_detail_search_space_graph_frontier =
    R"doc(Priority queue containing vertices of the search space graph.)doc";

static const char* __doc_fiction_detail_search_space_graph_frontier_flag =
    R"doc(Flag indicating if this graph's frontier is active.)doc";

static const char* __doc_fiction_detail_search_space_graph_network =
    R"doc(The network associated with this search space graph.)doc";

static const char* __doc_fiction_detail_search_space_graph_num_expansions =
    R"doc(The maximum number of positions to be considered for expansions.)doc";
...
static const char* __doc_fiction_detail_topo_view_ci_to_co_foreach_gate =
    R"doc(! Reimplementation of `foreach_gate`. */)doc";

static const char* __doc_fiction_detail_topo_view_ci_to_co_foreach_gate_reverse =
    R"doc(! Implementation of `foreach_gate` in reverse topological order. */)doc";

static const char* __doc_fiction_detail_topo_view_ci_to_co_foreach_node =
    R"doc(! Reimplementation of `foreach_node`. */)doc";

static const char* __doc_fiction_detail_topo_view_ci_to_co_index_to_node =
    R"doc(! Reimplementation of `index_to_node`. */)doc";

static const char* __doc_fiction_detail_topo_view_ci_to_co_node_to_index =
    R"doc(! Reimplementation of `node_to_index`. */)doc";
...
static const char* __doc_fiction_detail_topo_view_co_to_ci_foreach_gate =
    R"doc(! Reimplementation of `foreach_gate`. */)doc";

static const char* __doc_fiction_detail_topo_view_co_to_ci_foreach_gate_reverse =
    R"doc(! Implementation of `foreach_gate` in reverse topological order. */)doc";

static const char* __doc_fiction_detail_topo_view_co_to_ci_foreach_node =
    R"doc(! Reimplementation of `foreach_node`. */)doc";

static const char* __doc_fiction_detail_topo_view_co_to_ci_index_to_node =
    R"doc(! Reimplementation of `index_to_node`. */)doc";

static const char* __doc_fiction_detail_topo_view_co_to_ci_node_to_index =
    R"doc(! Reimplementation of `node_to_index`. */)doc";
...
static const char* __doc_fiction_detail_write_fgl_layout_impl_os =
...
static const char* __doc_fiction_detail_write_location_and_ground_state_impl_os =
...
static const char* __doc_fiction_detail_write_location_and_ground_state_impl_sim_result =
    R"doc(Simulation results.)doc";

static const char* __doc_fiction_detail_write_location_and_ground_state_impl_write_location_and_ground_state_impl =
    R"doc()doc";
...
static const char* __doc_fiction_detail_write_qca_layout_svg_impl_write_qca_layout_svg_impl =
...
static const char* __doc_fiction_detail_write_sidb_layout_svg_impl_background_color =
...
static const char* __doc_fiction_detail_write_sidb_layout_svg_impl_generate_svg =
...
static const char* __doc_fiction_detail_write_sidb_layout_svg_impl_set_colors =
    R"doc(Sets the colors based on the color mode.)doc";

static const char* __doc_fiction_detail_write_sidb_layout_svg_impl_sidb_color =
    R"doc(The color of the SiDB without charge information.)doc";

static const char* __doc_fiction_detail_write_sidb_layout_svg_impl_sidb_edge_color =
...
static const char* __doc_fiction_detail_write_sqd_sim_result_impl_sim_result =
    R"doc(The simulation result to write.)doc";

static const char* __doc_fiction_detail_write_sqd_sim_result_impl_write_electron_distributions =
    R"doc(Writes all charge distributions to the output stream in XML format.)doc";

static const char* __doc_fiction_detail_write_sqd_sim_result_impl_write_engine_info =
...
static const char* __doc_fiction_detail_yen_k_shortest_paths_impl_k_shortest_paths =
...
static const char* __doc_fiction_detail_yen_k_shortest_paths_impl_num_shortest_paths =
...
static const char* __doc_fiction_detect_bdl_wires_params =
    R"doc(This struct encapsulates parameters used for detecting BDL wires.)doc";

static const char* __doc_fiction_detect_bdl_wires_params_bdl_pairs_params =
...
static const char* __doc_fiction_determine_clocking_stats =
...
static const char* __doc_fiction_determine_vertex_coloring_params_heuristic_params =
    R"doc(Parameters for `engine != SAT`.)doc";

static const char* __doc_fiction_determine_vertex_coloring_params_sat_params =
    R"doc(Parameters for `engine == SAT`.)doc";

static const char* __doc_fiction_determine_vertex_coloring_params_verify_coloring_after_computation =
...
static const char* __doc_fiction_determine_vertex_coloring_sat_params_sat_search_tactic =
...
static const char* __doc_fiction_determine_vertex_coloring_stats_color_frequency =
...
static const char* __doc_fiction_determine_vertex_coloring_stats_most_frequent_color =
...
static const char*
    __doc_fiction_displacement_robustness_domain_params_dimer_displacement_policy_STAY_ON_ORIGINAL_DIMER =
...
static const char* __doc_fiction_displacement_robustness_domain_params_displacement_analysis_mode =
    R"doc(Possible modes to determine the displacement robustness domain.)doc";

static const char* __doc_fiction_displacement_robustness_domain_params_displacement_analysis_mode_EXHAUSTIVE =
...
static const char* __doc_fiction_displacement_robustness_domain_params_fixed_sidbs =
    R"doc(SiDBs in the given layout which shall not be affected by variations.)doc";

static const char* __doc_fiction_displacement_robustness_domain_params_operational_params =
    R"doc(Parameters to check the operation status of the SiDB layout.)doc";
...
static const char* __doc_fiction_displacement_robustness_domain_stats =
...
static const char* __doc_fiction_eq_type_NO =
...
static const char* __doc_fiction_equivalence_checking_stats_counter_example =
...
static const char* __doc_fiction_equivalence_checking_stats_tp_diff =
    R"doc(Throughput values at which weak equivalence manifests.)doc";

static const char* __doc_fiction_equivalence_checking_stats_tp_impl =
    R"doc(Throughput values at which weak equivalence manifests.)doc";

static const char* __doc_fiction_equivalence_checking_stats_tp_spec =
    R"doc(Throughput values at which weak equivalence manifests.)doc";
...
static const char* __doc_fiction_exact_physical_design_params_border_io =
    R"doc(Flag to indicate that I/Os should be placed at the layout's border.)doc";

static const char* __doc_fiction_exact_physical_design_params_crossings =
...
static const char* __doc_fiction_exact_physical_design_params_upper_bound_x =
    R"doc(Number of tiles to use as an upper bound in x direction.)doc";

static const char* __doc_fiction_exact_physical_design_params_upper_bound_y =
...
static const char* __doc_fiction_exact_sidb_simulation_engine =
...
static const char* __doc_fiction_fanout_substitution_params_degree =
...
static const char* __doc_fiction_fanout_substitution_params_substitution_strategy =
    R"doc(Breadth-first vs. depth-first fanout-tree substitution strategies.)doc";

static const char* __doc_fiction_fanout_substitution_params_substitution_strategy_BREADTH =
    R"doc(Breadth-first substitution. Creates balanced fanout trees.)doc";

static const char* __doc_fiction_fanout_substitution_params_substitution_strategy_DEPTH =
...
static const char* __doc_fiction_gate_design_exception_truth_table =
    R"doc(The truth table associated with the error.)doc";

static const char* __doc_fiction_gate_design_exception_which_port_list =
    R"doc(Get the port list associated with the exception.)doc";

static const char* __doc_fiction_gate_design_exception_which_tile =
    R"doc(Get the tile associated with the exception.)doc";

static const char* __doc_fiction_gate_design_exception_which_truth_table =
...
static const char* __doc_fiction_gate_level_drv_params_border_io =
    R"doc(Check if the I/Os are located at the layout's border.)doc";

static const char* __doc_fiction_gate_level_drv_params_clocked_data_flow =
    R"doc(Check if all node connections obey the clocking scheme data flow.)doc";

static const char* __doc_fiction_gate_level_drv_params_crossing_gates =
    R"doc(Check for wires that are crossing gates.)doc";

static const char* __doc_fiction_gate_level_drv_params_empty_io =
...
static const char* __doc_fiction_gate_level_drv_params_io_pins =
    R"doc(Check if the I/Os are assigned to wire segments.)doc";

static const char* __doc_fiction_gate_level_drv_params_missing_connections =
...
static const char* __doc_fiction_generate_edge_intersection_graph_stats_num_edges =
    R"doc(Stores the size of the generated edge intersection graph.)doc";

static const char* __doc_fiction_generate_edge_intersection_graph_stats_num_vertices =
    R"doc(Stores the size of the generated edge intersection graph.)doc";
...
static const char* __doc_fiction_generate_random_sidb_layout_params_number_of_sidbs =
    R"doc(Number of SiDBs that are placed on the layout.)doc";

static const char* __doc_fiction_generate_random_sidb_layout_params_number_of_unique_generated_layouts =
...
static const char* __doc_fiction_graph_coloring_engine_SAT =
...
static const char* __doc_fiction_graph_oriented_layout_design_params =
    R"doc(Parameters for the graph-oriented layout design algorithm.)doc";

static const char* __doc_fiction_graph_oriented_layout_design_params_cost =
...
static const char* __doc_fiction_graph_oriented_layout_design_params_cost_objective_CROSSINGS =
...
static const char* __doc_fiction_graph_oriented_layout_design_params_mode =
...
static const char* __doc_fiction_graph_oriented_layout_design_stats_duration =
...
static const char* __doc_fiction_gray_code_iterator_current_iteration =
...
static const char* __doc_fiction_inml_technology_cell_mark =
...
static const char* __doc_fiction_inml_technology_cell_type_CROSSWIRE_MAGNET =
...
static const char* __doc_fiction_inml_technology_cell_type_FANOUT_COUPLER_MAGNET =
...
static const char* __doc_fiction_inml_technology_cell_type_INVERTER_MAGNET =
...
static const char* __doc_fiction_inml_technology_cell_type_SLANTED_EDGE_DOWN_MAGNET =
    R"doc(Symbol used for lower slanted edge magnets.)doc";

static const char* __doc_fiction_inml_technology_cell_type_SLANTED_EDGE_UP_MAGNET =
...
static const char* __doc_fiction_is_operational_params_input_bdl_iterator_params =
...
static const char* __doc_fiction_is_sidb_gate_design_impossible_params_bdl_iterator_params =
    R"doc(Parameters used for the BDL input iterator.)doc";

static const char* __doc_fiction_is_sidb_gate_design_impossible_params_simulation_params =
    R"doc(All parameters for physical SiDB simulations.)doc";
...
static const char* __doc_fiction_maximum_defect_influence_distance_params_defect =
    R"doc(The defect to calculate the maximum defect influence distance for.)doc";

static const char* __doc_fiction_maximum_defect_influence_distance_params_simulation_parameters =
...
static const char* __doc_fiction_network_balancing_params_unify_outputs =
...
static const char* __doc_fiction_network_reader_out =
...
static const char* __doc_fiction_on_the_fly_circuit_design_params_exact_design_parameters =
    R"doc(Parameters for the *exact* placement and routing algorithm.)doc";

static const char* __doc_fiction_on_the_fly_circuit_design_params_sidb_on_the_fly_gate_library_parameters =
    R"doc(Parameters for the SiDB on-the-fly gate library.)doc";

static const char* __doc_fiction_on_the_fly_circuit_design_stats =
    R"doc(Statistics for the on-the-fly defect-aware circuit design.)doc";

static const char* __doc_fiction_on_the_fly_circuit_design_stats_duration =
    R"doc(The total runtime of the operational domain computation.)doc";

static const char* __doc_fiction_on_the_fly_circuit_design_stats_exact_stats =
    R"doc(The `stats` of the *exact* algorithm.)doc";

static const char* __doc_fiction_on_the_fly_circuit_design_stats_gate_layout =
...
static const char* __doc_fiction_operational_domain_stats_duration =
    R"doc(The total runtime of the operational domain computation.)doc";

static const char* __doc_fiction_operational_domain_stats_num_evaluated_parameter_combinations =
    R"doc(Number of evaluated parameter combinations.)doc";
...
static const char* __doc_fiction_operational_domain_stats_num_operational_parameter_combinations =
    R"doc(Number of parameter combinations, for which the layout is operational.)doc";

static const char* __doc_fiction_operational_domain_stats_num_simulator_invocations =
    R"doc(Number of simulator invocations.)doc";

static const char* __doc_fiction_operational_domain_stats_num_total_parameter_points =
...
static const char* __doc_fiction_operational_domain_value_range_dimension =
    R"doc(The sweep parameter of the dimension.)doc";

static const char* __doc_fiction_operational_domain_value_range_max =
    R"doc(The maximum value of the dimension sweep.)doc";

static const char* __doc_fiction_operational_domain_value_range_min =
...
static const char* __doc_fiction_orthogonal_physical_design_params_number_of_clock_phases =
...
static const char* __doc_fiction_parameter_point =
    R"doc(The parameter point holds parameter values in the x and y dimension.)doc";
...
static const char* __doc_fiction_population_stability_information_distance_corresponding_to_potential =
    R"doc(Distance (unit: nm) corresponding to the minimum potential difference.)doc";
...
static const char* __doc_fiction_population_stability_information_system_energy =
    R"doc(Total electrostatic energy (unit: eV) of given charge distribution.)doc";

static const char* __doc_fiction_population_stability_information_transition_from_to =
    R"doc(Charge transition from the current charge state to the closest one.)doc";
...
static const char* __doc_fiction_port_position =
...
static const char* __doc_fiction_post_layout_optimization_params_optimize_pos_only =
...
static const char* __doc_fiction_post_layout_optimization_stats_num_crossings_after =
    R"doc(Number of crossings after the post-layout optimization process.)doc";

static const char* __doc_fiction_post_layout_optimization_stats_num_crossings_before =
    R"doc(Number of crossings before the post-layout optimization process.)doc";

static const char* __doc_fiction_post_layout_optimization_stats_num_wires_after =
    R"doc(Number of wire segments after the post-layout optimization process.)doc";

static const char* __doc_fiction_post_layout_optimization_stats_num_wires_before =
...
static const char* __doc_fiction_qca_technology_cell_mark =
    R"doc(Possible marks to be applied to a cell to change its type.)doc";
...
static const char* __doc_fiction_qca_technology_cell_type_CONST_0 =
    R"doc(Symbol used for constant 0 input QCA cells.)doc";

static const char* __doc_fiction_qca_technology_cell_type_CONST_1 =
...
static const char* __doc_fiction_quickexact_params_automatic_base_number_detection =
...
static const char* __doc_fiction_quickexact_params_simulation_parameters =
    R"doc(All parameters for physical SiDB simulations.)doc";
...
static const char* __doc_fiction_quicksim_params_iteration_steps =
...
static const char* __doc_fiction_quicksim_params_simulation_parameters =
...
static const char* __doc_fiction_sidb_defect_surface_params =
...
static const char* __doc_fiction_sidb_defect_type_STEP_EDGE =
...
static const char* __doc_fiction_sidb_on_the_fly_gate_library_params_defect_surface =
    R"doc(This layout stores all atomic defects.)doc";

static const char* __doc_fiction_sidb_on_the_fly_gate_library_params_design_gate_params =
...
static const char* __doc_fiction_sidb_simulation_parameters_mu_minus =
    R"doc(`mu_minus` (µ-) is the energy transition level (0/-) (unit: eV).)doc";

static const char* __doc_fiction_sidb_simulation_parameters_mu_plus =
...
static const char* __doc_fiction_sidb_simulation_result_algorithm_name =
    R"doc(Name of the algorithm used to determine the charge distributions.)doc";

static const char* __doc_fiction_sidb_simulation_result_charge_distributions =
...
static const char* __doc_fiction_sidb_simulation_result_simulation_parameters =
...
static const char* __doc_fiction_sidb_technology_cell_mark =
    R"doc(Possible marks to be applied to a cell to change its type.)doc";
...
static const char* __doc_fiction_sidb_technology_cell_type_LOGIC =
...
static const char* __doc_fiction_siqad_coord_t_coord_t =
    R"doc(Default constructor. Creates a dead coordinate at (0, 0, 0).)doc";
...
static const char* __doc_fiction_sweep_parameter =
    R"doc(Possible sweep parameters for the operational domain computation.)doc";

static const char* __doc_fiction_sweep_parameter_EPSILON_R =
...
static const char* __doc_fiction_synchronization_element_layout_synchronization_element_layout_storage_se_map =
    R"doc()doc";

static const char*
    __doc_fiction_synchronization_element_layout_synchronization_element_layout_storage_synchronization_element_layout_storage =
        R"doc()doc";
...
static const char* __doc_fiction_technology_constraints_TOPOLINANO =
...
static const char* __doc_fiction_time_to_solution_stats_mean_single_runtime =
...
static const char* __doc_fiction_transition_type_NEGATIVE_TO_NEUTRAL =
    R"doc(SiDB is negatively charged, but is closest to being neutrally charged.)doc";

static const char* __doc_fiction_transition_type_NEUTRAL_TO_NEGATIVE =
    R"doc(SiDB is neutrally charged, but is closest to being negatively charged.)doc";

static const char* __doc_fiction_transition_type_NEUTRAL_TO_POSITIVE =
    R"doc(SiDB is neutrally charged, but is closest to being positively charged.)doc";

static const char* __doc_fiction_transition_type_POSITIVE_TO_NEUTRAL =
...
static const char* __doc_fiction_unrecognized_cell_definition_exception_unrecognized_cell_definition_exception =
    R"doc()doc";
...
static const char* __doc_fiction_unsupported_clocking_scheme_exception_unsupported_clocking_scheme_exception =
    R"doc()doc";
...
static const char* __doc_fiction_unsupported_gate_orientation_exception_unsupported_gate_orientation_exception =
    R"doc()doc";
...
static const char* __doc_fiction_write_fqca_layout_params_create_inter_layer_via_cells =
...
static const char* __doc_fiction_write_operational_domain_params_operational_tag =
    R"doc(The tag used to represent the operational value of a parameter set.)doc";

static const char* __doc_fiction_write_operational_domain_params_sample_writing_mode =
...
static const char* __doc_fiction_write_qca_layout_params_create_inter_layer_via_cells =
    R"doc(Create via cells in between each layer.)doc";
...
static const char* __doc_fiction_write_qca_layout_svg_params_simple =
...
static const char* __doc_fiction_write_qcc_layout_params_use_filename_as_component_name =
...
static const char* __doc_fiction_write_sidb_layout_svg_params =
    R"doc(Parameters for writing SiDB layouts to SVG format.)doc";

static const char* __doc_fiction_write_sidb_layout_svg_params_color_background =
    R"doc(The color mode of the background for the SVG output.)doc";

static const char* __doc_fiction_write_sidb_layout_svg_params_color_mode =
...
static const char* __doc_fiction_write_sidb_layout_svg_params_lattice_mode =
    R"doc(The lattice mode of the SiDB layout.)doc";

static const char* __doc_fiction_write_sidb_layout_svg_params_lattice_point_size =
...
static const char* __doc_fiction_write_sidb_layout_svg_params_sidb_lattice_mode_HIDE_LATTICE =
    R"doc(Lattice is hidden. Only SiDBs are shown.)doc";

static const char* __doc_fiction_write_sidb_layout_svg_params_sidb_lattice_mode_SHOW_LATTICE =
