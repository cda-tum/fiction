...
Args:
    ...
    sidb::simulation::analysis::transition_type: The optional type of charge transition to
...
static const char* mkd_doc_fiction_band_bending_resilience_params_assess_population_stability_params =
    R"doc(Parameters for the assessing physical population stability simulation)doc";

static const char* mkd_doc_fiction_band_bending_resilience_params_bdl_iterator_params =
    R"doc(Parameters for the input BDL iterator.)doc";
...
static const char* mkd_doc_fiction_bdl_input_iterator_last_bdl_for_each_wire =
    R"doc(Last BDL pairs for each BDL wire.)doc";
...
static const char* mkd_doc_fiction_bdl_input_iterator_params_bdl_wire_params =
    R"doc(Parameters to detect BDL wires.)doc";
...
static const char* mkd_doc_fiction_bdl_wire =
    R"doc(This struct encapsulates a vector of `sidb::simulation::logic::bdl_pair` objects, representing
...
Creates a new `sidb::simulation::logic::bdl_wire` object as a copy of another `sidb::simulation::logic::bdl_wire`
object.

Args:
    other: The `sidb::simulation::logic::bdl_wire` object to copy from.
...
another `sidb::simulation::logic::bdl_wire` object.

Args:
    other: The `sidb::simulation::logic::bdl_wire` object to move from.
...
Copies the content of another `sidb::simulation::logic::bdl_wire` object, including start and
end pairs.
...
static const char* mkd_doc_fiction_bdl_wire_selection =
    R"doc(An enumeration of the selection of different types of wires.)doc";

static const char* mkd_doc_fiction_bdl_wire_selection_ALL = R"doc(Select all BDL wires.)doc";

static const char* mkd_doc_fiction_bdl_wire_selection_INPUT =
    R"doc(Select only BDL wires that start with input cells.)doc";

static const char* mkd_doc_fiction_bdl_wire_selection_OUTPUT =
    R"doc(Select only BDL wires that end with output cells.)doc";

static const char* mkd_doc_fiction_bdl_wire_update_direction =
    R"doc(Update the port of the wire based on the current BDL pairs.)doc";
...
static const char* mkd_doc_fiction_bounding_box_2d_min =
    R"doc(The minimum and maximum coordinates of the bounding box.)doc";
...
static const char* mkd_doc_fiction_bounding_box_2d_x_size =
    R"doc(The horizontal size of the bounding box in layout coordinates.)doc";

static const char* mkd_doc_fiction_bounding_box_2d_y_size =
    R"doc(The vertical size of the bounding box in layout coordinates.)doc";
...
Args:
    sidb::simulation::analysis::energy_distribution: Energy distribution.
...
static const char* mkd_doc_fiction_cds_configuration =
    R"doc(An enumeration of modes for the charge distribution surface.)doc";
...
static const char* mkd_doc_fiction_cell_level_layout_is_incoming_clocked =
    R"doc(Function is deleted for cell-level layouts.)doc";

static const char* mkd_doc_fiction_cell_level_layout_is_outgoing_clocked =
    R"doc(Function is deleted for cell-level layouts.)doc";
...
static const char* mkd_doc_fiction_charge_distribution_history_CONSIDER =
    R"doc(The previous charge distribution is used.)doc";
...
static const char* mkd_doc_fiction_charge_index_recomputation_FROM_SCRATCH =
    R"doc(The charge index is recomputed from scratch.)doc";
...
static const char* mkd_doc_fiction_charge_transition_threshold_bounds_NEGATIVE_UPPER_BOUND =
    R"doc(For the upper bound check against mu_minus to validate DB-.)doc";

static const char* mkd_doc_fiction_charge_transition_threshold_bounds_NEUTRAL_LOWER_BOUND =
    R"doc(For the lower bound check against mu_minus to validate DB0.)doc";

static const char* mkd_doc_fiction_charge_transition_threshold_bounds_NEUTRAL_UPPER_BOUND =
    R"doc(For the upper bound check against mu_plus to validate DB0.)doc";

static const char* mkd_doc_fiction_charge_transition_threshold_bounds_POSITIVE_LOWER_BOUND =
    R"doc(For the lower bound check against mu_plus to validate DB+.)doc";
...
static const char* mkd_doc_fiction_clocking_scheme_fn =
...
static const char* mkd_doc_fiction_clocking_scheme_max_in_degree =
    R"doc(Maximum number of inputs the clocking scheme supports per clock zone.)doc";

static const char* mkd_doc_fiction_clocking_scheme_max_out_degree =
    R"doc(Maximum number of outputs the clocking scheme supports per clock zone.)doc";
...
static const char* mkd_doc_fiction_clocking_scheme_override =
...
static const char* mkd_doc_fiction_clocking_scheme_regular =
...
static const char* mkd_doc_fiction_clustercomplete_params_simulation_parameters =
...
static const char* mkd_doc_fiction_color_routing_params_partial_sat =
    R"doc(Allow partial solutions when the SAT engine is used.)doc";
...
static const char* mkd_doc_fiction_color_routing_stats_epg_stats =
    R"doc(Statistics of the edge intersection graph generation.)doc";
...
static const char* mkd_doc_fiction_critical_temperature_domain =
    R"doc(The `sidb::simulation::logic::critical_temperature_domain` class collects the critical
...
static const char* mkd_doc_fiction_critical_temperature_domain_critical_temperature_domain =
...
`sidb::simulation::logic::generate_bdl_input_pattern_layouts`, `sidb::simulation::logic::detect_bdl_pairs` and
`sidb::simulation::logic::detect_bdl_wires` and pass them to every call, instead of re-deriving
them each time.
...
Args:
    input_pattern_layouts: One layout per input pattern, indexed by
                           ...
                           `sidb::simulation::logic::generate_bdl_input_pattern_layouts`.
    spec: Expected Boolean function of the layout given as a multi-
          output truth table.
    params: Simulation and physical parameters.
...
static const char* mkd_doc_fiction_critical_temperature_stats =
    R"doc(This struct stores the result of the temperature simulation.)doc";
...
static const char* mkd_doc_fiction_critical_temperature_stats_num_valid_lyt =
    R"doc(Number of physically valid charge configurations.)doc";
...
static const char* mkd_doc_fiction_critical_temperature_stats_simulation_parameters =
    R"doc(All parameters for physical SiDB simulations.)doc";

static const char* mkd_doc_fiction_critical_temperature_stats_time_total =
    R"doc(The total runtime of the critical temperature computation.)doc";
...
static const char* mkd_doc_fiction_cube_coord_t_coord_t =
...
static const char* mkd_doc_fiction_defect_influence_domain =
    R"doc(A `sidb::simulation::defects::defect_influence_domain` defines for each defect position the
...
static const char* mkd_doc_fiction_defect_influence_params_defect =
    R"doc(The defect to calculate the defect influence for.)doc";

static const char* mkd_doc_fiction_defect_influence_params_influence_def = R"doc(Definition of defect influence.)doc";

static const char* mkd_doc_fiction_defect_influence_params_influence_definition =
    R"doc(Definition of defect influence.)doc";
...
static const char* mkd_doc_fiction_defect_influence_params_operational_params =
    R"doc(Parameters for the `is_operational` algorithm.)doc";
...
static const char* mkd_doc_fiction_defect_influence_stats_num_evaluated_defect_positions =
...
static const char* mkd_doc_fiction_defect_influence_stats_num_simulator_invocations =
    R"doc(Number of simulator invocations.)doc";

static const char* mkd_doc_fiction_defect_influence_stats_time_total =
    R"doc(The total runtime of the defect influence computation.)doc";
...
static const char* mkd_doc_fiction_depth_view_params_count_complements =
    R"doc(Take complemented edges into account for depth computation.)doc";
...
static const char* mkd_doc_fiction_design_sidb_gates_params_canvas =
...
static const char* mkd_doc_fiction_design_sidb_gates_params_design_sidb_gates_mode =
    R"doc(Selector for the available design approaches.)doc";

static const char* mkd_doc_fiction_design_sidb_gates_params_design_sidb_gates_mode_AUTOMATIC_EXHAUSTIVE_GATE_DESIGNER =
    R"doc(Gates are designed by using the *Automatic Exhaustive Gate Designer*.)doc";
...
static const char* mkd_doc_fiction_design_sidb_gates_params_design_sidb_gates_mode_QUICKCELL =
    R"doc(Gates are designed by using *QuickCell*.)doc";

static const char* mkd_doc_fiction_design_sidb_gates_params_design_sidb_gates_mode_RANDOM =
    R"doc(Gate layouts are designed randomly.)doc";

static const char* mkd_doc_fiction_design_sidb_gates_params_number_of_canvas_sidbs =
    R"doc(Number of SiDBs placed in the canvas to create a working gate.)doc";

static const char* mkd_doc_fiction_design_sidb_gates_params_operational_params =
    R"doc(Parameters for the `is_operational` function.)doc";
...
static const char* mkd_doc_fiction_design_sidb_gates_stats_number_of_layouts =
    R"doc(The number of all possible layouts.)doc";
...
static const char* mkd_doc_fiction_design_sidb_gates_stats_pruning_total =
    R"doc(The runtime of the pruning process.)doc";
...
static const char* mkd_doc_fiction_design_sidb_gates_stats_time_total =
    R"doc(The total runtime of SiDB gate design process.)doc";
...
static const char* mkd_doc_fiction_detail_a_star_impl_came_from =
    R"doc(Tracks the origin of each coordinate to recreate the path.)doc";

static const char* mkd_doc_fiction_detail_a_star_impl_closed_list =
    R"doc(Closed list that acts as a set of already visited coordinates.)doc";
...
static const char* mkd_doc_fiction_detail_a_star_impl_cost =
...
static const char* mkd_doc_fiction_detail_clustercomplete_impl_available_threads =
    R"doc(Number of available threads.)doc";
...
static const char*
    mkd_doc_fiction_detail_clustercomplete_impl_collect_physically_valid_charge_distributions_single_threaded =
...
static const char* mkd_doc_fiction_detail_clustercomplete_impl_mutex_to_protect_the_simulation_results =
    R"doc(Mutex to protect the simulation results.)doc";
...
static const char* mkd_doc_fiction_detail_clustercomplete_impl_worker =
    R"doc(Forward declaration of the worker struct.)doc";

static const char* mkd_doc_fiction_detail_clustercomplete_impl_worker_2 =
    R"doc(Forward declaration of the worker struct.)doc";

static const char* mkd_doc_fiction_detail_clustercomplete_impl_worker_all_workers =
    R"doc(The vector of all workers where this worker is at `ix`.)doc";
...
static const char* mkd_doc_fiction_detail_clustercomplete_impl_worker_index =
    R"doc(Worker index in the vector of all workers.)doc";
...
static const char* mkd_doc_fiction_detail_clustercomplete_impl_worker_queue_mutex_to_protect_this_queue =
    R"doc(Mutex used to protect shared resources in this queue.)doc";
...
static const char*
    mkd_doc_fiction_detail_critical_path_length_and_throughput_impl_critical_path_length_and_throughput_impl =
        R"doc()doc";
...
static const char* mkd_doc_fiction_detail_critical_temperature_impl_bii =
    R"doc(Iterator that iterates over all possible input states.)doc";

static const char* mkd_doc_fiction_detail_critical_temperature_impl_critical_temperature =
    R"doc(Critical temperature [K].)doc";
...
static const char* mkd_doc_fiction_detail_critical_temperature_impl_params =
    R"doc(Parameters for the critical_temperature algorithm.)doc";
...
static const char* mkd_doc_fiction_detail_defect_influence_impl_current_defect_position =
    R"doc(The current defect position.)doc";
...
static const char* mkd_doc_fiction_detail_defect_influence_impl_dist =
    R"doc(Uniform distribution for the y-coordinate of the defect.)doc";
...
static const char* mkd_doc_fiction_detail_defect_influence_impl_influence_domain =
    R"doc(The defect influence domain of the layout.)doc";
...
static const char* mkd_doc_fiction_detail_defect_influence_impl_layout =
...
static const char* mkd_doc_fiction_detail_defect_influence_impl_num_evaluated_defect_positions =
    R"doc(Number of evaluated defect positions.)doc";

static const char* mkd_doc_fiction_detail_defect_influence_impl_num_simulator_invocations =
    R"doc(Number of simulator invocations.)doc";
...
static const char* mkd_doc_fiction_detail_defect_influence_impl_nw_bb_layout =
    R"doc(The north-west cell of the bounding box of the layout.)doc";

static const char* mkd_doc_fiction_detail_defect_influence_impl_nw_cell = R"doc(North-west cell.)doc";

static const char* mkd_doc_fiction_detail_defect_influence_impl_params =
    R"doc(The parameters for the defect influence domain computation.)doc";

static const char* mkd_doc_fiction_detail_defect_influence_impl_previous_defect_position =
    R"doc(The previous defect position.)doc";
...
static const char* mkd_doc_fiction_detail_defect_influence_impl_se_bb_layout =
    R"doc(The south-east cell of the bounding box of the layout.)doc";

static const char* mkd_doc_fiction_detail_defect_influence_impl_se_cell = R"doc(South-east cell.)doc";

static const char* mkd_doc_fiction_detail_defect_influence_impl_stats =
    R"doc(The statistics of the defect influence domain computation.)doc";
...
static const char* mkd_doc_fiction_detail_delete_virtual_pis_impl_ntk_topo =
    R"doc(Topological view of the input network.)doc";
...
static const char* mkd_doc_fiction_detail_design_sidb_gates_impl_all_canvas_layouts =
    R"doc(All Canvas SiDB layout (without I/O pins).)doc";

static const char* mkd_doc_fiction_detail_design_sidb_gates_impl_all_sidbs_in_canvas =
    R"doc(All cells within the canvas.)doc";
...
static const char* mkd_doc_fiction_detail_design_sidb_gates_impl_number_of_discarded_layouts_at_first_pruning =
    R"doc(Number of discarded layouts at first pruning.)doc";

static const char* mkd_doc_fiction_detail_design_sidb_gates_impl_number_of_discarded_layouts_at_second_pruning =
    R"doc(Number of discarded layouts at second pruning.)doc";

static const char* mkd_doc_fiction_detail_design_sidb_gates_impl_number_of_discarded_layouts_at_third_pruning =
    R"doc(Number of discarded layouts at third pruning.)doc";

static const char* mkd_doc_fiction_detail_design_sidb_gates_impl_number_of_input_wires =
    R"doc(Number of input BDL wires.)doc";

static const char* mkd_doc_fiction_detail_design_sidb_gates_impl_number_of_output_wires =
    R"doc(Number of output BDL wires.)doc";

static const char* mkd_doc_fiction_detail_design_sidb_gates_impl_number_of_threads =
    R"doc(Number of threads to be used for the design process.)doc";

static const char* mkd_doc_fiction_detail_design_sidb_gates_impl_output_bdl_wires = R"doc(Output BDL wires.)doc";

static const char* mkd_doc_fiction_detail_design_sidb_gates_impl_params =
...
static const char* mkd_doc_fiction_detail_design_sidb_gates_impl_truth_table =
    R"doc(Truth table of the given gate.)doc";
...
`sidb::simulation::logic::bdl_wire_selection::INPUT`, it returns all wires containing an input
cell. If `selection` is set to `sidb::simulation::logic::bdl_wire_selection::OUTPUT`, it
...
Args:
    selection: The type of wires to filter by, specified by the
               `sidb::simulation::logic::bdl_wire_selection` enum.

Returns:
    A vector of filtered `sidb::simulation::logic::bdl_wire` objects based on the current
...
Returns:
    A vector of `sidb::simulation::logic::bdl_wire` objects containing cells of the specified
...
static const char* mkd_doc_fiction_detail_determine_clocking_impl_layout =
    R"doc(The layout to assign clock numbers to.)doc";
...
static const char*
    mkd_doc_fiction_detail_displacement_robustness_domain_impl_calculate_all_possible_displacements_for_each_sidb =
...
static const char*
    mkd_doc_fiction_detail_displacement_robustness_domain_impl_determine_probability_of_fabricating_operational_gate =
...
static const char* mkd_doc_fiction_detail_displacement_robustness_domain_impl_params =
    R"doc(The parameters for the displacement robustness computation.)doc";
...
static const char* mkd_doc_fiction_detail_displacement_robustness_domain_impl_sidbs_of_the_original_layout =
    R"doc(SiDB positions of the originally given SiDB layout.)doc";

static const char* mkd_doc_fiction_detail_displacement_robustness_domain_impl_stats =
    R"doc(The statistics of the displacement robustness computation.)doc";

static const char* mkd_doc_fiction_detail_displacement_robustness_domain_impl_truth_table =
    R"doc(The logical specification of the layout.)doc";
...
static const char* mkd_doc_fiction_detail_enumerate_all_paths_impl_collection =
    R"doc(Collection of all enumerated paths.)doc";
...
static const char* mkd_doc_fiction_detail_enumerate_all_paths_impl_layout =
...
static const char* mkd_doc_fiction_detail_enumerate_all_paths_impl_objective =
...
static const char* mkd_doc_fiction_detail_exact_impl_ari =
...
static const char* mkd_doc_fiction_detail_exact_impl_lower_bound =
    R"doc(Lower bound for the number of layout tiles.)doc";
...
static const char* mkd_doc_fiction_detail_exact_impl_result_aspect_ratio =
    R"doc(Aspect ratio of found result. Only needed for the asynchronous case.)doc";
...
static const char* mkd_doc_fiction_detail_exact_impl_smt_handler_check_point =
    R"doc(Current solver checkpoint extracted from the solver tree.)doc";
...
static const char* mkd_doc_fiction_detail_exact_impl_smt_handler_depth_ntk =
    R"doc(Mapping of levels to nodes used for symmetry breaking.)doc";
...
static const char* mkd_doc_fiction_detail_exact_impl_smt_handler_inv_levels =
    R"doc(Mapping of inverse levels to nodes used for symmetry breaking.)doc";
...
static const char* mkd_doc_fiction_detail_exact_impl_smt_handler_layout =
...
static const char* mkd_doc_fiction_detail_exact_impl_smt_handler_network =
...
static const char* mkd_doc_fiction_detail_exact_impl_smt_handler_solver =
...
static const char* mkd_doc_fiction_detail_exact_impl_smt_handler_solver_check_point_state =
    R"doc(Solver and watched literals.)doc";
...
static const char* mkd_doc_fiction_detail_exact_impl_smt_handler_solver_state_solver =
    R"doc(The actual stored solver.)doc";
...
static const char* mkd_doc_fiction_detail_exact_impl_thread_info_worker_aspect_ratio =
    R"doc(Currently examined layout aspect ratio.)doc";
...
static const char* mkd_doc_fiction_detail_fanout_substitution_impl_available_fanouts =
    R"doc(Queue map of available fanouts.)doc";
...
static const char* mkd_doc_fiction_detail_fanout_substitution_impl_ntk_topo =
    R"doc(Topological view of the converted network.)doc";

static const char* mkd_doc_fiction_detail_fanout_substitution_impl_ps =
    R"doc(Parameters controlling how fanout substitution is performed.)doc";

static const char* mkd_doc_fiction_detail_fanout_substitution_impl_rng =
    R"doc(Optional helper struct holding the RNG and its distribution.)doc";
...
static const char* mkd_doc_fiction_detail_gate_level_drvs_impl_lyt =
    R"doc(Layout to perform design rule checks on.)doc";
...
static const char* mkd_doc_fiction_detail_generate_edge_intersection_graph_impl_generate_edge_intersection_graph_impl =
    R"doc()doc";

static const char* mkd_doc_fiction_detail_generate_edge_intersection_graph_impl_graph =
    R"doc(The edge intersection graph to be created.)doc";
...
static const char*
    mkd_doc_fiction_detail_generate_edge_intersection_graph_impl_labeled_layout_coordinate_lookup_path_append =
...
static const char*
    mkd_doc_fiction_detail_generate_edge_intersection_graph_impl_labeled_layout_coordinate_lookup_path_has_intersection_with =
...
static const char*
    mkd_doc_fiction_detail_generate_edge_intersection_graph_impl_labeled_layout_coordinate_lookup_path_has_overlap_with =
...
static const char*
    mkd_doc_fiction_detail_generate_edge_intersection_graph_impl_labeled_layout_coordinate_lookup_path_label =
        R"doc(Label to identify the path in the edge intersection graph.)doc";

static const char*
    mkd_doc_fiction_detail_generate_edge_intersection_graph_impl_labeled_layout_coordinate_lookup_path_path_elements =
        R"doc(Uniquely identify path elements in a set to make them searchable in
O(1).)doc";

static const char* mkd_doc_fiction_detail_generate_edge_intersection_graph_impl_layout =
    R"doc(Reference to the layout.)doc";

static const char* mkd_doc_fiction_detail_generate_edge_intersection_graph_impl_node_id =
    R"doc(IDs for nodes and edges.)doc";

static const char* mkd_doc_fiction_detail_generate_edge_intersection_graph_impl_objectives =
    R"doc(The routing objectives.)doc";
...
static const char* mkd_doc_fiction_detail_graph_oriented_layout_design_impl_best_optimized_solution =
    R"doc(Current best solution w.r.t. area after relocating POs.)doc";
...
static const char* mkd_doc_fiction_detail_graph_oriented_layout_design_impl_custom_cost_objective =
    R"doc(Custom cost objective.)doc";
...
static const char* mkd_doc_fiction_detail_graph_oriented_layout_design_impl_initialize =
    R"doc(Initialize the search space graphs.)doc";
...
static const char* mkd_doc_fiction_detail_graph_oriented_layout_design_impl_initialize_networks_and_nodes_to_place =
    R"doc(Initializes the networks and nodes to place.)doc";
...
static const char* mkd_doc_fiction_detail_graph_oriented_layout_design_impl_max_placed_nodes =
    R"doc(Keep track of the maximum number of placed nodes.)doc";

static const char* mkd_doc_fiction_detail_graph_oriented_layout_design_impl_ntk =
    R"doc(The network to be placed and routed.)doc";

static const char* mkd_doc_fiction_detail_graph_oriented_layout_design_impl_num_search_space_graphs =
    R"doc(Number of search space graphs.)doc";

static const char* mkd_doc_fiction_detail_graph_oriented_layout_design_impl_num_search_space_graphs_high_efficiency =
    R"doc(In high-efficiency mode, only 2 search space graphs are used)doc";
...
static const char*
    mkd_doc_fiction_detail_graph_oriented_layout_design_impl_num_search_space_graphs_highest_effort_custom =
...
static const char*
    mkd_doc_fiction_detail_graph_oriented_layout_design_impl_num_search_space_graphs_maximum_effort_custom =
...
static const char* mkd_doc_fiction_detail_graph_oriented_layout_design_impl_ssg_vec =
    R"doc(Vector of search space graphs.)doc";
...
static const char* mkd_doc_fiction_detail_graph_oriented_layout_design_impl_timeout_limit_reached =
    R"doc(Timeout limit reached.)doc";
...
static const char* mkd_doc_fiction_detail_ground_state_space_impl_params =
    R"doc(Parameters used during the construction.)doc";
...
static const char* mkd_doc_fiction_detail_ground_state_space_impl_terminate =
    R"doc(`true` if and only if the construction is to be terminated.)doc";
...
static const char* mkd_doc_fiction_detail_ground_state_space_impl_witness_partitioning_state_negative_witnesses =
    R"doc(The set of witnesses for the negative charge state.)doc";

static const char* mkd_doc_fiction_detail_ground_state_space_impl_witness_partitioning_state_neutral_witnesses =
    R"doc(The set of witnesses for the neutral charge state.)doc";

static const char*
    mkd_doc_fiction_detail_ground_state_space_impl_witness_partitioning_state_omit_free_witnesses_and_count_overlap =
...
static const char* mkd_doc_fiction_detail_ground_state_space_impl_witness_partitioning_state_positive_witnesses =
    R"doc(The set of witnesses for the positive charge state.)doc";

static const char* mkd_doc_fiction_detail_ground_state_space_impl_witness_partitioning_state_required_neg_count =
    R"doc(The number of witnesses required for the negative charge state.)doc";

static const char* mkd_doc_fiction_detail_ground_state_space_impl_witness_partitioning_state_required_neut_count =
    R"doc(The number of witnesses required for the neutral charge state.)doc";

static const char* mkd_doc_fiction_detail_ground_state_space_impl_witness_partitioning_state_required_pos_count =
    R"doc(The number of witnesses required for the positive charge state.)doc";

static const char*
    mkd_doc_fiction_detail_ground_state_space_impl_witness_partitioning_state_witness_partitioning_state =
...
static const char* mkd_doc_fiction_detail_hexagonalization_impl_layout =
    R"doc(The 2DDWave-clocked layout to hexagonalize.)doc";
...
static const char* mkd_doc_fiction_detail_is_operational_impl =
    R"doc(Implementation of the `sidb::simulation::logic::is_operational` algorithm for a given SiDB
layout.

This class provides an implementation of the `sidb::simulation::logic::is_operational`
...
static const char* mkd_doc_fiction_detail_is_operational_impl_bii =
    R"doc(Iterator that iterates over all possible input states.)doc";
...
static const char* mkd_doc_fiction_detail_is_operational_impl_canvas_lyt =
    R"doc(Layout consisting of all canvas SiDBs.)doc";
...
static const char*
    mkd_doc_fiction_detail_is_operational_impl_determine_non_operational_input_patterns_and_non_operationality_reason =
...
Args:
    ...
    tt: Expected Boolean function of the layout given as a multi-
        output truth table.
    params: Parameters for the `sidb::simulation::logic::is_operational` algorithm.
...
Args:
    ...
    initialize_bii: If `true`, the BDL input iterator is initialized,
                    ...
                    in special cases (sidb::simulation::logic::verify_logic_match.hpp).
...
static const char* mkd_doc_fiction_detail_is_operational_impl_number_of_input_wires =
    R"doc(Number of input BDL wires.)doc";

static const char* mkd_doc_fiction_detail_is_operational_impl_number_of_output_wires =
    R"doc(Number of output BDL wires.)doc";
...
static const char* mkd_doc_fiction_detail_is_operational_impl_parameters =
    R"doc(Parameters for the `is_operational` algorithm.)doc";
...
static const char* mkd_doc_fiction_detail_is_operational_impl_run =
    R"doc(Run the `sidb::simulation::logic::is_operational` algorithm.
...
static const char* mkd_doc_fiction_detail_is_operational_impl_simulator_invocations =
    R"doc(Number of simulator invocations.)doc";
...
static const char* mkd_doc_fiction_detail_layout_invalidity_reason_POTENTIAL_POSITIVE_CHARGES =
    R"doc(Positive SiDBs can potentially occur.)doc";
...
static const char* mkd_doc_fiction_detail_non_operationality_reason =
    R"doc(Reason why a layout is non-operational.)doc";

static const char* mkd_doc_fiction_detail_non_operationality_reason_KINKS =
    R"doc(Kinks induced the layout to become non-operational.)doc";

static const char* mkd_doc_fiction_detail_non_operationality_reason_LOGIC_MISMATCH =
    R"doc(The layout is non-operational because of logic mismatch.)doc";

static const char* mkd_doc_fiction_detail_non_operationality_reason_NONE =
    R"doc(No reason for non-operationality could be determined.)doc";

static const char* mkd_doc_fiction_detail_non_operationality_reason_POTENTIAL_POSITIVE_CHARGES =
    R"doc(Positive charges may occur but the simulation base is set to `2`.)doc";

static const char* mkd_doc_fiction_detail_operational_domain_impl = R"doc()doc";

static const char* mkd_doc_fiction_detail_operational_domain_impl_canvas_lyt =
    R"doc(This layout consists of the canvas cells of the layout.)doc";
...
static const char* mkd_doc_fiction_detail_operational_domain_impl_layout =
    R"doc(The SiDB cell-level layout to investigate.)doc";
...
static const char* mkd_doc_fiction_detail_operational_domain_impl_num_evaluated_parameter_combinations =
    R"doc(Number of evaluated parameter combinations.)doc";

static const char* mkd_doc_fiction_detail_operational_domain_impl_num_simulator_invocations =
    R"doc(Number of simulator invocations.)doc";
...
static const char* mkd_doc_fiction_detail_operational_domain_impl_op_domain =
...
static const char* mkd_doc_fiction_detail_operational_domain_impl_output_bdl_pairs =
    R"doc(The output BDL pairs of the layout.)doc";

static const char* mkd_doc_fiction_detail_operational_domain_impl_output_bdl_wires = R"doc(Output BDL wires.)doc";

static const char* mkd_doc_fiction_detail_operational_domain_impl_params =
    R"doc(The parameters for the operational domain computation.)doc";
...
static const char* mkd_doc_fiction_detail_operational_domain_impl_stats =
...
static const char* mkd_doc_fiction_detail_operational_domain_impl_step_point_step_point =
...
static const char* mkd_doc_fiction_detail_operational_domain_impl_step_point_step_values =
    R"doc(All dimension step values.)doc";
...
static const char* mkd_doc_fiction_detail_operational_domain_impl_truth_table =
    R"doc(The logical specification of the layout.)doc";
...
static const char* mkd_doc_fiction_detail_physical_population_stability_impl_energy_and_charge_index_charge_index =
    R"doc(Charge index of the charge distribution.)doc";

static const char* mkd_doc_fiction_detail_physical_population_stability_impl_energy_and_charge_index_energy =
    R"doc(Electrostatic energy of the charge distribution (unit: eV).)doc";
...
static const char* mkd_doc_fiction_detail_physical_population_stability_impl_params =
    R"doc(Parameters required to simulate the population stability.)doc";
...
static const char* mkd_doc_fiction_detail_pi_locations =
    R"doc(This enum class indicates the allowed positions for PIs.)doc";

static const char* mkd_doc_fiction_detail_pi_locations_LEFT =
    R"doc(Flag indicating if primary inputs (PIs) can be placed at the left.)doc";

static const char* mkd_doc_fiction_detail_pi_locations_TOP =
    R"doc(Flag indicating if primary inputs (PIs) can be placed at the top.)doc";
...
static const char* mkd_doc_fiction_detail_placement_info_current_node =
    R"doc(The index of the current node being placed.)doc";

static const char* mkd_doc_fiction_detail_placement_info_current_po =
    R"doc(The index of the current primary output.)doc";

static const char* mkd_doc_fiction_detail_placement_info_node2pos =
    R"doc(Mapping of nodes to their positions in the layout.)doc";

static const char* mkd_doc_fiction_detail_placement_info_pi2node =
    R"doc(Mapping of primary input nodes to layout nodes.)doc";
...
static const char* mkd_doc_fiction_detail_post_layout_optimization_impl_max_gate_relocations =
    R"doc(Maximum number of relocations to try for each gate.)doc";

static const char* mkd_doc_fiction_detail_post_layout_optimization_impl_max_non_po =
    R"doc(Maximum coordinate of all gates that are not POs.)doc";

static const char* mkd_doc_fiction_detail_post_layout_optimization_impl_plyt =
...
static const char* mkd_doc_fiction_detail_post_layout_optimization_impl_ps =
    R"doc(Post-layout optimization parameters.)doc";

static const char* mkd_doc_fiction_detail_post_layout_optimization_impl_pst =
...
static const char* mkd_doc_fiction_detail_post_layout_optimization_impl_timeout_limit_reached =
    R"doc(Timeout limit reached.)doc";
...
static const char* mkd_doc_fiction_detail_post_layout_optimization_impl_wiring_reduction_params =
    R"doc(Wiring reduction parameters.)doc";

static const char* mkd_doc_fiction_detail_post_layout_optimization_impl_wiring_reduction_stats =
    R"doc(Wiring reduction stats.)doc";
...
static const char* mkd_doc_fiction_detail_priority_queue_counter =
    R"doc(Counter to keep track of the insertion order of elements.)doc";

static const char* mkd_doc_fiction_detail_priority_queue_elements =
    R"doc(Priority queue containing elements with associated priorities.)doc";
...
static const char* mkd_doc_fiction_detail_quickexact_impl_all_sidbs_in_lyt_without_negative_preassigned_ones =
    R"doc(All SiDBs of the layout but without the negatively-charged SiDBs.)doc";
...
static const char* mkd_doc_fiction_detail_quickexact_impl_number_of_sidbs =
    R"doc(Number of SiDBs of the input layout.)doc";
...
static const char* mkd_doc_fiction_detail_quickexact_impl_required_simulation_base_number =
    R"doc(Base number required for the correct physical simulation.)doc";
...
static const char* mkd_doc_fiction_detail_quickexact_impl_required_simulation_base_number_TWO =
    R"doc(Two state simulation (i.e., negative and neutral) is sufficient.)doc";
...
static const char* mkd_doc_fiction_detail_read_fgl_layout_impl_gate_storage_id =
    R"doc(Unique identifier for the gate.)doc";

static const char* mkd_doc_fiction_detail_read_fgl_layout_impl_gate_storage_incoming =
    R"doc(List of incoming connections to the gate.)doc";

static const char* mkd_doc_fiction_detail_read_fgl_layout_impl_gate_storage_loc =
    R"doc(Location of the gate represented its x-, y- and z-coordinate.)doc";

static const char* mkd_doc_fiction_detail_read_fgl_layout_impl_gate_storage_name =
    R"doc(Name of the gate (for inputs and outputs).)doc";
...
static const char* mkd_doc_fiction_detail_read_fgl_layout_impl_is =
    R"doc(The input stream from which the gate-level layout is read.)doc";

static const char* mkd_doc_fiction_detail_read_fgl_layout_impl_lyt =
    R"doc(The layout which will be altered based on the parsed information.)doc";
...
static const char* mkd_doc_fiction_detail_read_sqd_layout_impl_is =
    R"doc(The input stream from which the SQD file is read.)doc";

static const char* mkd_doc_fiction_detail_read_sqd_layout_impl_lyt =
    R"doc(The layout to which the parsed cells are added.)doc";

static const char* mkd_doc_fiction_detail_read_sqd_layout_impl_max_cell_pos =
    R"doc(The maximum position of a cell in the layout.)doc";
...
static const char*
    mkd_doc_fiction_detail_routing_objective_with_fanin_update_information_routing_objective_with_fanin_update_information =
...
static const char* mkd_doc_fiction_detail_sat_clocking_handler_number_of_clocks =
    R"doc(Number of clocks in layout's clocking scheme.)doc";

static const char* mkd_doc_fiction_detail_sat_clocking_handler_sat_clocking_handler = R"doc(Default constructor.)doc";

static const char* mkd_doc_fiction_detail_sat_clocking_handler_solver =
    R"doc(The solver used to find a solution to the clocking problem.)doc";
...
static const char* mkd_doc_fiction_detail_sat_coloring_handler_color_frequency_equal_to_largest_clique_size =
    R"doc()doc";

static const char* mkd_doc_fiction_detail_sat_coloring_handler_determine_min_coloring_with_binary_search = R"doc()doc";

static const char* mkd_doc_fiction_detail_sat_coloring_handler_determine_min_coloring_with_linearly_ascending_search =
    R"doc()doc";

static const char* mkd_doc_fiction_detail_sat_coloring_handler_determine_min_coloring_with_linearly_descending_search =
    R"doc()doc";
...
static const char* mkd_doc_fiction_detail_sat_coloring_handler_graph =
    R"doc(A reference to the graph to be colored.)doc";

static const char* mkd_doc_fiction_detail_sat_coloring_handler_largest_clique =
    R"doc(Iterator to the largest given clique.)doc";
...
static const char* mkd_doc_fiction_detail_sat_coloring_handler_solver_instance_solver_instance_2 =
    R"doc(Default constructor is not available.)doc";

static const char* mkd_doc_fiction_detail_sat_coloring_handler_solver_instance_variables =
    R"doc(Stores all variables.)doc";
...
static const char* mkd_doc_fiction_detail_search_space_graph_cost =
    R"doc(The cost objective used to expand a vertex in the search space graph.)doc";

static const char* mkd_doc_fiction_detail_search_space_graph_cost_so_far =
    R"doc(The cost so far for reaching each vertex in the layout.)doc";

static const char* mkd_doc_fiction_detail_search_space_graph_current_vertex =
    R"doc(The current vertex in the search space graph.)doc";

static const char* mkd_doc_fiction_detail_search_space_graph_frontier =
    R"doc(Priority queue containing vertices of the search space graph.)doc";

static const char* mkd_doc_fiction_detail_search_space_graph_frontier_flag =
    R"doc(Flag indicating if this graph's frontier is active.)doc";

static const char* mkd_doc_fiction_detail_search_space_graph_network =
    R"doc(The network associated with this search space graph.)doc";

static const char* mkd_doc_fiction_detail_search_space_graph_nodes_to_place =
    R"doc(Topological list of nodes to be placed in the layout.)doc";
...
static const char* mkd_doc_fiction_detail_wiring_reduction_impl_plyt =
...
static const char* mkd_doc_fiction_detail_wiring_reduction_impl_pst =
...
static const char* mkd_doc_fiction_detail_wiring_reduction_impl_timeout_limit_reached =
    R"doc(Timeout limit reached.)doc";
...
static const char* mkd_doc_fiction_detail_write_fgl_layout_impl_os =
    R"doc(The output stream to which the gate-level layout is written.)doc";
...
static const char* mkd_doc_fiction_detail_write_location_and_ground_state_impl_os =
    R"doc(Output stream used for writing the simulation result.)doc";

static const char* mkd_doc_fiction_detail_write_location_and_ground_state_impl_run = R"doc()doc";

static const char* mkd_doc_fiction_detail_write_location_and_ground_state_impl_sim_result =
    R"doc(Simulation results.)doc";

static const char* mkd_doc_fiction_detail_write_location_and_ground_state_impl_write_location_and_ground_state_impl =
    R"doc()doc";
...
static const char* mkd_doc_fiction_detail_write_mol_qca_layout_svg_impl_write_mol_qca_layout_svg_impl =
    R"doc(Default constructor.)doc";
...
static const char* mkd_doc_fiction_detail_write_qca_layout_svg_impl_write_qca_layout_svg_impl =
    R"doc(Default constructor.)doc";
...
static const char* mkd_doc_fiction_detail_write_sidb_layout_svg_impl_background_color =
    R"doc(The color mode for the SVG output.)doc";
...
static const char* mkd_doc_fiction_detail_write_sidb_layout_svg_impl_generate_svg =
    R"doc(Generates the SVG layout with both H-Si lattice points and SiDBs.)doc";
...
static const char* mkd_doc_fiction_detail_write_sidb_layout_svg_impl_set_colors =
    R"doc(Sets the colors based on the color mode.)doc";

static const char* mkd_doc_fiction_detail_write_sidb_layout_svg_impl_sidb_color =
    R"doc(The color of the SiDB without charge information.)doc";

static const char* mkd_doc_fiction_detail_write_sidb_layout_svg_impl_sidb_edge_color =
    R"doc(The edge color of the SiDB without charge information.)doc";

static const char* mkd_doc_fiction_detail_write_sidb_layout_svg_impl_write_sidb_layout_svg_impl =
...
static const char* mkd_doc_fiction_detail_write_sqd_sim_result_impl_ordered_cells =
...
static const char* mkd_doc_fiction_detail_write_sqd_sim_result_impl_sim_result =
    R"doc(The simulation result to write.)doc";

static const char* mkd_doc_fiction_detail_write_sqd_sim_result_impl_write_electron_distributions =
    R"doc(Writes all charge distributions to the output stream in XML format.)doc";

static const char* mkd_doc_fiction_detail_write_sqd_sim_result_impl_write_engine_info =
    R"doc(Writes the engine information to the output stream in XML format.)doc";
...
static const char* mkd_doc_fiction_detail_yen_k_shortest_paths_impl_k_shortest_paths =
    R"doc(The list of k shortest paths that is created during the algorithm.)doc";
...
static const char* mkd_doc_fiction_detail_yen_k_shortest_paths_impl_num_shortest_paths =
    R"doc(The number of paths to determine, i.e., k.)doc";

static const char* mkd_doc_fiction_detail_yen_k_shortest_paths_impl_objective =
    R"doc(Source and target coordinates.)doc";
...
static const char* mkd_doc_fiction_detail_yen_k_shortest_paths_impl_reset_temporary_obstructions =
...
static const char* mkd_doc_fiction_detail_yen_k_shortest_paths_impl_shortest_path_candidates =
...
static const char* mkd_doc_fiction_detect_bdl_pairs_params =
...
Args:
    ...
    wire_selection: The type of wires to detect, specified by the
                    `sidb::simulation::logic::bdl_wire_selection` enum. Default is
                    `sidb::simulation::logic::bdl_wire_selection::ALL`.
...
static const char* mkd_doc_fiction_detect_bdl_wires_params =
    R"doc(This struct encapsulates parameters used for detecting BDL wires.)doc";

static const char* mkd_doc_fiction_detect_bdl_wires_params_bdl_pairs_params =
    R"doc(Parameters for the `detect_bdl_pairs` algorithm.)doc";
...
static const char* mkd_doc_fiction_determine_clocking_params =
...
static const char* mkd_doc_fiction_determine_clocking_stats =
    R"doc(Statistics for the `determine_clocking` algorithm.)doc";
...
static const char* mkd_doc_fiction_determine_vertex_coloring_heuristic_params =
...
static const char* mkd_doc_fiction_determine_vertex_coloring_params_heuristic_params =
    R"doc(Parameters for `engine != SAT`.)doc";

static const char* mkd_doc_fiction_determine_vertex_coloring_params_sat_params =
    R"doc(Parameters for `engine == SAT`.)doc";

static const char* mkd_doc_fiction_determine_vertex_coloring_params_verify_coloring_after_computation =
    R"doc(Verify that the found coloring is valid.)doc";
...
static const char* mkd_doc_fiction_determine_vertex_coloring_sat_params_sat_search_tactic =
    R"doc(The search tactic to apply.)doc";
...
static const char* mkd_doc_fiction_determine_vertex_coloring_stats_color_frequency =
    R"doc(The frequency of the most used color.)doc";
...
static const char* mkd_doc_fiction_determine_vertex_coloring_stats_most_frequent_color =
    R"doc(The color that appeared the most.)doc";
...
static const char* mkd_doc_fiction_displacement_robustness_domain_params =
    R"doc(Parameters for the `sidb::simulation::defects::determine_displacement_robustness_domain` and
`sidb::simulation::defects::determine_probability_of_fabricating_operational_gate` algorithms.
...
static const char*
    mkd_doc_fiction_displacement_robustness_domain_params_dimer_displacement_policy_STAY_ON_ORIGINAL_DIMER =
...
static const char* mkd_doc_fiction_displacement_robustness_domain_params_displacement_analysis_mode =
    R"doc(Possible modes to determine the displacement robustness domain.)doc";

static const char* mkd_doc_fiction_displacement_robustness_domain_params_displacement_analysis_mode_EXHAUSTIVE =
    R"doc(All possible displacements are analyzed.)doc";
...
static const char* mkd_doc_fiction_displacement_robustness_domain_params_fixed_sidbs =
    R"doc(SiDBs in the given layout which shall not be affected by variations.)doc";
...
static const char* mkd_doc_fiction_displacement_robustness_domain_params_operational_params =
    R"doc(Parameters to check the operational status of the SiDB layout.)doc";
...
static const char* mkd_doc_fiction_displacement_robustness_domain_stats =
    R"doc(Statistics for the displacement robustness domain computation.)doc";
...
static const char* mkd_doc_fiction_energy_state_electrostatic_potential_energy =
    R"doc(The electrostatic potential energy of the charge distribution (eV).)doc";
...
static const char* mkd_doc_fiction_enumerate_all_paths_params =
...
static const char* mkd_doc_fiction_eq_type_NO =
    R"doc(`Spec` and `Impl` are logically not equivalent OR `Impl` has DRVs.)doc";
...
static const char* mkd_doc_fiction_equivalence_checking_stats_counter_example =
    R"doc(Stores a possible counter example.)doc";
...
static const char* mkd_doc_fiction_equivalence_checking_stats_tp_diff =
    R"doc(Throughput values at which weak equivalence manifests.)doc";

static const char* mkd_doc_fiction_equivalence_checking_stats_tp_impl =
    R"doc(Throughput values at which weak equivalence manifests.)doc";

static const char* mkd_doc_fiction_equivalence_checking_stats_tp_spec =
    R"doc(Throughput values at which weak equivalence manifests.)doc";
...
static const char* mkd_doc_fiction_exact_physical_design_params =
    R"doc(Parameters for the exact physical design algorithm.)doc";

static const char* mkd_doc_fiction_exact_physical_design_params_border_io =
    R"doc(Flag to indicate that I/Os should be placed at the layout's border.)doc";

static const char* mkd_doc_fiction_exact_physical_design_params_crossings =
    R"doc(Flag to indicate that crossings may be used.)doc";
...
static const char* mkd_doc_fiction_exact_physical_design_params_upper_bound_x =
    R"doc(Number of tiles to use as an upper bound in x direction.)doc";

static const char* mkd_doc_fiction_exact_physical_design_params_upper_bound_y =
    R"doc(Number of tiles to use as an upper bound in y direction.)doc";
...
static const char* mkd_doc_fiction_exact_sidb_simulation_engine =
...
Returns:
    sidb::simulation::result is returned with all results.
...
static const char* mkd_doc_fiction_fanin_container_fanin_nodes =
    R"doc(A vector of all fanin nodes except for constants.)doc";
...
static const char* mkd_doc_fiction_fanin_edge_container_fanin_edges =
...
static const char* mkd_doc_fiction_fanout_substitution_params =
    R"doc(Parameters for the fanout substitution algorithm.)doc";

static const char* mkd_doc_fiction_fanout_substitution_params_degree =
    R"doc(Maximum output degree of each fan-out node.)doc";
...
static const char* mkd_doc_fiction_fanout_substitution_params_substitution_strategy =
    R"doc(Breadth-first vs. depth-first fanout-tree substitution strategies.)doc";

static const char* mkd_doc_fiction_fanout_substitution_params_substitution_strategy_BREADTH =
    R"doc(Breadth-first substitution. Creates balanced fanout trees.)doc";

static const char* mkd_doc_fiction_fanout_substitution_params_substitution_strategy_DEPTH =
    R"doc(Depth-first substitution. Creates fanout trees with one deep branch.)doc";
...
static const char* mkd_doc_fiction_fcn_gate_library_fcn_gate_library =
...
static const char* mkd_doc_fiction_gate_design_exception_truth_table =
    R"doc(The truth table associated with the error.)doc";

static const char* mkd_doc_fiction_gate_design_exception_which_port_list =
    R"doc(Get the port list associated with the exception.)doc";

static const char* mkd_doc_fiction_gate_design_exception_which_tile =
    R"doc(Get the tile associated with the exception.)doc";

static const char* mkd_doc_fiction_gate_design_exception_which_truth_table =
    R"doc(Get the truth table associated with the exception.)doc";
...
static const char* mkd_doc_fiction_gate_level_drv_params_border_io =
    R"doc(Check if the I/Os are located at the layout's border.)doc";

static const char* mkd_doc_fiction_gate_level_drv_params_clocked_data_flow =
    R"doc(Check if all node connections obey the clocking scheme data flow.)doc";

static const char* mkd_doc_fiction_gate_level_drv_params_crossing_gates =
    R"doc(Check for wires that are crossing gates.)doc";

static const char* mkd_doc_fiction_gate_level_drv_params_empty_io =
    R"doc(Check if the I/Os are assigned to empty tiles.)doc";

static const char* mkd_doc_fiction_gate_level_drv_params_has_io = R"doc(Check if the layout has I/Os.)doc";

static const char* mkd_doc_fiction_gate_level_drv_params_io_pins =
    R"doc(Check if the I/Os are assigned to wire segments.)doc";

static const char* mkd_doc_fiction_gate_level_drv_params_missing_connections =
    R"doc(Check for nodes without connections.)doc";
...
static const char* mkd_doc_fiction_gate_level_drv_params_placed_dead_nodes =
    R"doc(Check for placed but dead nodes.)doc";
...
static const char* mkd_doc_fiction_gate_level_layout_clear_values =
    R"doc(Resets the custom value of every node in the layout to 0.)doc";

static const char* mkd_doc_fiction_gate_level_layout_clear_visited =
    R"doc(Resets the visited flag of every node in the layout to 0.)doc";
...
using the same encoding as `sidb::simulation::logic::bdl_input_iterator`.
...
static const char* mkd_doc_fiction_generate_edge_intersection_graph_params =
...
static const char* mkd_doc_fiction_generate_edge_intersection_graph_stats_num_edges =
    R"doc(Stores the size of the generated edge intersection graph.)doc";

static const char* mkd_doc_fiction_generate_edge_intersection_graph_stats_num_vertices =
    R"doc(Stores the size of the generated edge intersection graph.)doc";
...
static const char* mkd_doc_fiction_generate_random_sidb_layout_params_number_of_sidbs =
    R"doc(Number of SiDBs that are placed on the layout.)doc";

static const char* mkd_doc_fiction_generate_random_sidb_layout_params_number_of_unique_generated_layouts =
    R"doc(The desired number of unique layouts to be generated.)doc";
...
`sidb::simulation::generic::can_positive_charges_occur` function returns `true`.)doc";
...
static const char* mkd_doc_fiction_generate_random_sidb_layout_params_simulation_parameters =
    R"doc(Simulation parameters.)doc";
...
static const char* mkd_doc_fiction_graph_coloring_engine_SAT =
...
static const char* mkd_doc_fiction_graph_oriented_layout_design_params =
    R"doc(Parameters for the graph-oriented layout design algorithm.)doc";

static const char* mkd_doc_fiction_graph_oriented_layout_design_params_cost =
    R"doc(The cost objective used. Defaults to AREA)doc";
...
static const char* mkd_doc_fiction_graph_oriented_layout_design_params_cost_objective_CROSSINGS =
    R"doc(CROSSINGS: Optimizes for the number of wire crossings in the layout.)doc";
...
static const char* mkd_doc_fiction_graph_oriented_layout_design_params_mode =
    R"doc(The effort mode used. Defaults to HIGH_EFFORT.)doc";
...
static const char* mkd_doc_fiction_graph_oriented_layout_design_params_straight_inverters =
    R"doc(Enforce NOT gates to be routed non-bending only.)doc";
...
static const char* mkd_doc_fiction_graph_oriented_layout_design_stats_time_total =
    R"doc(Runtime of the graph-oriented layout design process.)doc";
...
static const char* mkd_doc_fiction_gray_code_iterator_current_iteration =
    R"doc(Current number (i.e., current iteration number).)doc";
...
static const char* mkd_doc_fiction_ground_state_space_params =
    R"doc(The set of parameters used in the *Ground State Space* construction.)doc";
...
static const char* mkd_doc_fiction_ground_state_space_results_runtime =
    R"doc(The runtime of the construction is stored.)doc";
...
static const char* mkd_doc_fiction_hexagonalization_params_input_pin_extension =
    R"doc(Input extension mode. Defaults to none)doc";
...
static const char* mkd_doc_fiction_hexagonalization_params_io_pin_extension_mode_NONE =
    R"doc(Do not extend primary inputs/outputs to the top/bottom row (default).)doc";

static const char* mkd_doc_fiction_hexagonalization_params_output_pin_extension =
    R"doc(Output extension mode. Defaults to none)doc";

static const char* mkd_doc_fiction_hexagonalization_stats =
...
static const char* mkd_doc_fiction_hexagonalization_stats_time_total =
    R"doc(Runtime of the hexagonalization process.)doc";
...
static const char* mkd_doc_fiction_inml_technology_cell_mark =
    R"doc(Possible marks to be applied to a cell to change its type.)doc";
...
static const char* mkd_doc_fiction_inml_technology_cell_type_CROSSWIRE_MAGNET =
    R"doc(Symbol used for cross-wire magnets.)doc";

static const char* mkd_doc_fiction_inml_technology_cell_type_EMPTY = R"doc(Symbol used for empty iNML cells.)doc";

static const char* mkd_doc_fiction_inml_technology_cell_type_FANOUT_COUPLER_MAGNET =
    R"doc(Symbol used for coupler (fan-out) magnets.)doc";

static const char* mkd_doc_fiction_inml_technology_cell_type_INPUT = R"doc(Symbol used for input iNML cells.)doc";

static const char* mkd_doc_fiction_inml_technology_cell_type_INVERTER_MAGNET =
    R"doc(Symbol used for inverter magnets.)doc";
...
static const char* mkd_doc_fiction_inml_technology_cell_type_SLANTED_EDGE_DOWN_MAGNET =
    R"doc(Symbol used for lower slanted edge magnets.)doc";

static const char* mkd_doc_fiction_inml_technology_cell_type_SLANTED_EDGE_UP_MAGNET =
    R"doc(Symbol used for upper slanted edge magnets.)doc";
...
using the `sidb::simulation::logic::is_operational` algorithm. It determines whether the SiDB
...
`sidb::simulation::logic::generate_bdl_input_pattern_layouts` and pass them to every call,
...
Args:
    input_pattern_layouts: One layout per input pattern, indexed by
                           input pattern, as generated by
                           `sidb::simulation::logic::generate_bdl_input_pattern_layouts`. All
...
static const char* mkd_doc_fiction_is_operational_params_input_bdl_iterator_params =
    R"doc(Parameters for the BDL input iterator.)doc";
...
static const char* mkd_doc_fiction_is_sidb_gate_design_impossible_params_bdl_iterator_params =
    R"doc(Parameters used for the BDL input iterator.)doc";

static const char* mkd_doc_fiction_is_sidb_gate_design_impossible_params_simulation_params =
    R"doc(All parameters for physical SiDB simulations.)doc";
...
static const char* mkd_doc_fiction_mincross_impl_total_crossings =
    R"doc(Current total number of edge crossings in the network.)doc";
...
static const char* mkd_doc_fiction_mincross_params =
    R"doc(Parameters for the `mincross` crossing minimization algorithm.)doc";
...
static const char* mkd_doc_fiction_mincross_stats =
    R"doc(Statistics collected during the execution of the `mincross` algorithm.)doc";

static const char* mkd_doc_fiction_mincross_stats_num_crossings =
    R"doc(The total number of edge crossings after optimization.)doc";
...
static const char* mkd_doc_fiction_mol_qca_technology_cell_mark =
    R"doc(Possible marks to be applied to a cell to change its type.)doc";
...
static const char* mkd_doc_fiction_mol_qca_technology_cell_type_CONST_0 =
    R"doc(Symbol used for constant 0 input molQCA cells.)doc";

static const char* mkd_doc_fiction_mol_qca_technology_cell_type_CONST_1 =
    R"doc(Symbol used for constant 1 input molQCA cells.)doc";
...
static const char* mkd_doc_fiction_mol_qca_technology_cell_type_NORMAL1 =
    R"doc(Symbol used for normal molQCA cells with clocking 0.)doc";

static const char* mkd_doc_fiction_mol_qca_technology_cell_type_NORMAL2 =
    R"doc(Symbol used for normal molQCA cells with clocking 1.)doc";

static const char* mkd_doc_fiction_mol_qca_technology_cell_type_NORMAL3 =
    R"doc(Symbol used for normal molQCA cells with clocking 2.)doc";

static const char* mkd_doc_fiction_mol_qca_technology_cell_type_NORMAL4 =
    R"doc(Symbol used for normal molQCA cells with clocking 3.)doc";
...
static const char* mkd_doc_fiction_network_balancing_params =
    R"doc(Parameters for the network balancing algorithm.)doc";

static const char* mkd_doc_fiction_network_balancing_params_unify_outputs =
    R"doc(Flag to indicate that all output nodes should be in the same rank.)doc";
...
static const char* mkd_doc_fiction_network_reader_networks =
    R"doc(Vector of logic networks read from files given at construction.)doc";

static const char* mkd_doc_fiction_network_reader_out =
    R"doc(Output stream to which status updates are to be written.)doc";
...
Args:
    sidb::simulation::analysis::energy_distribution: This contains the energies in eV of all
...
static const char* mkd_doc_fiction_offset_ucoord_t_ucoord_t =
    R"doc(Default constructor. Creates a dead coordinate at (0, 0, 0).)doc";
...
static const char* mkd_doc_fiction_on_the_fly_circuit_design_on_defective_surface_stats_exact_stats =
    R"doc(The `stats` of the *exact* algorithm.)doc";

static const char* mkd_doc_fiction_on_the_fly_circuit_design_on_defective_surface_stats_gate_layout =
    R"doc(The gate-level layout after P&R.)doc";

static const char* mkd_doc_fiction_on_the_fly_circuit_design_on_defective_surface_stats_time_total =
    R"doc(The total runtime of the on-the-fly circuit design.)doc";
...
static const char* mkd_doc_fiction_on_the_fly_sidb_circuit_design_on_defective_surface_params_exact_design_parameters =
    R"doc(Parameters for the *exact* placement and routing algorithm.)doc";

static const char*
    mkd_doc_fiction_on_the_fly_sidb_circuit_design_on_defective_surface_params_sidb_on_the_fly_gate_library_parameters =
        R"doc(Parameters for the SiDB on-the-fly gate library.)doc";
...
static const char* mkd_doc_fiction_on_the_fly_sidb_circuit_design_params_sidb_on_the_fly_gate_library_parameters =
    R"doc(Parameters for the SiDB on-the-fly gate library.)doc";
...
static const char* mkd_doc_fiction_operational_domain_ratio_params_op_domain_params =
    R"doc(Parameters for the operational domain computation.)doc";
...
static const char* mkd_doc_fiction_operational_domain_stats_num_evaluated_parameter_combinations =
    R"doc(Number of evaluated parameter combinations.)doc";
...
static const char* mkd_doc_fiction_operational_domain_stats_num_operational_parameter_combinations =
    R"doc(Number of parameter combinations, for which the layout is operational.)doc";

static const char* mkd_doc_fiction_operational_domain_stats_num_simulator_invocations =
    R"doc(Number of simulator invocations.)doc";

static const char* mkd_doc_fiction_operational_domain_stats_num_total_parameter_points =
    R"doc(Total number of parameter points in the parameter space.)doc";

static const char* mkd_doc_fiction_operational_domain_stats_time_total =
    R"doc(The total runtime of the operational domain computation.)doc";
...
static const char* mkd_doc_fiction_operational_domain_value_range_dimension =
    R"doc(The sweep parameter of the dimension.)doc";

static const char* mkd_doc_fiction_operational_domain_value_range_max =
    R"doc(The maximum value of the dimension sweep.)doc";

static const char* mkd_doc_fiction_operational_domain_value_range_min =
    R"doc(The minimum value of the dimension sweep.)doc";

static const char* mkd_doc_fiction_operational_domain_value_range_step =
    R"doc(The step size of the dimension sweep.)doc";
...
static const char* mkd_doc_fiction_orthogonal_physical_design_params =
    R"doc(Parameters for the orthogonal physical design algorithm.)doc";

static const char* mkd_doc_fiction_orthogonal_physical_design_params_number_of_clock_phases =
    R"doc(Number of clock phases to use. 3 and 4 are supported.)doc";
...
static const char* mkd_doc_fiction_out_of_place_edge_color_view_edge_colors =
...
static const char* mkd_doc_fiction_parameter_point =
    R"doc(The parameter point holds one parameter value per sweep dimension.)doc";
...
static const char*
    mkd_doc_fiction_physical_population_stability_params_precision_for_distance_corresponding_to_potential =
        R"doc(The precision level for the conversion from the minimum potential
difference to the corresponding distance.)doc";

static const char* mkd_doc_fiction_physical_population_stability_params_simulation_parameters =
    R"doc(Parameters for the electrostatic potential.)doc";
...
static const char* mkd_doc_fiction_population_stability_information_critical_cell =
...
static const char* mkd_doc_fiction_population_stability_information_system_energy =
    R"doc(Total electrostatic energy (unit: eV) of given charge distribution.)doc";
...
static const char* mkd_doc_fiction_port_position =
    R"doc(A port position is a relative location of a cell within a tile.)doc";
...
static const char* mkd_doc_fiction_post_layout_optimization_params =
...
static const char* mkd_doc_fiction_post_layout_optimization_params_optimize_pos_only =
    R"doc(Only optimize PO positions.)doc";
...
static const char* mkd_doc_fiction_post_layout_optimization_stats_area_improvement =
    R"doc(Area reduction (in %) after the post-layout optimization process.)doc";

static const char* mkd_doc_fiction_post_layout_optimization_stats_num_crossings_after =
    R"doc(Number of crossings after the post-layout optimization process.)doc";

static const char* mkd_doc_fiction_post_layout_optimization_stats_num_crossings_before =
    R"doc(Number of crossings before the post-layout optimization process.)doc";

static const char* mkd_doc_fiction_post_layout_optimization_stats_num_wires_after =
    R"doc(Number of wire segments after the post-layout optimization process.)doc";

static const char* mkd_doc_fiction_post_layout_optimization_stats_num_wires_before =
    R"doc(Number of wire segments before the post-layout optimization process.)doc";
...
static const char* mkd_doc_fiction_post_layout_optimization_stats_time_total =
    R"doc(Runtime of the post-layout optimization process.)doc";

static const char* mkd_doc_fiction_post_layout_optimization_stats_x_size_after =
    R"doc(Layout width after the post-layout optimization process.)doc";

static const char* mkd_doc_fiction_post_layout_optimization_stats_x_size_before =
    R"doc(Layout width before the post-layout optimization process.)doc";

static const char* mkd_doc_fiction_post_layout_optimization_stats_y_size_after =
    R"doc(Layout height after the post-layout optimization process.)doc";

static const char* mkd_doc_fiction_post_layout_optimization_stats_y_size_before =
...
static const char* mkd_doc_fiction_potential_projection_order_potential_projection_order =
    R"doc(Default constructor, creating the empty potential projection order.)doc";
...
static const char* mkd_doc_fiction_qca_technology_cell_mark =
    R"doc(Possible marks to be applied to a cell to change its type.)doc";
...
static const char* mkd_doc_fiction_qca_technology_cell_type_CONST_0 =
    R"doc(Symbol used for constant 0 input QCA cells.)doc";

static const char* mkd_doc_fiction_qca_technology_cell_type_CONST_1 =
    R"doc(Symbol used for constant 1 input QCA cells.)doc";
...
(`sidb::simulation::engines::exhaustive_ground_state_simulation`).
...
static const char* mkd_doc_fiction_quickexact_params_automatic_base_number_detection =
    R"doc(Modes to use for the *QuickExact* algorithm.)doc";
...
static const char* mkd_doc_fiction_quickexact_params_simulation_parameters =
    R"doc(All parameters for physical SiDB simulations.)doc";
...
Returns:
    `sidb::simulation::result` is returned if the simulation was
...
static const char* mkd_doc_fiction_quicksim_params =
...
static const char* mkd_doc_fiction_quicksim_params_iteration_steps =
    R"doc(Number of iterations to run the simulation for.)doc";
...
static const char* mkd_doc_fiction_quicksim_params_simulation_parameters =
    R"doc(Simulation parameters for the simulation of the physical SiDB system.)doc";
...
static const char* mkd_doc_fiction_sidb_binary_cluster_hierarchy_node =
    R"doc(Forward-declaration of sidb_binary_cluster_hierarchy_node.)doc";

static const char* mkd_doc_fiction_sidb_binary_cluster_hierarchy_node_2 =
    R"doc(Forward-declaration of sidb_binary_cluster_hierarchy_node.)doc";
...
static const char* mkd_doc_fiction_sidb_cluster_charge_state_compositions =
    R"doc(Stored compositions of this cluster charge state.)doc";
...
static const char* mkd_doc_fiction_sidb_cluster_external_sidbs =
    R"doc(The SiDBs in the layout that are not contained by the cluster.)doc";
...
static const char* mkd_doc_fiction_sidb_cluster_hierarchy_linkage_method_SINGLE =
    R"doc(Single linkage takes the minimum distance between nodes in a cluster.)doc";
...
static const char* mkd_doc_fiction_sidb_cluster_receptor_state_sidb_ix =
    R"doc(SiDB index. It is contained in the receptor cluster.)doc";
...
static const char* mkd_doc_fiction_sidb_cluster_uid =
    R"doc(Unique identifier. Equal to the SiDB index for singleton clusters.)doc";
...
static const char* mkd_doc_fiction_sidb_defect_surface_params =
    R"doc(This struct stores parameters for the `sidb_defect_surface`)doc";
...
static const char* mkd_doc_fiction_sidb_defect_type_STEP_EDGE =
    R"doc(A step edge, which is a break in the surface reconstruction.)doc";
...
static const char* mkd_doc_fiction_sidb_on_the_fly_gate_library_params_complex_gate_design_policy_DESIGN_ON_THE_FLY =
    R"doc(Design complex gates on-the-fly.)doc";

static const char* mkd_doc_fiction_sidb_on_the_fly_gate_library_params_complex_gate_design_policy_USING_PREDEFINED =
    R"doc(Use predefined complex gates if possible.)doc";

static const char* mkd_doc_fiction_sidb_on_the_fly_gate_library_params_design_gate_params =
    R"doc(This struct holds parameters to design SiDB gates.)doc";
...
static const char*
    mkd_doc_fiction_sidb_on_the_fly_gate_library_params_using_predefined_crossing_and_double_wire_if_possible =
...
static const char* mkd_doc_fiction_sidb_simulation_domain =
    R"doc(The `sidb::simulation::domain` is designed to represent a generic
...
static const char* mkd_doc_fiction_sidb_simulation_domain_domain_values =
    R"doc(The domain values stored in a thread-safe map.)doc";
...
static const char* mkd_doc_fiction_sidb_simulation_domain_sidb_simulation_domain =
    R"doc(Constructs a new `sidb_simulation_domain` instance.)doc";
...
static const char* mkd_doc_fiction_sidb_simulation_engine =
...
static const char* mkd_doc_fiction_sidb_simulation_parameters_lambda_tf =
    R"doc(`lambda_tf` is the Thomas-Fermi screening distance (unit: nm).)doc";

static const char* mkd_doc_fiction_sidb_simulation_parameters_mu_minus =
    R"doc(`mu_minus` (µ-) is the energy transition level (0/-) (unit: eV).)doc";

static const char* mkd_doc_fiction_sidb_simulation_parameters_mu_plus =
    R"doc(`mu_plus` (µ+) is the energy transition level (+/0) (unit: eV).)doc";
...
static const char* mkd_doc_fiction_sidb_simulation_result_algorithm_name =
    R"doc(Name of the algorithm used to determine the charge distributions.)doc";

static const char* mkd_doc_fiction_sidb_simulation_result_charge_distributions =
    R"doc(Charge distributions determined by the algorithm.)doc";
...
static const char* mkd_doc_fiction_sidb_simulation_result_simulation_parameters =
    R"doc(Physical parameters used in the simulation.)doc";

static const char* mkd_doc_fiction_sidb_simulation_result_simulation_runtime =
    R"doc(Total simulation runtime in seconds.)doc";
...
static const char* mkd_doc_fiction_sidb_technology_cell_mark =
    R"doc(Possible marks to be applied to a cell to change its type.)doc";
...
static const char* mkd_doc_fiction_sidb_technology_cell_type_LOGIC =
    R"doc(Symbol used for logic SiDB cells (e.g. canvas SiDBs).)doc";
...
static const char* mkd_doc_fiction_sim7_mol_library_sim7_mol_library =
    R"doc(Deleted constructor to prevent instantiation.)doc";
...
static const char* mkd_doc_fiction_siqad_coord_t_coord_t =
    R"doc(Default constructor. Creates a dead coordinate at (0, 0, 0).)doc";
...
static const char* mkd_doc_fiction_smart_distance_cache_functor_distance_cache =
...
static const char* mkd_doc_fiction_sqd_parsing_error =
...
static const char* mkd_doc_fiction_state_type =
    R"doc(Label to categorize ground and excited states of an SiDB layout.)doc";
...
static const char* mkd_doc_fiction_sweep_parameter =
    R"doc(Possible sweep parameters for the operational domain computation.)doc";

static const char* mkd_doc_fiction_sweep_parameter_EPSILON_R =
    R"doc(The relative permittivity of the dielectric material.)doc";
...
static const char* mkd_doc_fiction_synchronization_element_layout_synchronization_element_layout_storage_se_map =
    R"doc()doc";

static const char*
    mkd_doc_fiction_synchronization_element_layout_synchronization_element_layout_storage_synchronization_element_layout_storage =
        R"doc()doc";
...
static const char* mkd_doc_fiction_technology_constraints_TOPOLINANO =
    R"doc(ToPoLiNano technology-specific constraints.)doc";
...
static const char* mkd_doc_fiction_technology_mapping_stats_mapper_stats =
    R"doc(Statistics for mockturtle's mapper.)doc";
...
Args:
    ...
    sidb::simulation::engines::quicksim_params: Parameters required for the *QuickSim* algorithm.
    tts_params: Parameters used for the time-to-solution calculation.
    ps: Pointer to a struct where the results (sidb::simulation::utils::time_to_solution, acc,
...
Args:
    ...
    ps: Pointer to a struct where the statistics of this function call
        (sidb::simulation::utils::time_to_solution, acc, single runtime) are to be stored.
...
static const char* mkd_doc_fiction_time_to_solution_stats_mean_single_runtime =
    R"doc(Average single simulation runtime in seconds.)doc";
...
static const char* mkd_doc_fiction_transition_type_NEGATIVE_TO_NEUTRAL =
    R"doc(SiDB is negatively charged, but is closest to being neutrally charged.)doc";

static const char* mkd_doc_fiction_transition_type_NEUTRAL_TO_NEGATIVE =
    R"doc(SiDB is neutrally charged, but is closest to being negatively charged.)doc";

static const char* mkd_doc_fiction_transition_type_NEUTRAL_TO_POSITIVE =
    R"doc(SiDB is neutrally charged, but is closest to being positively charged.)doc";

static const char* mkd_doc_fiction_transition_type_POSITIVE_TO_NEUTRAL =
    R"doc(SiDB is positively charged, but is closest to being neutrally charged.)doc";
...
static const char* mkd_doc_fiction_unrecognized_cell_definition_exception_unrecognized_cell_definition_exception =
    R"doc()doc";
...
static const char* mkd_doc_fiction_unsupported_clocking_scheme_exception_unsupported_clocking_scheme_exception =
    R"doc()doc";
...
static const char* mkd_doc_fiction_unsupported_gate_orientation_exception_coord =
    R"doc(Coordinate at which the unsupported gate orientation was found.)doc";

static const char* mkd_doc_fiction_unsupported_gate_orientation_exception_ports =
    R"doc(Ports of the unsupported gate orientation.)doc";

static const char* mkd_doc_fiction_unsupported_gate_orientation_exception_unsupported_gate_orientation_exception =
    R"doc()doc";
...
static const char* mkd_doc_fiction_unsupported_gate_type_exception_coord =
    R"doc(Coordinate at which the unsupported gate type was found.)doc";
...
static const char* mkd_doc_fiction_virtual_pi_network_virtual_storage_map_virtual_to_real_pi =
    R"doc(Map from virtual_pis to real_pis.)doc";

static const char* mkd_doc_fiction_virtual_pi_network_virtual_storage_virtual_inputs =
    R"doc(Vector storing virtual_inputs.)doc";
...
static const char* mkd_doc_fiction_wiring_reduction_stats =
...
static const char* mkd_doc_fiction_wiring_reduction_stats_num_wires_after =
    R"doc(Number of wire segments after the wiring reduction process.)doc";

static const char* mkd_doc_fiction_wiring_reduction_stats_num_wires_before =
...
static const char* mkd_doc_fiction_wiring_reduction_stats_time_total =
    R"doc(Runtime of the wiring reduction process.)doc";

static const char* mkd_doc_fiction_wiring_reduction_stats_wiring_improvement =
    R"doc(Improvement in the number wire segments.)doc";

static const char* mkd_doc_fiction_wiring_reduction_stats_x_size_after =
    R"doc(Layout width after the wiring reduction process.)doc";

static const char* mkd_doc_fiction_wiring_reduction_stats_x_size_before =
    R"doc(Layout width before the wiring reduction process.)doc";

static const char* mkd_doc_fiction_wiring_reduction_stats_y_size_after =
    R"doc(Layout height before the wiring reduction process.)doc";

static const char* mkd_doc_fiction_wiring_reduction_stats_y_size_before =
    R"doc(Layout height before the wiring reduction process.)doc";
...
static const char* mkd_doc_fiction_write_defect_influence_domain_params =
    R"doc(Parameters for writing a defect influence domain to a CSV file.)doc";

static const char* mkd_doc_fiction_write_defect_influence_domain_params_influential_tag =
    R"doc(The tag used to represent the influential value of a defect position.)doc";
...
static const char* mkd_doc_fiction_write_fqca_layout_params_create_inter_layer_via_cells =
    R"doc(Create via cells in between each layer.)doc";
...
Raises:
    std::invalid_argument: if the number of dimensions in the
                           ...
                           `sidb::simulation::logic::sweep_parameter`, so a fourth dimension
...
static const char* mkd_doc_fiction_write_operational_domain_params =
...
static const char* mkd_doc_fiction_write_operational_domain_params_operational_tag =
    R"doc(The tag used to represent the operational value of a parameter set.)doc";

static const char* mkd_doc_fiction_write_operational_domain_params_sample_writing_mode =
    R"doc(Mode selector for writing samples to file.)doc";
...
static const char* mkd_doc_fiction_write_qca_layout_params_create_inter_layer_via_cells =
    R"doc(Create via cells in between each layer.)doc";
...
static const char* mkd_doc_fiction_write_qca_layout_svg_params_simple =
    R"doc(Limit details to create smaller file sizes.)doc";
...
static const char* mkd_doc_fiction_write_qcc_layout_params_use_filename_as_component_name =
    R"doc(Use the given filename as the component name inside the QCC file.)doc";
...
static const char* mkd_doc_fiction_write_sidb_layout_svg_params =
    R"doc(Parameters for writing SiDB layouts to SVG format.)doc";

static const char* mkd_doc_fiction_write_sidb_layout_svg_params_color_background =
    R"doc(The color mode of the background for the SVG output.)doc";

static const char* mkd_doc_fiction_write_sidb_layout_svg_params_color_mode =
    R"doc(Enumeration to specify the color mode for the SVG output.)doc";
...
static const char* mkd_doc_fiction_write_sidb_layout_svg_params_lattice_mode =
    R"doc(The lattice mode of the SiDB layout.)doc";

static const char* mkd_doc_fiction_write_sidb_layout_svg_params_lattice_point_size =
    R"doc(Size of the H-Si lattice points in SVG units.)doc";

static const char* mkd_doc_fiction_write_sidb_layout_svg_params_sidb_border_width =
    R"doc(Border width of the SiDB.)doc";
...
static const char* mkd_doc_fiction_write_sidb_layout_svg_params_sidb_lattice_mode_HIDE_LATTICE =
    R"doc(Lattice is hidden. Only SiDBs are shown.)doc";

static const char* mkd_doc_fiction_write_sidb_layout_svg_params_sidb_lattice_mode_SHOW_LATTICE =
    R"doc(Lattice is shown.)doc";
...
static const char* mkd_doc_fiction_yen_k_shortest_paths_params =
    R"doc(Parameters for Yen's :math:`k`-shortest paths algorithm.)doc";

static const char* mkd_doc_fiction_yen_k_shortest_paths_params_astar_params =
