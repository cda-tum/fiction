...
static const char *mkd_doc_fiction_fcn_area_2 =
...
static const char *mkd_doc_fiction_fcn_area_params_hspace = R"doc(Horizontal spacing between cells.)doc";

static const char *mkd_doc_fiction_fcn_area_params_vspace = R"doc(Vertical spacing between cells.)doc";

static const char *mkd_doc_fiction_fcn_area_params_width = R"doc(Width of each cell.)doc";

static const char *mkd_doc_fiction_fcn_area_stats =
...
static const char *mkd_doc_fiction_fcn_area_stats_area = R"doc(Layout area in nm².)doc";

static const char *mkd_doc_fiction_fcn_area_stats_height = R"doc(Layout height in nm.)doc";

static const char *mkd_doc_fiction_fcn_area_stats_report =
...
static const char *mkd_doc_fiction_fcn_area_stats_width = R"doc(Layout width in nm.)doc";
...
R"doc( Base class for various FCN libraries used to map gate-level layouts
 to cell-level ones. Any new gate library can extend `gate_library` if
...
static const char *mkd_doc_fiction_fcn_gate_library_gate_library = R"doc(Gate libraries should not be instantiated but used as static objects.)doc";
...
static const char *mkd_doc_fiction_fcn_port_direction =
...
static const char *mkd_doc_fiction_fcn_port_direction_cardinal = R"doc()doc";

static const char *mkd_doc_fiction_fcn_port_direction_cardinal_EAST = R"doc(East direction.)doc";

static const char *mkd_doc_fiction_fcn_port_direction_cardinal_NONE = R"doc(None direction.)doc";

static const char *mkd_doc_fiction_fcn_port_direction_cardinal_NORTH = R"doc(North direction.)doc";

static const char *mkd_doc_fiction_fcn_port_direction_cardinal_NORTH_EAST = R"doc(North-East direction.)doc";

static const char *mkd_doc_fiction_fcn_port_direction_cardinal_NORTH_WEST = R"doc(North-West direction.)doc";

static const char *mkd_doc_fiction_fcn_port_direction_cardinal_SOUTH = R"doc(South direction.)doc";

static const char *mkd_doc_fiction_fcn_port_direction_cardinal_SOUTH_EAST = R"doc(South-East direction.)doc";

static const char *mkd_doc_fiction_fcn_port_direction_cardinal_SOUTH_WEST = R"doc(South-West direction.)doc";

static const char *mkd_doc_fiction_fcn_port_direction_cardinal_WEST = R"doc(West direction.)doc";

static const char *mkd_doc_fiction_fcn_port_direction_dir = R"doc(Direction.)doc";

static const char *mkd_doc_fiction_fcn_port_direction_operator_eq =
...
static const char *mkd_doc_fiction_fcn_port_direction_operator_lt =
...
static const char *mkd_doc_fiction_fcn_port_direction_pi = R"doc(Primary input port.)doc";

static const char *mkd_doc_fiction_fcn_port_direction_po = R"doc(Primary output port.)doc";

static const char *mkd_doc_fiction_fcn_port_direction_port_direction = R"doc(Default constructor.)doc";

static const char *mkd_doc_fiction_fcn_port_direction_port_direction_2 = R"doc(Standard constructor.)doc";

static const char *mkd_doc_fiction_fcn_port_list =
R"doc(Port lists are collections of input and output ports.

Template Args:
    PortType: A port type, e.g., port_position or port_direction.)doc";

static const char *mkd_doc_fiction_fcn_port_list_inp = R"doc(Input and output positions.)doc";

static const char *mkd_doc_fiction_fcn_port_list_operator_eq =
...
static const char *mkd_doc_fiction_fcn_port_list_operator_iadd =
...
static const char *mkd_doc_fiction_fcn_port_list_out = R"doc()doc";

static const char *mkd_doc_fiction_fcn_port_list_port_list = R"doc(Default constructor.)doc";

static const char *mkd_doc_fiction_fcn_port_list_port_list_2 = R"doc(Standard constructor.)doc";

static const char *mkd_doc_fiction_fcn_port_position = R"doc(A port position is a relative location of a cell within a tile.)doc";

static const char *mkd_doc_fiction_fcn_port_position_operator_eq =
R"doc(Comparator for equality tests.
...
static const char *mkd_doc_fiction_fcn_port_position_operator_lt =
R"doc(Comparator for set insertion.
...
static const char *mkd_doc_fiction_fcn_port_position_pi = R"doc(Primary input port.)doc";

static const char *mkd_doc_fiction_fcn_port_position_po = R"doc(Primary output port.)doc";

static const char *mkd_doc_fiction_fcn_port_position_port_position = R"doc(Default constructor.)doc";

static const char *mkd_doc_fiction_fcn_port_position_port_position_2 = R"doc(Standard constructor.)doc";

static const char *mkd_doc_fiction_fcn_port_position_x = R"doc(Positions.)doc";

static const char *mkd_doc_fiction_fcn_port_position_y = R"doc()doc";

static const char *mkd_doc_fiction_fcn_unsupported_gate_orientation_exception =
...
static const char *mkd_doc_fiction_fcn_unsupported_gate_orientation_exception_coord = R"doc(Coordinate at which the unsupported gate orientation was found.)doc";

static const char *mkd_doc_fiction_fcn_unsupported_gate_orientation_exception_ports = R"doc(Ports of the unsupported gate orientation.)doc";

static const char *mkd_doc_fiction_fcn_unsupported_gate_orientation_exception_unsupported_gate_orientation_exception = R"doc()doc";

static const char *mkd_doc_fiction_fcn_unsupported_gate_orientation_exception_where =
...
static const char *mkd_doc_fiction_fcn_unsupported_gate_orientation_exception_which_ports =
...
static const char *mkd_doc_fiction_fcn_unsupported_gate_type_exception =
...
static const char *mkd_doc_fiction_fcn_unsupported_gate_type_exception_coord = R"doc(Coordinate at which the unsupported gate type was found.)doc";

static const char *mkd_doc_fiction_fcn_unsupported_gate_type_exception_unsupported_gate_type_exception = R"doc()doc";

static const char *mkd_doc_fiction_fcn_unsupported_gate_type_exception_where = R"doc()doc";
...
static const char *mkd_doc_fiction_inml_io_detail_write_qcc_layout_impl_num_magnets = R"doc()doc";

static const char *mkd_doc_fiction_inml_io_detail_write_qcc_layout_impl_os = R"doc()doc";

static const char *mkd_doc_fiction_inml_io_detail_write_qcc_layout_impl_ps = R"doc()doc";

static const char *mkd_doc_fiction_inml_io_detail_write_qcc_layout_impl_run = R"doc()doc";
...
static const char *mkd_doc_fiction_layouts_cartesian_layout_adjacent_coordinates =
...
static const char *mkd_doc_fiction_layouts_cartesian_layout_adjacent_opposite_coordinates =
...
static const char *mkd_doc_fiction_layouts_cartesian_layout_coord =
...
static const char *mkd_doc_fiction_layouts_cartesian_layout_coordinates =
...
static const char *mkd_doc_fiction_layouts_cartesian_layout_foreach_adjacent_coordinate =
...
static const char *mkd_doc_fiction_layouts_cartesian_layout_foreach_adjacent_opposite_coordinates =
...
static const char *mkd_doc_fiction_layouts_cartesian_layout_foreach_coordinate =
...
static const char *mkd_doc_fiction_layouts_cartesian_layout_foreach_ground_coordinate =
...
static const char *mkd_doc_fiction_layouts_cartesian_layout_is_adjacent_elevation_of =
...
static const char *mkd_doc_fiction_layouts_cartesian_layout_is_adjacent_of =
...
static const char *mkd_doc_fiction_layouts_cartesian_layout_is_at_any_border =
...
static const char *mkd_doc_fiction_layouts_cartesian_layout_is_at_eastern_border =
...
static const char *mkd_doc_fiction_layouts_cartesian_layout_is_at_northern_border =
R"doc(Returns whether the given coordinate is located at the layout's
...
static const char *mkd_doc_fiction_layouts_cartesian_layout_is_at_southern_border =
R"doc(Returns whether the given coordinate is located at the layout's
...
static const char *mkd_doc_fiction_layouts_cartesian_layout_is_at_western_border =
R"doc(Returns whether the given coordinate is located at the layout's
...
static const char *mkd_doc_fiction_layouts_cartesian_layout_is_below =
...
static const char *mkd_doc_fiction_layouts_cartesian_layout_is_east_of =
...
static const char *mkd_doc_fiction_layouts_cartesian_layout_is_eastwards_of =
...
static const char *mkd_doc_fiction_layouts_cartesian_layout_is_ground_layer =
...
static const char *mkd_doc_fiction_layouts_cartesian_layout_is_north_of =
...
static const char *mkd_doc_fiction_layouts_cartesian_layout_is_northwards_of =
...
static const char *mkd_doc_fiction_layouts_cartesian_layout_is_south_of =
...
static const char *mkd_doc_fiction_layouts_cartesian_layout_is_southwards_of =
...
static const char *mkd_doc_fiction_layouts_cartesian_layout_is_west_of =
...
static const char *mkd_doc_fiction_layouts_cartesian_layout_is_westwards_of =
...
static const char *mkd_doc_fiction_layouts_gate_level_layout_has_eastern_incoming_signal =
...
static const char *mkd_doc_fiction_layouts_gate_level_layout_has_eastern_outgoing_signal =
...
static const char *mkd_doc_fiction_layouts_gate_level_layout_has_no_outgoing_signal =
...
static const char *mkd_doc_fiction_layouts_gate_level_layout_has_north_eastern_incoming_signal =
...
static const char *mkd_doc_fiction_layouts_gate_level_layout_has_north_eastern_outgoing_signal =
...
static const char *mkd_doc_fiction_layouts_gate_level_layout_has_north_western_incoming_signal =
...
static const char *mkd_doc_fiction_layouts_gate_level_layout_has_north_western_outgoing_signal =
...
static const char *mkd_doc_fiction_layouts_gate_level_layout_has_northern_incoming_signal =
...
static const char *mkd_doc_fiction_layouts_gate_level_layout_has_northern_outgoing_signal =
...
static const char *mkd_doc_fiction_layouts_gate_level_layout_has_south_eastern_outgoing_signal =
...
static const char *mkd_doc_fiction_layouts_gate_level_layout_has_south_western_incoming_signal =
...
static const char *mkd_doc_fiction_layouts_gate_level_layout_has_south_western_outgoing_signal =
...
static const char *mkd_doc_fiction_layouts_gate_level_layout_has_southern_incoming_signal =
...
static const char *mkd_doc_fiction_layouts_gate_level_layout_has_southern_outgoing_signal =
...
static const char *mkd_doc_fiction_layouts_gate_level_layout_has_western_incoming_signal =
...
static const char *mkd_doc_fiction_layouts_gate_level_layout_has_western_outgoing_signal =
...
static const char *mkd_doc_fiction_layouts_hexagonal_layout_adjacent_coordinates =
R"doc(Returns a container that contains all coordinates that are adjacent to
...
static const char *mkd_doc_fiction_layouts_hexagonal_layout_coord =
R"doc(Creates and returns a coordinate in the layout from the given x-, y-,
and z-values.
...
static const char *mkd_doc_fiction_layouts_hexagonal_layout_coordinates =
R"doc(Returns a range of all coordinates accessible in the layout between
`start` and `stop`. If no values are provided, all coordinates in the
layout will be included. The returned iterator range points to the
first and last coordinate, respectively. The range object can be used
...
static const char *mkd_doc_fiction_layouts_hexagonal_layout_foreach_adjacent_coordinate =
...
static const char *mkd_doc_fiction_layouts_hexagonal_layout_foreach_coordinate =
R"doc(Applies a function to all coordinates accessible in the layout between
`start` and `stop`. The iteration order is the same as for the
coordinates function.
...
static const char *mkd_doc_fiction_layouts_hexagonal_layout_foreach_ground_coordinate =
R"doc(Applies a function to all coordinates accessible in the layout's
ground layer between `start` and `stop`. The iteration order is the
same as for the ground_coordinates function.
...
static const char *mkd_doc_fiction_layouts_hexagonal_layout_is_adjacent_elevation_of =
R"doc(Similar to is_adjacent_of but also considers `c1`'s elevation, i.e.,
if `c2` is adjacent to `above(c1)` or `below(c1)`.
...
static const char *mkd_doc_fiction_layouts_hexagonal_layout_is_adjacent_of =
...
static const char *mkd_doc_fiction_layouts_hexagonal_layout_is_at_any_border =
R"doc(Returns whether the given coordinate is located at any of the layout's
borders where x or y are either minimal or maximal.
...
static const char *mkd_doc_fiction_layouts_hexagonal_layout_is_at_eastern_border =
R"doc(Returns whether the given coordinate is located at the layout's
eastern border where x is maximal.
...
static const char *mkd_doc_fiction_layouts_hexagonal_layout_is_at_northern_border =
R"doc(Returns whether the given coordinate is located at the layout's
northern border where y is minimal.
...
static const char *mkd_doc_fiction_layouts_hexagonal_layout_is_at_southern_border =
R"doc(Returns whether the given coordinate is located at the layout's
southern border where y is maximal.
...
static const char *mkd_doc_fiction_layouts_hexagonal_layout_is_at_western_border =
R"doc(Returns whether the given coordinate is located at the layout's
western border where x is minimal.
...
static const char *mkd_doc_fiction_layouts_hexagonal_layout_is_below =
R"doc(Returns `true` iff coordinate `c2` is directly below coordinate `c1`.
...
static const char *mkd_doc_fiction_layouts_hexagonal_layout_is_east_of =
R"doc(Returns `true` iff coordinate `c2` is directly east of coordinate
`c1`.
...
static const char *mkd_doc_fiction_layouts_hexagonal_layout_is_eastwards_of =
R"doc(Returns `true` iff coordinate `c2` is somewhere east of coordinate
`c1`.
...
static const char *mkd_doc_fiction_layouts_hexagonal_layout_is_ground_layer =
R"doc(Returns whether the given coordinate is located in the ground layer
where z is minimal.
...
static const char *mkd_doc_fiction_layouts_hexagonal_layout_is_in_even_column =
...
static const char *mkd_doc_fiction_layouts_hexagonal_layout_is_in_even_row =
...
static const char *mkd_doc_fiction_layouts_hexagonal_layout_is_in_odd_column =
...
static const char *mkd_doc_fiction_layouts_hexagonal_layout_is_in_odd_row =
...
static const char *mkd_doc_fiction_layouts_hexagonal_layout_is_north_of =
R"doc(Returns `true` iff coordinate `c2` is directly north of coordinate
`c1`.
...
static const char *mkd_doc_fiction_layouts_hexagonal_layout_is_northwards_of =
R"doc(Returns `true` iff coordinate `c2` is somewhere north of coordinate
`c1`.
...
static const char *mkd_doc_fiction_layouts_hexagonal_layout_is_south_of =
R"doc(Returns `true` iff coordinate `c2` is directly south of coordinate
`c1`.
...
static const char *mkd_doc_fiction_layouts_hexagonal_layout_is_southwards_of =
R"doc(Returns `true` iff coordinate `c2` is somewhere south of coordinate
`c1`.
...
static const char *mkd_doc_fiction_layouts_hexagonal_layout_is_west_of =
R"doc(Returns `true` iff coordinate `c2` is directly west of coordinate
`c1`.
...
static const char *mkd_doc_fiction_layouts_hexagonal_layout_is_westwards_of =
R"doc(Returns `true` iff coordinate `c2` is somewhere west of coordinate
`c1`.
...
static const char *mkd_doc_fiction_layouts_io_fgl_parsing_error_fgl_parsing_error =
...
static const char *mkd_doc_fiction_layouts_io_gate_layout_cartesian_drawer =
...
static const char *mkd_doc_fiction_layouts_io_print_gate_level_layout =
...
static const char *mkd_doc_fiction_layouts_io_print_layout =
...
static const char *mkd_doc_fiction_layouts_io_read_fgl_layout_3 =
...
static const char *mkd_doc_fiction_layouts_io_read_fgl_layout_4 =
R"doc(Reads a gate-level layout from an FGL file provided as a file name.
...
static const char *mkd_doc_fiction_layouts_io_simple_gate_layout_tile_drawer =
...
static const char *mkd_doc_fiction_networks_io_color_view_drawer_node_fillcolor = R"doc()doc";

static const char *mkd_doc_fiction_networks_io_color_view_drawer_node_label = R"doc()doc";

static const char *mkd_doc_fiction_networks_io_edge_color_view_drawer =
...
static const char *mkd_doc_fiction_networks_io_edge_color_view_drawer_last_accessed = R"doc()doc";

static const char *mkd_doc_fiction_networks_io_edge_color_view_drawer_node_fillcolor =
...
static const char *mkd_doc_fiction_networks_io_edge_color_view_drawer_signal_style = R"doc()doc";
...
static const char *mkd_doc_fiction_networks_io_network_reader_get_networks =
...
static const char *mkd_doc_fiction_networks_io_network_reader_network_reader =
...
static const char *mkd_doc_fiction_networks_io_network_reader_networks = R"doc(Vector of logic networks read from files given at construction.)doc";

static const char *mkd_doc_fiction_networks_io_network_reader_out = R"doc(Output stream to which status updates are to be written.)doc";

static const char *mkd_doc_fiction_networks_io_network_reader_read =
...
static const char *mkd_doc_fiction_networks_io_technology_dot_drawer =
...
static const char *mkd_doc_fiction_networks_io_technology_dot_drawer_is_node_number =
...
static const char *mkd_doc_fiction_networks_io_technology_dot_drawer_node_fillcolor = R"doc()doc";
...
static const char *mkd_doc_fiction_networks_technology_network_add_additional_functions =
R"doc(Adds some further Boolean functions to the truth table cache for fixed
indexing.

)doc";

static const char *mkd_doc_fiction_networks_technology_network_clone = R"doc()doc";

static const char *mkd_doc_fiction_networks_technology_network_clone_node = R"doc()doc";

static const char *mkd_doc_fiction_networks_technology_network_create_and = R"doc()doc";

static const char *mkd_doc_fiction_networks_technology_network_create_buf =
...
static const char *mkd_doc_fiction_networks_technology_network_create_dot = R"doc()doc";

static const char *mkd_doc_fiction_networks_technology_network_create_ge = R"doc()doc";

static const char *mkd_doc_fiction_networks_technology_network_create_gt = R"doc()doc";

static const char *mkd_doc_fiction_networks_technology_network_create_ite = R"doc()doc";

static const char *mkd_doc_fiction_networks_technology_network_create_le = R"doc()doc";

static const char *mkd_doc_fiction_networks_technology_network_create_lt = R"doc()doc";

static const char *mkd_doc_fiction_networks_technology_network_create_maj = R"doc()doc";

static const char *mkd_doc_fiction_networks_technology_network_create_nand = R"doc()doc";

static const char *mkd_doc_fiction_networks_technology_network_create_nary_and = R"doc()doc";

static const char *mkd_doc_fiction_networks_technology_network_create_nary_or = R"doc()doc";

static const char *mkd_doc_fiction_networks_technology_network_create_nary_xor = R"doc()doc";

static const char *mkd_doc_fiction_networks_technology_network_create_node = R"doc(Disable structural hashing.)doc";

static const char *mkd_doc_fiction_networks_technology_network_create_node_2 = R"doc(Disable structural hashing.)doc";

static const char *mkd_doc_fiction_networks_technology_network_create_nor = R"doc()doc";

static const char *mkd_doc_fiction_networks_technology_network_create_not = R"doc()doc";

static const char *mkd_doc_fiction_networks_technology_network_create_or = R"doc()doc";

static const char *mkd_doc_fiction_networks_technology_network_create_xnor = R"doc()doc";

static const char *mkd_doc_fiction_networks_technology_network_create_xor = R"doc()doc";

static const char *mkd_doc_fiction_networks_technology_network_create_xor3 = R"doc()doc";

static const char *mkd_doc_fiction_networks_technology_network_is_and = R"doc()doc";

static const char *mkd_doc_fiction_networks_technology_network_is_and3 = R"doc()doc";

static const char *mkd_doc_fiction_networks_technology_network_is_and_xor = R"doc()doc";

static const char *mkd_doc_fiction_networks_technology_network_is_buf =
...
static const char *mkd_doc_fiction_networks_technology_network_is_dot = R"doc()doc";

static const char *mkd_doc_fiction_networks_technology_network_is_fanout =
...
static const char *mkd_doc_fiction_networks_technology_network_is_gamble = R"doc()doc";

static const char *mkd_doc_fiction_networks_technology_network_is_ge = R"doc()doc";

static const char *mkd_doc_fiction_networks_technology_network_is_gt = R"doc()doc";

static const char *mkd_doc_fiction_networks_technology_network_is_inv =
...
static const char *mkd_doc_fiction_networks_technology_network_is_ite = R"doc()doc";

static const char *mkd_doc_fiction_networks_technology_network_is_le = R"doc()doc";

static const char *mkd_doc_fiction_networks_technology_network_is_lt = R"doc()doc";

static const char *mkd_doc_fiction_networks_technology_network_is_maj = R"doc()doc";

static const char *mkd_doc_fiction_networks_technology_network_is_nand = R"doc()doc";

static const char *mkd_doc_fiction_networks_technology_network_is_nor = R"doc()doc";

static const char *mkd_doc_fiction_networks_technology_network_is_onehot = R"doc()doc";

static const char *mkd_doc_fiction_networks_technology_network_is_or = R"doc()doc";

static const char *mkd_doc_fiction_networks_technology_network_is_or_and = R"doc()doc";

static const char *mkd_doc_fiction_networks_technology_network_is_po =
...
static const char *mkd_doc_fiction_networks_technology_network_is_xnor = R"doc()doc";

static const char *mkd_doc_fiction_networks_technology_network_is_xor = R"doc()doc";

static const char *mkd_doc_fiction_networks_technology_network_is_xor3 = R"doc()doc";

static const char *mkd_doc_fiction_networks_technology_network_is_xor_and = R"doc()doc";

static const char *mkd_doc_fiction_networks_technology_network_substitute_po_signals =
...
static const char *mkd_doc_fiction_networks_views_5 =
R"doc(Deduction guide for `fiction::networks::views::static_depth_view`.
...
static const char *mkd_doc_fiction_networks_views_6 =
...
static const char *mkd_doc_fiction_networks_views_bfs_topo_view =
...
static const char *mkd_doc_fiction_networks_views_depth_view_params = R"doc(Parameters for depth view.)doc";

static const char *mkd_doc_fiction_networks_views_depth_view_params_count_complements = R"doc(Take complemented edges into account for depth computation.)doc";

static const char *mkd_doc_fiction_networks_views_depth_view_params_pi_cost = R"doc(Whether PIs have costs.)doc";

static const char *mkd_doc_fiction_networks_views_mutable_rank_view =
...
static const char *mkd_doc_fiction_networks_views_out_of_place_edge_color_view =
...
static const char *mkd_doc_fiction_networks_views_out_of_place_edge_color_view_clear_colors = R"doc(Remove all assigned colors.)doc";

static const char *mkd_doc_fiction_networks_views_out_of_place_edge_color_view_edge_color =
...
static const char *mkd_doc_fiction_networks_views_out_of_place_edge_color_view_edge_colors = R"doc(Out-of-place storage for edge colors.)doc";

static const char *mkd_doc_fiction_networks_views_out_of_place_edge_color_view_eval_edge_color =
...
static const char *mkd_doc_fiction_networks_views_out_of_place_edge_color_view_eval_edge_color_2 =
...
static const char *mkd_doc_fiction_networks_views_out_of_place_edge_color_view_out_of_place_edge_color_view =
R"doc(Standard constructor.
...
static const char *mkd_doc_fiction_networks_views_out_of_place_edge_color_view_paint_edge =
...
static const char *mkd_doc_fiction_networks_views_out_of_place_edge_color_view_paint_edge_2 =
...
static const char *mkd_doc_fiction_networks_views_out_of_place_edge_color_view_paint_edge_3 =
...
static const char *mkd_doc_fiction_networks_views_static_depth_view =
...
static const char *mkd_doc_fiction_networks_virtual_pi_network = R"doc()doc";

static const char *mkd_doc_fiction_networks_virtual_pi_network_clone = R"doc(Clones the `virtual_pi_network` object.)doc";

static const char *mkd_doc_fiction_networks_virtual_pi_network_create_virtual_pi =
...
static const char *mkd_doc_fiction_networks_virtual_pi_network_foreach_real_ci =
...
static const char *mkd_doc_fiction_networks_virtual_pi_network_foreach_real_pi =
...
static const char *mkd_doc_fiction_networks_virtual_pi_network_foreach_virtual_ci =
R"doc(Iterates over the virtual CIs of the circuit and applies a given
function.
...
static const char *mkd_doc_fiction_networks_virtual_pi_network_foreach_virtual_pi =
...
static const char *mkd_doc_fiction_networks_virtual_pi_network_get_real_pi =
...
static const char *mkd_doc_fiction_networks_virtual_pi_network_is_real_ci =
...
static const char *mkd_doc_fiction_networks_virtual_pi_network_is_real_pi =
...
static const char *mkd_doc_fiction_networks_virtual_pi_network_is_virtual_ci =
...
static const char *mkd_doc_fiction_networks_virtual_pi_network_is_virtual_pi =
...
static const char *mkd_doc_fiction_networks_virtual_pi_network_num_real_cis =
...
static const char *mkd_doc_fiction_networks_virtual_pi_network_num_real_pis =
...
static const char *mkd_doc_fiction_networks_virtual_pi_network_num_virtual_cis =
...
static const char *mkd_doc_fiction_networks_virtual_pi_network_num_virtual_pis =
...
static const char *mkd_doc_fiction_networks_virtual_pi_network_real_size =
...
static const char *mkd_doc_fiction_networks_virtual_pi_network_v_storage = R"doc(Shared pointer of the virtual PI storage.)doc";

static const char *mkd_doc_fiction_networks_virtual_pi_network_virtual_pi_network =
R"doc(Default constructor for the `virtual_pi_network` class. Initializes
`v_storage` as a shared pointer.

)doc";

static const char *mkd_doc_fiction_networks_virtual_pi_network_virtual_pi_network_2 =
...
static const char *mkd_doc_fiction_networks_virtual_pi_network_virtual_storage = R"doc()doc";

static const char *mkd_doc_fiction_networks_virtual_pi_network_virtual_storage_map_virtual_to_real_pi = R"doc(Map from virtual_pis to real_pis.)doc";

static const char *mkd_doc_fiction_networks_virtual_pi_network_virtual_storage_virtual_inputs = R"doc(Vector storing virtual_inputs.)doc";
...
static const char *mkd_doc_fiction_physical_design_color_routing =
...
static const char *mkd_doc_fiction_physical_design_color_routing_params = R"doc(Parameters for the color routing algorithm.)doc";

static const char *mkd_doc_fiction_physical_design_color_routing_params_conduct_partial_routing =
R"doc(Do not abort if some objectives cannot be fulfilled, but partially
route the layout as much as possible.)doc";

static const char *mkd_doc_fiction_physical_design_color_routing_params_crossings = R"doc(Enable crossings.)doc";

static const char *mkd_doc_fiction_physical_design_color_routing_params_engine = R"doc(The engine to use.)doc";

static const char *mkd_doc_fiction_physical_design_color_routing_params_partial_sat = R"doc(Allow partial solutions when the SAT engine is used.)doc";

static const char *mkd_doc_fiction_physical_design_color_routing_params_path_limit =
...
static const char *mkd_doc_fiction_physical_design_color_routing_stats = R"doc()doc";

static const char *mkd_doc_fiction_physical_design_color_routing_stats_color_stats = R"doc(Statistics of the vertex coloring.)doc";

static const char *mkd_doc_fiction_physical_design_color_routing_stats_epg_stats = R"doc(Statistics of the edge intersection graph generation.)doc";

static const char *mkd_doc_fiction_physical_design_color_routing_stats_number_of_unsatisfied_objectives =
R"doc(For each routing objective that was not fulfilled by the coloring
engine, this counter is incremented.)doc";

static const char *mkd_doc_fiction_physical_design_color_routing_stats_time_total = R"doc(Runtime measurement.)doc";

static const char *mkd_doc_fiction_physical_design_detail_add_obstructions =
...
static const char *mkd_doc_fiction_physical_design_detail_calculate_offset_matrix =
...
static const char *mkd_doc_fiction_physical_design_detail_color_routing_impl = R"doc()doc";

static const char *mkd_doc_fiction_physical_design_detail_color_routing_impl_color_routing_impl = R"doc()doc";

static const char *mkd_doc_fiction_physical_design_detail_color_routing_impl_conduct_routing =
...
static const char *mkd_doc_fiction_physical_design_detail_color_routing_impl_layout = R"doc(The layout to route.)doc";

static const char *mkd_doc_fiction_physical_design_detail_color_routing_impl_objectives = R"doc(The routing objectives.)doc";

static const char *mkd_doc_fiction_physical_design_detail_color_routing_impl_ps = R"doc(Parameters.)doc";

static const char *mkd_doc_fiction_physical_design_detail_color_routing_impl_pst = R"doc(Statistics.)doc";

static const char *mkd_doc_fiction_physical_design_detail_color_routing_impl_run = R"doc()doc";

static const char *mkd_doc_fiction_physical_design_detail_coloring_container = R"doc()doc";

static const char *mkd_doc_fiction_physical_design_detail_coloring_container_color_east = R"doc()doc";

static const char *mkd_doc_fiction_physical_design_detail_coloring_container_color_ntk = R"doc()doc";

static const char *mkd_doc_fiction_physical_design_detail_coloring_container_color_null = R"doc()doc";

static const char *mkd_doc_fiction_physical_design_detail_coloring_container_color_south = R"doc()doc";

static const char *mkd_doc_fiction_physical_design_detail_coloring_container_coloring_container = R"doc()doc";

static const char *mkd_doc_fiction_physical_design_detail_coloring_container_opposite_color = R"doc()doc";

static const char *mkd_doc_fiction_physical_design_detail_compare_gate_tiles =
...
static const char *mkd_doc_fiction_physical_design_detail_compute_num_inputs_left_to_middle_pi =
...
static const char *mkd_doc_fiction_physical_design_detail_compute_num_inputs_right_to_middle_pi =
R"doc(This function iterates over all primary inputs in the given Cartesian
...
static const char *mkd_doc_fiction_physical_design_detail_compute_num_outputs_left_to_middle_po =
...
static const char *mkd_doc_fiction_physical_design_detail_compute_num_outputs_right_to_middle_po =
R"doc(This function iterates over all primary outputs in the given Cartesian
...
static const char *mkd_doc_fiction_physical_design_detail_connect_and_place = R"doc()doc";

static const char *mkd_doc_fiction_physical_design_detail_connect_and_place_2 = R"doc()doc";

static const char *mkd_doc_fiction_physical_design_detail_create_wiring_reduction_layout =
...
static const char *mkd_doc_fiction_physical_design_detail_determine_new_coord =
...
static const char *mkd_doc_fiction_physical_design_detail_exact_impl_run_asynchronously =
...
static const char *mkd_doc_fiction_physical_design_detail_exact_impl_run_synchronously =
...
static const char *mkd_doc_fiction_physical_design_detail_exact_impl_scheme = R"doc(The utilized clocking scheme.)doc";

static const char *mkd_doc_fiction_physical_design_detail_exact_impl_smt_handler =
...
static const char *mkd_doc_fiction_physical_design_detail_exact_impl_smt_handler_apply_to_added_and_updated_tiles =
...
static const char *mkd_doc_fiction_physical_design_detail_exact_impl_smt_handler_apply_to_added_tiles =
...
static const char *mkd_doc_fiction_physical_design_detail_exact_impl_smt_handler_apply_to_updated_tiles =
...
static const char *mkd_doc_fiction_physical_design_detail_exact_impl_smt_handler_assign_layout =
...
static const char *mkd_doc_fiction_physical_design_detail_exact_impl_smt_handler_assign_layout_clocking =
...
static const char *mkd_doc_fiction_physical_design_detail_exact_impl_smt_handler_assign_pi_clockings =
...
static const char *mkd_doc_fiction_physical_design_detail_exact_impl_smt_handler_assumption_literals =
...
static const char *mkd_doc_fiction_physical_design_detail_exact_impl_smt_handler_assumption_literals_e =
R"doc(Watched literals for eastern and southern constraints which are used
to reformulate them.)doc";

static const char *mkd_doc_fiction_physical_design_detail_exact_impl_smt_handler_assumption_literals_s =
R"doc(Watched literals for eastern and southern constraints which are used
to reformulate them.)doc";

static const char *mkd_doc_fiction_physical_design_detail_exact_impl_smt_handler_black_list =
R"doc(Maps tiles to blacklisted gate types via their truth tables and port
information.)doc";

static const char *mkd_doc_fiction_physical_design_detail_exact_impl_smt_handler_black_list_gates =
...
static const char *mkd_doc_fiction_physical_design_detail_exact_impl_smt_handler_define_gate_fanout_tiles =
R"doc(Adds constraints to the solver to enforce that a tile which was
...
static const char *mkd_doc_fiction_physical_design_detail_exact_impl_smt_handler_define_number_of_connections =
...
static const char *mkd_doc_fiction_physical_design_detail_exact_impl_smt_handler_define_wire_fanin_tiles =
...
static const char *mkd_doc_fiction_physical_design_detail_exact_impl_smt_handler_define_wire_fanout_tiles =
R"doc(Adds constraints to the solver to enforce that a tile that was
...
static const char *mkd_doc_fiction_physical_design_detail_exact_impl_smt_handler_depth_ntk = R"doc(Mapping of levels to nodes used for symmetry breaking.)doc";

static const char *mkd_doc_fiction_physical_design_detail_exact_impl_smt_handler_eliminate_cycles =
...
static const char *mkd_doc_fiction_physical_design_detail_exact_impl_smt_handler_enforce_border_io =
R"doc(Adds constraints to the solver to position the primary inputs and
primary outputs at the layout's borders.

)doc";

static const char *mkd_doc_fiction_physical_design_detail_exact_impl_smt_handler_enforce_straight_inverters =
R"doc(Adds constraints to the solver to enforce that no bent inverters are
used.

)doc";

static const char *mkd_doc_fiction_physical_design_detail_exact_impl_smt_handler_establish_sub_paths =
...
static const char *mkd_doc_fiction_physical_design_detail_exact_impl_smt_handler_establish_transitive_paths =
...
static const char *mkd_doc_fiction_physical_design_detail_exact_impl_smt_handler_generate_smt_instance =
R"doc(Generates the SMT instance by calling the constraint generating
functions.

)doc";

static const char *mkd_doc_fiction_physical_design_detail_exact_impl_smt_handler_get_lit_e =
...
static const char *mkd_doc_fiction_physical_design_detail_exact_impl_smt_handler_get_lit_s =
...
static const char *mkd_doc_fiction_physical_design_detail_exact_impl_smt_handler_get_ncl =
...
static const char *mkd_doc_fiction_physical_design_detail_exact_impl_smt_handler_get_solver_statistics =
...
static const char *mkd_doc_fiction_physical_design_detail_exact_impl_smt_handler_get_tc =
...
static const char *mkd_doc_fiction_physical_design_detail_exact_impl_smt_handler_get_tcl =
...
static const char *mkd_doc_fiction_physical_design_detail_exact_impl_smt_handler_get_te =
...
static const char *mkd_doc_fiction_physical_design_detail_exact_impl_smt_handler_get_tn =
...
static const char *mkd_doc_fiction_physical_design_detail_exact_impl_smt_handler_get_tp =
...
static const char *mkd_doc_fiction_physical_design_detail_exact_impl_smt_handler_get_tse =
...
static const char *mkd_doc_fiction_physical_design_detail_exact_impl_smt_handler_global_synchronization =
...
static const char *mkd_doc_fiction_physical_design_detail_exact_impl_smt_handler_inv_levels = R"doc(Mapping of inverse levels to nodes used for symmetry breaking.)doc";

static const char *mkd_doc_fiction_physical_design_detail_exact_impl_smt_handler_is_added_tile =
...
static const char *mkd_doc_fiction_physical_design_detail_exact_impl_smt_handler_is_satisfiable =
...
static const char *mkd_doc_fiction_physical_design_detail_exact_impl_smt_handler_is_updated_tile =
...
static const char *mkd_doc_fiction_physical_design_detail_exact_impl_smt_handler_layout = R"doc(The sketch that later contains the layout generated from a model.)doc";

static const char *mkd_doc_fiction_physical_design_detail_exact_impl_smt_handler_lc = R"doc(Assumption literal counter.)doc";

static const char *mkd_doc_fiction_physical_design_detail_exact_impl_smt_handler_lit =
...
static const char *mkd_doc_fiction_physical_design_detail_exact_impl_smt_handler_minimize_crossings =
...
static const char *mkd_doc_fiction_physical_design_detail_exact_impl_smt_handler_minimize_synchronization_elements =
...
static const char *mkd_doc_fiction_physical_design_detail_exact_impl_smt_handler_minimize_wires =
R"doc(Adds constraints to the given optimize to minimize the number of
crossing tiles to use.
...
static const char *mkd_doc_fiction_physical_design_detail_exact_impl_smt_handler_mk_as =
...
static const char *mkd_doc_fiction_physical_design_detail_exact_impl_smt_handler_mk_as_if_se =
R"doc(Helper function for generating an implication lit -> constraint where
...
static const char *mkd_doc_fiction_physical_design_detail_exact_impl_smt_handler_mk_clk_mod =
...
static const char *mkd_doc_fiction_physical_design_detail_exact_impl_smt_handler_mk_eq =
...
static const char *mkd_doc_fiction_physical_design_detail_exact_impl_smt_handler_ncl_to_real =
...
static const char *mkd_doc_fiction_physical_design_detail_exact_impl_smt_handler_network = R"doc(Logical specification for the layout.)doc";

static const char *mkd_doc_fiction_physical_design_detail_exact_impl_smt_handler_network_in_degree =
...
static const char *mkd_doc_fiction_physical_design_detail_exact_impl_smt_handler_network_out_degree =
...
static const char *mkd_doc_fiction_physical_design_detail_exact_impl_smt_handler_node2pos =
R"doc(Maps nodes to tile positions when creating the layout from the SMT
model.)doc";

static const char *mkd_doc_fiction_physical_design_detail_exact_impl_smt_handler_optimize =
...
static const char *mkd_doc_fiction_physical_design_detail_exact_impl_smt_handler_params =
R"doc(Configurations specifying layout restrictions. Used in instance
generation among other places.)doc";

static const char *mkd_doc_fiction_physical_design_detail_exact_impl_smt_handler_place_output =
...
static const char *mkd_doc_fiction_physical_design_detail_exact_impl_smt_handler_prevent_insufficiencies =
...
static const char *mkd_doc_fiction_physical_design_detail_exact_impl_smt_handler_restrict_clocks =
...
static const char *mkd_doc_fiction_physical_design_detail_exact_impl_smt_handler_restrict_synchronization_elements =
...
static const char *mkd_doc_fiction_physical_design_detail_exact_impl_smt_handler_restrict_tile_elements =
...
static const char *mkd_doc_fiction_physical_design_detail_exact_impl_smt_handler_restrict_vertices =
R"doc(Adds constraints to the solver to enforce that each node is placed
exactly once on exactly one tile.

)doc";

static const char *mkd_doc_fiction_physical_design_detail_exact_impl_smt_handler_route =
...
static const char *mkd_doc_fiction_physical_design_detail_exact_impl_smt_handler_set_timeout =
...
static const char *mkd_doc_fiction_physical_design_detail_exact_impl_smt_handler_skip_const_or_io_edge =
...
static const char *mkd_doc_fiction_physical_design_detail_exact_impl_smt_handler_skip_const_or_io_node =
...
static const char *mkd_doc_fiction_physical_design_detail_exact_impl_smt_handler_skippable =
...
static const char *mkd_doc_fiction_physical_design_detail_exact_impl_smt_handler_smt_handler =
R"doc(Standard constructor.
...
static const char *mkd_doc_fiction_physical_design_detail_exact_impl_smt_handler_solver = R"doc(Shortcut to the solver stored in check_point.)doc";

static const char *mkd_doc_fiction_physical_design_detail_exact_impl_smt_handler_solver_check_point =
...
static const char *mkd_doc_fiction_physical_design_detail_exact_impl_smt_handler_solver_check_point_added_tiles =
...
static const char *mkd_doc_fiction_physical_design_detail_exact_impl_smt_handler_solver_check_point_assumptions =
R"doc(Assumptions that are true for only one solver run. Always includes the
assumption literal that did not change.)doc";

static const char *mkd_doc_fiction_physical_design_detail_exact_impl_smt_handler_solver_check_point_state = R"doc(Solver and watched literals.)doc";

static const char *mkd_doc_fiction_physical_design_detail_exact_impl_smt_handler_solver_check_point_updated_tiles =
R"doc(added_tiles contains only the newly added tiles in eastern or southern
direction. updated_tiles instead contains the column (eastern) or row
(southern) of tiles that used to be at the border but is not anymore
now. In these tiles, certain assertions change so that their previous
...
static const char *mkd_doc_fiction_physical_design_detail_exact_impl_smt_handler_solver_state =
...
static const char *mkd_doc_fiction_physical_design_detail_exact_impl_smt_handler_solver_state_lit =
R"doc(Watched literals for eastern and southern constraints which are used
to reformulate them.)doc";

static const char *mkd_doc_fiction_physical_design_detail_exact_impl_smt_handler_solver_state_solver = R"doc(The actual stored solver.)doc";

static const char *mkd_doc_fiction_physical_design_detail_exact_impl_smt_handler_solver_tree =
...
static const char *mkd_doc_fiction_physical_design_detail_exact_impl_smt_handler_technology_specific_constraints =
R"doc(Adds constraints to the solver to enforce technology-specific
restrictions.

)doc";

static const char *mkd_doc_fiction_physical_design_detail_exact_impl_smt_handler_tile_ite_counters =
...
static const char *mkd_doc_fiction_physical_design_detail_exact_impl_smt_handler_update =
...
static const char *mkd_doc_fiction_physical_design_detail_exact_impl_smt_handler_utilize_hierarchical_information =
...
static const char *mkd_doc_fiction_physical_design_detail_get_path =
...
static const char *mkd_doc_fiction_physical_design_detail_graph_oriented_layout_design_impl =
...
static const char *mkd_doc_fiction_physical_design_detail_graph_oriented_layout_design_impl_adjust_layout_size =
...
static const char *mkd_doc_fiction_physical_design_detail_graph_oriented_layout_design_impl_best_acp_solution =
...
static const char *mkd_doc_fiction_physical_design_detail_graph_oriented_layout_design_impl_best_area_solution =
...
static const char *mkd_doc_fiction_physical_design_detail_graph_oriented_layout_design_impl_best_crossing_solution =
...
static const char *mkd_doc_fiction_physical_design_detail_graph_oriented_layout_design_impl_best_custom_solution =
R"doc(The current best solution with respect to a custom cost objective,
initialized to the maximum possible value. This value will be updated
as better solutions are found.)doc";

static const char *mkd_doc_fiction_physical_design_detail_graph_oriented_layout_design_impl_best_optimized_solution = R"doc(Current best solution w.r.t. area after relocating POs.)doc";

static const char *mkd_doc_fiction_physical_design_detail_graph_oriented_layout_design_impl_best_wire_solution =
...
static const char *mkd_doc_fiction_physical_design_detail_graph_oriented_layout_design_impl_check_path =
...
static const char *mkd_doc_fiction_physical_design_detail_graph_oriented_layout_design_impl_expand =
...
static const char *mkd_doc_fiction_physical_design_detail_graph_oriented_layout_design_impl_futures_pool =
R"doc(Thread pool for multithreaded execution to avoid thread creation
overhead.)doc";

static const char *mkd_doc_fiction_physical_design_detail_graph_oriented_layout_design_impl_generate_next_positions =
...
static const char *mkd_doc_fiction_physical_design_detail_graph_oriented_layout_design_impl_get_possible_positions =
...
static const char *mkd_doc_fiction_physical_design_detail_graph_oriented_layout_design_impl_get_possible_positions_double_fanin =
...
static const char *mkd_doc_fiction_physical_design_detail_graph_oriented_layout_design_impl_get_possible_positions_pis =
...
Args:
    layout: The layout in which to find the possible positions for
            PIs.
    ssg: Search space graph with the allowed PI locations and random
         engine.
...
static const char *mkd_doc_fiction_physical_design_detail_graph_oriented_layout_design_impl_get_possible_positions_pos =
...
static const char *mkd_doc_fiction_physical_design_detail_graph_oriented_layout_design_impl_get_possible_positions_single_fanin =
...
static const char *mkd_doc_fiction_physical_design_detail_graph_oriented_layout_design_impl_graph_oriented_layout_design_impl =
...
Args:
    ...
    custom: The custom layout cost function.

)doc";

static const char *mkd_doc_fiction_physical_design_detail_graph_oriented_layout_design_impl_improve_acp_solution =
...
static const char *mkd_doc_fiction_physical_design_detail_graph_oriented_layout_design_impl_improve_area_solution =
...
static const char *mkd_doc_fiction_physical_design_detail_graph_oriented_layout_design_impl_improve_crossing_solution =
R"doc(Flag indicating that an initial solution has been found with the
...
static const char *mkd_doc_fiction_physical_design_detail_graph_oriented_layout_design_impl_improve_custom_solution =
...
static const char *mkd_doc_fiction_physical_design_detail_graph_oriented_layout_design_impl_improve_wire_solution =
R"doc(Flag indicating that an initial solution has been found with the
...
static const char *mkd_doc_fiction_physical_design_detail_graph_oriented_layout_design_impl_initialize = R"doc(Initialize the search space graphs.)doc";

static const char *mkd_doc_fiction_physical_design_detail_graph_oriented_layout_design_impl_initialize_layout =
...
static const char *mkd_doc_fiction_physical_design_detail_graph_oriented_layout_design_impl_initialize_networks_and_nodes_to_place = R"doc(Initializes the networks and nodes to place.)doc";

static const char *mkd_doc_fiction_physical_design_detail_graph_oriented_layout_design_impl_initialize_pis_cost_and_num_expansions =
R"doc(Initializes each search space graph's PI locations, random engine, and
initial cost.

)doc";

static const char *mkd_doc_fiction_physical_design_detail_graph_oriented_layout_design_impl_max_placed_nodes = R"doc(Keep track of the maximum number of placed nodes.)doc";

static const char *mkd_doc_fiction_physical_design_detail_graph_oriented_layout_design_impl_ntk = R"doc(The network to be placed and routed.)doc";

static const char *mkd_doc_fiction_physical_design_detail_graph_oriented_layout_design_impl_num_search_space_graphs = R"doc(Number of search space graphs.)doc";

static const char *mkd_doc_fiction_physical_design_detail_graph_oriented_layout_design_impl_num_search_space_graphs_high_efficiency = R"doc(In high-efficiency mode, only 2 search space graphs are used)doc";

static const char *mkd_doc_fiction_physical_design_detail_graph_oriented_layout_design_impl_num_search_space_graphs_high_effort =
...
static const char *mkd_doc_fiction_physical_design_detail_graph_oriented_layout_design_impl_num_search_space_graphs_highest_effort =
...
static const char *mkd_doc_fiction_physical_design_detail_graph_oriented_layout_design_impl_num_search_space_graphs_highest_effort_custom =
...
static const char *mkd_doc_fiction_physical_design_detail_graph_oriented_layout_design_impl_num_search_space_graphs_maximum_effort =
...
static const char *mkd_doc_fiction_physical_design_detail_graph_oriented_layout_design_impl_num_search_space_graphs_maximum_effort_custom =
...
static const char *mkd_doc_fiction_physical_design_detail_graph_oriented_layout_design_impl_place_and_route =
...
static const char *mkd_doc_fiction_physical_design_detail_graph_oriented_layout_design_impl_process_ssg =
...
static const char *mkd_doc_fiction_physical_design_detail_graph_oriented_layout_design_impl_route_single_input_node =
...
static const char *mkd_doc_fiction_physical_design_detail_graph_oriented_layout_design_impl_run =
...
static const char *mkd_doc_fiction_physical_design_detail_graph_oriented_layout_design_impl_seed =
R"doc(Random seed for PI spacing, fanout substitution, and topological
ordering.)doc";

static const char *mkd_doc_fiction_physical_design_detail_graph_oriented_layout_design_impl_ssg_vec = R"doc(Vector of search space graphs.)doc";

static const char *mkd_doc_fiction_physical_design_detail_graph_oriented_layout_design_impl_start = R"doc(Start time.)doc";

static const char *mkd_doc_fiction_physical_design_detail_graph_oriented_layout_design_impl_timeout = R"doc(Timeout limit (in ms).)doc";

static const char *mkd_doc_fiction_physical_design_detail_graph_oriented_layout_design_impl_timeout_limit_reached = R"doc(Timeout limit reached.)doc";

static const char *mkd_doc_fiction_physical_design_detail_graph_oriented_layout_design_impl_update_stats =
...
static const char *mkd_doc_fiction_physical_design_detail_graph_oriented_layout_design_impl_valid_layout =
...
static const char *mkd_doc_fiction_physical_design_detail_hexagonalization_impl_ps = R"doc(Hexagonalization parameters.)doc";
...
static const char *mkd_doc_fiction_physical_design_detail_is_eastern_po_orientation_available = R"doc()doc";

static const char *mkd_doc_fiction_physical_design_detail_nested_vector_hash =
...
static const char *mkd_doc_fiction_physical_design_detail_nested_vector_hash_operator_call =
...
static const char *mkd_doc_fiction_physical_design_detail_new_gate_location =
...
static const char *mkd_doc_fiction_physical_design_detail_new_gate_location_DEST = R"doc(Check if the destination tile is empty.)doc";
...
static const char *mkd_doc_fiction_physical_design_detail_orthogonal_impl =
...
static const char *mkd_doc_fiction_physical_design_detail_orthogonal_impl_ntk = R"doc()doc";

static const char *mkd_doc_fiction_physical_design_detail_orthogonal_impl_orthogonal_impl =
...
static const char *mkd_doc_fiction_physical_design_detail_orthogonal_impl_po_counter = R"doc()doc";

static const char *mkd_doc_fiction_physical_design_detail_orthogonal_impl_ps = R"doc()doc";
...
static const char *mkd_doc_fiction_physical_design_detail_pi_locations_LEFT = R"doc(Flag indicating if primary inputs (PIs) can be placed at the left.)doc";

static const char *mkd_doc_fiction_physical_design_detail_pi_locations_TOP = R"doc(Flag indicating if primary inputs (PIs) can be placed at the top.)doc";

static const char *mkd_doc_fiction_physical_design_detail_pi_locations_TOP_AND_LEFT =
R"doc(Flag indicating if primary inputs (PIs) can be placed at the top and
at the left.)doc";

static const char *mkd_doc_fiction_physical_design_detail_place_outputs =
...
static const char *mkd_doc_fiction_physical_design_detail_placement_info =
...
static const char *mkd_doc_fiction_physical_design_detail_post_layout_optimization_impl_max_gate_relocations = R"doc(Maximum number of relocations to try for each gate.)doc";

static const char *mkd_doc_fiction_physical_design_detail_post_layout_optimization_impl_max_non_po = R"doc(Maximum coordinate of all gates that are not POs.)doc";
...
static const char *mkd_doc_fiction_physical_design_detail_post_layout_optimization_impl_update_timeout =
...
static const char *mkd_doc_fiction_physical_design_detail_post_layout_optimization_impl_wiring_reduction_params = R"doc(Wiring reduction parameters.)doc";

static const char *mkd_doc_fiction_physical_design_detail_post_layout_optimization_impl_wiring_reduction_stats = R"doc(Wiring reduction stats.)doc";

static const char *mkd_doc_fiction_physical_design_detail_priority_queue =
...
static const char *mkd_doc_fiction_physical_design_detail_priority_queue_counter = R"doc(Counter to keep track of the insertion order of elements.)doc";

static const char *mkd_doc_fiction_physical_design_detail_priority_queue_elements = R"doc(Priority queue containing elements with associated priorities.)doc";

static const char *mkd_doc_fiction_physical_design_detail_priority_queue_empty =
...
static const char *mkd_doc_fiction_physical_design_detail_priority_queue_get =
...
static const char *mkd_doc_fiction_physical_design_detail_priority_queue_put =
...
static const char *mkd_doc_fiction_physical_design_detail_search_direction_HORIZONTAL = R"doc(Search from left to right.)doc";

static const char *mkd_doc_fiction_physical_design_detail_search_direction_VERTICAL = R"doc(Search from top to bottom.)doc";

static const char *mkd_doc_fiction_physical_design_detail_search_space_graph =
...
static const char *mkd_doc_fiction_physical_design_detail_search_space_graph_current_vertex = R"doc(The current vertex in the search space graph.)doc";

static const char *mkd_doc_fiction_physical_design_detail_search_space_graph_frontier = R"doc(Priority queue containing vertices of the search space graph.)doc";

static const char *mkd_doc_fiction_physical_design_detail_search_space_graph_frontier_flag = R"doc(Flag indicating if this graph's frontier is active.)doc";

static const char *mkd_doc_fiction_physical_design_detail_search_space_graph_network = R"doc(The network associated with this search space graph.)doc";

static const char *mkd_doc_fiction_physical_design_detail_search_space_graph_nodes_to_place = R"doc(Topological list of nodes to be placed in the layout.)doc";

static const char *mkd_doc_fiction_physical_design_detail_search_space_graph_pi_locs =
...
static const char *mkd_doc_fiction_physical_design_detail_topo_view =
...
static const char *mkd_doc_fiction_physical_design_detail_topo_view_create_topo_rec = R"doc()doc";

static const char *mkd_doc_fiction_physical_design_detail_topo_view_foreach_gate = R"doc()doc";

static const char *mkd_doc_fiction_physical_design_detail_topo_view_foreach_gate_reverse = R"doc()doc";

static const char *mkd_doc_fiction_physical_design_detail_topo_view_foreach_node = R"doc()doc";

static const char *mkd_doc_fiction_physical_design_detail_topo_view_index_to_node = R"doc()doc";

static const char *mkd_doc_fiction_physical_design_detail_topo_view_node_to_index = R"doc()doc";

static const char *mkd_doc_fiction_physical_design_detail_topo_view_num_gates = R"doc()doc";

static const char *mkd_doc_fiction_physical_design_detail_topo_view_offset = R"doc()doc";

static const char *mkd_doc_fiction_physical_design_detail_topo_view_rng = R"doc()doc";

static const char *mkd_doc_fiction_physical_design_detail_topo_view_size = R"doc()doc";

static const char *mkd_doc_fiction_physical_design_detail_topo_view_topo_order = R"doc()doc";
...
static const char *mkd_doc_fiction_physical_design_detail_wire_east = R"doc()doc";
...
static const char *mkd_doc_fiction_physical_design_detail_wiring_reduction_impl_ps = R"doc(Wiring reduction parameters.)doc";
...
static const char *mkd_doc_fiction_physical_design_detail_wiring_reduction_layout_foreach_adjacent_coordinate_first_column =
...
static const char *mkd_doc_fiction_physical_design_detail_wiring_reduction_layout_foreach_adjacent_coordinate_first_row =
R"doc(Iterates over adjacent coordinates of a given coordinate in the first
row.
...
static const char *mkd_doc_fiction_physical_design_detail_wiring_reduction_layout_foreach_adjacent_coordinate_last_column =
...
static const char *mkd_doc_fiction_physical_design_detail_wiring_reduction_layout_foreach_adjacent_coordinate_last_row =
R"doc(Iterates over adjacent coordinates of a given coordinate in the last
row.
...
static const char *mkd_doc_fiction_physical_design_detail_wiring_reduction_layout_foreach_adjacent_coordinate_middle_columns =
...
static const char *mkd_doc_fiction_physical_design_detail_wiring_reduction_layout_foreach_adjacent_coordinate_middle_rows =
R"doc(Iterates over adjacent coordinates of a given coordinate in the middle
rows.
...
static const char *mkd_doc_fiction_physical_design_detail_wiring_reduction_layout_get_search_direction =
...
static const char *mkd_doc_fiction_physical_design_determine_clocking =
...
static const char *mkd_doc_fiction_physical_design_determine_clocking_params = R"doc(Parameters for the `determine_clocking` algorithm.)doc";

static const char *mkd_doc_fiction_physical_design_determine_clocking_params_sat_engine = R"doc(The SAT solver to use.)doc";

static const char *mkd_doc_fiction_physical_design_determine_clocking_stats = R"doc(Statistics for the `determine_clocking` algorithm.)doc";

static const char *mkd_doc_fiction_physical_design_determine_clocking_stats_report =
...
static const char *mkd_doc_fiction_physical_design_determine_clocking_stats_time_total = R"doc(Total runtime.)doc";

static const char *mkd_doc_fiction_physical_design_exact =
...
static const char *mkd_doc_fiction_physical_design_exact_physical_design_params_border_io = R"doc(Flag to indicate that I/Os should be placed at the layout's border.)doc";

static const char *mkd_doc_fiction_physical_design_exact_physical_design_params_crossings = R"doc(Flag to indicate that crossings may be used.)doc";

static const char *mkd_doc_fiction_physical_design_exact_physical_design_params_desynchronize =
R"doc(Flag to indicate that a discrepancy in fan-in path lengths is allowed
(reduces runtime!).)doc";

static const char *mkd_doc_fiction_physical_design_exact_physical_design_params_fixed_size =
...
static const char *mkd_doc_fiction_physical_design_exact_physical_design_params_synchronization_elements =
R"doc(Flag to indicate that artificial clock latch delays should be used to
balance paths (runtime expensive!).)doc";

static const char *mkd_doc_fiction_physical_design_exact_physical_design_params_technology_specifics =
...
static const char *mkd_doc_fiction_physical_design_exact_physical_design_params_upper_bound_y = R"doc(Number of tiles to use as an upper bound in y direction.)doc";

static const char *mkd_doc_fiction_physical_design_exact_physical_design_stats = R"doc(Statistics.)doc";

static const char *mkd_doc_fiction_physical_design_exact_physical_design_stats_num_aspect_ratios = R"doc()doc";

static const char *mkd_doc_fiction_physical_design_exact_physical_design_stats_num_crossings = R"doc()doc";

static const char *mkd_doc_fiction_physical_design_exact_physical_design_stats_num_gates = R"doc()doc";

static const char *mkd_doc_fiction_physical_design_exact_physical_design_stats_num_wires = R"doc()doc";

static const char *mkd_doc_fiction_physical_design_exact_physical_design_stats_report = R"doc()doc";

static const char *mkd_doc_fiction_physical_design_exact_physical_design_stats_time_total = R"doc()doc";

static const char *mkd_doc_fiction_physical_design_exact_physical_design_stats_x_size = R"doc()doc";

static const char *mkd_doc_fiction_physical_design_exact_physical_design_stats_y_size = R"doc()doc";

static const char *mkd_doc_fiction_physical_design_exact_with_blacklist =
...
static const char *mkd_doc_fiction_physical_design_graph_oriented_layout_design_params_cost = R"doc(The cost objective used. Defaults to AREA)doc";

static const char *mkd_doc_fiction_physical_design_graph_oriented_layout_design_params_cost_objective =
...
static const char *mkd_doc_fiction_physical_design_graph_oriented_layout_design_params_cost_objective_ACP =
R"doc(ACP (Area-Crossings Product): Optimizes for a combination of layout
area and the number of crossings.)doc";

static const char *mkd_doc_fiction_physical_design_graph_oriented_layout_design_params_cost_objective_AREA =
R"doc(AREA: Optimizes for the total area of the layout, aiming to minimize
      the space required for the design.)doc";

static const char *mkd_doc_fiction_physical_design_graph_oriented_layout_design_params_cost_objective_CROSSINGS = R"doc(CROSSINGS: Optimizes for the number of wire crossings in the layout.)doc";

static const char *mkd_doc_fiction_physical_design_graph_oriented_layout_design_params_cost_objective_CUSTOM =
...
static const char *mkd_doc_fiction_physical_design_graph_oriented_layout_design_params_cost_objective_WIRES =
R"doc(WIRES: Optimizes for the number of wire segments in the layout,
       reducing the delay and increasing throughput.)doc";

static const char *mkd_doc_fiction_physical_design_graph_oriented_layout_design_params_effort_mode =
...
static const char *mkd_doc_fiction_physical_design_graph_oriented_layout_design_params_effort_mode_HIGHEST_EFFORT =
...
static const char *mkd_doc_fiction_physical_design_graph_oriented_layout_design_params_effort_mode_HIGH_EFFICIENCY =
...
static const char *mkd_doc_fiction_physical_design_graph_oriented_layout_design_params_effort_mode_HIGH_EFFORT =
...
static const char *mkd_doc_fiction_physical_design_graph_oriented_layout_design_params_effort_mode_MAXIMUM_EFFORT =
...
static const char *mkd_doc_fiction_physical_design_graph_oriented_layout_design_params_enable_multithreading =
...
static const char *mkd_doc_fiction_physical_design_graph_oriented_layout_design_params_mode = R"doc(The effort mode used. Defaults to HIGH_EFFORT.)doc";

static const char *mkd_doc_fiction_physical_design_graph_oriented_layout_design_params_num_vertex_expansions =
...
static const char *mkd_doc_fiction_physical_design_graph_oriented_layout_design_params_randomize_tiles_to_skip_between_pis =
...
static const char *mkd_doc_fiction_physical_design_graph_oriented_layout_design_params_return_first =
R"doc(Return the first found layout, which might still have a high cost but
can be found fast.)doc";

static const char *mkd_doc_fiction_physical_design_graph_oriented_layout_design_params_seed =
R"doc(Random seed for PI spacing, fanout substitution, and topological
ordering. Generated randomly if not specified.)doc";

static const char *mkd_doc_fiction_physical_design_graph_oriented_layout_design_params_straight_inverters = R"doc(Enforce NOT gates to be routed non-bending only.)doc";

static const char *mkd_doc_fiction_physical_design_graph_oriented_layout_design_params_tiles_to_skip_between_pis =
...
static const char *mkd_doc_fiction_physical_design_graph_oriented_layout_design_params_verbose = R"doc(Verbosity.)doc";

static const char *mkd_doc_fiction_physical_design_graph_oriented_layout_design_stats =
R"doc(This struct stores statistics about the graph-oriented layout design
process.)doc";

static const char *mkd_doc_fiction_physical_design_graph_oriented_layout_design_stats_num_crossings = R"doc(Number of crossings.)doc";

static const char *mkd_doc_fiction_physical_design_graph_oriented_layout_design_stats_num_gates = R"doc(Number of gates.)doc";

static const char *mkd_doc_fiction_physical_design_graph_oriented_layout_design_stats_num_wires = R"doc(Number of wires.)doc";

static const char *mkd_doc_fiction_physical_design_graph_oriented_layout_design_stats_report =
R"doc(Reports the statistics to the given output stream.
...
static const char *mkd_doc_fiction_physical_design_graph_oriented_layout_design_stats_time_total = R"doc(Runtime of the graph-oriented layout design process.)doc";

static const char *mkd_doc_fiction_physical_design_graph_oriented_layout_design_stats_x_size = R"doc(Layout width.)doc";

static const char *mkd_doc_fiction_physical_design_graph_oriented_layout_design_stats_y_size = R"doc(Layout height.)doc";

static const char *mkd_doc_fiction_physical_design_hexagonalization =
...
static const char *mkd_doc_fiction_physical_design_hexagonalization_io_pin_routing_error_hexagonalization_io_pin_routing_error =
...
static const char *mkd_doc_fiction_physical_design_hexagonalization_params =
...
static const char *mkd_doc_fiction_physical_design_hexagonalization_params_input_pin_extension = R"doc(Input extension mode. Defaults to none)doc";

static const char *mkd_doc_fiction_physical_design_hexagonalization_params_io_pin_extension_mode =
R"doc(Specifies how primary inputs/outputs should be handled in the
hexagonalization process.)doc";

static const char *mkd_doc_fiction_physical_design_hexagonalization_params_io_pin_extension_mode_EXTEND = R"doc(Extend primary inputs/outputs to the top/bottom row.)doc";

static const char *mkd_doc_fiction_physical_design_hexagonalization_params_io_pin_extension_mode_EXTEND_PLANAR =
...
static const char *mkd_doc_fiction_physical_design_hexagonalization_stats = R"doc(This struct stores statistics about the hexagonalization process.)doc";

static const char *mkd_doc_fiction_physical_design_hexagonalization_stats_num_crossings = R"doc(Number of crossings.)doc";

static const char *mkd_doc_fiction_physical_design_hexagonalization_stats_num_gates = R"doc(Number of gates.)doc";

static const char *mkd_doc_fiction_physical_design_hexagonalization_stats_num_wires = R"doc(Number of wires.)doc";

static const char *mkd_doc_fiction_physical_design_hexagonalization_stats_report =
R"doc(Reports the statistics to the given output stream.
...
static const char *mkd_doc_fiction_physical_design_hexagonalization_stats_time_total = R"doc(Runtime of the hexagonalization process.)doc";

static const char *mkd_doc_fiction_physical_design_hexagonalization_stats_x_size = R"doc(Layout width.)doc";
...
static const char *mkd_doc_fiction_physical_design_operator_lshift_2 =
...
static const char *mkd_doc_fiction_physical_design_orthogonal =
...
static const char *mkd_doc_fiction_physical_design_orthogonal_physical_design_stats_num_crossings = R"doc()doc";

static const char *mkd_doc_fiction_physical_design_orthogonal_physical_design_stats_num_gates = R"doc()doc";

static const char *mkd_doc_fiction_physical_design_orthogonal_physical_design_stats_num_wires = R"doc()doc";

static const char *mkd_doc_fiction_physical_design_orthogonal_physical_design_stats_report = R"doc()doc";

static const char *mkd_doc_fiction_physical_design_orthogonal_physical_design_stats_time_total = R"doc()doc";
...
static const char *mkd_doc_fiction_physical_design_path_finding_a_star_distance =
...
static const char *mkd_doc_fiction_physical_design_path_finding_a_star_distance_functor =
...
static const char *mkd_doc_fiction_physical_design_path_finding_a_star_distance_functor_a_star_distance_functor = R"doc()doc";

static const char *mkd_doc_fiction_physical_design_path_finding_a_star_params = R"doc(Parameters for the A* algorithm.)doc";

static const char *mkd_doc_fiction_physical_design_path_finding_a_star_params_crossings =
R"doc(Allow paths to cross over obstructed tiles if they are occupied by
wire segments.)doc";

static const char *mkd_doc_fiction_physical_design_path_finding_chebyshev_distance =
...
static const char *mkd_doc_fiction_physical_design_path_finding_chebyshev_distance_functor =
...
static const char *mkd_doc_fiction_physical_design_path_finding_chebyshev_distance_functor_chebyshev_distance_functor = R"doc()doc";

static const char *mkd_doc_fiction_physical_design_path_finding_cost_functor =
...
static const char *mkd_doc_fiction_physical_design_path_finding_cost_functor_cost_function = R"doc(Cost function.)doc";

static const char *mkd_doc_fiction_physical_design_path_finding_cost_functor_cost_functor =
...
static const char *mkd_doc_fiction_physical_design_path_finding_cost_functor_operator_call =
...
static const char *mkd_doc_fiction_physical_design_path_finding_detail_a_star_impl = R"doc()doc";

static const char *mkd_doc_fiction_physical_design_path_finding_detail_a_star_impl_a_star_impl = R"doc()doc";

static const char *mkd_doc_fiction_physical_design_path_finding_detail_a_star_impl_came_from = R"doc(Tracks the origin of each coordinate to recreate the path.)doc";

static const char *mkd_doc_fiction_physical_design_path_finding_detail_a_star_impl_closed_list = R"doc(Closed list that acts as a set of already visited coordinates.)doc";

static const char *mkd_doc_fiction_physical_design_path_finding_detail_a_star_impl_coordinate_f = R"doc(Stores a coordinate and its f-value.)doc";

static const char *mkd_doc_fiction_physical_design_path_finding_detail_a_star_impl_coordinate_f_coord = R"doc(Coordinate.)doc";

static const char *mkd_doc_fiction_physical_design_path_finding_detail_a_star_impl_coordinate_f_f = R"doc(f-value of the coordinate.)doc";

static const char *mkd_doc_fiction_physical_design_path_finding_detail_a_star_impl_coordinate_f_operator_eq =
...
static const char *mkd_doc_fiction_physical_design_path_finding_detail_a_star_impl_coordinate_f_operator_gt =
...
static const char *mkd_doc_fiction_physical_design_path_finding_detail_a_star_impl_cost = R"doc(The cost functor that implements the cost function.)doc";

static const char *mkd_doc_fiction_physical_design_path_finding_detail_a_star_impl_distance =
R"doc(The distance functor that implements the heuristic estimation
function.)doc";

static const char *mkd_doc_fiction_physical_design_path_finding_detail_a_star_impl_expand =
...
static const char *mkd_doc_fiction_physical_design_path_finding_detail_a_star_impl_g =
...
static const char *mkd_doc_fiction_physical_design_path_finding_detail_a_star_impl_g_values =
R"doc(Stores the g-cost for each coordinate c, i.e., the length of the
shortest path from source to c found so far.)doc";

static const char *mkd_doc_fiction_physical_design_path_finding_detail_a_star_impl_get_lowest_f_coord =
...
static const char *mkd_doc_fiction_physical_design_path_finding_detail_a_star_impl_is_visited =
...
static const char *mkd_doc_fiction_physical_design_path_finding_detail_a_star_impl_layout =
R"doc(The layout in which the shortest path between `source` and `target` is
to be found.)doc";

static const char *mkd_doc_fiction_physical_design_path_finding_detail_a_star_impl_no_improvement =
...
static const char *mkd_doc_fiction_physical_design_path_finding_detail_a_star_impl_objective = R"doc(The source-target coordinate pair.)doc";

static const char *mkd_doc_fiction_physical_design_path_finding_detail_a_star_impl_open_list =
R"doc(Open list that contains all coordinates to process next sorted by
their f-value.)doc";

static const char *mkd_doc_fiction_physical_design_path_finding_detail_a_star_impl_params = R"doc(Routing parameters.)doc";

static const char *mkd_doc_fiction_physical_design_path_finding_detail_a_star_impl_reconstruct_path =
...
static const char *mkd_doc_fiction_physical_design_path_finding_detail_a_star_impl_run =
...
static const char *mkd_doc_fiction_physical_design_path_finding_detail_enumerate_all_paths_impl = R"doc()doc";

static const char *mkd_doc_fiction_physical_design_path_finding_detail_enumerate_all_paths_impl_collection = R"doc(Collection of all enumerated paths.)doc";

static const char *mkd_doc_fiction_physical_design_path_finding_detail_enumerate_all_paths_impl_enumerate_all_paths_impl = R"doc()doc";

static const char *mkd_doc_fiction_physical_design_path_finding_detail_enumerate_all_paths_impl_is_visited =
...
static const char *mkd_doc_fiction_physical_design_path_finding_detail_enumerate_all_paths_impl_layout = R"doc(The layout whose paths are to be enumerated.)doc";

static const char *mkd_doc_fiction_physical_design_path_finding_detail_enumerate_all_paths_impl_mark_unvisited =
...
static const char *mkd_doc_fiction_physical_design_path_finding_detail_enumerate_all_paths_impl_mark_visited =
...
static const char *mkd_doc_fiction_physical_design_path_finding_detail_enumerate_all_paths_impl_objective = R"doc(The source-target coordinate pair.)doc";

static const char *mkd_doc_fiction_physical_design_path_finding_detail_enumerate_all_paths_impl_params = R"doc(Routing parameters.)doc";

static const char *mkd_doc_fiction_physical_design_path_finding_detail_enumerate_all_paths_impl_recursively_enumerate_all_paths =
...
static const char *mkd_doc_fiction_physical_design_path_finding_detail_enumerate_all_paths_impl_run =
...
static const char *mkd_doc_fiction_physical_design_path_finding_detail_yen_k_shortest_paths_impl_objective = R"doc(Source and target coordinates.)doc";

static const char *mkd_doc_fiction_physical_design_path_finding_detail_yen_k_shortest_paths_impl_params = R"doc(Routing parameters.)doc";

static const char *mkd_doc_fiction_physical_design_path_finding_detail_yen_k_shortest_paths_impl_path_cost =
...
static const char *mkd_doc_fiction_physical_design_path_finding_distance_functor =
...
static const char *mkd_doc_fiction_physical_design_path_finding_distance_functor_distance_function = R"doc(Distance function.)doc";

static const char *mkd_doc_fiction_physical_design_path_finding_distance_functor_distance_functor =
...
static const char *mkd_doc_fiction_physical_design_path_finding_distance_functor_operator_call =
...
static const char *mkd_doc_fiction_physical_design_path_finding_distance_map_functor =
...
static const char *mkd_doc_fiction_physical_design_path_finding_distance_map_functor_coordinate_index =
...
static const char *mkd_doc_fiction_physical_design_path_finding_distance_map_functor_dist_map = R"doc(Distance map.)doc";

static const char *mkd_doc_fiction_physical_design_path_finding_distance_map_functor_distance_map_functor =
...
static const char *mkd_doc_fiction_physical_design_path_finding_distance_map_functor_operator_call =
...
static const char *mkd_doc_fiction_physical_design_path_finding_enumerate_all_paths =
...
static const char *mkd_doc_fiction_physical_design_path_finding_enumerate_all_paths_params = R"doc(Parameters for the algorithm that enumerates all paths in a layout.)doc";

static const char *mkd_doc_fiction_physical_design_path_finding_enumerate_all_paths_params_crossings =
R"doc(Allow paths to cross over obstructed tiles if they are occupied by
wire segments.)doc";

static const char *mkd_doc_fiction_physical_design_path_finding_euclidean_distance =
...
static const char *mkd_doc_fiction_physical_design_path_finding_euclidean_distance_functor =
...
static const char *mkd_doc_fiction_physical_design_path_finding_euclidean_distance_functor_euclidean_distance_functor = R"doc()doc";

static const char *mkd_doc_fiction_physical_design_path_finding_initialize_distance_map =
...
static const char *mkd_doc_fiction_physical_design_path_finding_initialize_sparse_distance_map =
...
static const char *mkd_doc_fiction_physical_design_path_finding_manhattan_distance =
...
static const char *mkd_doc_fiction_physical_design_path_finding_manhattan_distance_functor =
...
static const char *mkd_doc_fiction_physical_design_path_finding_manhattan_distance_functor_manhattan_distance_functor = R"doc()doc";

static const char *mkd_doc_fiction_physical_design_path_finding_random_cost =
...
static const char *mkd_doc_fiction_physical_design_path_finding_random_cost_functor =
...
static const char *mkd_doc_fiction_physical_design_path_finding_random_cost_functor_random_cost_functor = R"doc()doc";

static const char *mkd_doc_fiction_physical_design_path_finding_smart_distance_cache_functor =
...
static const char *mkd_doc_fiction_physical_design_path_finding_smart_distance_cache_functor_distance_cache = R"doc(Sparse distance map serving as a cache.)doc";

static const char *mkd_doc_fiction_physical_design_path_finding_smart_distance_cache_functor_operator_call =
...
static const char *mkd_doc_fiction_physical_design_path_finding_smart_distance_cache_functor_smart_distance_cache_functor =
...
static const char *mkd_doc_fiction_physical_design_path_finding_sparse_distance_map_functor =
...
static const char *mkd_doc_fiction_physical_design_path_finding_sparse_distance_map_functor_operator_call =
...
static const char *mkd_doc_fiction_physical_design_path_finding_sparse_distance_map_functor_sparse_dist_map = R"doc(Sparse distance map.)doc";

static const char *mkd_doc_fiction_physical_design_path_finding_sparse_distance_map_functor_sparse_distance_map_functor =
...
static const char *mkd_doc_fiction_physical_design_path_finding_squared_euclidean_distance =
...
static const char *mkd_doc_fiction_physical_design_path_finding_squared_euclidean_distance_functor =
...
static const char *mkd_doc_fiction_physical_design_path_finding_squared_euclidean_distance_functor_squared_euclidean_distance_functor = R"doc()doc";

static const char *mkd_doc_fiction_physical_design_path_finding_twoddwave_distance =
...
static const char *mkd_doc_fiction_physical_design_path_finding_twoddwave_distance_functor =
...
static const char *mkd_doc_fiction_physical_design_path_finding_twoddwave_distance_functor_twoddwave_distance_functor = R"doc()doc";

static const char *mkd_doc_fiction_physical_design_path_finding_unit_cost =
...
static const char *mkd_doc_fiction_physical_design_path_finding_unit_cost_functor =
...
static const char *mkd_doc_fiction_physical_design_path_finding_unit_cost_functor_unit_cost_functor = R"doc()doc";

static const char *mkd_doc_fiction_physical_design_path_finding_yen_k_shortest_paths =
...
static const char *mkd_doc_fiction_physical_design_path_finding_yen_k_shortest_paths_params = R"doc(Parameters for Yen's :math:`k`-shortest paths algorithm.)doc";
...
static const char *mkd_doc_fiction_physical_design_post_layout_optimization_params = R"doc(Parameters for the post-layout optimization algorithm.)doc";

static const char *mkd_doc_fiction_physical_design_post_layout_optimization_params_max_gate_relocations =
...
static const char *mkd_doc_fiction_physical_design_post_layout_optimization_params_timeout =
...
static const char *mkd_doc_fiction_physical_design_post_layout_optimization_stats =
R"doc(This struct stores statistics about the post-layout optimization
process.)doc";

static const char *mkd_doc_fiction_physical_design_post_layout_optimization_stats_area_improvement = R"doc(Area reduction (in %) after the post-layout optimization process.)doc";

static const char *mkd_doc_fiction_physical_design_post_layout_optimization_stats_num_crossings_after = R"doc(Number of crossings after the post-layout optimization process.)doc";

static const char *mkd_doc_fiction_physical_design_post_layout_optimization_stats_num_crossings_before = R"doc(Number of crossings before the post-layout optimization process.)doc";

static const char *mkd_doc_fiction_physical_design_post_layout_optimization_stats_num_wires_after = R"doc(Number of wire segments after the post-layout optimization process.)doc";

static const char *mkd_doc_fiction_physical_design_post_layout_optimization_stats_num_wires_before = R"doc(Number of wire segments before the post-layout optimization process.)doc";

static const char *mkd_doc_fiction_physical_design_post_layout_optimization_stats_report =
R"doc(Reports the statistics to the given output stream.
...
static const char *mkd_doc_fiction_physical_design_post_layout_optimization_stats_time_total = R"doc(Runtime of the post-layout optimization process.)doc";

static const char *mkd_doc_fiction_physical_design_post_layout_optimization_stats_x_size_after = R"doc(Layout width after the post-layout optimization process.)doc";

static const char *mkd_doc_fiction_physical_design_post_layout_optimization_stats_x_size_before = R"doc(Layout width before the post-layout optimization process.)doc";

static const char *mkd_doc_fiction_physical_design_post_layout_optimization_stats_y_size_after = R"doc(Layout height after the post-layout optimization process.)doc";
...
static const char *mkd_doc_fiction_physical_design_technology_constraints_TOPOLINANO = R"doc(ToPoLiNano technology-specific constraints.)doc";

static const char *mkd_doc_fiction_physical_design_to_string =
...
static const char *mkd_doc_fiction_physical_design_to_string_2 =
...
static const char *mkd_doc_fiction_physical_design_wiring_reduction_stats = R"doc(This struct stores statistics about the wiring reduction process.)doc";

static const char *mkd_doc_fiction_physical_design_wiring_reduction_stats_area_improvement = R"doc(Improvement in layout area.)doc";

static const char *mkd_doc_fiction_physical_design_wiring_reduction_stats_num_wires_after = R"doc(Number of wire segments after the wiring reduction process.)doc";

static const char *mkd_doc_fiction_physical_design_wiring_reduction_stats_num_wires_before = R"doc(Number of wire segments before the wiring reduction process.)doc";

static const char *mkd_doc_fiction_physical_design_wiring_reduction_stats_report =
R"doc(Reports the statistics to the given output stream.
...
static const char *mkd_doc_fiction_physical_design_wiring_reduction_stats_time_total = R"doc(Runtime of the wiring reduction process.)doc";

static const char *mkd_doc_fiction_physical_design_wiring_reduction_stats_wiring_improvement = R"doc(Improvement in the number wire segments.)doc";

static const char *mkd_doc_fiction_physical_design_wiring_reduction_stats_x_size_after = R"doc(Layout width after the wiring reduction process.)doc";

static const char *mkd_doc_fiction_physical_design_wiring_reduction_stats_x_size_before = R"doc(Layout width before the wiring reduction process.)doc";

static const char *mkd_doc_fiction_physical_design_wiring_reduction_stats_y_size_after = R"doc(Layout height before the wiring reduction process.)doc";
...
static const char *mkd_doc_fiction_qca_io_detail_qcad_cell_pos_y = R"doc()doc";

static const char *mkd_doc_fiction_qca_io_detail_qcad_color = R"doc()doc";

static const char *mkd_doc_fiction_qca_io_detail_qcad_color_blue = R"doc()doc";
...
static const char *mkd_doc_fiction_qca_io_detail_write_qca_layout_impl_os = R"doc()doc";

static const char *mkd_doc_fiction_qca_io_detail_write_qca_layout_impl_ps = R"doc()doc";

static const char *mkd_doc_fiction_qca_io_detail_write_qca_layout_impl_run = R"doc()doc";

static const char *mkd_doc_fiction_qca_io_detail_write_qca_layout_impl_via_counter = R"doc()doc";

static const char *mkd_doc_fiction_qca_io_detail_write_qca_layout_impl_via_layer_cells = R"doc()doc";

static const char *mkd_doc_fiction_qca_io_detail_write_qca_layout_impl_write_cell = R"doc()doc";

static const char *mkd_doc_fiction_qca_io_detail_write_qca_layout_impl_write_cell_colors = R"doc()doc";

static const char *mkd_doc_fiction_qca_io_detail_write_qca_layout_impl_write_cell_function = R"doc()doc";

static const char *mkd_doc_fiction_qca_io_detail_write_qca_layout_impl_write_cell_layers = R"doc()doc";

static const char *mkd_doc_fiction_qca_io_detail_write_qca_layout_impl_write_cell_mode = R"doc()doc";

static const char *mkd_doc_fiction_qca_io_detail_write_qca_layout_impl_write_cell_name = R"doc()doc";
...
static const char *mkd_doc_fiction_qca_qca_one_library_qca_one_library = R"doc()doc";
...
static const char *mkd_doc_fiction_sidb_charge_distribution =
R"doc(A charge distribution assigns one charge state to every SiDB of a
...
a distribution costs one byte per SiDB.)doc";

static const char *mkd_doc_fiction_sidb_charge_distribution_assign_all_charge_states =
R"doc(Assigns one charge state to every SiDB.
...
static const char *mkd_doc_fiction_sidb_charge_distribution_assign_charge_state =
R"doc(Assigns the charge state of the SiDB at a site. A site the
...
static const char *mkd_doc_fiction_sidb_charge_distribution_assign_charge_state_by_index =
R"doc(Assigns the charge state of the SiDB at an index.
...
static const char *mkd_doc_fiction_sidb_charge_distribution_assign_energy =
R"doc(Sets the electrostatic potential energy of the distribution.
...
static const char *mkd_doc_fiction_sidb_charge_distribution_charge_distribution = R"doc(Creates a distribution over no SiDBs.)doc";

static const char *mkd_doc_fiction_sidb_charge_distribution_charge_distribution_2 =
R"doc(Creates a distribution over the SiDBs of a layout with every SiDB in
one charge state.
...
static const char *mkd_doc_fiction_sidb_charge_distribution_charge_distribution_3 =
R"doc(Creates a distribution over a shared site list with every SiDB in one
charge state.

Args:
    sites: Distinct sites in raster order; callers must not mutate the
           shared list.
    cs: Charge state of every SiDB.

Raises:
    std::invalid_argument: if the sites are not distinct and in raster
                           order.

)doc";

static const char *mkd_doc_fiction_sidb_charge_distribution_charge_distribution_4 =
R"doc(Creates a distribution over a shared site list from explicit charge
states and an energy.

Args:
    sites: Distinct sites in raster order; callers must not mutate the
           shared list.
    states: One charge state per site.
    energy: Electrostatic potential energy of the distribution (unit:
            eV).

Raises:
    std::invalid_argument: if the site and state counts differ or
                           sites are not distinct and in raster order.

)doc";

static const char *mkd_doc_fiction_sidb_charge_distribution_charge_exists =
R"doc(Whether any SiDB has a given charge state.
...
static const char *mkd_doc_fiction_sidb_charge_distribution_charge_index =
R"doc(The charge index: the distribution read as a number in the given base
...
static const char *mkd_doc_fiction_sidb_charge_distribution_energy =
R"doc(The electrostatic potential energy of the distribution.
...
Template Args:
    Fn: Callable on `(const lattice_site&)`.

)doc";

static const char *mkd_doc_fiction_sidb_charge_distribution_get_charge_state =
R"doc(The charge state of the SiDB at a site.
...
static const char *mkd_doc_fiction_sidb_charge_distribution_get_charge_state_by_index =
R"doc(The charge state of the SiDB at an index.
...
static const char *mkd_doc_fiction_sidb_charge_distribution_index_of =
R"doc(The index of a site in the distribution.
...
static const char *mkd_doc_fiction_sidb_charge_distribution_num_negative_sidbs =
R"doc(Number of negatively charged SiDBs.
...
static const char *mkd_doc_fiction_sidb_charge_distribution_num_neutral_sidbs =
R"doc(Number of neutrally charged SiDBs.
...
static const char *mkd_doc_fiction_sidb_charge_distribution_num_positive_sidbs =
R"doc(Number of positively charged SiDBs.
...
static const char *mkd_doc_fiction_sidb_charge_distribution_operator_eq =
R"doc(Compares two distributions: same charge states and same energy.
...
static const char *mkd_doc_fiction_sidb_charge_distribution_same_charge_states =
R"doc(Compares two distributions for equal charge states, ignoring the
energy.
...
static const char *mkd_doc_fiction_sidb_charge_distribution_shared_sites =
R"doc(The shared site list, to build further distributions over the same
SiDBs.
...
static const char *mkd_doc_fiction_sidb_charge_distribution_validate_sites =
R"doc(Checks the shared site's ordering and uniqueness.
...
static const char *mkd_doc_fiction_sidb_generators_is_gate_design_impossible_params =
R"doc(This struct contains parameters to determine if SiDB gate design is
impossible.)doc";

static const char *mkd_doc_fiction_sidb_generators_is_gate_design_impossible_params_bdl_iterator_params = R"doc(Parameters used for the BDL input iterator.)doc";
...
static const char *mkd_doc_fiction_sidb_generators_on_the_fly_circuit_design_on_defective_surface_stats_exact_stats = R"doc(The `stats` of the *exact* algorithm.)doc";

static const char *mkd_doc_fiction_sidb_generators_on_the_fly_circuit_design_on_defective_surface_stats_gate_layout = R"doc(The gate-level layout after P&R.)doc";
...
static const char *mkd_doc_fiction_sidb_generators_unsuccessful_pr_error =
...
static const char *mkd_doc_fiction_sidb_io_detail_parse_dot_tag =
R"doc(Parses the `<type>` element of a `<dbdot>`; a missing element means a
normal SiDB.

Args:
    tag_element: The element, or `nullptr`.
...
static const char *mkd_doc_fiction_sidb_io_print_sidb_layout_3 =
R"doc(Prints an `sidb::layout` with a charge distribution as a lattice
picture. See the overload with a charge distribution pointer for the
picture's layout.
...
static const char *mkd_doc_fiction_sidb_io_unsupported_defect_index_exception =
...
static const char *mkd_doc_fiction_sidb_model_charge_state_NEGATIVE = R"doc()doc";

static const char *mkd_doc_fiction_sidb_model_charge_state_NEUTRAL = R"doc()doc";

static const char *mkd_doc_fiction_sidb_model_charge_state_NONE = R"doc()doc";

static const char *mkd_doc_fiction_sidb_model_charge_state_POSITIVE = R"doc()doc";

static const char *mkd_doc_fiction_sidb_model_charge_state_to_sign =
...
static const char *mkd_doc_fiction_sidb_model_charge_states_for_base_number =
...
static const char *mkd_doc_fiction_sidb_model_defect_charge =
R"doc(Electrical charge in units of the elementary charge e (e.g., 1 ^= 1*e,
-2 ^= -2*e).)doc";

static const char *mkd_doc_fiction_sidb_model_defect_defect = R"doc(Standard constructor.)doc";

static const char *mkd_doc_fiction_sidb_model_defect_epsilon_r = R"doc(Electric permittivity (unitless).)doc";

static const char *mkd_doc_fiction_sidb_model_defect_extent =
...
static const char *mkd_doc_fiction_sidb_model_defect_lambda_tf = R"doc(Thomas-Fermi screening distance in nm.)doc";

static const char *mkd_doc_fiction_sidb_model_defect_operator_eq =
R"doc(This operator compares two `defect` instances for equality. It checks
...
static const char *mkd_doc_fiction_sidb_model_defect_type =
...
static const char *mkd_doc_fiction_sidb_model_defect_type_2 = R"doc(Type of defect.)doc";

static const char *mkd_doc_fiction_sidb_model_defect_type_ARSENIC =
...
static const char *mkd_doc_fiction_sidb_model_defect_type_DB = R"doc(A stray dangling bond.)doc";

static const char *mkd_doc_fiction_sidb_model_defect_type_DIHYDRIDE_PAIR =
R"doc(A missing bond between dimers that leads to two double hydrogen
passivations.)doc";

static const char *mkd_doc_fiction_sidb_model_defect_type_ETCH_PIT = R"doc(A collection of missing dimers.)doc";

static const char *mkd_doc_fiction_sidb_model_defect_type_GUNK = R"doc(Residual material.)doc";

static const char *mkd_doc_fiction_sidb_model_defect_type_MISSING_DIMER = R"doc(The dimer is missing altogether.)doc";

static const char *mkd_doc_fiction_sidb_model_defect_type_NONE = R"doc(Defect-free H-Si.)doc";

static const char *mkd_doc_fiction_sidb_model_defect_type_ONE_BY_ONE = R"doc(A collection of dihydride pairs.)doc";

static const char *mkd_doc_fiction_sidb_model_defect_type_RAISED_SI = R"doc(A raised silicon dimer.)doc";

static const char *mkd_doc_fiction_sidb_model_defect_type_SILOXANE = R"doc(An oxidized dimer.)doc";

static const char *mkd_doc_fiction_sidb_model_defect_type_SINGLE_DIHYDRIDE = R"doc(Double hydrogen passivation.)doc";

static const char *mkd_doc_fiction_sidb_model_defect_type_SI_VACANCY = R"doc(A missing silicon atom.)doc";

static const char *mkd_doc_fiction_sidb_model_defect_type_STEP_EDGE = R"doc(A step edge, which is a break in the surface reconstruction.)doc";

static const char *mkd_doc_fiction_sidb_model_defect_type_THREE_BY_ONE = R"doc(A collection of 1 by 1's.)doc";
...
static const char *mkd_doc_fiction_sidb_model_is_negatively_charged_defect =
...
static const char *mkd_doc_fiction_sidb_model_is_neutral_defect_type =
...
static const char *mkd_doc_fiction_sidb_model_is_neutrally_charged_defect =
...
static const char *mkd_doc_fiction_sidb_model_is_positively_charged_defect =
...
static const char *mkd_doc_fiction_sidb_model_sign_to_charge_state =
...
static const char *mkd_doc_fiction_sidb_model_simulation_parameters =
...
static const char *mkd_doc_fiction_sidb_model_simulation_parameters_base =
...
static const char *mkd_doc_fiction_sidb_model_simulation_parameters_epsilon_r =
R"doc(`epsilon_r` is the electric permittivity. It is a material specific
number (unit-less).)doc";

static const char *mkd_doc_fiction_sidb_model_simulation_parameters_k =
R"doc(`k` is the Coulomb constant `K_E` divided by `epsilon_r` (unit:
:math:`N \cdot m^{2} \cdot C^{-2}`).

)doc";

static const char *mkd_doc_fiction_sidb_model_simulation_parameters_lambda_tf = R"doc(`lambda_tf` is the Thomas-Fermi screening distance (unit: nm).)doc";

static const char *mkd_doc_fiction_sidb_model_simulation_parameters_mu_minus = R"doc(`mu_minus` (µ-) is the energy transition level (0/-) (unit: eV).)doc";

static const char *mkd_doc_fiction_sidb_model_simulation_parameters_mu_plus = R"doc(`mu_plus` (µ+) is the energy transition level (+/0) (unit: eV).)doc";

static const char *mkd_doc_fiction_sidb_model_simulation_parameters_simulation_parameters =
...
static const char *mkd_doc_fiction_sidb_simulation_analysis_calculate_boltzmann_factor =
...
static const char *mkd_doc_fiction_sidb_simulation_analysis_critical_temperature_gate_based =
...
static const char *mkd_doc_fiction_sidb_simulation_analysis_critical_temperature_gate_based_2 =
...
static const char *mkd_doc_fiction_sidb_simulation_analysis_critical_temperature_params =
R"doc(This struct stores the parameters for the *Critical Temperature*
algorithm.)doc";

static const char *mkd_doc_fiction_sidb_simulation_analysis_critical_temperature_params_alpha =
R"doc(Alpha parameter for the *QuickSim* algorithm (only applicable if
engine == QUICKSIM).)doc";

static const char *mkd_doc_fiction_sidb_simulation_analysis_critical_temperature_params_confidence_level =
...
static const char *mkd_doc_fiction_sidb_simulation_analysis_critical_temperature_params_iteration_steps =
R"doc(Number of iteration steps for the *QuickSim* algorithm (only
applicable if engine == QUICKSIM).)doc";

static const char *mkd_doc_fiction_sidb_simulation_analysis_critical_temperature_params_max_temperature =
...
static const char *mkd_doc_fiction_sidb_simulation_analysis_critical_temperature_stats_algorithm_name =
R"doc(Name of the algorithm used to compute the physically valid charge
distributions.)doc";

static const char *mkd_doc_fiction_sidb_simulation_analysis_critical_temperature_stats_energy_between_ground_state_and_first_erroneous =
R"doc(Energy difference between the ground state and the first (erroneous)
excited state (unit: meV).)doc";

static const char *mkd_doc_fiction_sidb_simulation_analysis_critical_temperature_stats_num_valid_lyt = R"doc(Number of physically valid charge configurations.)doc";

static const char *mkd_doc_fiction_sidb_simulation_analysis_critical_temperature_stats_report =
...
static const char *mkd_doc_fiction_sidb_simulation_analysis_detail_critical_temperature_impl_critical_temperature = R"doc(Critical temperature [K].)doc";

static const char *mkd_doc_fiction_sidb_simulation_analysis_detail_critical_temperature_impl_critical_temperature_impl =
R"doc(Initializes the algorithm for a layout.

Args:
    source_layout: The layout to simulate.
    ps: Parameters for the critical temperature algorithm.
    st: Statistics of the process.

)doc";

static const char *mkd_doc_fiction_sidb_simulation_analysis_detail_critical_temperature_impl_critical_temperature_impl_2 =
...
static const char *mkd_doc_fiction_sidb_simulation_analysis_detail_critical_temperature_impl_determine_critical_temperature =
...
static const char *mkd_doc_fiction_sidb_simulation_analysis_detail_critical_temperature_impl_get_critical_temperature =
...
static const char *mkd_doc_fiction_sidb_simulation_analysis_detail_critical_temperature_impl_input_pattern_layouts =
...
static const char *mkd_doc_fiction_sidb_simulation_analysis_detail_critical_temperature_impl_is_ground_state_transparent =
...
Args:
    est: All energies of all physically valid charge distributions
...
static const char *mkd_doc_fiction_sidb_simulation_analysis_detail_critical_temperature_impl_pre_detected_input_bdl_wires =
R"doc(Pre-detected input BDL wires, or `nullptr` if they are to be detected
here. Not owned by this object.)doc";

static const char *mkd_doc_fiction_sidb_simulation_analysis_detail_critical_temperature_impl_pre_detected_output_bdl_pairs =
R"doc(Pre-detected output BDL pairs, or `nullptr` if they are to be detected
here. Not owned by this object.)doc";

static const char *mkd_doc_fiction_sidb_simulation_analysis_detail_critical_temperature_impl_pre_detected_output_bdl_wires =
...
static const char *mkd_doc_fiction_sidb_simulation_analysis_energy_distribution_add_energy_state =
...
static const char *mkd_doc_fiction_sidb_simulation_analysis_energy_distribution_degeneracy =
...
static const char *mkd_doc_fiction_sidb_simulation_analysis_energy_distribution_distribution =
R"doc(The energy distribution map. The key is the energy value and the value
is the degeneracy of the energy value.)doc";

static const char *mkd_doc_fiction_sidb_simulation_analysis_energy_distribution_empty =
...
static const char *mkd_doc_fiction_sidb_simulation_analysis_energy_distribution_energy_distribution = R"doc(Default constructor.)doc";

static const char *mkd_doc_fiction_sidb_simulation_analysis_energy_distribution_for_each =
...
static const char *mkd_doc_fiction_sidb_simulation_analysis_energy_distribution_get_nth_state =
...
static const char *mkd_doc_fiction_sidb_simulation_analysis_energy_distribution_max_energy =
...
static const char *mkd_doc_fiction_sidb_simulation_analysis_energy_distribution_min_energy =
...
static const char *mkd_doc_fiction_sidb_simulation_analysis_energy_distribution_size =
...
static const char *mkd_doc_fiction_sidb_simulation_analysis_energy_state =
...
static const char *mkd_doc_fiction_sidb_simulation_analysis_energy_state_degeneracy = R"doc(The degeneracy of the state.)doc";

static const char *mkd_doc_fiction_sidb_simulation_analysis_energy_state_electrostatic_potential_energy = R"doc(The electrostatic potential energy of the charge distribution (eV).)doc";

static const char *mkd_doc_fiction_sidb_simulation_analysis_energy_state_energy_state =
R"doc(Default constructor.
...
static const char *mkd_doc_fiction_sidb_simulation_analysis_occupation_probability_non_gate_based =
...
Args:
    energy_dist: This contains the energies in eV of all possible
                 charge distributions with the degeneracy.
    temperature: System temperature to assume (unit: K).
...
static const char *mkd_doc_fiction_sidb_simulation_analysis_state_type_ACCEPTED =
...
static const char *mkd_doc_fiction_sidb_simulation_analysis_transition_type_NEGATIVE_TO_NEUTRAL = R"doc(SiDB is negatively charged, but is closest to being neutrally charged.)doc";

static const char *mkd_doc_fiction_sidb_simulation_analysis_transition_type_NEUTRAL_TO_NEGATIVE = R"doc(SiDB is neutrally charged, but is closest to being negatively charged.)doc";
...
static const char *mkd_doc_fiction_sidb_simulation_charge_transition_threshold_bounds =
R"doc(The bounds a local potential is tested against to decide whether a
charge state is population stable.)doc";

static const char *mkd_doc_fiction_sidb_simulation_charge_transition_threshold_bounds_NEGATIVE_UPPER_BOUND = R"doc(The upper bound check against `mu_minus` to validate DB-.)doc";

static const char *mkd_doc_fiction_sidb_simulation_charge_transition_threshold_bounds_NEUTRAL_LOWER_BOUND = R"doc(The lower bound check against `mu_minus` to validate DB0.)doc";

static const char *mkd_doc_fiction_sidb_simulation_charge_transition_threshold_bounds_NEUTRAL_UPPER_BOUND = R"doc(The upper bound check against `mu_plus` to validate DB0.)doc";
...
static const char *mkd_doc_fiction_sidb_simulation_defects_detail_defect_influence_impl_num_evaluated_defect_positions = R"doc(Number of evaluated defect positions.)doc";
...
SiDBs or recomputed from scratch.)doc";

static const char *mkd_doc_fiction_sidb_simulation_detail_charge_distribution_history_CONSIDER =
R"doc(Update only the contributions of the SiDBs the last index change
flipped.)doc";

static const char *mkd_doc_fiction_sidb_simulation_detail_charge_distribution_history_NEGLECT = R"doc(Recompute every local potential.)doc";

static const char *mkd_doc_fiction_sidb_simulation_detail_charge_distribution_mode = R"doc(Whether the charge states follow a charge-index assignment.)doc";

static const char *mkd_doc_fiction_sidb_simulation_detail_charge_distribution_mode_KEEP_CHARGE_DISTRIBUTION = R"doc(Keep the charge states.)doc";

static const char *mkd_doc_fiction_sidb_simulation_detail_charge_distribution_mode_UPDATE_CHARGE_DISTRIBUTION = R"doc(Decode the index into charge states.)doc";

static const char *mkd_doc_fiction_sidb_simulation_detail_charge_index_mode = R"doc(Whether the charge index follows a charge-state assignment.)doc";

static const char *mkd_doc_fiction_sidb_simulation_detail_charge_index_mode_KEEP_CHARGE_INDEX = R"doc(Keep the charge index.)doc";

static const char *mkd_doc_fiction_sidb_simulation_detail_charge_index_mode_UPDATE_CHARGE_INDEX = R"doc(Recompute the charge index.)doc";

static const char *mkd_doc_fiction_sidb_simulation_detail_charge_index_recomputation = R"doc(How a charge index is decoded into charge states.)doc";

static const char *mkd_doc_fiction_sidb_simulation_detail_charge_index_recomputation_FROM_SCRATCH = R"doc(Decode every digit; leading zero digits become negative charge states.)doc";
...
static const char *mkd_doc_fiction_sidb_simulation_detail_energy_calculation = R"doc(Whether the energy is recomputed after a change.)doc";

static const char *mkd_doc_fiction_sidb_simulation_detail_energy_calculation_KEEP_OLD_ENERGY_VALUE = R"doc(Keep the stored energy.)doc";

static const char *mkd_doc_fiction_sidb_simulation_detail_energy_calculation_UPDATE_ENERGY = R"doc(Recompute the energy.)doc";

static const char *mkd_doc_fiction_sidb_simulation_detail_simulation_state =
R"doc(The mutable working set of the SiDB simulators over one
`potential_landscape`: the charge state of every SiDB, the local
internal potentials, the energy, the validity flag, and the charge-
index machinery the exhaustive engines enumerate with (Gray codes, a
dependent SiDB whose charge follows the others, and a sublayout of
SiDBs that can be positively charged). The landscape stays read-only,
so worker threads share one landscape and own one state each.

`snapshot()` yields the current `charge_distribution` in O(N).)doc";

static const char *mkd_doc_fiction_sidb_simulation_detail_simulation_state_adjacent_search =
R"doc(QuickSim's max-min diversity step: among the neutral SiDBs, picks one
at random that is at least `alpha` times the maximal distance away
from every negative SiDB, charges it negatively, and updates the
potentials and the energy incrementally.

Args:
    alpha: Fraction of the maximal distance a candidate has to keep
           from the negative SiDBs.
    negative_indices: Indices of the negative SiDBs; the chosen SiDB
                      is appended.

)doc";

static const char *mkd_doc_fiction_sidb_simulation_detail_simulation_state_assign_all_charge_states =
R"doc(Assigns one charge state to every SiDB.

Args:
    cs: Charge state.
    index_mode: Whether to recompute the charge index.

)doc";

static const char *mkd_doc_fiction_sidb_simulation_detail_simulation_state_assign_base_number =
R"doc(Sets the base of the charge index and the maximum index accordingly.
...
static const char *mkd_doc_fiction_sidb_simulation_detail_simulation_state_assign_base_number_to_three =
R"doc(Switches to a base-3 sublayout index over the SiDBs that can be
positively charged.

)doc";

static const char *mkd_doc_fiction_sidb_simulation_detail_simulation_state_assign_charge_index =
R"doc(Assigns a charge index.

Args:
    index: Charge index, at most `max_charge_index()`.
    mode: Whether to decode the index into charge states.

)doc";

static const char *mkd_doc_fiction_sidb_simulation_detail_simulation_state_assign_charge_index_by_gray_code =
R"doc(Assigns a charge index given as a Gray code and flips the one SiDB
that differs from the previous Gray code.
...
static const char *mkd_doc_fiction_sidb_simulation_detail_simulation_state_assign_charge_state_by_index =
R"doc(Assigns the charge state of an SiDB.
...
Args:
    i: Index of the dependent SiDB.

)doc";

static const char *mkd_doc_fiction_sidb_simulation_detail_simulation_state_assign_local_internal_potential =
R"doc(Overwrites the local internal potential at an SiDB.

Args:
    i: Index of the SiDB.
    pot: Local internal potential (unit: V).

)doc";

static const char *mkd_doc_fiction_sidb_simulation_detail_simulation_state_base =
R"doc(The base of the physical model, 2 or 3: whether positive charge states
take part at all.
...
states, skipping the dependent SiDB and splitting the SiDBs that can
be positively charged into their own base-3 index.

)doc";

static const char *mkd_doc_fiction_sidb_simulation_detail_simulation_state_charge_distribution_to_index_general =
R"doc(Recomputes the charge index over every SiDB in the plain base,
ignoring the dependent SiDB and the sublayout.

)doc";

static const char *mkd_doc_fiction_sidb_simulation_detail_simulation_state_charge_index =
R"doc(The charge index.
...
static const char *mkd_doc_fiction_sidb_simulation_detail_simulation_state_energy_model = R"doc(How the energy is computed.)doc";

static const char *mkd_doc_fiction_sidb_simulation_detail_simulation_state_energy_model_FULL =
R"doc(The full energy: SiDB and defect charges in the internal and external
potentials.)doc";

static const char *mkd_doc_fiction_sidb_simulation_detail_simulation_state_energy_model_INTERNAL_ONLY =
R"doc(The SiDB charges in the internal potential only, which is what
QuickSim compares.)doc";

static const char *mkd_doc_fiction_sidb_simulation_detail_simulation_state_get_charge_state_by_index =
R"doc(The charge state of an SiDB.
...
static const char *mkd_doc_fiction_sidb_simulation_detail_simulation_state_increase_charge_index_of_sub_layout_by_one =
...
static const char *mkd_doc_fiction_sidb_simulation_detail_simulation_state_index_base =
R"doc(The base the charge index is decoded in. It equals `base()` until a
three-state sublayout is split off, from then on the remaining SiDBs
are decoded in base 2.
...
static const char *mkd_doc_fiction_sidb_simulation_detail_simulation_state_index_decoding_TRACKED =
R"doc(Decode the layout index and the sublayout index separately and record
the flipped SiDBs, as QuickExact needs.)doc";
...
static const char *mkd_doc_fiction_sidb_simulation_detail_simulation_state_index_to_charge_distribution_tracked =
R"doc(Decodes the sublayout index (base 3) and the layout index (base 2)
into charge states and records every SiDB that flipped, as
...
Returns:
    `true` iff configuration stable.

)doc";

static const char *mkd_doc_fiction_sidb_simulation_detail_simulation_state_is_physically_valid =
R"doc(Whether the current charge states are physically valid, as of the last
`validity_check`.

Returns:
    `true` iff physically valid.

)doc";

static const char *mkd_doc_fiction_sidb_simulation_detail_simulation_state_is_three_state_simulation_required =
R"doc(Determines from the all-negative charge distribution which SiDBs can
become positively charged and, if any can, switches to a base-3
sublayout index over them and a base-2 index over the rest.

Returns:
    `true` iff some SiDB other than the dependent one can be
    positively charged.
...
Returns:
    Local internal potential (unit: V).

)doc";

static const char *mkd_doc_fiction_sidb_simulation_detail_simulation_state_local_internal_potentials =
R"doc(All local internal potentials.
...
static const char *mkd_doc_fiction_sidb_simulation_detail_simulation_state_local_potential =
R"doc(The local potential at an SiDB: internal plus external.

Args:
    i: Index of the SiDB.

Returns:
    Local potential (unit: V).

)doc";

static const char *mkd_doc_fiction_sidb_simulation_detail_simulation_state_max_charge_index =
R"doc(The largest charge index over the SiDBs the index enumerates.

Returns:
    The maximum charge index.
...
Returns:
    The maximum sublayout charge index.
...
other charges, i.e., whose (0/-) transition lies above the Fermi level
even at the current potentials.

Returns:
    Indices of the SiDBs that have to be negatively charged.

)doc";

static const char *mkd_doc_fiction_sidb_simulation_detail_simulation_state_num_negative_sidbs =
R"doc(Number of negatively charged SiDBs.
...
static const char *mkd_doc_fiction_sidb_simulation_detail_simulation_state_num_sidbs =
R"doc(Number of SiDBs.
...
static const char *mkd_doc_fiction_sidb_simulation_detail_simulation_state_reseed =
R"doc(Reseeds the random generator of `adjacent_search` from
`std::random_device`. A state copied into a worker thread calls this
so the threads do not replay one random sequence.

)doc";

static const char *mkd_doc_fiction_sidb_simulation_detail_simulation_state_reset_charge_index_sub_layout =
R"doc(Resets the sublayout charge index to zero and decodes it with the
flips recorded.
...
and the potentials, energy, and validity computed for it.

Args:
    land: Landscape; must outlive the state.
    cs: Initial charge state of every SiDB.
    model: Energy model.
    decoding: Index decoding.

)doc";

static const char *mkd_doc_fiction_sidb_simulation_detail_simulation_state_snapshot =
R"doc(The current charge distribution with its energy.
...
Returns:
    Indices of the sublayout SiDBs.
...
static const char *mkd_doc_fiction_sidb_simulation_detail_simulation_state_two_state_sidbs =
R"doc(The SiDBs that can only be negatively or neutrally charged, ascending,
without the dependent SiDB.

Returns:
    Indices of the two-state SiDBs.

)doc";

static const char *mkd_doc_fiction_sidb_simulation_detail_simulation_state_update_after_charge_change =
R"doc(Updates potentials, the dependent SiDB, the energy, and the validity
...
static const char *mkd_doc_fiction_sidb_simulation_detail_simulation_state_update_local_internal_potential =
R"doc(Updates the local internal potentials after charge states changed.

Args:
    history_mode: Whether to apply only the recorded flips or to
...
R"doc(The `domain` is designed to represent a generic simulation domain
where keys are associated with values stored as tuples. It uses a
`locked_parallel_flat_hash_map` to ensure thread-safe access to the
stored data. All methods of this class are thread-safe.
...
static const char *mkd_doc_fiction_sidb_simulation_domain_domain = R"doc(Constructs a new `domain` instance.)doc";
...
static const char *mkd_doc_fiction_sidb_simulation_engines_clustercomplete =
...
static const char *mkd_doc_fiction_sidb_simulation_engines_clustercomplete_params =
...
static const char *mkd_doc_fiction_sidb_simulation_engines_clustercomplete_params_available_threads =
...
static const char *mkd_doc_fiction_sidb_simulation_engines_clustercomplete_params_ground_state_space_reporting_OFF =
R"doc(Disabling this option will suppress the output of *Ground State Space*
statistics.)doc";

static const char *mkd_doc_fiction_sidb_simulation_engines_clustercomplete_params_ground_state_space_reporting_ON =
R"doc(Enabling this option will output *Ground State Space* statistics to
the standard output.)doc";

static const char *mkd_doc_fiction_sidb_simulation_engines_clustercomplete_params_local_external_potential =
R"doc(Local external electrostatic potentials (e.g., locally applied
electrodes).)doc";

static const char *mkd_doc_fiction_sidb_simulation_engines_clustercomplete_params_num_overlapping_witnesses_limit_gss =
...
static const char *mkd_doc_fiction_sidb_simulation_engines_clustercomplete_params_sim_params = R"doc(Physical simulation parameters.)doc";

static const char *mkd_doc_fiction_sidb_simulation_engines_clustercomplete_params_validity_witness_partitioning_max_cluster_size_gss =
...
Args:
    cl_state: Clustering state to which the given composition should
              be added.
...
static const char *mkd_doc_fiction_sidb_simulation_engines_detail_clustercomplete_impl_add_if_configuration_stability_is_met =
R"doc(This function handles performs the last analysis step before
collecting a simulation sim_result. In order to judge whether a
population stable charge distribution is physically valid, the
*configuration stability* needs to be tested. If this criterion
passes, the charge distribution is added to the simulation results.

Args:
    cl_state: A clustering state consisting of only singleton clusters
              along with associated charge states that make up a
              charge distribution that conforms to the *population
              stability* criterion.

)doc";

static const char *mkd_doc_fiction_sidb_simulation_engines_detail_clustercomplete_impl_add_parent =
...
Args:
    cl_state: Clustering state to which the parent projector state
              should be added.
...
static const char *mkd_doc_fiction_sidb_simulation_engines_detail_clustercomplete_impl_add_physically_valid_charge_configurations =
...
Args:
    cl_state: A clustering state that holds a specific combination of
              multiset charge configurations as projector states of
              which the respectively associated clusters form a
              clustering in the cluster hierarchy.

)doc";

static const char *mkd_doc_fiction_sidb_simulation_engines_detail_clustercomplete_impl_add_physically_valid_charge_configurations_2 =
R"doc(This recursive function is the heart of the *ClusterComplete*
destruction. The given clustering state is dissected at the largest
cluster to each possible specialization of it, which then enters the
recursive call with the clustering state modified to have a set of
...
static const char *mkd_doc_fiction_sidb_simulation_engines_detail_clustercomplete_impl_available_threads = R"doc(Number of available threads.)doc";

static const char *mkd_doc_fiction_sidb_simulation_engines_detail_clustercomplete_impl_clustercomplete_impl =
R"doc(Constructor.
...
static const char *mkd_doc_fiction_sidb_simulation_engines_detail_clustercomplete_impl_collect_physically_valid_charge_distributions_single_threaded =
...
static const char *mkd_doc_fiction_sidb_simulation_engines_detail_clustercomplete_impl_fail_onto_negative_charge =
...
static const char *mkd_doc_fiction_sidb_simulation_engines_detail_clustercomplete_impl_find_cluster_of_maximum_size =
...
static const char *mkd_doc_fiction_sidb_simulation_engines_detail_clustercomplete_impl_get_projector_state_bound =
...
static const char *mkd_doc_fiction_sidb_simulation_engines_detail_clustercomplete_impl_initialize_worker_queues =
...
Args:
    cl_state: The clustering state that bundles a slice (i.e., a
              ...
              configurations) together with a store of accumulated
              potential projection bounds onto all SiDBs in the
              layout, where this information is specific to the
...
static const char *mkd_doc_fiction_sidb_simulation_engines_detail_clustercomplete_impl_mu_bounds_with_error =
...
Args:
    cl_state: Clustering state from which the given composition should
              be removed.
...
static const char *mkd_doc_fiction_sidb_simulation_engines_detail_clustercomplete_impl_run =
...
sim_result into the set of all physically valid charge distributions
that are returned.
...
static const char *mkd_doc_fiction_sidb_simulation_engines_detail_clustercomplete_impl_sim_result = R"doc(Simulation results.)doc";

static const char *mkd_doc_fiction_sidb_simulation_engines_detail_clustercomplete_impl_take_parent_out =
...
Args:
    cl_state: The clustering state from which the parent projector
              state should be taken out.
...
static const char *mkd_doc_fiction_sidb_simulation_engines_detail_clustercomplete_impl_ub_fail_onto_neutral_charge =
R"doc(Performs V < -e - mu-.
...
static const char *mkd_doc_fiction_sidb_simulation_engines_detail_clustercomplete_impl_unfold_all_compositions =
...
static const char *mkd_doc_fiction_sidb_simulation_engines_detail_clustercomplete_impl_unfold_composition =
...
static const char *mkd_doc_fiction_sidb_simulation_engines_detail_clustercomplete_impl_worker = R"doc(Forward declaration of the worker struct.)doc";

static const char *mkd_doc_fiction_sidb_simulation_engines_detail_clustercomplete_impl_worker_2 = R"doc(Forward declaration of the worker struct.)doc";

static const char *mkd_doc_fiction_sidb_simulation_engines_detail_clustercomplete_impl_worker_all_workers = R"doc(The vector of all workers where this worker is at `ix`.)doc";

static const char *mkd_doc_fiction_sidb_simulation_engines_detail_clustercomplete_impl_worker_cl_state =
...
static const char *mkd_doc_fiction_sidb_simulation_engines_detail_clustercomplete_impl_worker_queue_add_to_queue =
...
static const char *mkd_doc_fiction_sidb_simulation_engines_detail_clustercomplete_impl_worker_queue_apply_informant =
...
static const char *mkd_doc_fiction_sidb_simulation_engines_detail_clustercomplete_impl_worker_queue_clustering_state_for_thieves =
...
static const char *mkd_doc_fiction_sidb_simulation_engines_detail_clustercomplete_impl_worker_queue_get_from_this_queue =
...
static const char *mkd_doc_fiction_sidb_simulation_engines_detail_clustercomplete_impl_worker_queue_initialize_queue_after_stealing =
...
static const char *mkd_doc_fiction_sidb_simulation_engines_detail_clustercomplete_impl_worker_queue_mole_composition =
...
static const char *mkd_doc_fiction_sidb_simulation_engines_detail_clustercomplete_impl_worker_queue_mole_parent_to_move_out_ix =
...
static const char *mkd_doc_fiction_sidb_simulation_engines_detail_clustercomplete_impl_worker_queue_mutex_to_protect_this_queue = R"doc(Mutex used to protect shared resources in this queue.)doc";

static const char *mkd_doc_fiction_sidb_simulation_engines_detail_clustercomplete_impl_worker_queue_pop_last_layer =
R"doc(Called during backtracking to descend to the previous layer of the
queue, along with popping the unnecessary mole.

)doc";

static const char *mkd_doc_fiction_sidb_simulation_engines_detail_clustercomplete_impl_worker_queue_queue =
...
static const char *mkd_doc_fiction_sidb_simulation_engines_detail_clustercomplete_impl_worker_queue_thief_informants =
...
static const char *mkd_doc_fiction_sidb_simulation_engines_detail_clustercomplete_impl_worker_queue_try_steal_from_this_queue =
...
static const char *mkd_doc_fiction_sidb_simulation_engines_detail_clustercomplete_impl_worker_queue_work_in_queue_count =
R"doc(Counter to keep track of the total amount of work in the double-layer
work queue.)doc";

static const char *mkd_doc_fiction_sidb_simulation_engines_detail_clustercomplete_impl_worker_queue_worker_queue =
R"doc(Standard constructor.
...
static const char *mkd_doc_fiction_sidb_simulation_engines_detail_clustercomplete_impl_worker_work_stealing_queue =
R"doc(This worker's queue where work can be obtained from either by this
worker or by others (work stealing).)doc";

static const char *mkd_doc_fiction_sidb_simulation_engines_detail_clustercomplete_impl_worker_worker =
R"doc(Standard constructor.
...
static const char *mkd_doc_fiction_sidb_simulation_engines_detail_ground_state_space_impl_check_charge_space =
...
static const char *mkd_doc_fiction_sidb_simulation_engines_detail_ground_state_space_impl_clst =
R"doc(The clst starts at all singletons, then moves up through merges until
only the top cluster remains)doc";

static const char *mkd_doc_fiction_sidb_simulation_engines_detail_ground_state_space_impl_compute_external_pot_bounds_for_saved_compositions =
...
static const char *mkd_doc_fiction_sidb_simulation_engines_detail_ground_state_space_impl_compute_meets_for_internal_pot_bounds =
...
static const char *mkd_doc_fiction_sidb_simulation_engines_detail_ground_state_space_impl_construct_merged_charge_state_space =
...
static const char *mkd_doc_fiction_sidb_simulation_engines_detail_ground_state_space_impl_construct_merged_potential_projections =
...
static const char *mkd_doc_fiction_sidb_simulation_engines_detail_ground_state_space_impl_derive_children_received_bounds_without_siblings =
...
static const char *mkd_doc_fiction_sidb_simulation_engines_detail_ground_state_space_impl_fail_onto_negative_charge =
R"doc(Returns `true` if and only if the given potential bound closes out
SiDB-.
...
static const char *mkd_doc_fiction_sidb_simulation_engines_detail_ground_state_space_impl_fill_merged_charge_state_space =
...
static const char *mkd_doc_fiction_sidb_simulation_engines_detail_ground_state_space_impl_find_valid_witness_partitioning =
...
static const char *mkd_doc_fiction_sidb_simulation_engines_detail_ground_state_space_impl_get_initial_clustering =
R"doc(Recursive function used to get the initial clst; the data object that
collects all SiDBs in the layout that are each individually lifted to
(singleton) SiDB cluster objects. Each SiDB cluster object has
information of its electrostatic potential effect onto each SiDB in
the layout, as well as information on the accumulated electrostatic
...
static const char *mkd_doc_fiction_sidb_simulation_engines_detail_ground_state_space_impl_get_next_projected_pot_bound =
...
static const char *mkd_doc_fiction_sidb_simulation_engines_detail_ground_state_space_impl_get_projection_bound =
R"doc(Helper function for obtaining the stored lower or upper bound on the
...
static const char *mkd_doc_fiction_sidb_simulation_engines_detail_ground_state_space_impl_get_projector_state_bound =
R"doc(Helper function for obtaining the stored lower or upper bound on the
electrostatic potential that SiDBs in the given projector state--i.e.,
a cluster together with an associated multiset charge configuration--
collectively project onto the given SiDB.
...
static const char *mkd_doc_fiction_sidb_simulation_engines_detail_ground_state_space_impl_get_received_potential_bounds =
...
static const char *mkd_doc_fiction_sidb_simulation_engines_detail_ground_state_space_impl_ground_state_space_impl =
...
static const char *mkd_doc_fiction_sidb_simulation_engines_detail_ground_state_space_impl_handle_invalid_state =
...
static const char *mkd_doc_fiction_sidb_simulation_engines_detail_ground_state_space_impl_lb_fail_onto_neutral_charge =
R"doc(Performs V > e - mu+.
...
static const char *mkd_doc_fiction_sidb_simulation_engines_detail_ground_state_space_impl_maximum_top_level_multisets =
...
static const char *mkd_doc_fiction_sidb_simulation_engines_detail_ground_state_space_impl_merge_pot_projection_bounds =
...
static const char *mkd_doc_fiction_sidb_simulation_engines_detail_ground_state_space_impl_move_up_hierarchy =
...
the clst may continue as before. The termination of the *Ground State
Space* algorithm is signalled when the clst only contains the top
cluster.

)doc";

static const char *mkd_doc_fiction_sidb_simulation_engines_detail_ground_state_space_impl_mu_bounds_with_error =
R"doc(Globally available array of bounds that section the band gap, used for
pruning.)doc";

static const char *mkd_doc_fiction_sidb_simulation_engines_detail_ground_state_space_impl_params = R"doc(Parameters used during the construction.)doc";

static const char *mkd_doc_fiction_sidb_simulation_engines_detail_ground_state_space_impl_perform_potential_bound_analysis =
...
static const char *mkd_doc_fiction_sidb_simulation_engines_detail_ground_state_space_impl_potential_bound_analysis_mode =
...
static const char *mkd_doc_fiction_sidb_simulation_engines_detail_ground_state_space_impl_potential_bound_analysis_mode_ANALYZE_COMPOSITION =
R"doc(Switch used to analyse multiset charge configurations with information
of specific composition thereof.)doc";

static const char *mkd_doc_fiction_sidb_simulation_engines_detail_ground_state_space_impl_potential_bound_analysis_mode_ANALYZE_MULTISET =
R"doc(Switch used to analyse multiset charge configurations without
composition information.)doc";

static const char *mkd_doc_fiction_sidb_simulation_engines_detail_ground_state_space_impl_projector_state_count =
R"doc(Count the total number of projector states that are stored in the
constructed hierarchy.)doc";

static const char *mkd_doc_fiction_sidb_simulation_engines_detail_ground_state_space_impl_remove_all_cluster_charge_state_occurrences =
...
static const char *mkd_doc_fiction_sidb_simulation_engines_detail_ground_state_space_impl_run =
...
static const char *mkd_doc_fiction_sidb_simulation_engines_detail_ground_state_space_impl_subtract_sibling_pot_from_received_ext_pot_bound =
...
static const char *mkd_doc_fiction_sidb_simulation_engines_detail_ground_state_space_impl_terminate = R"doc(`true` if and only if the construction is to be terminated.)doc";

static const char *mkd_doc_fiction_sidb_simulation_engines_detail_ground_state_space_impl_top_cluster =
R"doc(The top cluster, the cluster that contains all SiDBs, is returned as
the result of the construction.)doc";

static const char *mkd_doc_fiction_sidb_simulation_engines_detail_ground_state_space_impl_ub_fail_onto_neutral_charge =
R"doc(Performs V < -e - mu-.
...
static const char *mkd_doc_fiction_sidb_simulation_engines_detail_ground_state_space_impl_update_charge_spaces =
R"doc(The charge spaces of each cluster in the current clst are checked and
updated accordingly when needed.

Args:
    skip_cluster: This optional parameter specifies a cluster to skip
                  in the pass over all clusters in the current clst.
...
static const char *mkd_doc_fiction_sidb_simulation_engines_detail_ground_state_space_impl_update_external_pot_projection_if_bound_removed =
...
static const char *mkd_doc_fiction_sidb_simulation_engines_detail_ground_state_space_impl_update_external_potential_projection =
...
static const char *mkd_doc_fiction_sidb_simulation_engines_detail_ground_state_space_impl_verify_composition =
...
static const char *mkd_doc_fiction_sidb_simulation_engines_detail_ground_state_space_impl_witness_partitioning_state =
...
static const char *mkd_doc_fiction_sidb_simulation_engines_detail_ground_state_space_impl_witness_partitioning_state_negative_witnesses = R"doc(The set of witnesses for the negative charge state.)doc";

static const char *mkd_doc_fiction_sidb_simulation_engines_detail_ground_state_space_impl_witness_partitioning_state_neutral_witnesses = R"doc(The set of witnesses for the neutral charge state.)doc";

static const char *mkd_doc_fiction_sidb_simulation_engines_detail_ground_state_space_impl_witness_partitioning_state_omit_free_witnesses_and_count_overlap =
...
static const char *mkd_doc_fiction_sidb_simulation_engines_detail_ground_state_space_impl_witness_partitioning_state_positive_witnesses = R"doc(The set of witnesses for the positive charge state.)doc";

static const char *mkd_doc_fiction_sidb_simulation_engines_detail_ground_state_space_impl_witness_partitioning_state_required_neg_count = R"doc(The number of witnesses required for the negative charge state.)doc";

static const char *mkd_doc_fiction_sidb_simulation_engines_detail_ground_state_space_impl_witness_partitioning_state_required_neut_count = R"doc(The number of witnesses required for the neutral charge state.)doc";

static const char *mkd_doc_fiction_sidb_simulation_engines_detail_ground_state_space_impl_witness_partitioning_state_required_pos_count = R"doc(The number of witnesses required for the positive charge state.)doc";

static const char *mkd_doc_fiction_sidb_simulation_engines_detail_ground_state_space_impl_witness_partitioning_state_witness_partitioning_state =
...
static const char *mkd_doc_fiction_sidb_simulation_engines_detail_quickexact_impl = R"doc(Runs *QuickExact* on one layout.)doc";

static const char *mkd_doc_fiction_sidb_simulation_engines_detail_quickexact_impl_free_sidbs =
R"doc(SiDBs the simulation enumerates, i.e., every SiDB that is not pre-
assigned negative.)doc";

static const char *mkd_doc_fiction_sidb_simulation_engines_detail_quickexact_impl_landscape = R"doc(Landscape of the full layout.)doc";

static const char *mkd_doc_fiction_sidb_simulation_engines_detail_quickexact_impl_params = R"doc(Parameters used for the simulation.)doc";

static const char *mkd_doc_fiction_sidb_simulation_engines_detail_quickexact_impl_preassigned_negative_sidbs =
R"doc(SiDBs that have to be negatively charged in every physically valid
distribution.)doc";

static const char *mkd_doc_fiction_sidb_simulation_engines_detail_quickexact_impl_quickexact_impl =
R"doc(Builds the potential landscape of the layout and the all-negative
starting state.

Args:
    lyt: Layout to simulate.
    parameter: *QuickExact* parameters.

)doc";

static const char *mkd_doc_fiction_sidb_simulation_engines_detail_quickexact_impl_record =
R"doc(Records the current charge states of the reduced state as a
distribution over the full layout. The pre-assigned SiDBs are
negative; the energy is that of the reduced system, which equals the
full one.

Args:
    reduced_state: State over the reduced layout.

)doc";

static const char *mkd_doc_fiction_sidb_simulation_engines_detail_quickexact_impl_required_simulation_base_number = R"doc(The required base number for the simulation.)doc";

static const char *mkd_doc_fiction_sidb_simulation_engines_detail_quickexact_impl_required_simulation_base_number_THREE = R"doc(Three state simulation (i.e., negative, neutral, and positive).)doc";

static const char *mkd_doc_fiction_sidb_simulation_engines_detail_quickexact_impl_required_simulation_base_number_TWO = R"doc(Two state simulation (i.e., negative and neutral).)doc";

static const char *mkd_doc_fiction_sidb_simulation_engines_detail_quickexact_impl_run =
R"doc(Runs the simulation.

Returns:
    The physically valid charge distributions of the layout.

)doc";

static const char *mkd_doc_fiction_sidb_simulation_engines_detail_quickexact_impl_sim_result = R"doc(Simulation results.)doc";

static const char *mkd_doc_fiction_sidb_simulation_engines_detail_quickexact_impl_simulate_without_preassigned_negative_sidbs =
R"doc(Simulates the layout with the pre-assigned negative SiDBs removed and
modeled as negative charges the remaining SiDBs see, which shrinks the
enumerated space. The external potential of the removed SiDBs is
carried over, so the energy of the reduced system equals that of the
full one.

Args:
    base_number: Whether positively charged SiDBs can occur.

)doc";

static const char *mkd_doc_fiction_sidb_simulation_engines_detail_quickexact_impl_state =
R"doc(State over the full layout. It stays all-negative except for the
single-SiDB case.)doc";

static const char *mkd_doc_fiction_sidb_simulation_engines_detail_quickexact_impl_three_state_simulation =
R"doc(Enumerates every charge distribution of the reduced layout with the
SiDBs that can be positively charged in base 3 and the rest in base 2,
and records the physically valid ones.
...
static const char *mkd_doc_fiction_sidb_simulation_engines_detail_quickexact_impl_two_state_simulation =
R"doc(Enumerates every two-state charge distribution of the reduced layout
as a Gray code and records the physically valid ones.
...
static const char *mkd_doc_fiction_sidb_simulation_engines_exhaustive_ground_state_simulation =
...
static const char *mkd_doc_fiction_sidb_simulation_engines_ground_state_space_2 =
R"doc(Runs *Ground State Space* on a layout under the parameters' physical
model, without external potentials.

Args:
    lyt: Layout to simulate.
    params: Parameters of the pruning; `params.sim_params` sets the
            physical model.
...
static const char *mkd_doc_fiction_sidb_simulation_engines_ground_state_space_params = R"doc(The set of parameters used in the *Ground State Space* construction.)doc";

static const char *mkd_doc_fiction_sidb_simulation_engines_ground_state_space_params_num_overlapping_witnesses_limit_gss =
R"doc(The complexity is of validity witness partitioning bounded by a
factorial in the number of overlapping witnesses. This parameter thus
allows the validity witness partitioning procedure to perform the
reduction to overlapping witnesses for larger cluster sizes that could
...
static const char *mkd_doc_fiction_sidb_simulation_engines_ground_state_space_params_sim_params =
R"doc(The physical parameters that *Ground State Space* will use to prune
the simulation search space.)doc";

static const char *mkd_doc_fiction_sidb_simulation_engines_ground_state_space_params_witness_partitioning_cluster_size_limit =
R"doc(This specifies the maximum cluster size for which *Ground State Space*
will solve an NP-complete sub-problem exhaustively. The sets of SiDBs
that witness local population stability for each respective charge
state may be partitioned into disjoint sets such that the number of
...
static const char *mkd_doc_fiction_sidb_simulation_engines_ground_state_space_results =
R"doc(This struct is used to store the results of the *Ground State Space*
construction.)doc";

static const char *mkd_doc_fiction_sidb_simulation_engines_ground_state_space_results_maximum_top_level_multisets =
...
static const char *mkd_doc_fiction_sidb_simulation_engines_ground_state_space_results_projector_state_count =
...
static const char *mkd_doc_fiction_sidb_simulation_engines_ground_state_space_results_report =
...
static const char *mkd_doc_fiction_sidb_simulation_engines_quickexact_params_automatic_base_number_detection_OFF =
R"doc(The base number from the physical parameters is used for the
simulation.)doc";

static const char *mkd_doc_fiction_sidb_simulation_engines_quickexact_params_automatic_base_number_detection_ON =
...
static const char *mkd_doc_fiction_sidb_simulation_engines_quickexact_params_base_number_detection =
...
static const char *mkd_doc_fiction_sidb_simulation_engines_quickexact_params_local_external_potential =
R"doc(Local external electrostatic potentials (e.g., locally applied
...
R"doc(*QuickSim* is a heuristic ground-state simulation of SiDB layouts
...
static const char *mkd_doc_fiction_sidb_simulation_engines_quicksim_params_timeout = R"doc(Timeout limit (in ms).)doc";

static const char *mkd_doc_fiction_sidb_simulation_exact_engine = R"doc(Selector exclusively for exact SiDB simulation engines.)doc";

static const char *mkd_doc_fiction_sidb_simulation_exact_engine_CLUSTERCOMPLETE =
R"doc(*ClusterComplete* is a novel exact simulation engine that requires
exponential runtime, though, depending on the simulation problem, it
effectively reduces the base number by a real number, thus allowing
...
static const char *mkd_doc_fiction_sidb_simulation_exact_engine_EXGS =
R"doc(*Exhaustive Ground State Search* (EXGS) is an exact simulation engine
that always has exponential runtime.)doc";

static const char *mkd_doc_fiction_sidb_simulation_exact_engine_QUICKEXACT =
R"doc(*QuickExact* is also an exact simulation engine that requires
exponential runtime, but it scales a lot better than ExGS due to its
effective search-space pruning.)doc";
...
static const char *mkd_doc_fiction_sidb_simulation_heuristic_engine = R"doc(Selector exclusively for heuristic SiDB simulation engines.)doc";
...
physical parameters, the SiDB positions in ångström, and every charge
distribution sorted by energy.)doc";

static const char *mkd_doc_fiction_sidb_simulation_io_detail_sqd_sim_result_writer_os = R"doc(Output stream.)doc";

static const char *mkd_doc_fiction_sidb_simulation_io_detail_sqd_sim_result_writer_run =
R"doc(Writes the complete SiQAD simulation-result document.
...
static const char *mkd_doc_fiction_sidb_simulation_io_detail_sqd_sim_result_writer_sim_result = R"doc(Simulation result to write.)doc";

static const char *mkd_doc_fiction_sidb_simulation_io_detail_sqd_sim_result_writer_sqd_sim_result_writer =
R"doc(Creates a SiQAD simulation-result writer.

Args:
    src: Simulation result.
    s: Output stream.

)doc";

static const char *mkd_doc_fiction_sidb_simulation_io_detail_sqd_sim_result_writer_write_electron_distributions = R"doc(Writes the charge distributions in energy order.)doc";

static const char *mkd_doc_fiction_sidb_simulation_io_detail_sqd_sim_result_writer_write_engine_info = R"doc(Writes the engine name, version, and runtime.)doc";

static const char *mkd_doc_fiction_sidb_simulation_io_detail_sqd_sim_result_writer_write_physical_locations = R"doc(Writes the SiDB positions in ångström.)doc";

static const char *mkd_doc_fiction_sidb_simulation_io_detail_sqd_sim_result_writer_write_simulation_parameters = R"doc(Writes the physical and additional simulation parameters.)doc";
...
R"doc(Detects the input BDL pairs and wires of `source_layout` and applies
input pattern `0`.
...
static const char *mkd_doc_fiction_sidb_simulation_logic_bdl_input_iterator_detected_input_wires = R"doc(The input wires.)doc";
...
static const char *mkd_doc_fiction_sidb_simulation_logic_bdl_input_iterator_params_input_bdl_config =
R"doc(The `input_bdl_config` member allows selection between different modes
for handling input BDLs.)doc";

static const char *mkd_doc_fiction_sidb_simulation_logic_bdl_input_iterator_params_input_bdl_configuration =
...
static const char *mkd_doc_fiction_sidb_simulation_logic_bdl_input_iterator_params_input_bdl_configuration_PERTURBER_ABSENCE_ENCODED =
R"doc(A perturber is used to set the input to `1`, while the absence of a
perturber represents a `0` (as described in
https://ieeexplore.ieee.org/abstract/document/8963859).)doc";

static const char *mkd_doc_fiction_sidb_simulation_logic_bdl_input_iterator_params_input_bdl_configuration_PERTURBER_DISTANCE_ENCODED =
...
static const char *mkd_doc_fiction_sidb_simulation_logic_bdl_input_iterator_sidb_layout = R"doc(The layout with the current input pattern applied.)doc";
...
static const char *mkd_doc_fiction_sidb_simulation_logic_bdl_pair_bdl_pair_2 =
...
static const char *mkd_doc_fiction_sidb_simulation_logic_bdl_pair_equal_ignore_type =
...
static const char *mkd_doc_fiction_sidb_simulation_logic_bdl_pair_has_same_x_coordinate =
...
static const char *mkd_doc_fiction_sidb_simulation_logic_bdl_pair_has_same_y_coordinate =
R"doc(Checks if the `upper` and `lower` SiDBs in this BDL pair have the same
...
static const char *mkd_doc_fiction_sidb_simulation_logic_bdl_pair_lower =
R"doc(The lower SiDB of the pair. Upper and lower are defined relative to
each other via the `operator<` overload.)doc";

static const char *mkd_doc_fiction_sidb_simulation_logic_bdl_pair_not_equal_ignore_type =
...
static const char *mkd_doc_fiction_sidb_simulation_logic_bdl_pair_operator_eq =
...
static const char *mkd_doc_fiction_sidb_simulation_logic_bdl_pair_operator_ge =
...
static const char *mkd_doc_fiction_sidb_simulation_logic_bdl_pair_operator_gt =
...
static const char *mkd_doc_fiction_sidb_simulation_logic_bdl_pair_operator_le =
...
static const char *mkd_doc_fiction_sidb_simulation_logic_bdl_pair_operator_lt =
...
static const char *mkd_doc_fiction_sidb_simulation_logic_bdl_pair_type =
...
static const char *mkd_doc_fiction_sidb_simulation_logic_bdl_pair_upper =
...
static const char *mkd_doc_fiction_sidb_simulation_logic_critical_temperature_domain_add_dimension =
...
static const char *mkd_doc_fiction_sidb_simulation_logic_critical_temperature_domain_dimensions =
...
static const char *mkd_doc_fiction_sidb_simulation_logic_critical_temperature_domain_get_dimension =
...
static const char *mkd_doc_fiction_sidb_simulation_logic_critical_temperature_domain_get_number_of_dimensions =
...
static const char *mkd_doc_fiction_sidb_simulation_logic_critical_temperature_domain_minimum_ct =
...
static const char *mkd_doc_fiction_sidb_simulation_logic_detail_is_operational_impl_sidb_layout = R"doc(The layout to check.)doc";
...
static const char *mkd_doc_fiction_sidb_simulation_logic_detail_non_operationality_reason_LOGIC_MISMATCH = R"doc(The layout is non-operational because of logic mismatch.)doc";
...
static const char *mkd_doc_fiction_sidb_simulation_logic_detail_num_sweep_steps =
R"doc(Validates a sweep range and calculates its rounded number of steps.

Args:
    range: Sweep bounds and step size.

Returns:
    The number of steps, excluding the initial point.

Raises:
    std::invalid_argument: if bounds are non-finite or reversed, the
                           step is not finite and positive, or the
                           number of points exceeds the storage range.
...
static const char *mkd_doc_fiction_sidb_simulation_logic_detail_operational_domain_impl_find_operational_contour_step_point =
...
static const char *mkd_doc_fiction_sidb_simulation_logic_detail_operational_domain_impl_find_operational_step_point_via_random_sampling =
...
static const char *mkd_doc_fiction_sidb_simulation_logic_detail_operational_domain_impl_flood_fill =
...
static const char *mkd_doc_fiction_sidb_simulation_logic_detail_operational_domain_impl_grid_search =
...
static const char *mkd_doc_fiction_sidb_simulation_logic_detail_operational_domain_impl_grid_search_for_physically_valid_parameters =
...
Args:
    cd: Charge distribution to evaluate.
...
static const char *mkd_doc_fiction_sidb_simulation_logic_detail_operational_domain_impl_indices = R"doc(Dimension steps.)doc";

static const char *mkd_doc_fiction_sidb_simulation_logic_detail_operational_domain_impl_infer_operational_status_in_enclosing_contour =
...
static const char *mkd_doc_fiction_sidb_simulation_logic_detail_operational_domain_impl_initialize_sweep =
R"doc(Builds the indices and values of each validated sweep dimension.

Raises:
    std::invalid_argument: if a sweep range is invalid or exceeds the
                           storage range.

)doc";

static const char *mkd_doc_fiction_sidb_simulation_logic_detail_operational_domain_impl_input_bdl_wires = R"doc(Input BDL wires.)doc";

static const char *mkd_doc_fiction_sidb_simulation_logic_detail_operational_domain_impl_input_pattern_layouts =
...
static const char *mkd_doc_fiction_sidb_simulation_logic_detail_operational_domain_impl_is_step_point_inferred_operational =
...
static const char *mkd_doc_fiction_sidb_simulation_logic_detail_operational_domain_impl_is_step_point_operational =
...
static const char *mkd_doc_fiction_sidb_simulation_logic_detail_operational_domain_impl_is_step_point_suitable =
...
static const char *mkd_doc_fiction_sidb_simulation_logic_detail_operational_domain_impl_moore_neighborhood_2d =
...
static const char *mkd_doc_fiction_sidb_simulation_logic_detail_operational_domain_impl_num_dimensions = R"doc(The number of dimensions.)doc";

static const char *mkd_doc_fiction_sidb_simulation_logic_detail_operational_domain_impl_num_evaluated_parameter_combinations = R"doc(Number of evaluated parameter combinations.)doc";

static const char *mkd_doc_fiction_sidb_simulation_logic_detail_operational_domain_impl_num_simulator_invocations = R"doc(Number of simulator invocations.)doc";

static const char *mkd_doc_fiction_sidb_simulation_logic_detail_operational_domain_impl_number_of_threads =
R"doc(Number of worker threads to distribute the parameter points over,
taken from the parameters and floored at `1`.)doc";

static const char *mkd_doc_fiction_sidb_simulation_logic_detail_operational_domain_impl_op_domain = R"doc(The operational domain of the layout.)doc";

static const char *mkd_doc_fiction_sidb_simulation_logic_detail_operational_domain_impl_operational_domain_impl =
...
static const char *mkd_doc_fiction_sidb_simulation_logic_detail_operational_domain_impl_operational_domain_impl_2 =
R"doc(Initializes the layout, parameters, and statistics for a physical-
validity sweep.
...
static const char *mkd_doc_fiction_sidb_simulation_logic_detail_operational_domain_impl_output_bdl_pairs = R"doc(The output BDL pairs of the layout.)doc";
...
static const char *mkd_doc_fiction_sidb_simulation_logic_detail_operational_domain_impl_set_dimension_value =
...
static const char *mkd_doc_fiction_sidb_simulation_logic_detail_operational_domain_impl_sidb_layout = R"doc(The SiDB layout to investigate.)doc";

static const char *mkd_doc_fiction_sidb_simulation_logic_detail_operational_domain_impl_simulate_operational_status_in_parallel =
...
static const char *mkd_doc_fiction_sidb_simulation_logic_detail_operational_domain_impl_stats = R"doc(The statistics of the operational domain computation.)doc";

static const char *mkd_doc_fiction_sidb_simulation_logic_detail_operational_domain_impl_step_point = R"doc(Forward-declare step_point.)doc";

static const char *mkd_doc_fiction_sidb_simulation_logic_detail_operational_domain_impl_step_point_2 = R"doc(Forward-declare step_point.)doc";

static const char *mkd_doc_fiction_sidb_simulation_logic_detail_operational_domain_impl_step_point_operator_le =
...
static const char *mkd_doc_fiction_sidb_simulation_logic_detail_operational_domain_impl_step_point_step_point = R"doc(Standard default constructor.)doc";

static const char *mkd_doc_fiction_sidb_simulation_logic_detail_operational_domain_impl_step_point_step_point_2 =
R"doc(Standard constructor.
...
static const char *mkd_doc_fiction_sidb_simulation_logic_detail_operational_domain_impl_step_point_step_values = R"doc(All dimension step values.)doc";

static const char *mkd_doc_fiction_sidb_simulation_logic_detail_operational_domain_impl_to_parameter_point =
...
static const char *mkd_doc_fiction_sidb_simulation_logic_detail_operational_domain_impl_to_step_point =
...
Returns:
    The first grid point at or above each coordinate of `pp`.

Raises:
    std::invalid_argument: if the dimension count is wrong or a
                           coordinate is non-finite or outside the
                           grid.

)doc";

static const char *mkd_doc_fiction_sidb_simulation_logic_detail_operational_domain_impl_trace_boundary_surface =
...
static const char *mkd_doc_fiction_sidb_simulation_logic_detail_operational_domain_impl_trace_contour_curve =
...
static const char *mkd_doc_fiction_sidb_simulation_logic_detail_operational_domain_impl_truth_table = R"doc(The logical specification of the layout.)doc";

static const char *mkd_doc_fiction_sidb_simulation_logic_detail_operational_domain_impl_values = R"doc(All dimension values.)doc";

static const char *mkd_doc_fiction_sidb_simulation_logic_detail_operational_domain_impl_von_neumann_neighborhood =
...
R"doc(Validates the sweep count, finite ordered bounds, positive finite
steps, point counts, and the preconditions of the operational domain
sketch.
...
static const char *mkd_doc_fiction_sidb_simulation_logic_detect_bdl_pairs_params_minimum_distance =
...
static const char *mkd_doc_fiction_sidb_simulation_logic_detect_bdl_wires_params = R"doc(This struct encapsulates parameters used for detecting BDL wires.)doc";

static const char *mkd_doc_fiction_sidb_simulation_logic_detect_bdl_wires_params_bdl_pairs_params = R"doc(Parameters for the `detect_bdl_pairs` algorithm.)doc";

static const char *mkd_doc_fiction_sidb_simulation_logic_detect_bdl_wires_params_threshold_bdl_interdistance =
...
static const char *mkd_doc_fiction_sidb_simulation_logic_is_operational_params_operational_analysis_strategy =
...
static const char *mkd_doc_fiction_sidb_simulation_logic_is_operational_params_operational_analysis_strategy_FILTER_ONLY =
...
static const char *mkd_doc_fiction_sidb_simulation_logic_is_operational_params_operational_analysis_strategy_SIMULATION_ONLY =
...
static const char *mkd_doc_fiction_sidb_simulation_logic_is_operational_params_operational_condition =
R"doc(Condition to decide whether a layout is operational or non-
operational.)doc";

static const char *mkd_doc_fiction_sidb_simulation_logic_is_operational_params_operational_condition_REJECT_KINKS =
R"doc(The I/O pins are not allowed to show kinks. If kinks exist, the layout
is considered non-operational.)doc";

static const char *mkd_doc_fiction_sidb_simulation_logic_is_operational_params_operational_condition_TOLERATE_KINKS =
R"doc(Even if the I/O pins show kinks, the layout is still considered as
operational.)doc";

static const char *mkd_doc_fiction_sidb_simulation_logic_is_operational_params_sim_engine =
R"doc(The simulation engine to be used for the operational domain
computation.)doc";

static const char *mkd_doc_fiction_sidb_simulation_logic_is_operational_params_sim_params =
...
static const char *mkd_doc_fiction_sidb_simulation_logic_operational_domain_add_dimension =
R"doc(Adds a dimension to sweep over. The first dimension is the x
dimension, the second dimension is the y dimension, etc.
...
static const char *mkd_doc_fiction_sidb_simulation_logic_operational_domain_get_dimension =
R"doc(Returns a specific dimension by index.
...
static const char *mkd_doc_fiction_sidb_simulation_logic_operational_domain_get_number_of_dimensions =
R"doc(Returns the number of dimensions to sweep over.
...
static const char *mkd_doc_fiction_sidb_simulation_logic_operational_domain_operational_domain = R"doc(Default constructor.)doc";

static const char *mkd_doc_fiction_sidb_simulation_logic_operational_domain_operational_domain_2 =
R"doc(Standard constructor.
...
static const char *mkd_doc_fiction_sidb_simulation_logic_operational_domain_params =
...
static const char *mkd_doc_fiction_sidb_simulation_logic_operational_domain_ratio_params =
...
static const char *mkd_doc_fiction_sidb_simulation_logic_operational_domain_ratio_params_op_domain_params = R"doc(Parameters for the operational domain computation.)doc";

static const char *mkd_doc_fiction_sidb_simulation_logic_operational_domain_stats =
R"doc(Statistics for the operational domain computation. The statistics are
used across the different operational domain computation algorithms.)doc";

static const char *mkd_doc_fiction_sidb_simulation_logic_operational_domain_stats_num_evaluated_parameter_combinations = R"doc(Number of evaluated parameter combinations.)doc";

static const char *mkd_doc_fiction_sidb_simulation_logic_operational_domain_stats_num_non_operational_parameter_combinations =
R"doc(Number of parameter combinations, for which the layout is non-
operational.)doc";

static const char *mkd_doc_fiction_sidb_simulation_logic_operational_domain_stats_num_operational_parameter_combinations = R"doc(Number of parameter combinations, for which the layout is operational.)doc";

static const char *mkd_doc_fiction_sidb_simulation_logic_operational_domain_stats_num_simulator_invocations = R"doc(Number of simulator invocations.)doc";

static const char *mkd_doc_fiction_sidb_simulation_logic_operational_domain_stats_num_total_parameter_points = R"doc(Total number of parameter points in the parameter space.)doc";

static const char *mkd_doc_fiction_sidb_simulation_logic_operational_domain_stats_time_total = R"doc(The total runtime of the operational domain computation.)doc";

static const char *mkd_doc_fiction_sidb_simulation_logic_operational_domain_value_range =
R"doc(A range of values for a dimension sweep. The range is defined by a
minimum value, a maximum value and a step size.)doc";

static const char *mkd_doc_fiction_sidb_simulation_logic_operational_domain_value_range_dimension = R"doc(The sweep parameter of the dimension.)doc";

static const char *mkd_doc_fiction_sidb_simulation_logic_operational_domain_value_range_max = R"doc(The maximum value of the dimension sweep.)doc";

static const char *mkd_doc_fiction_sidb_simulation_logic_operational_domain_value_range_min = R"doc(The minimum value of the dimension sweep.)doc";
...
static const char *mkd_doc_fiction_sidb_simulation_logic_operational_status = R"doc(Possible operational status of a layout.)doc";

static const char *mkd_doc_fiction_sidb_simulation_logic_operational_status_NON_OPERATIONAL = R"doc(The layout is non-operational.)doc";

static const char *mkd_doc_fiction_sidb_simulation_logic_operational_status_OPERATIONAL = R"doc(The layout is operational.)doc";
...
static const char *mkd_doc_fiction_sidb_simulation_logic_parameter_point_operator_eq =
...
static const char *mkd_doc_fiction_sidb_simulation_logic_parameter_point_parameter_point = R"doc(Default constructor.)doc";

static const char *mkd_doc_fiction_sidb_simulation_logic_parameter_point_parameter_point_2 =
R"doc(Standard constructor.
...
static const char *mkd_doc_fiction_sidb_simulation_logic_parameter_point_parameters = R"doc(Parameter values for each dimension.)doc";

static const char *mkd_doc_fiction_sidb_simulation_logic_parameter_point_quantize =
...
static const char *mkd_doc_fiction_sidb_simulation_logic_sweep_parameter = R"doc(Possible sweep parameters for the operational domain computation.)doc";

static const char *mkd_doc_fiction_sidb_simulation_logic_sweep_parameter_EPSILON_R = R"doc(The relative permittivity of the dielectric material.)doc";

static const char *mkd_doc_fiction_sidb_simulation_logic_sweep_parameter_LAMBDA_TF = R"doc(The Thomas-Fermi screening length.)doc";
...
static const char *mkd_doc_fiction_sidb_simulation_potential_landscape =
R"doc(The static electrostatics of an SiDB layout under one set of physical
...
static const char *mkd_doc_fiction_sidb_simulation_potential_landscape_chargeless_potential_at_distance =
R"doc(The chargeless potential of a unit charge at a distance under the
...
static const char *mkd_doc_fiction_sidb_simulation_potential_landscape_chargeless_potential_of_defect_at_distance =
R"doc(The chargeless potential a defect exerts at a distance, screened by
the defect's own permittivity and screening length.
...
static const char *mkd_doc_fiction_sidb_simulation_potential_landscape_defect_defect_potentials =
...
static const char *mkd_doc_fiction_sidb_simulation_potential_landscape_defects =
R"doc(The charged surface defects that enter the landscape.
...
static const char *mkd_doc_fiction_sidb_simulation_potential_landscape_effective_charge_transition_thresholds =
R"doc(The charge transition thresholds of an SiDB, indexed by
...
static const char *mkd_doc_fiction_sidb_simulation_potential_landscape_energy =
R"doc(The electrostatic potential energy of a charge distribution given its
local internal potentials, i.e., the energy of the SiDB charges in the
potential of the other SiDBs, the defects, and the external sources,
plus the energy of the defect charges. O(N + D·N) for D charged
defects.

Args:
    cd: Charge distribution over this landscape's SiDBs.
    local_internal_potential: Local internal potential per SiDB, as
                              `local_internal_potentials` computes it.
...
Raises:
    std::invalid_argument: if the distribution sites differ from the
                           landscape. std::invalid_argument: if the
                           potential vector does not contain one value
                           per SiDB.

)doc";

static const char *mkd_doc_fiction_sidb_simulation_potential_landscape_energy_2 =
R"doc(The electrostatic potential energy of a charge distribution. O(N²).
...
static const char *mkd_doc_fiction_sidb_simulation_potential_landscape_evaluate =
R"doc(Evaluates a charge distribution: returns a copy with its energy set.
O(N²).
...
static const char *mkd_doc_fiction_sidb_simulation_potential_landscape_get_layout =
R"doc(The layout the landscape describes.
...
static const char *mkd_doc_fiction_sidb_simulation_potential_landscape_is_configuration_stable =
R"doc(Whether no charge hop between two SiDBs lowers the energy, i.e., the
distribution is configuration stable.

Args:
    cd: Charge distribution over this landscape's SiDBs.
    local_internal_potential: Local internal potential per SiDB.

Returns:
    `true` iff no energetically favored hop exists.
...
static const char *mkd_doc_fiction_sidb_simulation_potential_landscape_is_physically_valid =
R"doc(Whether a charge distribution is physically valid: population stable
...
static const char *mkd_doc_fiction_sidb_simulation_potential_landscape_is_physically_valid_2 =
R"doc(Whether a charge distribution is physically valid. O(N²).
...
static const char *mkd_doc_fiction_sidb_simulation_potential_landscape_is_population_stable =
R"doc(Whether every SiDB's charge state is population stable under its local
potential: a negative SiDB below the (0/-) transition, a positive one
above the (+/0) transition, a neutral one in between.
...
Returns:
    `true` iff the population stability holds for every SiDB.
...
static const char *mkd_doc_fiction_sidb_simulation_potential_landscape_local_potentials =
R"doc(The local potentials of a charge distribution: internal plus external
...
static const char *mkd_doc_fiction_sidb_simulation_potential_landscape_num_sidbs =
R"doc(Number of SiDBs.
...
static const char *mkd_doc_fiction_sidb_simulation_potential_landscape_validate_distribution =
R"doc(Checks that a distribution covers the landscape's sites.

Args:
    cd: Charge distribution.

Raises:
    std::invalid_argument: if the site lists or cardinalities differ.

)doc";

static const char *mkd_doc_fiction_sidb_simulation_potential_landscape_validate_distribution_2 =
R"doc(Checks a distribution and its cached local internal potentials.

Args:
    cd: Charge distribution.
    internal_potentials: Local internal potential per SiDB.

Raises:
    std::invalid_argument: if the sites differ or the potential count
                           differs from the SiDB count.

)doc";

static const char *mkd_doc_fiction_sidb_simulation_potential_landscape_validate_index =
R"doc(Validates an SiDB index before matrix indexing.
...
state per SiDB in the layout's raster order plus its energy.)doc";
...
static const char *mkd_doc_fiction_sidb_simulation_result_charge_state =
R"doc(The charge state of an SiDB in one of the charge distributions.
...
R"doc(The charge distributions of minimal energy. Distributions with
...
static const char *mkd_doc_fiction_sidb_simulation_result_lyt = R"doc(The simulated layout.)doc";

static const char *mkd_doc_fiction_sidb_simulation_result_sim_params = R"doc(Physical parameters used in the simulation.)doc";
...
static const char *mkd_doc_fiction_synthesis_all_standard_2_input_functions =
R"doc(Auxiliary function to create technology mapping parameters for AND,
...
static const char *mkd_doc_fiction_synthesis_all_standard_3_input_functions =
...
static const char *mkd_doc_fiction_synthesis_all_supported_functions =
...
static const char *mkd_doc_fiction_synthesis_all_supported_standard_functions =
R"doc(Auxiliary function to create technology mapping parameters for all
...
static const char *mkd_doc_fiction_synthesis_and_or_not =
R"doc(Auxiliary function to create technology mapping parameters for AND,
OR, and NOT gates.
...
static const char *mkd_doc_fiction_synthesis_and_or_not_maj =
R"doc(Auxiliary function to create technology mapping parameters for AND,
...
static const char *mkd_doc_fiction_synthesis_convert_network =
...
static const char *mkd_doc_fiction_synthesis_detail_convert_network_impl = R"doc()doc";

static const char *mkd_doc_fiction_synthesis_detail_delete_virtual_pis_impl = R"doc()doc";

static const char *mkd_doc_fiction_synthesis_detail_delete_virtual_pis_impl_delete_virtual_pis_impl = R"doc()doc";

static const char *mkd_doc_fiction_synthesis_detail_delete_virtual_pis_impl_initialize_copy_virtual_pi_network =
...
static const char *mkd_doc_fiction_synthesis_detail_delete_virtual_pis_impl_ntk = R"doc(Network without virtual PIs.)doc";

static const char *mkd_doc_fiction_synthesis_detail_delete_virtual_pis_impl_ntk_topo = R"doc(Topological view of the input network.)doc";

static const char *mkd_doc_fiction_synthesis_detail_delete_virtual_pis_impl_run = R"doc()doc";

static const char *mkd_doc_fiction_synthesis_detail_fanout_substitution_impl = R"doc()doc";
...
static const char *mkd_doc_fiction_synthesis_detail_fanout_substitution_impl_generate_depth_tree =
...
static const char *mkd_doc_fiction_synthesis_detail_fanout_substitution_impl_ps = R"doc(Parameters controlling how fanout substitution is performed.)doc";

static const char *mkd_doc_fiction_synthesis_detail_fanout_substitution_impl_rng = R"doc(Optional helper struct holding the RNG and its distribution.)doc";

static const char *mkd_doc_fiction_synthesis_detail_fanout_substitution_impl_run = R"doc()doc";

static const char *mkd_doc_fiction_synthesis_detail_get_po_levels = R"doc()doc";

static const char *mkd_doc_fiction_synthesis_detail_is_balanced_impl = R"doc()doc";
...
static const char *mkd_doc_fiction_synthesis_detail_is_balanced_impl_ntk_depth = R"doc()doc";

static const char *mkd_doc_fiction_synthesis_detail_is_balanced_impl_ps = R"doc()doc";

static const char *mkd_doc_fiction_synthesis_detail_is_balanced_impl_run = R"doc()doc";
...
static const char *mkd_doc_fiction_synthesis_detail_is_fanout_substituted_impl_ps = R"doc()doc";

static const char *mkd_doc_fiction_synthesis_detail_is_fanout_substituted_impl_run = R"doc()doc";

static const char *mkd_doc_fiction_synthesis_detail_is_fanout_substituted_impl_substituted = R"doc()doc";
...
static const char *mkd_doc_fiction_synthesis_detail_network_balancing_impl_ntk_depth = R"doc()doc";

static const char *mkd_doc_fiction_synthesis_detail_network_balancing_impl_ntk_topo = R"doc()doc";

static const char *mkd_doc_fiction_synthesis_detail_network_balancing_impl_ps = R"doc()doc";

static const char *mkd_doc_fiction_synthesis_detail_network_balancing_impl_run = R"doc()doc";

static const char *mkd_doc_fiction_synthesis_detail_rng_state =
...
static const char *mkd_doc_fiction_synthesis_detail_rng_state_dist =
...
static const char *mkd_doc_fiction_synthesis_detail_rng_state_gen =
...
static const char *mkd_doc_fiction_synthesis_detail_rng_state_rng_state =
R"doc(Default constructor.
...
static const char *mkd_doc_fiction_synthesis_detail_technology_mapping_impl = R"doc()doc";

static const char *mkd_doc_fiction_synthesis_detail_technology_mapping_impl_ntk = R"doc(Input network to be mapped.)doc";

static const char *mkd_doc_fiction_synthesis_detail_technology_mapping_impl_params = R"doc(Technology mapping parameters.)doc";

static const char *mkd_doc_fiction_synthesis_detail_technology_mapping_impl_perform_mapping =
...
static const char *mkd_doc_fiction_synthesis_detail_technology_mapping_impl_run = R"doc()doc";

static const char *mkd_doc_fiction_synthesis_detail_technology_mapping_impl_set_up_gates =
...
static const char *mkd_doc_fiction_synthesis_detail_technology_mapping_impl_stats = R"doc(Technology mapping statistics.)doc";

static const char *mkd_doc_fiction_synthesis_detail_technology_mapping_impl_technology_mapping_impl = R"doc()doc";

static const char *mkd_doc_fiction_synthesis_detail_technology_mapping_impl_validate_required_gates =
...
static const char *mkd_doc_fiction_synthesis_fanout_substitution_params_strategy =
R"doc(Substitution strategy of high-degree fanout networks (depth-first vs.
breadth-first).)doc";

static const char *mkd_doc_fiction_synthesis_fanout_substitution_params_substitution_strategy = R"doc(Breadth-first vs. depth-first fanout-tree substitution strategies.)doc";

static const char *mkd_doc_fiction_synthesis_fanout_substitution_params_substitution_strategy_BREADTH = R"doc(Breadth-first substitution. Creates balanced fanout trees.)doc";

static const char *mkd_doc_fiction_synthesis_fanout_substitution_params_substitution_strategy_DEPTH = R"doc(Depth-first substitution. Creates fanout trees with one deep branch.)doc";

static const char *mkd_doc_fiction_synthesis_fanout_substitution_params_substitution_strategy_RANDOM =
...
static const char *mkd_doc_fiction_synthesis_is_fanout_substituted =
...
static const char *mkd_doc_fiction_synthesis_missing_required_gates_exception =
...
static const char *mkd_doc_fiction_synthesis_missing_required_gates_exception_missing_required_gates_exception = R"doc()doc";

static const char *mkd_doc_fiction_synthesis_network_balancing =
...
static const char *mkd_doc_fiction_synthesis_technology_mapping =
...
static const char *mkd_doc_fiction_synthesis_technology_mapping_params = R"doc()doc";

static const char *mkd_doc_fiction_synthesis_technology_mapping_params_and2 = R"doc(2-input AND gate.)doc";

static const char *mkd_doc_fiction_synthesis_technology_mapping_params_and3 = R"doc(3-input AND gate.)doc";

static const char *mkd_doc_fiction_synthesis_technology_mapping_params_and_xor = R"doc(3-input AND-XOR gate.)doc";

static const char *mkd_doc_fiction_synthesis_technology_mapping_params_decay =
R"doc(Enforce the application of at least one constant input to three-input
gates.)doc";

static const char *mkd_doc_fiction_synthesis_technology_mapping_params_dot = R"doc(3-input DOT gate.)doc";

static const char *mkd_doc_fiction_synthesis_technology_mapping_params_gamble = R"doc(3-input GAMBLE gate.)doc";

static const char *mkd_doc_fiction_synthesis_technology_mapping_params_ge2 = R"doc(2-input greater-or-equal gate.)doc";

static const char *mkd_doc_fiction_synthesis_technology_mapping_params_gt2 = R"doc(2-input greater-than gate.)doc";

static const char *mkd_doc_fiction_synthesis_technology_mapping_params_inv = R"doc(1-input NOT gate (inverter).)doc";

static const char *mkd_doc_fiction_synthesis_technology_mapping_params_le2 = R"doc(2-input less-or-equal gate.)doc";

static const char *mkd_doc_fiction_synthesis_technology_mapping_params_lt2 = R"doc(2-input less-than gate.)doc";

static const char *mkd_doc_fiction_synthesis_technology_mapping_params_maj3 = R"doc(3-input MAJ gate.)doc";

static const char *mkd_doc_fiction_synthesis_technology_mapping_params_mapper_params = R"doc(mockturtle's mapper parameters.)doc";

static const char *mkd_doc_fiction_synthesis_technology_mapping_params_mux = R"doc(3-input MUX gate (ITE).)doc";

static const char *mkd_doc_fiction_synthesis_technology_mapping_params_nand2 = R"doc(2-input NAND gate.)doc";

static const char *mkd_doc_fiction_synthesis_technology_mapping_params_nor2 = R"doc(2-input NOR gate.)doc";

static const char *mkd_doc_fiction_synthesis_technology_mapping_params_onehot = R"doc(3-input ONEHOT gate.)doc";

static const char *mkd_doc_fiction_synthesis_technology_mapping_params_or2 = R"doc(2-input OR gate.)doc";

static const char *mkd_doc_fiction_synthesis_technology_mapping_params_or_and = R"doc(3-input OR-AND gate.)doc";

static const char *mkd_doc_fiction_synthesis_technology_mapping_params_xnor2 = R"doc(2-input XNOR gate.)doc";

static const char *mkd_doc_fiction_synthesis_technology_mapping_params_xor2 = R"doc(2-input XOR gate.)doc";

static const char *mkd_doc_fiction_synthesis_technology_mapping_params_xor_and = R"doc(3-input XOR-AND gate.)doc";

static const char *mkd_doc_fiction_synthesis_technology_mapping_stats = R"doc(Statistics for technology mapping.)doc";

static const char *mkd_doc_fiction_synthesis_technology_mapping_stats_mapper_stats = R"doc(Statistics for mockturtle's mapper.)doc";
...
static const char *mkd_doc_fiction_utils_math_cartesian_combinations =
...
static const char *mkd_doc_fiction_utils_math_cost_function_chi =
...
static const char *mkd_doc_fiction_utils_math_determine_all_combinations_of_distributing_k_entities_on_n_positions =
...
static const char *mkd_doc_fiction_utils_math_round_to_n_decimal_places =
...
static const char *mkd_doc_fiction_utils_stl_convert_array_of_arrays =
...
static const char *mkd_doc_fiction_utils_stl_create_array =
...
static const char *mkd_doc_fiction_utils_stl_detail_convert_array_of_arrays =
R"doc(Based on https://stackoverflow.com/questions/57756557/initializing-a-
stdarray-with-a-constant-value

)doc";

static const char *mkd_doc_fiction_utils_stl_detail_create_array =
R"doc(From https://stackoverflow.com/questions/57756557/initializing-a-
stdarray-with-a-constant-value

)doc";

static const char *mkd_doc_fiction_utils_stl_find_first_two_of =
...
static const char *mkd_doc_fiction_utils_stl_safe_localtime =
...
static const char *mkd_doc_fiction_utils_stl_searchable_priority_queue =
...
static const char *mkd_doc_fiction_utils_stl_searchable_priority_queue_begin = R"doc()doc";

static const char *mkd_doc_fiction_utils_stl_searchable_priority_queue_begin_2 = R"doc()doc";

static const char *mkd_doc_fiction_utils_stl_searchable_priority_queue_cbegin = R"doc()doc";

static const char *mkd_doc_fiction_utils_stl_searchable_priority_queue_cend = R"doc()doc";

static const char *mkd_doc_fiction_utils_stl_searchable_priority_queue_contains =
...
static const char *mkd_doc_fiction_utils_stl_searchable_priority_queue_end = R"doc()doc";

static const char *mkd_doc_fiction_utils_stl_searchable_priority_queue_end_2 = R"doc()doc";

static const char *mkd_doc_fiction_utils_stl_searchable_priority_queue_find =
...
static const char *mkd_doc_fiction_utils_stl_searchable_priority_queue_find_2 =
...
static const char *mkd_doc_fiction_verification_cp_and_tp_critical_path_length = R"doc(Length of the critical path in tiles.)doc";

static const char *mkd_doc_fiction_verification_cp_and_tp_throughput =
R"doc(Throughput of the layout in clock cycles as :math:`\frac{1}{x}` where
only :math:`x` is stored.)doc";

static const char *mkd_doc_fiction_verification_critical_path_length_and_throughput =
...
static const char *mkd_doc_fiction_verification_detail_gate_level_drvs_impl_check_icon =
...
static const char *mkd_doc_fiction_verification_detail_gate_level_drvs_impl_clocked_data_flow_check =
...
static const char *mkd_doc_fiction_verification_detail_gate_level_drvs_impl_crossing_gates_check =
...
static const char *mkd_doc_fiction_verification_detail_gate_level_drvs_impl_has_io_check =
...
static const char *mkd_doc_fiction_verification_detail_gate_level_drvs_impl_lyt = R"doc(Layout to perform design rule checks on.)doc";

static const char *mkd_doc_fiction_verification_detail_gate_level_drvs_impl_missing_connections_check =
...
static const char *mkd_doc_fiction_verification_detail_gate_level_drvs_impl_non_adjacent_connections_check =
R"doc(Checks for proper clocking of connected tiles based on their assigned
nodes.
...
static const char *mkd_doc_fiction_verification_detail_gate_level_drvs_impl_ps = R"doc(Parameters.)doc";

static const char *mkd_doc_fiction_verification_detail_gate_level_drvs_impl_pst = R"doc(Statistics.)doc";

static const char *mkd_doc_fiction_verification_detail_gate_level_drvs_impl_run =
...
static const char *mkd_doc_fiction_verification_detail_gate_level_drvs_impl_summary =
...
static const char *mkd_doc_fiction_verification_detail_handle_virtual_pis =
...
static const char *mkd_doc_fiction_verification_equivalence_checking_stats_eq = R"doc(Stores the equivalence type.)doc";

static const char *mkd_doc_fiction_verification_equivalence_checking_stats_impl_drv_stats = R"doc()doc";

static const char *mkd_doc_fiction_verification_equivalence_checking_stats_runtime = R"doc(Stores the runtime.)doc";

static const char *mkd_doc_fiction_verification_equivalence_checking_stats_spec_drv_stats = R"doc(Stores DRVs.)doc";

static const char *mkd_doc_fiction_verification_equivalence_checking_stats_tp_diff = R"doc(Throughput values at which weak equivalence manifests.)doc";

static const char *mkd_doc_fiction_verification_equivalence_checking_stats_tp_impl = R"doc(Throughput values at which weak equivalence manifests.)doc";

static const char *mkd_doc_fiction_verification_equivalence_checking_stats_tp_spec = R"doc(Throughput values at which weak equivalence manifests.)doc";

static const char *mkd_doc_fiction_verification_gate_level_drv_params =
R"doc(Parameters for design rule violation checking that specify the checks
that are to be executed.)doc";

static const char *mkd_doc_fiction_verification_gate_level_drv_params_border_io = R"doc(Check if the I/Os are located at the layout's border.)doc";

static const char *mkd_doc_fiction_verification_gate_level_drv_params_clocked_data_flow = R"doc(Check if all node connections obey the clocking scheme data flow.)doc";
...
static const char *mkd_doc_fiction_verification_gate_level_drv_stats_report = R"doc(Report.)doc";

static const char *mkd_doc_fiction_verification_gate_level_drv_stats_warnings = R"doc(Number of warnings.)doc";

static const char *mkd_doc_fiction_verification_gate_level_drvs =
...
static const char *mkd_doc_fiction_verification_virtual_miter =
