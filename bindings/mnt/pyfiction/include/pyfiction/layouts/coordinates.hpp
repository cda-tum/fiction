...
inline void coordinate_utility(pybind11::module& m)
{
    ...
    m.def("area", &fiction::area<py_offset_coordinate>, py::arg("coord"), DOC(fiction_area));
    m.def("area", &fiction::area<py_cube_coordinate>, py::arg("coord"), DOC(fiction_area));
    m.def("area", &fiction::area<py_siqad_coordinate>, py::arg("coord"), DOC(fiction_area));

    m.def("volume", &fiction::volume<py_offset_coordinate>, py::arg("coord"), DOC(fiction_volume));
    m.def("volume", &fiction::volume<py_cube_coordinate>, py::arg("coord"), DOC(fiction_volume));
    m.def("volume", &fiction::volume<py_siqad_coordinate>, py::arg("coord"), DOC(fiction_volume));
