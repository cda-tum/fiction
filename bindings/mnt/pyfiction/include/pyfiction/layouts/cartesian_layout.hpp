...
inline void cartesian_layout(pybind11::module& m)
{
    ...
    py::class_<py_cartesian_layout>(m, "cartesian_layout", DOC(fiction_cartesian_layout_overridden))
        ...
        .def("resize", &py_cartesian_layout::resize, py::arg("dimension"), DOC(fiction_cartesian_layout_resize))

        .def("north", &py_cartesian_layout::north, py::arg("c"), DOC(fiction_cartesian_layout_north))
        .def("north_east", &py_cartesian_layout::north_east, py::arg("c"), DOC(fiction_cartesian_layout_north_east))
        .def("east", &py_cartesian_layout::east, py::arg("c"), DOC(fiction_cartesian_layout_east))
        .def("south_east", &py_cartesian_layout::south_east, py::arg("c"), DOC(fiction_cartesian_layout_south_east))
        .def("south", &py_cartesian_layout::south, py::arg("c"), DOC(fiction_cartesian_layout_south))
        .def("south_west", &py_cartesian_layout::south_west, py::arg("c"), DOC(fiction_cartesian_layout_south_west))
        .def("west", &py_cartesian_layout::west, py::arg("c"), DOC(fiction_cartesian_layout_west))
        .def("north_west", &py_cartesian_layout::north_west, py::arg("c"), DOC(fiction_cartesian_layout_north_west))
        .def("above", &py_cartesian_layout::above, py::arg("c"), DOC(fiction_cartesian_layout_above))
        .def("below", &py_cartesian_layout::below, py::arg("c"), DOC(fiction_cartesian_layout_below))
