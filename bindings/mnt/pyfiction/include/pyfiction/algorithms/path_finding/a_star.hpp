...
inline void a_star(pybind11::module& m)
{
    ...
    detail::a_star<py_cartesian_obstruction_layout<py_cube_coordinate>>(m);
    detail::a_star<py_cartesian_gate_layout<py_offset_coordinate>>(m);
    detail::a_star<py_cartesian_gate_layout<py_cube_coordinate>>(m);
    detail::a_star<py_cartesian_clocked_layout<py_offset_coordinate>>(m);
    detail::a_star<py_cartesian_clocked_layout<py_cube_coordinate>>(m);
    detail::a_star<py_cartesian_layout<py_offset_coordinate>>(m);
    detail::a_star<py_cartesian_layout<py_cube_coordinate>>(m);
    detail::a_star<py_shifted_cartesian_obstruction_layout<py_offset_coordinate>>(m);
    detail::a_star<py_shifted_cartesian_obstruction_layout<py_cube_coordinate>>(m);
    detail::a_star<py_shifted_cartesian_gate_layout<py_offset_coordinate>>(m);
    detail::a_star<py_shifted_cartesian_gate_layout<py_cube_coordinate>>(m);
