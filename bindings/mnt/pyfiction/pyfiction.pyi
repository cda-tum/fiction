...
class cartesian_gate_layout(clocked_cartesian_layout):
    ...
    def create_pi(
        self, name: str = "", t: offset_coordinate | tuple[int, int] | tuple[int, int, int] | None = None
    ) -> None: ...
    def create_po(
        self, s: int, name: str = "", t: offset_coordinate | tuple[int, int] | tuple[int, int, int] | None = None
    ) -> None: ...
    ...
    def clear_coordinate(self, t: offset_coordinate | tuple[int, int] | tuple[int, int, int]) -> None: ...
    def is_gate_coordinate(self, t: offset_coordinate | tuple[int, int] | tuple[int, int, int]) -> bool: ...
    def is_wire_coordinate(self, t: offset_coordinate | tuple[int, int] | tuple[int, int, int]) -> bool: ...
    def is_empty_coordinate(self, t: offset_coordinate | tuple[int, int] | tuple[int, int, int]) -> bool: ...
...
class hexagonal_gate_layout(clocked_hexagonal_layout):
    ...
    def create_pi(
        self, name: str = "", t: cube_coordinate | tuple[int, int] | tuple[int, int, int] | None = None
    ) -> None: ...
    def create_po(
        self, s: int, name: str = "", t: cube_coordinate | tuple[int, int] | tuple[int, int, int] | None = None
    ) -> None: ...
    def is_pi(self, n: int) -> bool: ...
    def is_po(self, n: int) -> bool: ...
    ...
    def get_output_name(self, index: int) -> str: ...
    def get_name(self, s: int) -> str: ...
    def create_buf(self, a: int, t: cube_coordinate | tuple[int, int] | tuple[int, int, int] | None = None) -> None: ...
    def create_not(self, a: int, t: cube_coordinate | tuple[int, int] | tuple[int, int, int] | None = None) -> None: ...
    def create_and(
    ...
    def clear_coordinate(self, t: cube_coordinate | tuple[int, int] | tuple[int, int, int]) -> None: ...
    def is_gate_coordinate(self, t: cube_coordinate | tuple[int, int] | tuple[int, int, int]) -> bool: ...
    def is_wire_coordinate(self, t: cube_coordinate | tuple[int, int] | tuple[int, int, int]) -> bool: ...
    def is_empty_coordinate(self, t: cube_coordinate | tuple[int, int] | tuple[int, int, int]) -> bool: ...
...
class bdl_input_iterator_100:
    ...
    def __add__(self, n: int) -> bdl_input_iterator_100: ...
    def __iadd__(self, n: int) -> Self: ...
    def __sub__(self, n: int) -> bdl_input_iterator_100: ...
    def __isub__(self, n: int) -> Self: ...
    def __getitem__(self, n: int) -> bdl_input_iterator_100: ...
    def num_input_pairs(self) -> int: ...
    def get_layout(self) -> sidb_layout: ...

class bdl_input_iterator_111:
    def __init__(self, lyt: object, params: bdl_input_iterator_params) -> None: ...
    def __next__(self) -> object: ...
    def __eq__(self, n: int) -> bool: ...
    def __ne__(self, n: int) -> bool: ...
    ...
    def __gt__(self, n: int) -> bool: ...
    def __ge__(self, n: int) -> bool: ...
    def __add__(self, n: int) -> bdl_input_iterator_111: ...
    def __iadd__(self, n: int) -> Self: ...
    def __sub__(self, n: int) -> bdl_input_iterator_111: ...
    def __isub__(self, n: int) -> Self: ...
    def __getitem__(self, n: int) -> bdl_input_iterator_111: ...
    def num_input_pairs(self) -> int: ...
    def get_layout(self) -> sidb_layout: ...
...
def sidb_nm_distance_111(
    lyt: sidb_111_lattice, c: offset_coordinate | tuple[int, int] | tuple[int, int, int]
) -> tuple[float, float]: ...
def sidb_nm_distance_100(
    lyt: sidb_100_lattice, c: offset_coordinate | tuple[int, int] | tuple[int, int, int]
) -> tuple[float, float]: ...
