...
class write_sidb_layout_svg_params:
    def __init__(self) -> None:
        self.lattice_point_size: float
        self.sidb_size: float
        self.sidb_border_width: float
        self.color_background: str
...
class sidb_simulation_result_100:
    def __init__(self) -> None:
        ...
        self.simulation_runtime: float
        self.charge_distributions: list[charge_distribution_surface_100]
        self.simulation_parameters: sidb_simulation_parameters
        self.additional_simulation_parameters: dict[str, Any]
...
class sidb_simulation_result_111:
    def __init__(self) -> None:
        self.algorithm_name: str
        self.simulation_runtime: float
        self.charge_distributions: list[charge_distribution_surface_111]
        self.simulation_parameters: sidb_simulation_parameters
        self.additional_simulation_parameters: dict[str, Any]
...
class time_to_solution_stats:
    def __init__(self) -> None:
        self.time_to_solution: float
        self.acc: float
        self.mean_single_runtime: float
        self.single_runtime_exact: float
        self.algorithm: str
...
class displacement_robustness_domain_params:
    def __init__(self) -> None:
        self.analysis_mode: displacement_analysis_mode
        self.percentage_of_analyzed_displaced_layouts: float
        self.displacement_variations: int
        self.operational_params: is_operational_params
