...
def exact_cartesian(
    network: technology_network, parameters: exact_params = ..., statistics: exact_stats | None = None
) -> cartesian_gate_layout: ...
...
def write_operational_domain(
    opdom: operational_domain, filename: str, params: write_operational_domain_params = ...
) -> None: ...
...
class bdl_input_iterator_100(Iterable[sidb_100_lattice]):
    def __init__(self, lyt: sidb_100_lattice, params: bdl_input_iterator_params = ...) -> None: ...
    def __iter__(self) -> bdl_input_iterator_100: ...
    def __next__(self) -> sidb_100_lattice: ...
...
class bdl_input_iterator_111(Iterable[sidb_111_lattice]):
    def __init__(self, lyt: sidb_111_lattice, params: bdl_input_iterator_params) -> None: ...
    def __iter__(self) -> bdl_input_iterator_111: ...
    def __next__(self) -> sidb_111_lattice: ...
    def __eq__(self, m: object) -> bool: ...
    def __ne__(self, m: object) -> bool: ...
    def __lt__(self, m: int) -> bool: ...
    def __le__(self, m: int) -> bool: ...
...
class charge_distribution_surface_111(sidb_111_lattice):
    ...
    def __init__(self, params: sidb_simulation_parameters = ..., cs: sidb_charge_state = ...) -> None: ...
    @overload
    def __init__(self, lyt: charge_distribution_surface_111) -> None: ...
    @overload
    def __init__(
        self,
...
def potential_to_distance_conversion(
    potential: float, params: sidb_simulation_parameters = ..., precision: float = ...
) -> float: ...
...
@overload
def groundstate_from_simulation_result(
...
class positive_charges:
    __members__: ClassVar[dict[positive_charges, str]]  # readonly

    ALLOWED: ClassVar[positive_charges]
    FORBIDDEN: ClassVar[positive_charges]
    MAY_OCCUR: ClassVar[positive_charges]
...
class generate_random_sidb_layout_params:
    ...
    coordinate_pair: tuple[offset_coordinate, offset_coordinate]
    number_of_sidbs: int
    positive_sidbs: positive_charges
    maximal_attempts: int
    number_of_unique_generated_layouts: int
    maximal_attempts_for_multiple_layouts: int

def generate_random_sidb_layout(
    lyt_skeleton: sidb_100_lattice | sidb_111_lattice, params: generate_random_sidb_layout_params = ...
) -> sidb_100_lattice | sidb_111_lattice: ...
...
def num_adjacent_coordinates(
    lyt: cartesian_layout | shifted_cartesian_layout | hexagonal_layout,
    c: offset_coordinate | tuple[int, int] | tuple[int, int, int],
) -> int: ...
def random_offset_coordinate(
...
def random_cube_coordinate(
    coordinate1: cube_coordinate | tuple[int, int] | tuple[int, int, int],
    coordinate2: cube_coordinate | tuple[int, int] | tuple[int, int, int],
) -> cube_coordinate: ...
def random_siqad_coordinate(
    coordinate1: siqad_coordinate | tuple[int, int] | tuple[int, int, int],
    coordinate2: siqad_coordinate | tuple[int, int] | tuple[int, int, int],
) -> siqad_coordinate: ...
...
def is_crossable_wire(
    ...
    | hexagonal_gate_layout,
    src: offset_coordinate,
    successor: offset_coordinate,
) -> bool: ...
def route_path(
    layout: cartesian_obstruction_layout
    | cartesian_gate_layout
...
def extract_routing_objectives(
    ...
    | hexagonal_obstruction_layout
    | hexagonal_gate_layout,
) -> list[tuple[offset_coordinate, offset_coordinate]]: ...
def clear_routing(
    layout: cartesian_obstruction_layout
    | cartesian_gate_layout
    | shifted_cartesian_obstruction_layout
...
def get_name(
    ntk_or_lyt: cartesian_gate_layout
    | shifted_cartesian_gate_layout
    | hexagonal_gate_layout
    | qca_layout
    | inml_layout
...
class high_degree_fanin_exception(Exception): ...

def has_high_degree_fanin_nodes(ntk: technology_network, threshold: int = ...) -> bool: ...

# Placement utils

def reserve_input_nodes(
    lyt: cartesian_gate_layout | shifted_cartesian_gate_layout | hexagonal_gate_layout, ntk: technology_network
) -> list[int]: ...
@overload
def place(
    lyt: cartesian_gate_layout | shifted_cartesian_gate_layout | hexagonal_gate_layout,
    t: offset_coordinate | tuple[int, int] | tuple[int, int, int],
    ntk: technology_network,
    n: int,
) -> int: ...
@overload
def place(
