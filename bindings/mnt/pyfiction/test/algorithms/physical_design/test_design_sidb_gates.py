...
class TestDesignSiDBGates(unittest.TestCase):
    ...
    def test_nor_gate_111_exhaustive(self):
        ...
        params.design_mode = design_sidb_gates_params_design_sidb_gates_mode_111.PRUNING_ONLY
    ...
    def test_nor_gate_111_random(self):
        layout = sidb_111_lattice((30, 30))
        ...
        self.assertEqual(params.operational_params.simulation_parameters.mu_minus, -0.32)
        self.assertEqual(params.number_of_canvas_sidbs, 3)
        self.assertEqual(params.maximum_number_of_solutions, 5)
        self.assertEqual(params.canvas[0], (10, 26, 0))
        self.assertEqual(params.canvas[1], (14, 34))

        designed_gates = design_sidb_gates(layout, [create_nor_tt()], params)
        self.assertGreaterEqual(len(designed_gates), params.maximum_number_of_solutions)
        self.assertLess(len(designed_gates), params.maximum_number_of_solutions + params.available_threads)
