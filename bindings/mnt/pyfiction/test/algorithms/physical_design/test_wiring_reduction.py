...
def test_wiring_reduction_default():
...
def test_wiring_reduction_with_parameters():
    network = read_technology_network(dir_path + "/../../resources/mux21.v")
...
def test_wiring_reduction_with_stats():
    network = read_technology_network(dir_path + "/../../resources/mux21.v")
...
def test_wiring_reduction_with_stats_and_parameters():
    network = read_technology_network(dir_path + "/../../resources/mux21.v")
