...
def test_non_clocked_path_finding():
...
def test_path_finding_with_obstructions():
    for lyt in [
...
def test_path_finding_with_obstructions_and_crossings():
    for lyt in [
