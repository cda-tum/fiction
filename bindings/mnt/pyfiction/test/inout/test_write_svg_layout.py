...
from mnt.pyfiction import (sidb_100_lattice, sidb_technology, color_mode, write_sidb_layout_svg_params,
                           write_sidb_layout_svg_to_string, charge_distribution_surface_100, sidb_charge_state)
...
<!-- Generated by """ + mnt.pyfiction.__version__ + " " + "(" + mnt.pyfiction.__repo__ + ")" + """ -->
<svg
