...
R"doc(The `detect_bdl_pairs` member holds the settings required to identify
and handle pairs of BDLs during processing. It encapsulates various
thresholds and criteria specific to the detection of BDL pairs.)doc";
...
a `0` is produced by positioning the perturber farther away.)doc";

static const char *__doc_fiction_bdl_input_iterator_params_input_bdl_configuration_ZERO_VIA_NO_PERTURBER =
R"doc(An input of `1` is generated by placing a perturber closer to the
target, whereas a `0` is produced by positioning the perturber farther
away.)doc";

static const char *__doc_fiction_bdl_input_iterator_params_input_bdl_configuration_ZERO_VIA_PERTURBER =
