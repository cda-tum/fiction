...
The complexity of this function is :math:`O(|T|)` where :math:`T` is
the set of all occupied tiles in `lyt`.
...
static const char* __doc_fiction_detail_enumerate_all_clocking_paths_impl_enumerate_all_clocking_paths_impl =
    R"doc()doc";
...
:math:`|N|` is the number of nodes in the given network and
...
static const char* __doc_fiction_quicksim_params_interation_steps =
...
static const char* __doc_fiction_sidb_simulation_parameters_mu =
    R"doc(µ- is the energy transition level (0/-) (unit: eV).)doc";

static const char* __doc_fiction_sidb_simulation_parameters_mu_p =
    R"doc(µ+ is the energy transition level (+/0) (unit: eV).)doc";
...
static const char* __doc_fiction_time_to_solution_stats_single_runtime_exhaustive =
    R"doc(Single simulation runtime of the exhaustive ground state searcher.)doc";
