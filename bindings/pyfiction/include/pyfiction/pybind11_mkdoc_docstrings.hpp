...
static const char* __doc_fiction_critical_temperature_stats_critical_temperature =
    R"doc(*Critical Temperature* of the given layout (unit: K).)doc";
...
static const char* __doc_fiction_design_sidb_gates_params_simulation_parameters =
    R"doc(All Parameters for physical SiDB simulations.)doc";
...
static const char* __doc_fiction_detail_operational_domain_impl_sweep_dimension =
    R"doc(Potential sweep dimensions.)doc";
...
static const char* __doc_fiction_is_operational_params_bdl_params =
    R"doc(Parameters for the BDL pair detection algorithms.)doc";
...
static const char* __doc_fiction_operational_domain_params_x_dimension =
    R"doc(The sweep parameter for the x dimension.)doc";

static const char* __doc_fiction_operational_domain_params_x_max =
    R"doc(The maximum value of the x dimension sweep.)doc";

static const char* __doc_fiction_operational_domain_params_x_min =
    R"doc(The minimum value of the x dimension sweep.)doc";

static const char* __doc_fiction_operational_domain_params_x_step = R"doc(The step size of the x dimension sweep.)doc";

static const char* __doc_fiction_operational_domain_params_y_dimension =
    R"doc(The sweep parameter for the y dimension.)doc";

static const char* __doc_fiction_operational_domain_params_y_max =
    R"doc(The maximum value of the y dimension sweep.)doc";

static const char* __doc_fiction_operational_domain_params_y_min =
    R"doc(The minimum value of the y dimension sweep.)doc";
...
static const char* __doc_fiction_operational_domain_sweep_parameter =
    R"doc(Possible sweep parameters for the operational domain computation.)doc";

static const char* __doc_fiction_operational_domain_sweep_parameter_EPSILON_R =
    R"doc(The relative permittivity of the dielectric material.)doc";

static const char* __doc_fiction_operational_domain_sweep_parameter_LAMBDA_TF =
    R"doc(The Thomas-Fermi screening length.)doc";
