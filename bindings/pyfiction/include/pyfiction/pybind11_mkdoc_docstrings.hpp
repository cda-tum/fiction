...
static const char* __doc_fiction_bdl_input_iterator_params_bdl_pairs_params =
    R"doc(Parameters to detect BDL pairs.)doc";
...
static const char* __doc_fiction_critical_temperature_params_input_bdl_iterator_params =
...
static const char* __doc_fiction_design_sidb_gates_params_design_sidb_gates_mode_EXHAUSTIVE =
    R"doc(All gate layouts are designed exhaustively.)doc";
...
static const char* __doc_fiction_detail_clustercomplete_impl_mutex_to_protect_the_simulation_results =
    R"doc(Mutex to protect the simulation results.)doc";

static const char* __doc_fiction_detail_clustercomplete_impl_potential_bound_update_operation =
    R"doc(Enumeration for specifying operations on potential bounds.)doc";

static const char* __doc_fiction_detail_clustercomplete_impl_potential_bound_update_operation_ADD =
    R"doc(Potential bounds of the parent are added.)doc";

static const char* __doc_fiction_detail_clustercomplete_impl_potential_bound_update_operation_SUBTRACT =
    R"doc(Potential bounds of the parent are subtracted.)doc";

static const char* __doc_fiction_detail_clustercomplete_impl_real_placed_defects =
    R"doc(Atomic defects that are placed in the layout.)doc";
...
static const char* __doc_fiction_detail_graph_oriented_layout_design_impl_num_evaluated_paths =
    R"doc(Count evaluated paths in the search space graphs.)doc";
...
static const char* __doc_fiction_detail_quickexact_impl_real_placed_defects =
    R"doc(Collection of defects that are placed in addition to the SiDBs.)doc";
...
static const char* __doc_fiction_ground_state_space_params =
...
static const char* __doc_fiction_ground_state_space_results_runtime =
...
static const char* __doc_fiction_is_sidb_gate_design_impossible_params_input_bdl_iterator_params =
    R"doc(Parameters for the BDL input iterator.)doc";
...
static const char* __doc_fiction_potential_projection_order_potential_projection_order =
...
static const char* __doc_fiction_sidb_cluster_charge_state_compositions =
...
static const char* __doc_fiction_sidb_cluster_external_sidbs =
...
static const char* __doc_fiction_sidb_cluster_hierarchy_linkage_method_SINGLE =
...
static const char* __doc_fiction_sidb_cluster_receptor_state_sidb_ix =
...
static const char* __doc_fiction_sidb_cluster_uid =
