...
static const char* __doc_fiction_assess_physical_population_stability_params_physical_parameters =
...
static const char* __doc_fiction_critical_temperature_params_max_temperature =
    R"doc(Simulation stops at max_temperature (~ 126 °C by default) (unit: K).)doc";
...
static const char* __doc_fiction_design_sidb_gates_params =
    R"doc(This struct contains parameters and settings to design SiDB gates.)doc";
...
static const char* __doc_fiction_design_sidb_gates_params_phys_params =
    R"doc(All Parameters for physical SiDB simulations.)doc";
...
static const char* __doc_fiction_detail_design_sidb_gates_impl_all_sidbs_in_cavas =
...
static const char* __doc_fiction_maximum_defect_influence_distance_params_sim_params =
...
static const char* __doc_fiction_quickexact_params_physical_parameters =
    R"doc(All parameters for physical SiDB simulations.)doc";
...
static const char* __doc_fiction_quicksim_params_phys_params =
    R"doc(General parameters for the simulation of the physical SiDB system.)doc";
...
static const char* __doc_fiction_sidb_simulation_parameters_lat_a =
    R"doc(``lat_a`` is the lattice vector in x-direction (unit: Å).)doc";

static const char* __doc_fiction_sidb_simulation_parameters_lat_b =
    R"doc(``lat_b`` is the lattice vector in y-direction (unit: Å).)doc";

static const char* __doc_fiction_sidb_simulation_parameters_lat_c =
    R"doc(``lat_c`` is the dimer pair separation (unit: Å).)doc";
...
static const char* __doc_fiction_sidb_simulation_result_physical_parameters =
