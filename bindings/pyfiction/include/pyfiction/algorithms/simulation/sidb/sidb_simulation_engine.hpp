...
inline void sidb_simulation_engine(pybind11::module& m)
{
    ...
    py::enum_<fiction::sidb_simulation_engine>(m, "sidb_simulation_engine")
        //, DOC(fiction_sidb_simulation_engine))
        .value("EXGS", fiction::sidb_simulation_engine::EXGS)
        //, DOC(fiction_sidb_simulation_engine_EXGS))
        .value("QUICKSIM", fiction::sidb_simulation_engine::QUICKSIM)
        //, DOC(fiction_sidb_simulation_engine_QUICKSIM))
