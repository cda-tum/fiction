...
inline void defect_influence_operational_domain(pybind11::module& m)
{
    ...
    py::class_<fiction::defect_influence_operational_domain<py_sidb_100_lattice>>(
        m, "defect_influence_operational_domain_100")
        .def(py::init<>());

    py::class_<fiction::defect_influence_operational_domain<py_sidb_111_lattice>>(
        m, "defect_influence_operational_domain_111")
        .def(py::init<>());

    py::class_<fiction::defect_influence_operational_domain_params>(m, "defect_influence_operational_domain_params")
        .def(py::init<>())
        .def_readwrite("defect_influence_params",
                       &fiction::defect_influence_operational_domain_params::defect_influence_params)
        .def_readwrite("operational_params", &fiction::defect_influence_operational_domain_params::operational_params);

    py::class_<fiction::defect_influence_operational_domain_stats>(m, "defect_influence_operational_domain_stats")
        .def(py::init<>())
        .def_readonly("time_total", &fiction::defect_influence_operational_domain_stats::time_total)
        .def_readonly("num_simulator_invocations",
                      &fiction::defect_influence_operational_domain_stats::num_simulator_invocations)
        .def_readonly("num_evaluated_parameter_combinations",
                      &fiction::defect_influence_operational_domain_stats::num_evaluated_defect_positions)
