...
void maximum_defect_influence_distance(pybind11::module& m)
{
    ...
    m.def("maximum_defect_influence_position_and_distance",
          ...
          "params"_a = fiction::maximum_defect_influence_position_and_distance_params{},
...
inline void maximum_defect_influence_distance(pybind11::module& m)
{
    ...
    py::class_<fiction::maximum_defect_influence_distance_params>(m, "maximum_defect_influence_distance_params")
        .def(py::init<>())
        .def_readwrite("defect", &fiction::maximum_defect_influence_distance_params::defect)
        .def_readwrite("sim_params", &fiction::maximum_defect_influence_distance_params::simulation_parameters)
