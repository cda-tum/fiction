...
inline void shifted_cartesian_layout(pybind11::module& m)
{
    ...
    py::class_<py_shifted_cartesian_layout>(m, "shifted_cartesian_layout",
        ...
        .def(
            "resize",
            [](py_shifted_cartesian_layout& lyt, const py_offset_coordinate& dimension) { lyt.resize(dimension); },
        ...
        .def(
            "north_east",
            [](const py_shifted_cartesian_layout& lyt, const py_offset_coordinate& c) { return lyt.north_east(c); },
        ...
        .def(
            "south_east",
            [](const py_shifted_cartesian_layout& lyt, const py_offset_coordinate& c) { return lyt.south_east(c); },
        ...
        .def(
            "south_west",
            [](const py_shifted_cartesian_layout& lyt, const py_offset_coordinate& c) { return lyt.south_west(c); },
        ...
        .def(
            "north_west",
            [](const py_shifted_cartesian_layout& lyt, const py_offset_coordinate& c) { return lyt.north_west(c); },
        ...
        .def(
            ...
            [](const py_shifted_cartesian_layout& lyt, const py_offset_coordinate& c)
