...
*ClusterComplete*, which depends on ALGLIB. On Windows and macOS, these bindings can be enabled through setting
`alglib=ON`, similar as above. This may be enabled alongside `z3=ON` by separating the definitions
