...
class TestTimeToSolution(unittest.TestCase):
    ...
    def test_one_DBs_100_lattice(self):
        ...
        time_to_solution_100(cds, quicksim_parameter, tts_params, stats)
    ...
    def test_one_DBs_111_lattice(self):
        ...
        time_to_solution_111(cds, quicksim_parameter, tts_params, stats)
