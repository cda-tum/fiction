...
class TestOperationalDomain(unittest.TestCase):
    ...
    def test_xor_gate_100_lattice(self):
        ...
        opdomain = operational_domain_grid_search_100(lyt, [create_xor_tt()], params, stats_grid)
        self.assertGreater(stats_grid.num_operational_parameter_combinations, 0)

        stats_flood_fill = operational_domain_stats()
        opdomain = operational_domain_flood_fill_100(lyt, [create_xor_tt()], 100, params, stats_flood_fill)
        ...
        opdomain = operational_domain_random_sampling_100(lyt, [create_xor_tt()], 100, params, stats_random_sampling)
        ...
        opdomain = operational_domain_contour_tracing_100(lyt, [create_xor_tt()], 100, params, stats_contour_tracing)
    ...
    def test_and_gate_111_lattice(self):
        ...
        stats_grid = operational_domain_stats()
        opdomain = operational_domain_grid_search_111(lyt, [create_and_tt()], params, stats_grid)
        self.assertGreater(stats_grid.num_operational_parameter_combinations, 0)

        stats_flood_fill = operational_domain_stats()
        opdomain = operational_domain_flood_fill_111(lyt, [create_and_tt()], 100, params, stats_flood_fill)
        self.assertGreater(stats_flood_fill.num_operational_parameter_combinations, 0)

        stats_random_sampling = operational_domain_stats()
        opdomain = operational_domain_random_sampling_111(lyt, [create_and_tt()], 100, params, stats_random_sampling)
        self.assertGreater(stats_random_sampling.num_operational_parameter_combinations, 0)

        stats_contour_tracing = operational_domain_stats()
        opdomain = operational_domain_contour_tracing_111(lyt, [create_and_tt()], 100, params, stats_contour_tracing)
        self.assertGreater(stats_contour_tracing.num_operational_parameter_combinations, 0)
