...
int main()  // NOLINT
{
    ...
    const design_sidb_gates_params<sidb_100_cell_clk_lyt_cube> params_2_in_1_out{
        ...
        design_sidb_gates_params<
            sidb_100_cell_clk_lyt_cube>::design_sidb_gates_mode::EXHAUSTIVE_GATE_DESIGNER,
        {{14, 12, 0}, {24, 23, 0}},
        3};
    ...
    for (const auto& [gate, truth_table] : gates)
    {
        ...
        for (const auto& gate_lyt : exhaustive_design)
        {
            ...
            const auto op_defect_contour = defect_influence_quicktrace(gate_lyt, truth_table, 100, params);
