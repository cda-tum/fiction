...
#ifndef FICTION_EXPERIMENTS_EXHAUSTIVE_GROUND_STATE_SIMULATION_HPP
#define FICTION_EXPERIMENTS_EXHAUSTIVE_GROUND_STATE_SIMULATION_HPP
 ...
 *
 * @note This algorithm has been superseded by *QuickExact* and *ClusterComplete* due to their much better runtimes
 * and more functionality; it is kept here for benchmarking/comparison purposes only and is no longer part of the
 * public fiction library.
 *
...
#endif  // FICTION_EXPERIMENTS_EXHAUSTIVE_GROUND_STATE_SIMULATION_HPP
