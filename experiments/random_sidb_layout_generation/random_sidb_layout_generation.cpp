...
int main(int argc, const char* argv[])  // NOLINT
{
    ...
    // ("MAY_OCCUR")
    generate_random_sidb_layout_params<layouts::offset::ucoord_t>::positive_charges charges{};
    if (charges_str == "ALLOWED")
    {
        charges = generate_random_sidb_layout_params<layouts::offset::ucoord_t>::positive_charges::ALLOWED;
    }
    else if (charges_str == "MAY_OCCUR")
    {
        charges = generate_random_sidb_layout_params<layouts::offset::ucoord_t>::positive_charges::MAY_OCCUR;
    }
    else
    {
        charges = generate_random_sidb_layout_params<layouts::offset::ucoord_t>::positive_charges::FORBIDDEN;
    }
