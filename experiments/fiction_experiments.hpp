...
static constexpr uint64_t clpl             = 0b0000000000000000000000000000000000000000000000100000000000000000;
static constexpr uint64_t xor5_r1          = 0b0000000000000000000000000000000000000000000001000000000000000000;
static constexpr uint64_t one_bit_add_maj  = 0b0000000000000000000000000000000000000000000010000000000000000000;
static constexpr uint64_t cm82a_5          = 0b0000000000000000000000000000000000000000000100000000000000000000;
static constexpr uint64_t two_bit_add_maj  = 0b0000000000000000000000000000000000000000001000000000000000000000;
static constexpr uint64_t xor5_maj         = 0b0000000000000000000000000000000000000000010000000000000000000000;
static constexpr uint64_t parity           = 0b0000000000000000000000000000000000000000100000000000000000000000;
static constexpr uint64_t fontes18         = 0b0000000000000000000000000000000000000000111111111111111110000000;

static constexpr uint64_t all              = 0b0000000000000000000000000000000000000000111111111111111111111111;
...
static const char* benchmarks[] = {
    ...
    "fontes18/majority", "fontes18/majority_5_r1", "fontes18/newtag", "fontes18/mem_ctrl", "fontes18/clpl",
    "fontes18/xor5_r1", "fontes18/1bitAdderMaj", "fontes18/cm82a_5", "fontes18/2bitAdderMaj",
    "fontes18/xor5Maj", "fontes18/parity"};
