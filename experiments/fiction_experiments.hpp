...
inline constexpr uint64_t arbiter          = 0b0000000000000000000000000000100000000000000000000000000000000000;
inline constexpr uint64_t bar              = 0b0000000000000000000000000001000000000000000000000000000000000000;
inline constexpr uint64_t cavlc            = 0b0000000000000000000000000010000000000000000000000000000000000000;
inline constexpr uint64_t ctrl             = 0b0000000000000000000000000100000000000000000000000000000000000000;
inline constexpr uint64_t dec              = 0b0000000000000000000000001000000000000000000000000000000000000000;
inline constexpr uint64_t div              = 0b0000000000000000000000010000000000000000000000000000000000000000;
inline constexpr uint64_t hyp              = 0b0000000000000000000000100000000000000000000000000000000000000000;
inline constexpr uint64_t i2c              = 0b0000000000000000000001000000000000000000000000000000000000000000;
inline constexpr uint64_t int2float        = 0b0000000000000000000010000000000000000000000000000000000000000000;
inline constexpr uint64_t log2             = 0b0000000000000000000100000000000000000000000000000000000000000000;
inline constexpr uint64_t max              = 0b0000000000000000001000000000000000000000000000000000000000000000;
inline constexpr uint64_t multiplier       = 0b0000000000000000010000000000000000000000000000000000000000000000;
inline constexpr uint64_t priority         = 0b0000000000000000100000000000000000000000000000000000000000000000;
inline constexpr uint64_t router           = 0b0000000000000001000000000000000000000000000000000000000000000000;
inline constexpr uint64_t sin              = 0b0000000000000010000000000000000000000000000000000000000000000000;
inline constexpr uint64_t sqrt             = 0b0000000000000100000000000000000000000000000000000000000000000000;
inline constexpr uint64_t square           = 0b0000000000001000000000000000000000000000000000000000000000000000;
inline constexpr uint64_t voter            = 0b0000000000010000000000000000000000000000000000000000000000000000;
inline constexpr uint64_t EPFL             = 0b0000000000011111111111111111110000000000000000000000000000000000;

inline constexpr uint64_t all              = 0b0000000000011111111111111111111111111111111111111111111111111111;
