...
int main()  // NOLINT
{
    ...
    static constexpr const uint64_t bench_select = fiction_experiments::mux21; //(fiction_experiments::trindade16 | fiction_experiments::fontes18) & ~fiction_experiments::clpl;
