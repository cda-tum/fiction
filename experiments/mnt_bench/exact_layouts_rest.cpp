...
int main()  // NOLINT
{
    ...
    exact_params.scheme = fiction::ptr<gate_lyt>(fiction::use_clocking<gate_lyt>());
    ...
    exact_params.upper_bound_x = 2;
    exact_params.upper_bound_y = 21;
    exact_params.fixed_size = true;
    fiction::exact_physical_design_stats exact_stats{};

    static constexpr const uint64_t bench_select = fiction_experiments::clpl;
    ...
    for (const auto& benchmark : fiction_experiments::all_benchmarks(bench_select))
    {
        ...
        if (gate_level_layout.has_value())
        {
            ...
            fiction::write_fgl_layout(*gate_level_layout, fmt::format("{}/{}_ONE_USE_exact_UnOpt_UnOrd.fgl", layouts_folder, benchmark));
