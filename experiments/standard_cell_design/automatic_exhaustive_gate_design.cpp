...
int main()  // NOLINT
{
    ...
    const auto skeleton_1i1o_straight =
        read_sqd_layout(fmt::format("{}/{}", folder, "skeleton_hex_inputsdbp_1i1o_straight.sqd"));

    design_gates_params params_1i1o_straight{
    ...
    const auto skeleton_1i1o_diagonal =
        read_sqd_layout(fmt::format("{}/{}", folder, "skeleton_hex_inputsdbp_1i1o_diagonal.sqd"));

    design_gates_params params_1i1o_diagonal{
        is_operational_params{simulation_parameters{2, -0.32}, engine::QUICKEXACT, bdl_input_iterator_params{},
                              is_operational_params::operational_condition::REJECT_KINKS},
        design_gates_params::design_gates_mode::AUTOMATIC_EXHAUSTIVE_GATE_DESIGNER,
        {{14, 6, 0}, {24, 14, 0}},
    ...
    const auto skeleton_2i1o = read_sqd_layout(fmt::format("{}/{}", folder, "skeleton_hex_inputsdbp_2i1o.sqd"));

    design_gates_params params_2i1o{is_operational_params{simulation_parameters{2, -0.32}, engine::QUICKEXACT,
    ...
    const auto skeleton_1i2o = read_sqd_layout(fmt::format("{}/{}", folder, "skeleton_hex_inputsdbp_1i2o.sqd"));

    design_gates_params params_1i2o{is_operational_params{simulation_parameters{2, -0.32}, engine::QUICKEXACT,
                                                          bdl_input_iterator_params{},
                                                          is_operational_params::operational_condition::REJECT_KINKS},
                                    design_gates_params::design_gates_mode::AUTOMATIC_EXHAUSTIVE_GATE_DESIGNER,
                                    {{15, 8, 0}, {23, 14, 0}},
    ...
    const auto skeleton_2i2o = read_sqd_layout(fmt::format("{}/{}", folder, "skeleton_hex_inputsdbp_2i2o.sqd"));

    design_gates_params params_2i2o{is_operational_params{simulation_parameters{2, -0.32}, engine::QUICKEXACT,
                                                          bdl_input_iterator_params{},
                                                          is_operational_params::operational_condition::REJECT_KINKS},
                                    design_gates_params::design_gates_mode::AUTOMATIC_EXHAUSTIVE_GATE_DESIGNER,
                                    {{14, 6, 0}, {24, 13, 0}},
    ...
    for (const auto& [truth_table, gate_name] : truth_tables_and_names)
    {
        ...
        {
            std::vector<layout> automatic_exhaustive_design = {};

            if (gate_name == "cx" || gate_name == "ha" || gate_name == "hourglass")
            {
                params_2i2o.number_of_canvas_sidbs = num_sidbs;
                automatic_exhaustive_design        = design_gates(skeleton_2i2o, truth_table, params_2i2o);
            }
            else if (gate_name == "wire" || gate_name == "inv")
            {
                params_1i1o_straight.number_of_canvas_sidbs = num_sidbs;
                automatic_exhaustive_design = design_gates(skeleton_1i1o_straight, truth_table, params_1i1o_straight);
            }
            else if (gate_name == "inv_diag" || gate_name == "wire_diag")
            {
                params_1i1o_diagonal.number_of_canvas_sidbs = num_sidbs;
                automatic_exhaustive_design = design_gates(skeleton_1i1o_diagonal, truth_table, params_1i1o_diagonal);
            }
            else if (gate_name == "f02")
            {
                params_1i2o.number_of_canvas_sidbs = num_sidbs;
                automatic_exhaustive_design        = design_gates(skeleton_1i2o, truth_table, params_1i2o);
            }
            else
            {
                params_2i1o.number_of_canvas_sidbs = num_sidbs;
                automatic_exhaustive_design        = design_gates(skeleton_2i1o, truth_table, params_2i1o);
            }
