...
functionality by a notion of [synchronization elements](https://ieeexplore.ieee.org/abstract/document/8626294) (SEs).
...
```{doxygenclass} fiction::layouts::synchronization_element_layout
:members:
```
