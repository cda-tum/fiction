...
Utilizes the SMT solver [Z3](https://github.com/Z3Prover/z3) to generate minimal FCN gate-level layouts from logic
...
```{doxygenfunction} fiction::physical_design::exact_with_blacklist
