...
- ``qcc <filename>`` creates a `ToPoliNano <https://topolinano.polito.it/>`_ QCC file
- ``qll <filename>`` creates a `MagCAD <https://topolinano.polito.it/>`_ & `SCERPA <https://ieeexplore.ieee.org/document/8935211>`_ QLL file
