  ...
  public:
                ...
                "complexity with added SiDBs. The shorter alias command is 'ccsim'.")
    {
        ...
        add_option("--report_gss_stats,-r", params.report_gss_stats,
                   ...
                   true);
#if (PROGRESS_BARS)
        add_option("--disable_progress_bar,-d", disable_progress_bar,
                   "Setting to true disables the progress bar, allowing more efficient simulation", true);
#endif
    }
...
#if (PROGRESS_BARS)
                    params.enable_progress_bar = !disable_progress_bar;
#endif
...
#if (PROGRESS_BARS)
    /**
     * Progress bars are disabled when true.
     */
