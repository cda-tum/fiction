...
class breadth_first_iterator
        : public graph_search_iterator<graph, std::queue<typename graph::graph_vertex_const_iterator>>
{
  public:
    /**
...
class depth_first_iterator
        : public graph_search_iterator<graph, std::stack<typename graph::graph_vertex_const_iterator>>
{
  public:
    /**
