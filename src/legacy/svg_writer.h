...
namespace svg
{
    ...
    constexpr const char *latch = "<g\n"
                                  ...
                                  "style=\"color:#000000;solid-color:#000000;solid-opacity:1;fill:#{2};fill-opacity:1;fill-rule:nonzero;stroke:none;stroke-width:1.19643486;stroke-opacity:1;enable-background:accumulate\" />\n"
                                  "<path\n"
                                  "d=\"m 494.58328,187.21668 0,-118.80357 118.80358,0\"\n"
                                  "style=\"color:#000000;solid-color:#000000;solid-opacity:1;fill:#{3};fill-opacity:1;fill-rule:nonzero;stroke:none;stroke-width:1.19643486;stroke-opacity:1;enable-background:accumulate\" />\n"
                                  "</g>\n"
                                  "<rect\n"
                                  ...
                                  "y=\"86.340652\"\n"
                                  "x=\"504.43588\"\n"
                                  "style=\"font-style:normal;font-weight:normal;font-size:12.5px;line-height:125%;font-family:'Noto Sans';letter-spacing:0px;word-spacing:0px;fill:#{5};fill-opacity:1;\"\n"
                                  "xml:space=\"preserve\"><tspan\n"
                                  "y=\"86.340652\"\n"
                                  ...
                                  "y=\"178.27962\"\n"
                                  "x=\"596.48468\"\n"
                                  "style=\"font-style:normal;font-weight:normal;font-size:12.5px;line-height:125%;font-family:'Noto Sans';letter-spacing:0px;word-spacing:0px;fill:#{7};fill-opacity:1;\"\n"
                                  "xml:space=\"preserve\"><tspan\n"
                                  "y=\"178.27962\"\n"
    ...
    /**
     * Creates a pair of the correct template and color for the given cell as SVG strings.
     *
     * @param c The cell to select a template and a color for.
     * @return A pair of cell description and color SVG strings.
     */
    std::pair<std::string, std::string> generate_description_color(fcn_cell_layout_ptr fcl, const fcn_cell_layout::cell& c,
                                                                   bool simple);
}
