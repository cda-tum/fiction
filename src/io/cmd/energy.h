...
#ifndef FICTION_ENERGY_H
#define FICTION_ENERGY_H
...
namespace alice
{
    ...
    public:
         ...
         */
        explicit energy_command(const environment::ptr& env)
                :
                command(env,
                        "Prints the energy dissipation for the current gate-level layout in store that would "
    ...
    protected:
        ...
        void execute() override
        {
            ...
            slow = energy.first; fast = energy.second;
