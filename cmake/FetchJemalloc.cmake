# FetchJemalloc.cmake   |   this file is intended to be run only on UNIX-like
# operating systems

if(CMAKE_SYSTEM_NAME STREQUAL "Windows")
  message(
    SEND_ERROR
      "Install jemalloc on Windows using the instructions found in https://github.com/jemalloc/jemalloc/blob/dev/INSTALL.md#building-for-windows."
  )
endif()
...
set(JEMALLOC_TAG
    "5.3.0"
    CACHE STRING "Which tag/revision of jemalloc to use")
...
ExternalProject_Add(
  ...
  CONFIGURE_COMMAND
    bash -c
    "echo \"${JEMALLOC_TAG}-0-g$(git ls-remote --tags https://github.com/jemalloc/jemalloc.git | grep ${JEMALLOC_TAG} | tail -1 | cut -f1)\" > ${JEMALLOC_SOURCE_DIR}/VERSION"
...
set_target_properties(
  jemalloc
  PROPERTIES IMPORTED_LOCATION "${JEMALLOC_INSTALL_DIR}/lib/libjemalloc.a"
