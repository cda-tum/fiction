...
| `fiction/algorithms/physical_design/design_sidb_gates.hpp`                        | `fiction/technology/sidb/generators/design_gates.hpp`                                                                                 |
...
| `fiction/io/write_defect_influence_domain.hpp`                                    | `fiction/technology/sidb/simulation/io/write_defect_influence_domain.hpp`                                                             |
| `fiction/io/write_location_and_ground_state.hpp`                                  | `fiction/technology/sidb/simulation/io/write_location_and_ground_state.hpp`                                                           |
| `fiction/io/write_operational_domain.hpp`                                         | `fiction/technology/sidb/simulation/io/write_operational_domain.hpp`                                                                  |
| `fiction/io/write_sqd_layout.hpp`                                                 | `fiction/technology/sidb/io/write_sqd_layout.hpp`                                                                                     |
| `fiction/io/write_sqd_sim_result.hpp`                                             | `fiction/technology/sidb/simulation/io/write_sqd_sim_result.hpp`                                                                      |
...
| `fiction/technology/sidb_cluster_hierarchy.hpp`                                   | `fiction/technology/sidb/simulation/engines/cluster_hierarchy.hpp`                                                                    |
...
and would not remove the string API.
