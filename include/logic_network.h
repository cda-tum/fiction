...
public:
    ...
    /**
     * Function alias for write_graphviz using perfect forwarding and the name write_network to fit naming in
     * logic_network.
     *
     * @tparam ARGS Stack of argument types.
     * @param args Stack of arguments.
     */
    template <typename... ARGS>
    void write_network(ARGS&&... args) noexcept
    {
        write_graphviz(std::forward<ARGS>(args)...);  // TODO implement pretty printer
    }
    /**
