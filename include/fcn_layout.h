...
public:
    ...
    /**
     * Assigns a latch delay to a given face in the layout. The delay should be given in clock cycles (i.e. a multiple
     * of n clock phases). For more information on these kinds of artificial clock latches see "Synchronization of
     * Clocked Field-Coupled Circuits" by Frank Sill Torres, Marcel Walter, Robert Wille, Daniel Große, and Rolf
     * Drechsler in IEEE-NANO 2018.
     *
     ...
     *
     * @param f Face (stack) to which a artificial latch delay should be assigned.
     * @param l Latch in clock cycles to be assigned to face (stack) f.
     */
