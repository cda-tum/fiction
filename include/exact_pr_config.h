...
{
    /**
     * Number of clocking zones to be used.
     */
    ...
    /**
     * Maximum number of crossing zones to use. If value is 0,
     * the number of crossings is unbounded.
     */
    unsigned crossings_limit = 0u;
    /**
     * Maximum number of wire elements to use to connect
     * two operations on the grid.
     */
    unsigned wire_limit = 0u;
    /**
     * Flag to indicate that upperBound is in fact a fixed grid size.
     */
