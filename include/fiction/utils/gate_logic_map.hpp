...
const std::map<std::string, std::map<std::string, std::string>> GATES_IN_OUT_NUMBER = {
    {"and", {{"in", "2"}, {"out", "1"}}},      {"or", {{"in", "2"}, {"out", "1"}}},
    {"nor", {{"in", "2"}, {"out", "1"}}},      {"xnor", {{"in", "2"}, {"out", "1"}}},
    {"nand", {{"in", "2"}, {"out", "1"}}},     {"xor", {{"in", "2"}, {"out", "1"}}},
    {"ha", {{"in", "2"}, {"out", "2"}}},       {"hourglass", {{"in", "2"}, {"out", "2"}}},
    {"inv", {{"in", "1"}, {"out", "1"}}},      {"cx", {{"in", "2"}, {"out", "2"}}},
    {"inv_diag", {{"in", "1"}, {"out", "1"}}}, {"fo2", {{"in", "1"}, {"out", "2"}}},
    {"wire", {{"in", "1"}, {"out", "1"}}},     {"wire_diag", {{"in", "1"}, {"out", "1"}}}};
