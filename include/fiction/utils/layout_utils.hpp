        ...
        if constexpr (has_offset_ucoord_v<Lyt>) {
            ...
            lyt_normalized.foreach_cell(
                    [&lyt_new, &lyt_normalized](const auto &c) {
                        lyt_new.assign_cell_type(siqad::to_fiction_coord<cell<Lyt>>(c),
                                                 lyt_normalized.get_cell_type(c));
                        lyt_new.assign_cell_mode(siqad::to_fiction_coord<cell<Lyt>>(c),
                                                 lyt_normalized.get_cell_mode(c));
                        lyt_new.assign_cell_name(siqad::to_fiction_coord<cell<Lyt>>(c),
                                                 lyt_normalized.get_cell_name(c));
                    });
