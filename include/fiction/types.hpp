 ...
 */
using cart_gate_clk_lyt =
    mockturtle::names_view<gate_level_layout<clocked_layout<tile_based_layout<cartesian_layout<cartesian::ucoord_t>>>>>;
using cart_gate_clk_lyt_ptr = std::shared_ptr<cart_gate_clk_lyt>;

using hex_odd_row_gate_clk_lyt = mockturtle::names_view<
...
using hex_even_row_gate_clk_lyt = mockturtle::names_view<
...
using hex_odd_col_gate_clk_lyt = mockturtle::names_view<
...
using hex_even_col_gate_clk_lyt = mockturtle::names_view<
