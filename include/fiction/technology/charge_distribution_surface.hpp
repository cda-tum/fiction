...
class charge_distribution_surface<Lyt, false> : public Lyt
{
  public:
     ...
     * Hint: Please take `get_potential_between_sidbs` if the electrostatic potential V_i,j is required.
     *
     ...
     * Hint: Please take `get_chargeless_potential_between_sidbs` if V_i,j / n_j is required.
     *
     * @param c1 The first cell
     * @param c2 The second cell
