...
#ifndef FICTION_TECHNOLOGY_SIDB_LIBRARIES_ON_THE_FLY_GATE_LIBRARY_HPP
#define FICTION_TECHNOLOGY_SIDB_LIBRARIES_ON_THE_FLY_GATE_LIBRARY_HPP
...
struct on_the_fly_gate_library_params
{
     ...
     */
    sidb::generators::design_sidb_gates_params<CellType> design_gate_params{};
    /**
                                              ...
                                              const fcn::port_list<fcn::port_direction>& p, const tile<GateLyt>& tile)
    {
        ...
        if (spec == synthesis::create_crossing_wire_tt() || spec == synthesis::create_double_wire_tt())
        {
            ...
            const auto found_gate_layouts =
                sidb::generators::design_sidb_gates(skeleton, spec, parameters.design_gate_params);
...
#endif  // FICTION_TECHNOLOGY_SIDB_LIBRARIES_ON_THE_FLY_GATE_LIBRARY_HPP
