...
#ifndef FICTION_TECHNOLOGY_SIDB_SIMULATION_GENERIC_MINIMUM_ENERGY_HPP
#define FICTION_TECHNOLOGY_SIDB_SIMULATION_GENERIC_MINIMUM_ENERGY_HPP
...
[[nodiscard]] double minimum_energy(const InputIt first, const InputIt last) noexcept
{
    ...
    if (first != last)
    {
        return fiction::sidb::simulation::generic::minimum_energy_distribution(first, last)
...
#endif  // FICTION_TECHNOLOGY_SIDB_SIMULATION_GENERIC_MINIMUM_ENERGY_HPP
