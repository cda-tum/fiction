 ...
 * @return `result` is returned if the simulation was successful, otherwise `std::nullopt`.
 */
template <typename Lyt>
[[nodiscard]] std::optional<sidb::simulation::result<Lyt>>
