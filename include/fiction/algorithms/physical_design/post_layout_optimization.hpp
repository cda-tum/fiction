 ...
 * Nanotechnologies\" by S. Hofmann, M. Walter, and R. Wille in NANOARCH 2023 (https://dl.acm.org/doi/10.1145/3611315.3633247). 
 * It can be used to reduce the area of a given sub-optimal Cartesian gate-level layout created by heuristics or machine learning.
 * This optimization utilizes the distinct characteristics of the 2DDWave clocking scheme, which only allows information flow
 * from top to bottom and left to right, therefore only aforementioned clocking scheme is supported.
 *
