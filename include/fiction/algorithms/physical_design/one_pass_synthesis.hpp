 ...
 *
 * @deprecated one_pass_synthesis() is deprecated since version 0.7.1 and will be removed in version 0.8.0.
...
class one_pass_synthesis_impl
{
  public:
     ...
     * @param st Statistics.
     */
    // kept as a const reference to avoid passing the 96-byte one_pass_synthesis_params by value
    // (see CodeQL "large object passed by value")
