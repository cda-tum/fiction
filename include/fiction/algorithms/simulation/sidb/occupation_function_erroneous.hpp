 ...
 *
 * @param energy_distribution_transparent_erroneous This vector contains the energies of all possible charge
 * distributions as the information if state is an transparent or erroneous excited state.
