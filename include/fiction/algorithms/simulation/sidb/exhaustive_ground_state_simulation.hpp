...
{
  public:
    quickexact_impl(Lyt& lyt, const quickexact_params<Lyt>& params) : layout{lyt}, parameter{params} {}
    ...
    void run()
    {
        ...
        mockturtle::stopwatch<>::duration time_counter{};
        {
            ...
            charge_distribution_surface charge_lyt{layout, parameter.physical_parameters, sidb_charge_state::NEGATIVE};
  ...
  private:
     ...
     */
    const quickexact_params<Lyt>& parameter;
