...
static constexpr const char* VERSION_HEADER = "<?xml version=\"1.0\" encoding=\"UTF-8\"?>\n"
                                              "<!--Generated by {} ({})-->\n";

static constexpr const char* OPEN_QCA_COMPONENT =
    "<qcacomponent Version=\"2\" tech=\"{}\" lib=\"{}\" name=\"{}\" "
    "ID=\"{}\" function=\"\" maxX=\"{}\" maxY=\"{}\" MagnetsCount=\"{}\">\n";
static constexpr const char* CLOSE_QCA_COMPONENT = "</qcacomponent>\n";

static constexpr const char* LIBRARY_NAME = "components_fiction";

static constexpr const char* OPEN_ENTITY      = "\t<entity>\n";
static constexpr const char* CLOSE_ENTITY     = "\t</entity>\n";
...
static constexpr const char* PIN            = "\t\t<pin tech=\"{}\" name=\"{}\" direction=\"{}\" x=\"{}\" y=\"{}\"/>\n";
static constexpr const char* COMPONENT_ITEM = "\t\t<item tech=\"{}\" name=\"{}\"/>\n";

static constexpr const char* OPEN_LAYOUT_ITEM  = "\t\t<item comp=\"{}\" x=\"{}\" y=\"{}\">\n";
...
{
  public:
    write_qcc_layout_impl(const Lyt& src, std::ostream& s, const write_qcc_layout_params& p) :
            lyt{src},
            bb{lyt},
  ...
  private:
    ...
    [[nodiscard]] std::string generate_layout_id_hash() const
    {
        ...
        std::for_each(pin_data.cbegin(), pin_data.cend(), [&ss](auto&& pdata) { ss << std::move(pdata); });
