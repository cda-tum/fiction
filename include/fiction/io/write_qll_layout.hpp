...
static constexpr const char* OPEN_QCA_LAYOUT  = "<qcalayout>\n";
static constexpr const char* CLOSE_QCA_LAYOUT = "</qcalayout>\n";
...
class write_qll_layout_impl
{
  ...
  private:
    ...
    void write_technology_settings()
    {
        ...
        os << fmt::format(qll::GENERAL_SETTINGS, lyt.x(), lyt.y(), lyt.num_clocks());
