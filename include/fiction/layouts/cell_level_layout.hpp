...
#pragma region Types and constructors
     ...
     */
    explicit cell_level_layout(const aspect_ratio_type_t<ClockedLayout>& ar = {}, const std::string& name = "",
     ...
     * @param tile_size_y Clock zone size in y-dimension in cells.
     */
    cell_level_layout(const aspect_ratio_type_t<ClockedLayout>& ar, const clocking_scheme<cell>& scheme,
