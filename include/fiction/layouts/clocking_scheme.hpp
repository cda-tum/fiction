 ...
 */
const clocking_scheme<cartesian::ucoord_t>::clock_function open = []([[maybe_unused]] cartesian::ucoord_t cz) noexcept
{ return clocking_scheme<cartesian::ucoord_t>::clock_number{}; };
/**
 ...
 */
const clocking_scheme<cartesian::ucoord_t>::clock_function twoddwave_3 = [](cartesian::ucoord_t cz) noexcept
{
    constexpr std::array<std::array<clocking_scheme<cartesian::ucoord_t>::clock_number, 3u>, 3u> cutout{
        {{{0, 1, 2}}, {{1, 2, 0}}, {{2, 0, 1}}}};
 ...
 */
const clocking_scheme<cartesian::ucoord_t>::clock_function twoddwave_4 = [](cartesian::ucoord_t cz) noexcept
{
    constexpr std::array<std::array<clocking_scheme<cartesian::ucoord_t>::clock_number, 4u>, 4u> cutout{
 ...
 */
const clocking_scheme<cartesian::ucoord_t>::clock_function use_4 = [](cartesian::ucoord_t s) noexcept
{
    constexpr std::array<std::array<clocking_scheme<cartesian::ucoord_t>::clock_number, 4u>, 4u> cutout{
 ...
 */
const clocking_scheme<cartesian::ucoord_t>::clock_function res_4 = [](cartesian::ucoord_t cz) noexcept
{
    constexpr std::array<std::array<clocking_scheme<cartesian::ucoord_t>::clock_number, 4u>, 4u> cutout{
 ...
 */
const clocking_scheme<cartesian::ucoord_t>::clock_function bancs_3 = [](cartesian::ucoord_t cz) noexcept
{
    constexpr std::array<std::array<clocking_scheme<cartesian::ucoord_t>::clock_number, 3u>, 6u> cutout{
 ...
 * from 2DDWave.
 */
const clocking_scheme<cartesian::ucoord_t>::clock_function topolinano_3 = [](cartesian::ucoord_t cz) noexcept
{
    constexpr std::array<std::array<clocking_scheme<cartesian::ucoord_t>::clock_number, 3u>, 3u> cutout{
        {{{0, 1, 2}}, {{0, 1, 2}}, {{0, 1, 2}}}};
 ...
 */
const clocking_scheme<cartesian::ucoord_t>::clock_function topolinano_4 = [](cartesian::ucoord_t cz) noexcept
{
    constexpr std::array<std::array<clocking_scheme<cartesian::ucoord_t>::clock_number, 4u>, 4u> cutout{
 ...
 */
static const clocking_scheme<cartesian::ucoord_t> open_3_clocking{clock_name::open3, clock_function::open, 3u, false};
/**
 * Pre-defined open clocking with 4 clock phases.
 */
static const clocking_scheme<cartesian::ucoord_t> open_4_clocking{clock_name::open4, clock_function::open, 4u, false};
/**
 * Pre-defined 3-phase 2DDWave clocking instance.
 */
static const clocking_scheme<cartesian::ucoord_t> twoddwave_3_clocking{clock_name::twoddwave3,
                                                                       clock_function::twoddwave_3, 3u, true};
/**
 * Pre-defined 4-phase 2DDWave clocking instance.
 */
static const clocking_scheme<cartesian::ucoord_t> twoddwave_4_clocking{clock_name::twoddwave4,
                                                                       clock_function::twoddwave_4, 4u, true};
/**
 * Pre-defined 4-phase USE clocking instance.
 */
static const clocking_scheme<cartesian::ucoord_t> use_4_clocking{clock_name::use, clock_function::use_4, 4u, true};
/**
 * Pre-defined 4-phase RES clocking instance.
 */
static const clocking_scheme<cartesian::ucoord_t> res_4_clocking{clock_name::res, clock_function::res_4, 4u, true};
/**
 * Pre-defined 3-phase BANCS clocking instance.
 */
static const clocking_scheme<cartesian::ucoord_t> bancs_3_clocking{clock_name::bancs, clock_function::bancs_3, 3u,
                                                                   true};
/**
 * Pre-defined 3-phase ToPoliNano clocking instance.
 */
static const clocking_scheme<cartesian::ucoord_t> topolinano_3_clocking{clock_name::topolinano3,
                                                                        clock_function::topolinano_3, 3u, true};
/**
 * Pre-defined 4-phase ToPoliNano clocking instance.
 */
static const clocking_scheme<cartesian::ucoord_t> topolinano_4_clocking{clock_name::topolinano4,
                                                                        clock_function::topolinano_4, 4u, true};

template <typename ClockZone>
std::optional<clocking_scheme<ClockZone>> get_clocking_scheme(const std::string& name) noexcept
{
    if constexpr (std::is_same_v<ClockZone, cartesian::ucoord_t>)
    {
        static const std::unordered_map<std::string, clocking_scheme<cartesian::ucoord_t>> scheme_lookup{
