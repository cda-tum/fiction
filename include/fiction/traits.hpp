...
#pragma region has_east
    ...
    template<class Lyt>
    struct has_east<Lyt, std::void_t<decltype(std::declval<Lyt>().east(std::declval<coordinate<Lyt>>()))>>
            : std::true_type {
    };
...
#pragma region has_west
    ...
    template<class Lyt>
    struct has_west<Lyt, std::void_t<decltype(std::declval<Lyt>().west(std::declval<coordinate<Lyt>>()))>>
            : std::true_type {
    };
    ...
    struct is_coordinate_layout<
            ...
            std::enable_if_t<
                    ...
                    std::void_t<typename Lyt::base_type, aspect_ratio<Lyt>, coordinate<Lyt>, typename Lyt::storage,
                            ...
                            decltype(std::declval<Lyt>().area()), decltype(std::declval<Lyt>().resize(
                                    aspect_ratio<Lyt>()))>>>
            : std::true_type {
    };
...
#pragma region has_foreach_coordinate
    ...
    struct has_foreach_coordinate<
            Lyt, std::void_t<decltype(std::declval<Lyt>().foreach_coordinate(
                    std::declval<void(coordinate<Lyt>, uint32_t)>()))>>
            : std::true_type {
    };
...
#pragma region has_foreach_adjacent_coordinate
    ...
    struct has_foreach_adjacent_coordinate<
            Lyt, std::void_t<decltype(std::declval<Lyt>().foreach_adjacent_coordinate(
                    std::declval<coordinate<Lyt>>(), std::declval<void(coordinate<Lyt>, uint32_t)>()))>>
            : std::true_type {
    };
...
#pragma region has_foreach_incoming_clocked_zone
    ...
    struct has_foreach_incoming_clocked_zone<
            Lyt, std::void_t<decltype(std::declval<Lyt>().foreach_incoming_clocked_zone(
                    std::declval<clock_zone<Lyt>>(), std::declval<void(clock_zone<Lyt>, uint32_t)>()))>>
            : std::true_type {
    };
...
#pragma region has_is_fanout
    ...
    template<class Ntk>
    struct has_is_fanout<Ntk, std::void_t<decltype(std::declval<Ntk>().is_fanout(
            std::declval<mockturtle::node<Ntk>>()))>>
            : std::true_type {
    };
...
#pragma region has_is_xor_and
    ...
    template<class Ntk>
    struct has_is_xor_and<Ntk, std::void_t<decltype(std::declval<Ntk>().is_xor_and(
            std::declval<mockturtle::node<Ntk>>()))>>
            : std::true_type {
    };
...
#pragma region has_is_or_and
    ...
    template<class Ntk>
    struct has_is_or_and<Ntk, std::void_t<decltype(std::declval<Ntk>().is_or_and(
            std::declval<mockturtle::node<Ntk>>()))>>
            : std::true_type {
    };
...
#pragma region has_is_onehot
    ...
    template<class Ntk>
    struct has_is_onehot<Ntk, std::void_t<decltype(std::declval<Ntk>().is_onehot(
            std::declval<mockturtle::node<Ntk>>()))>>
            : std::true_type {
    };
...
#pragma region has_is_gamble
    ...
    template<class Ntk>
    struct has_is_gamble<Ntk, std::void_t<decltype(std::declval<Ntk>().is_gamble(
            std::declval<mockturtle::node<Ntk>>()))>>
            : std::true_type {
    };
...
#pragma region has_is_and_xor
    ...
    template<class Ntk>
    struct has_is_and_xor<Ntk, std::void_t<decltype(std::declval<Ntk>().is_and_xor(
            std::declval<mockturtle::node<Ntk>>()))>>
            : std::true_type {
    };
