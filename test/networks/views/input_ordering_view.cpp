...
TEST_CASE("Input ordering view traits", "[input-ordering]")
{
    ...
    CHECK(!mockturtle::has_get_fo_two_v<ntk>);
    CHECK(!mockturtle::has_get_fo_one_v<ntk>);
    CHECK(!mockturtle::has_get_pi_to_pi_v<ntk>);
    CHECK(!mockturtle::has_nc_inv_flag_v<ntk>);
    CHECK(!mockturtle::has_nc_inv_num_v<ntk>);
    ...
    CHECK(mockturtle::has_foreach_fanout_v<ntk>);
    CHECK(mockturtle::has_get_fo_two_v<ordered_ntk>);
    CHECK(mockturtle::has_get_fo_one_v<ordered_ntk>);
    CHECK(mockturtle::has_get_pi_to_pi_v<ordered_ntk>);
    CHECK(mockturtle::has_nc_inv_flag_v<ordered_ntk>);
    CHECK(mockturtle::has_nc_inv_num_v<ordered_ntk>);
}
