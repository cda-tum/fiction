                   ...
                   (sidb_cell_clk_lyt_siqad))
{
    ...
    using lattice_layout_111 = sidb_lattice<TestType, sidb_100_lattice>;
    lattice_layout_111 lyt_111{};
    lyt_111.assign_cell_type({0, 0}, sidb_cell_clk_lyt::cell_type::NORMAL);
    lyt_111.assign_cell_type({3, 0}, sidb_cell_clk_lyt::cell_type::NORMAL);
    lyt_111.assign_cell_type({5, 0}, sidb_cell_clk_lyt::cell_type::NORMAL);
