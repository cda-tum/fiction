...
//                                                   sidb_100_lattice::LAT_B * 0.1 + sidb_100_lattice::LAT_C.second *
//                                                   0.1),
//                                        0.00001));
...
//         REQUIRE(!charge_layout_new.get_local_external_potentials().empty());
//         CHECK(charge_layout_new.get_local_external_potentials().size() == 1);
//         CHECK(charge_layout_new.get_local_external_potentials().size() == 1);
//
...
//         CHECK_THAT(system_energy_first - system_energy_second, Catch::Matchers::WithinAbs(0,
...
//
//         charge_layout_new.add_sidb_defect_to_potential_landscape(
//             {5, 1, 1}, sidb_defect{sidb_defect_type::UNKNOWN, -1,
...
//         charge_layout_new.add_sidb_defect_to_potential_landscape(
//             {-10, 5, 1}, sidb_defect{sidb_defect_type::UNKNOWN, 1,
//             charge_layout_new.get_simulation_params().epsilon_r,
//                                      charge_layout_new.get_simulation_params().lambda_tf});
