...
TEST_CASE("Test Defects")
{
    ...
    defect_lyt.assign_cell_type({5, 0, 0}, sidb_cell_clk_lyt_siqad::cell_type::EMPTY);
    defect_lyt.assign_sidb_defect({5, 0, 0},
    ...
    CHECK_THAT(charge_lyt.get_local_potential_by_index(2).value() -
                   charge_lyt_defect.get_local_defect_potential({5, 0, 0}),
               Catch::Matchers::WithinAbs(0.0, constants::ERROR_MARGIN));
}
