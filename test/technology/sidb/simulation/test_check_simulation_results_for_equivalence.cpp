...
{
    layout lyt1{};
    lyt1.assign_sidb(site_at_row(0, 0), dot_tag::NORMAL);
    lyt1.assign_sidb(site_at_row(0, 1), dot_tag::NORMAL);
    lyt1.assign_sidb(site_at_row(0, 2), dot_tag::NORMAL);
    lyt1.assign_sidb(site_at_row(0, 3), dot_tag::NORMAL);
    ...
    {
        auto lyt2 = lyt1;
        lyt2.assign_sidb(site_at_row(4, 2), dot_tag::NORMAL);
        lyt2.assign_sidb(site_at_row(4, 3), dot_tag::NORMAL);
        results2.lyt                  = lyt2;
...
TEST_CASE("Simulation equivalence beyond the charge-index range", "[equivalence-check-for-simulation-results]")
{
    ...
    {
        lyt.assign_sidb({static_cast<int32_t>(i), 0}, dot_tag::NORMAL);
    }
