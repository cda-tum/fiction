          ...
          "[determine-physically-valid-parameters]")
{
    ...
    SECTION("Using the typical ground state as given CDS")
    {
        ...
        const auto valid_parameters = sidb::simulation::generic::physically_valid_parameters(cds, op_domain_params);
        ...
        const auto valid_parameters_exgs =
            sidb::simulation::generic::physically_valid_parameters(cds, op_domain_params);
