...
TEST_CASE("Defect influence grid-search edge cases", "[defect-influence]")
{
    ...
    {
        auto lyt = layout{};
        lyt.assign_sidb({std::numeric_limits<int32_t>::max(), std::numeric_limits<int32_t>::max(), 1}, dot_tag::NORMAL);
    ...
    SECTION("QuickTrace tries every requested sample after an influential left edge")
    {
        ...
        lyt.assign_sidb(site_at_row(2, 0), dot_tag::NORMAL);
...
TEST_CASE("Defect influence when considering the change of the ground state", "[defect-influence]")
{
    ...
    SECTION("layout with one pertuber and one DB pair, negative defect")
    {
        ...
        lyt.assign_sidb(site_at_row(0, 0), dot_tag::NORMAL);
        lyt.assign_sidb(site_at_row(4, 0), dot_tag::NORMAL);
        lyt.assign_sidb(site_at_row(6, 0), dot_tag::NORMAL);
    ...
    SECTION("QuickExact simulation of a Y-shape SiDB OR gate with input 01")
    {
        ...
        lyt.assign_sidb(site_at_row(10, 0), dot_tag::NORMAL);
        lyt.assign_sidb(site_at_row(0, 2), dot_tag::NORMAL);
        lyt.assign_sidb(site_at_row(8, 2), dot_tag::NORMAL);

        lyt.assign_sidb(site_at_row(2, 4), dot_tag::NORMAL);
        lyt.assign_sidb(site_at_row(6, 4), dot_tag::NORMAL);
        lyt.assign_sidb(site_at_row(4, 8), dot_tag::NORMAL);
        lyt.assign_sidb(site_at_row(4, 11), dot_tag::NORMAL);
        lyt.assign_sidb(site_at_row(4, 15), dot_tag::NORMAL);
    ...
    SECTION("QuickExact simulation of a Y-shape SiDB OR gate with input 01, using cube coordinate")
    {
        ...
        lyt.assign_sidb({4, 4, 0}, dot_tag::NORMAL);
        lyt.assign_sidb({4, 5, 1}, dot_tag::NORMAL);
        lyt.assign_sidb({4, 7, 1}, dot_tag::NORMAL);
...
TEST_CASE("Defect influence reports progress", "[defect-influence]")
{
    auto lyt = layout{};
    lyt.assign_sidb({0, 0}, dot_tag::NORMAL);
    lyt.assign_sidb({4, 0}, dot_tag::NORMAL);
