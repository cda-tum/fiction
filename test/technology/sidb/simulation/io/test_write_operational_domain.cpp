...
/**
 * @file
 * @brief Tests for `fiction/technology/sidb/simulation/io/write_operational_domain.hpp`.
...
TEST_CASE("Write empty operational domain", "[write-operational-domain]")
{
    ...
    SECTION("default sweep dimensions")
    {
        ...
        sidb::simulation::io::write_operational_domain(opdom, os);
...
TEST_CASE("Write simple operational domain", "[write-operational-domain]")
{
    ...
    {
        const sidb::simulation::io::write_operational_domain_params params{.operational_tag     = "True",
                                                                           .non_operational_tag = "False"};

        const std::set<std::string> expected{"epsilon_r,lambda_tf,operational status", "0,0,True", "0,1,False"};

        sidb::simulation::io::write_operational_domain(opdom, os, params);
        const auto os_str = os.str();
    ...
    {
        sidb::simulation::io::write_operational_domain_params const params{
            .writing_mode =
                sidb::simulation::io::write_operational_domain_params::sample_writing_mode::OPERATIONAL_ONLY};
...
TEST_CASE("Write operational domain with floating-point parameter values", "[write-operational-domain]")
{
    ...
    SECTION("custom operational tags")
    {
        const sidb::simulation::io::write_operational_domain_params params{.operational_tag     = "operational",
