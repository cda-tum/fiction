...
TEST_CASE("Write operational domain with floating-point parameter and temperature values", "[write-operational-domain]")
{
    SECTION("One sweep parameters")
    {
        ...
        opdom.operational_values = {{parameter_point{{0.1}}, operational_status::OPERATIONAL},
                                    {parameter_point{{0.3}}, operational_status::NON_OPERATIONAL},
                                    {parameter_point{{1.2}}, operational_status::OPERATIONAL},
                                    {parameter_point{{2.4}}, operational_status::NON_OPERATIONAL}};

        opdom.metric_values = {{parameter_point{{0.1}}, 50.3},
                               {parameter_point{{0.3}}, 0.0},
                               {parameter_point{{1.2}}, 400.00},
        ...
        SECTION("default operational tags")
        {
            std::set<std::string> expected{"epsilon_r,operational status,ct", "0.1,1,50.3", "0.3,0,0", "1.2,1,400",
                                           "2.4,0,0"};
        ...
        SECTION("custom operational tags")
        {
            ...
            std::set<std::string> expected{"epsilon_r,operational status,ct", "0.1,operational,50.3",
        ...
        SECTION("skip non-operational samples")
        {
            ...
            std::set<std::string> expected{"epsilon_r,operational status,ct", "0.1,1,50.3", "1.2,1,400"};
    ...
    SECTION("Two sweep parameters")
    {
        ...
        SECTION("skip non-operational samples")
        {
            ...
            std::set<std::string> expected{"epsilon_r,lambda_tf,operational status,ct", "0.1,0.2,1,50.3",
                                           "1.2,1.4,1,400"};
