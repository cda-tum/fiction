...
TEST_CASE("Print layout without charges but defects", "[print-charge-layout]")
{
    ...
    layout.assign_cell_type({0, 0}, sidb_cell_clk_lyt::technology::NORMAL);
    layout.assign_cell_type({1, 0}, sidb_cell_clk_lyt::technology::NORMAL);
    layout.assign_cell_type({0, 1}, sidb_cell_clk_lyt::technology::NORMAL);
    layout.assign_cell_type({1, 1}, sidb_cell_clk_lyt::technology::NORMAL);
    ...
    cl.assign_sidb_defect({4, 0, 1}, sidb_defect{sidb_defect_type::UNKNOWN, 0});
