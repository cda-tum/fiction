...
const std::string EXPECTED_SVG_LIGHT_CELL_LEVEL_111 =
...
TEMPLATE_TEST_CASE(
    "Generate SiDB layout on the H-Si(111)-1x1 surface in SVG for cell-level layout and charge distribution surface",
    "[write-sidb-layout-svg-in-siqad-style]", sidb_111_cell_clk_lyt_cube, sidb_111_cell_clk_lyt)
{
    TestType layout{{4, 4}};
