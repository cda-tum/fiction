...
CellLyt single_layer_qca_and_gate() noexcept
{
    ...
    layout.assign_cell_type({0, 2}, fiction::qca_technology::INPUT);
    layout.assign_cell_type({2, 4}, fiction::qca_technology::INPUT);
    layout.assign_cell_type({2, 0}, fiction::qca_technology::CONST_0);
    layout.assign_cell_type({2, 1}, fiction::qca_technology::NORMAL);
    layout.assign_cell_type({2, 2}, fiction::qca_technology::NORMAL);
    layout.assign_cell_type({2, 3}, fiction::qca_technology::NORMAL);
    layout.assign_cell_type({1, 2}, fiction::qca_technology::NORMAL);
    layout.assign_cell_type({3, 2}, fiction::qca_technology::NORMAL);
    layout.assign_cell_type({4, 2}, fiction::qca_technology::OUTPUT);
...
CellLyt two_layer_qca_wire_crossing() noexcept
{
    ...
    layout.assign_cell_type({0, 2}, fiction::qca_technology::INPUT);
    layout.assign_cell_type({2, 0}, fiction::qca_technology::INPUT);

    layout.assign_cell_type({2, 1}, fiction::qca_technology::NORMAL);
    layout.assign_cell_type({2, 2}, fiction::qca_technology::NORMAL);
    layout.assign_cell_type({2, 3}, fiction::qca_technology::NORMAL);

    layout.assign_cell_type({0, 2, 1}, fiction::qca_technology::NORMAL);
    layout.assign_cell_type({1, 2, 1}, fiction::qca_technology::NORMAL);
    layout.assign_cell_type({2, 2, 1}, fiction::qca_technology::NORMAL);
    layout.assign_cell_type({3, 2, 1}, fiction::qca_technology::NORMAL);
    layout.assign_cell_type({4, 2, 1}, fiction::qca_technology::NORMAL);
    ...
    layout.assign_cell_type({4, 2}, fiction::qca_technology::OUTPUT);
    layout.assign_cell_type({2, 4}, fiction::qca_technology::OUTPUT);
...
CellLyt single_layer_inml_maj_gate() noexcept
{
    ...
    layout.assign_cell_type({0, 0}, fiction::inml_technology::INPUT);
    layout.assign_cell_type({0, 2}, fiction::inml_technology::INPUT);
    layout.assign_cell_type({0, 4}, fiction::inml_technology::INPUT);
    layout.assign_cell_type({1, 0}, fiction::inml_technology::NORMAL);
    layout.assign_cell_type({1, 2}, fiction::inml_technology::NORMAL);
    layout.assign_cell_type({1, 4}, fiction::inml_technology::NORMAL);
    layout.assign_cell_type({2, 0}, fiction::inml_technology::NORMAL);
    layout.assign_cell_type({2, 1}, fiction::inml_technology::NORMAL);
    layout.assign_cell_type({2, 2}, fiction::inml_technology::NORMAL);
    layout.assign_cell_type({2, 3}, fiction::inml_technology::NORMAL);
    layout.assign_cell_type({2, 4}, fiction::inml_technology::NORMAL);
    layout.assign_cell_type({3, 2}, fiction::inml_technology::NORMAL);
    layout.assign_cell_type({4, 2}, fiction::inml_technology::OUTPUT);
...
CellLyt single_layer_inml_coupler_with_inverter() noexcept
{
    ...
    layout.assign_cell_type({1, 2}, fiction::inml_technology::NORMAL);
    layout.assign_cell_type({2, 2}, fiction::inml_technology::NORMAL);
    layout.assign_cell_type({3, 1}, fiction::inml_technology::FANOUT_COUPLER_MAGNET);
    layout.assign_cell_type({3, 2}, fiction::inml_technology::FANOUT_COUPLER_MAGNET);
    layout.assign_cell_type({3, 3}, fiction::inml_technology::FANOUT_COUPLER_MAGNET);
    layout.assign_cell_type({4, 1}, fiction::inml_technology::FANOUT_COUPLER_MAGNET);
    layout.assign_cell_type({4, 3}, fiction::inml_technology::FANOUT_COUPLER_MAGNET);
    layout.assign_cell_type({5, 1}, fiction::inml_technology::NORMAL);
    layout.assign_cell_type({6, 1}, fiction::inml_technology::NORMAL);
    layout.assign_cell_type({5, 3}, fiction::inml_technology::NORMAL);
    layout.assign_cell_type({6, 3}, fiction::inml_technology::NORMAL);
    layout.assign_cell_type({7, 1}, fiction::inml_technology::INVERTER_MAGNET);
    layout.assign_cell_type({8, 1}, fiction::inml_technology::INVERTER_MAGNET);
    layout.assign_cell_type({9, 1}, fiction::inml_technology::INVERTER_MAGNET);
    layout.assign_cell_type({10, 1}, fiction::inml_technology::NORMAL);
    layout.assign_cell_type({7, 3}, fiction::inml_technology::NORMAL);
    layout.assign_cell_type({8, 3}, fiction::inml_technology::NORMAL);
    layout.assign_cell_type({9, 3}, fiction::inml_technology::NORMAL);
    layout.assign_cell_type({10, 3}, fiction::inml_technology::NORMAL);
    layout.assign_cell_type({11, 1}, fiction::inml_technology::OUTPUT);
    layout.assign_cell_type({11, 3}, fiction::inml_technology::OUTPUT);
...
CellLyt single_layer_inml_crosswire() noexcept
{
    ...
    layout.assign_cell_type({0, 0}, fiction::inml_technology::INPUT);
    layout.assign_cell_type({0, 2}, fiction::inml_technology::INPUT);
    layout.assign_cell_type({1, 0}, fiction::inml_technology::CROSSWIRE_MAGNET);
    layout.assign_cell_type({1, 2}, fiction::inml_technology::CROSSWIRE_MAGNET);
    layout.assign_cell_type({2, 1}, fiction::inml_technology::CROSSWIRE_MAGNET);
    layout.assign_cell_type({3, 0}, fiction::inml_technology::CROSSWIRE_MAGNET);
    layout.assign_cell_type({3, 2}, fiction::inml_technology::CROSSWIRE_MAGNET);
    layout.assign_cell_type({4, 0}, fiction::inml_technology::NORMAL);
    layout.assign_cell_type({4, 2}, fiction::inml_technology::NORMAL);
    layout.assign_cell_type({5, 0}, fiction::inml_technology::OUTPUT);
    layout.assign_cell_type({5, 2}, fiction::inml_technology::OUTPUT);
