...
std::vector<exact_physical_design_params> configurations() noexcept
{
    exact_physical_design_params twoddwave_config{};
    ...
    exact_physical_design_params use_config{};
    ...
    exact_physical_design_params res_config{};
    ...
    exact_physical_design_params async_config{};
...
void check_stats(const exact_physical_design_params& st) noexcept
{
...
TEST_CASE("Timeout", "[exact]")
{
    ...
    exact_physical_design_params timeout_config{};
