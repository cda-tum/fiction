...
TEST_CASE("occupation probability of all erroneous charge distribution states", "[occupation_probability_erroneous]")
{
    ...
    SECTION("one state with degeneracy")
    {
        ...
        energy_and_state_type.emplace_back(0.1, sidb_charge_distribution_type::TRANSPARENT);
        energy_and_state_type.emplace_back(0.1, sidb_charge_distribution_type::ERRONEOUS);
    ...
    SECTION("a few states with degeneracy")
    {
        ...
        energy_and_state_type.emplace_back(0.2, sidb_charge_distribution_type::TRANSPARENT);
        energy_and_state_type.emplace_back(0.2, sidb_charge_distribution_type::TRANSPARENT);
    ...
    {
        sidb_energy_and_state_type energy_and_state_type{};
        energy_and_state_type.emplace_back(1, sidb_charge_distribution_type::TRANSPARENT);
    ...
    {
        sidb_energy_and_state_type energy_and_state_type{};
        energy_and_state_type.emplace_back(1, sidb_charge_distribution_type::ERRONEOUS);
