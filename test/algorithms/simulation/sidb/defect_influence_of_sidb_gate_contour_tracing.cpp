...
//TEST_CASE("novel designed AND Gate influence distance function", "[defect-influence-of-sidb-gate-contour-tracing]")
//{
//    sidb_cell_clk_lyt_siqad lyt{};
//
//    lyt.assign_cell_type({38, 0, 0}, sidb_technology::cell_type::INPUT);
...
//    // canvas SiDBs
//    // -------------
//    lyt.assign_cell_type({21, 7, 1}, sidb_technology::cell_type::NORMAL);
//    lyt.assign_cell_type({17, 9, 0}, sidb_technology::cell_type::NORMAL);
//
//    lyt.assign_cell_type({19, 10, 0}, sidb_technology::cell_type::NORMAL);
...
//    const maximum_defect_influence_distance_params sim_params{sidb_defect, sidb_simulation_parameters{2, -0.32}, {20, 20}};
//    const defect_influence_params params{sim_params, is_operational_params{sim_params.physical_params}};
//
//    SECTION("input 00")
//    {
//        defect_influence_stats stats{};
//        const auto             defect_influence_domain =
//                defect_influence_of_sidb_gate_contour_tracing(cube_lyt, std::vector<tt>{create_and_tt()}, 1000, params, &stats);
//        std::cout << max_min_avoidance_distance(cube_lyt, defect_influence_domain) << std::endl;
//
//        write_operational_domain_params write_params{};
//        write_params.operational_tag     = "1";
//        write_params.non_operational_tag = "0";
...
TEST_CASE("novel designed AND Gate influence distance function which fails", "[defect-influence-of-sidb-gate-contour-tracing]")
{
    sidb_cell_clk_lyt_siqad lyt{};
    ...
    // canvas SiDBs
    // -------------
    lyt.assign_cell_type({19, 7, 1}, sidb_technology::cell_type::NORMAL);
    lyt.assign_cell_type({19, 9, 1}, sidb_technology::cell_type::NORMAL);
    lyt.assign_cell_type({19, 11, 0}, sidb_technology::cell_type::NORMAL);
    // -------------
    ...
    const sidb_defect                              sidb_defect{sidb_defect_type::UNKNOWN, -1, 9.7, 2.1};
    const maximum_defect_influence_distance_params sim_params{sidb_defect, sidb_simulation_parameters{2, -0.32}, {50, 20}};
    const defect_influence_params params{sim_params, is_operational_params{sim_params.physical_params}};
    ...
    SECTION("input 00")
    {
        defect_influence_stats stats{};
        const auto             defect_influence_domain =
                defect_influence_of_sidb_gate_contour_tracing(cube_lyt, std::vector<tt>{create_nand_tt()}, 100, params, &stats);
        std::cout << max_min_avoidance_distance(cube_lyt, defect_influence_domain) << std::endl;
