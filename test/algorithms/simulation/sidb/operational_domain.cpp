...
TEST_CASE("Error handling of operational domain algorithms", "[operational-domain]")
{
    ...
    SECTION("invalid number of dimensions")
    {
        ...
        SECTION("flood_fill")
        {
            ...
            {
                CHECK_THROWS_AS(
                    operational_domain_flood_fill(lat, std::vector{networks::utils::create_id_tt()}, 1, params),
        ...
        SECTION("contour_tracing")
        {
            ...
            {
                CHECK_THROWS_AS(
                    operational_domain_contour_tracing(lat, std::vector{networks::utils::create_id_tt()}, 1, params),
                    std::invalid_argument);
            }
        }
    }
    ...
    SECTION("operational domain sketch preconditions")
    {
        ...
        SECTION("kinks must be rejected")
        {
            ...
            CHECK_THROWS_AS(operational_domain_grid_search(and_lat, std::vector{networks::utils::create_and_tt()},
                                                           tolerating_params),
                            std::invalid_argument);
            CHECK_THROWS_AS(operational_domain_random_sampling(and_lat, std::vector{networks::utils::create_and_tt()},
                                                               1, tolerating_params),
                            std::invalid_argument);
            CHECK_THROWS_AS(operational_domain_flood_fill(and_lat, std::vector{networks::utils::create_and_tt()}, 1,
                                                          tolerating_params),
                            std::invalid_argument);
            CHECK_THROWS_AS(operational_domain_contour_tracing(and_lat, std::vector{networks::utils::create_and_tt()},
                                                               1, tolerating_params),
                            std::invalid_argument);
        }
        ...
        SECTION("the layout must have canvas cells")
        {
            ...
            CHECK_THROWS_AS(
                operational_domain_grid_search(lat, std::vector{networks::utils::create_id_tt()}, sketch_params),
                std::invalid_argument);
        }
        ...
        {
            CHECK_NOTHROW(
                operational_domain_grid_search(and_lat, std::vector{networks::utils::create_and_tt()}, sketch_params));
        }
    }
    ...
    SECTION("invalid sweep dimensions")
    {
        ...
        SECTION("min/max mismatch")
        {
            ...
            for (const auto& params : {invalid_params_1, invalid_params_2, invalid_params_3})
            {
                ...
                {
                    CHECK_THROWS_AS(
                        operational_domain_grid_search(lat, std::vector{networks::utils::create_id_tt()}, params),
                        std::invalid_argument);
                }
                SECTION("random_sampling")
                {
                    CHECK_THROWS_AS(operational_domain_random_sampling(
                ...
                SECTION("contour_tracing")
                {
                    CHECK_THROWS_AS(operational_domain_contour_tracing(
...
TEST_CASE("SiQAD OR gate", "[operational-domain]")
{
    ...
    const auto op_domain = operational_domain_grid_search(lyt, std::vector{networks::utils::create_or_tt()},
...
TEST_CASE("Three-dimensional operational domain sketch", "[operational-domain]")
{
    ...
    const auto simulated =
        operational_domain_grid_search(lat, std::vector{networks::utils::create_and_tt()}, simulation_params);
    ...
    SECTION("grid search yields a superset of the simulated operational domain")
    {
        ...
        const auto sketch =
            operational_domain_grid_search(lat, std::vector{networks::utils::create_and_tt()}, sketch_params, &stats);
    ...
    {
        const auto sketch =
            operational_domain_random_sampling(lat, std::vector{networks::utils::create_and_tt()}, 8, sketch_params);
        ...
        sketch.for_each(
            [&](const auto& parameter_point, const auto& status)
            {
                ...
                const auto [expected, _] = is_operational(lat, std::vector{networks::utils::create_and_tt()},
                                                          point_params, input_wires, output_wires);
    ...
    SECTION("flood fill yields a subset of the grid-searched sketch")
    {
        ...
        const auto grid_sketch =
            operational_domain_grid_search(lat, std::vector{networks::utils::create_and_tt()}, sketch_params);
        const auto flood_sketch =
            operational_domain_flood_fill(lat, std::vector{networks::utils::create_and_tt()}, 4, sketch_params);
...
TEST_CASE("Three-dimensional contour tracing", "[operational-domain]")
{
    ...
    const auto exhaustive = operational_domain_grid_search(lat, std::vector{networks::utils::create_and_tt()}, params);
    ...
    SECTION("agrees with the grid search on every point it reports")
    {
        ...
        const auto traced =
            operational_domain_contour_tracing(lat, std::vector{networks::utils::create_and_tt()}, 8, params, &stats);
    ...
    SECTION("carries the operational domain sketch")
    {
        ...
        const auto traced_sketch =
            operational_domain_contour_tracing(lat, std::vector{networks::utils::create_and_tt()}, 8, sketch_params);
...
TEST_CASE("Sampling zero points does not divide by zero", "[operational-domain]")
{
    ...
    const auto op_domain = operational_domain_random_sampling(lat, std::vector{networks::utils::create_and_tt()}, 0,
                                                              op_domain_params, &op_domain_stats);
...
TEST_CASE("Pinning the thread count does not change the operational domain", "[operational-domain]")
{
    ...
    const auto default_domain = operational_domain_grid_search(lat, std::vector{networks::utils::create_and_tt()},
                                                               op_domain_params, &default_stats);
    ...
    const auto single_threaded_domain = operational_domain_grid_search(
    ...
    const auto zero_domain = operational_domain_grid_search(lat, std::vector{networks::utils::create_and_tt()},
                                                            op_domain_params, &zero_stats);
...
TEST_CASE("BDL wire operational domain computation", "[operational-domain]")
{
    ...
    SECTION("operational area, only one parameter point")
    {
        ...
        SECTION("grid_search")
        {
            const auto op_domain = operational_domain_grid_search(lat, std::vector{networks::utils::create_id_tt()},
                                                                  op_domain_params, &op_domain_stats);
            ...
            SECTION("reject kinks")
            {
                ...
                const auto op_domain_kinks = operational_domain_grid_search(
        ...
        SECTION("random_sampling")
        {
            const auto op_domain = operational_domain_random_sampling(lat, std::vector{networks::utils::create_id_tt()},
                                                                      100, op_domain_params, &op_domain_stats);
        ...
        SECTION("flood_fill")
        {
            const auto op_domain = operational_domain_flood_fill(lat, std::vector{networks::utils::create_id_tt()}, 1,
                                                                 op_domain_params, &op_domain_stats);
        ...
        SECTION("contour_tracing")
        {
            const auto op_domain = operational_domain_contour_tracing(lat, std::vector{networks::utils::create_id_tt()},
                                                                      1, op_domain_params, &op_domain_stats);
    ...
    SECTION("non-operational area")
    {
        ...
        {
            const auto op_domain = operational_domain_random_sampling(lat, std::vector{networks::utils::create_id_tt()},
                                                                      5000, op_domain_params, &op_domain_stats);
        ...
        SECTION("flood_fill")
        {
            const auto op_domain = operational_domain_flood_fill(lat, std::vector{networks::utils::create_id_tt()}, 25,
                                                                 op_domain_params, &op_domain_stats);
        ...
        {
            const auto op_domain = operational_domain_contour_tracing(lat, std::vector{networks::utils::create_id_tt()},
                                                                      25, op_domain_params, &op_domain_stats);
    ...
    SECTION("floating-point error")
    {
        ...
        SECTION("flood_fill")
        {
            const auto op_domain = operational_domain_flood_fill(lat, std::vector{networks::utils::create_id_tt()},
                                                                 10000, op_domain_params, &op_domain_stats);
    ...
    SECTION("semi-operational area")
    {
        ...
        SECTION("flood_fill")
        {
            ...
            {
                const auto op_domain = operational_domain_flood_fill(lat, std::vector{networks::utils::create_id_tt()},
                                                                     50, op_domain_params, &op_domain_stats);
...
TEST_CASE("Contour tracing does not retrace an already enclosed area", "[operational-domain]")
{
    ...
    const auto grid_search_domain =
        operational_domain_grid_search(lat, std::vector{networks::utils::create_id_tt()}, op_domain_params);
...
TEST_CASE("SiQAD's AND gate operational domain computation", "[operational-domain]")
{
    ...
    SECTION("grid_search")
    {
        const auto op_domain = operational_domain_grid_search(lat, std::vector{networks::utils::create_and_tt()},
                                                              op_domain_params, &op_domain_stats);
    ...
    SECTION("random_sampling")
    {
        const auto op_domain = operational_domain_random_sampling(lat, std::vector{networks::utils::create_and_tt()},
                                                                  100, op_domain_params, &op_domain_stats);
    ...
    SECTION("flood_fill")
    {
        const auto op_domain = operational_domain_flood_fill(lat, std::vector{networks::utils::create_and_tt()}, 1,
                                                             op_domain_params, &op_domain_stats);
    ...
    SECTION("contour_tracing")
    {
        const auto op_domain = operational_domain_contour_tracing(lat, std::vector{networks::utils::create_and_tt()}, 1,
                                                                  op_domain_params, &op_domain_stats);
...
TEMPLATE_TEST_CASE("AND gate on the H-Si(111)-1x1 surface", "[operational-domain]", sidb_111_cell_clk_lyt_siqad)
{
    ...
    SECTION("grid_search")
    {
        const auto op_domain = operational_domain_grid_search(layout, std::vector{networks::utils::create_and_tt()},
                                                              op_domain_params, &op_domain_stats);
    ...
    SECTION("random_sampling")
    {
        const auto op_domain = operational_domain_random_sampling(layout, std::vector{networks::utils::create_and_tt()},
                                                                  100, op_domain_params, &op_domain_stats);
    ...
    SECTION("flood_fill")
    {
        SECTION("one random sample")
        {
            const auto op_domain = operational_domain_flood_fill(layout, std::vector{networks::utils::create_and_tt()},
                                                                 1, op_domain_params, &op_domain_stats);
    ...
    SECTION("contour_tracing")
    {
        const auto op_domain = operational_domain_contour_tracing(layout, std::vector{networks::utils::create_and_tt()},
                                                                  1, op_domain_params, &op_domain_stats);
          ...
          "[operational-domain]")
{
    ...
    SECTION("grid_search")
    {
        const auto op_domain = critical_temperature_domain_grid_search(
    ...
    SECTION("random_sampling in non-operational regime")
    {
        ...
        const auto op_domain = critical_temperature_domain_random_sampling(
    ...
    SECTION("flood_fill")
    {
        ...
        const auto op_domain = critical_temperature_domain_flood_fill(
...
TEST_CASE("Two BDL pair wire with degeneracy for input 1", "[operational-domain]")
{
    ...
    SECTION("grid search, input is set via the distance of the perturbers")
    {
        ...
        const auto op_domain = operational_domain_grid_search(lyt, std::vector{networks::utils::create_id_tt()},
                                                              op_domain_params, &op_domain_stats);
