...
//     const operational_domain<parameter_point, operational_status>& op_domain, const operational_domain_params&
//     params, const std::optional<operational_status>& status) noexcept
//{
...
//                  {zero_dimensional_params, one_dimensional_params, three_dimensional_params,
//                  four_dimensional_params})
//             {
...
//                 SECTION("contour_tracing")
//                 {
//                     CHECK_THROWS_AS(operational_domain_contour_tracing(lat, std::vector<tt>{create_id_tt()}, 1,
//                     params),
//                                     std::invalid_argument);
//                 }
//             }
...
//             {
//                 const auto z_dimension = operational_domain_value_range{sweep_parameter::MU_MINUS, -0.32, -0.32,
//                 0.01};
//
...
//                 op_domain_params.sweep_dimensions.push_back(z_dimension);
//
//                 const auto op_domain_3d = operational_domain_random_sampling(lat, std::vector<tt>{create_id_tt()},
//                 100,
//                                                                              op_domain_params, &op_domain_stats);
//
//                 // check if the operational domain has the correct size
...
//             SECTION("3-dimensional")
//             {
//                 const auto z_dimension = operational_domain_value_range{sweep_parameter::MU_MINUS, -0.35, -0.29,
//                 0.01};
//
//                 op_domain_params.sweep_dimensions.push_back(z_dimension);
//
...
//                 SECTION("one random sample")
//                 {
//                     const auto op_domain_3d = operational_domain_flood_fill(lat, std::vector<tt>{create_id_tt()},
//                     100,
//                                                                             op_domain_params, &op_domain_stats);
//
//                     // check if the operational domain has the correct size
...
//             SECTION("3-dimensional")
//             {
//                 const auto z_dimension = operational_domain_value_range{sweep_parameter::MU_MINUS, -0.14, -0.10,
//                 0.01};
//
//                 op_domain_params.sweep_dimensions.push_back(z_dimension);
//
...
TEMPLATE_TEST_CASE("test", "[operational-domain]", sidb_100_cell_clk_lyt_siqad)
{
    ...
    operational_domain_params op_domain_params;
    op_domain_params.operational_params.simulation_parameters = sim_params;
    op_domain_params.sweep_dimensions                         = {{sweep_parameter::EPSILON_R, 1.0, 10.0, 0.5},
                                                                 {sweep_parameter::LAMBDA_TF, 1.0, 10.0, 0.5}};
    ...
    SECTION("grid_search")
    {
        ...
        const auto op_domain =
            operational_domain_grid_search(layout, std::vector<tt>{create_or_tt()}, op_domain_params, &op_domain_stats);

        std::cout << mockturtle::to_seconds(op_domain_stats.time_total) << std::endl;
    ...
    SECTION("grid_search")
    {
        ...
        write_operational_domain(op_domain, "and_gate_only_pruning.csv");
    }
}
