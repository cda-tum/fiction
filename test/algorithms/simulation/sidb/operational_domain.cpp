...
TEST_CASE("SiQAD's AND gate operational domain computation, using cube coordinates", "[operational-domain]")
{
    ...
    lyt.assign_cell_type(layouts::siqad::to_fiction_coord<layouts::cube::coord_t>(layouts::siqad::coord_t{0, 0, 1}),
                         sidb_technology::cell_type::INPUT);
    lyt.assign_cell_type(layouts::siqad::to_fiction_coord<layouts::cube::coord_t>(layouts::siqad::coord_t{2, 1, 1}),
                         sidb_technology::cell_type::INPUT);

    lyt.assign_cell_type(layouts::siqad::to_fiction_coord<layouts::cube::coord_t>(layouts::siqad::coord_t{20, 0, 1}),
                         sidb_technology::cell_type::INPUT);
    lyt.assign_cell_type(layouts::siqad::to_fiction_coord<layouts::cube::coord_t>(layouts::siqad::coord_t{18, 1, 1}),
                         sidb_technology::cell_type::INPUT);

    lyt.assign_cell_type(layouts::siqad::to_fiction_coord<layouts::cube::coord_t>(layouts::siqad::coord_t{4, 2, 1}),
                         sidb_technology::cell_type::NORMAL);
    lyt.assign_cell_type(layouts::siqad::to_fiction_coord<layouts::cube::coord_t>(layouts::siqad::coord_t{6, 3, 1}),
                         sidb_technology::cell_type::NORMAL);

    lyt.assign_cell_type(layouts::siqad::to_fiction_coord<layouts::cube::coord_t>(layouts::siqad::coord_t{14, 3, 1}),
                         sidb_technology::cell_type::NORMAL);
    lyt.assign_cell_type(layouts::siqad::to_fiction_coord<layouts::cube::coord_t>(layouts::siqad::coord_t{16, 2, 1}),
                         sidb_technology::cell_type::NORMAL);

    lyt.assign_cell_type(layouts::siqad::to_fiction_coord<layouts::cube::coord_t>(layouts::siqad::coord_t{10, 6, 0}),
                         sidb_technology::cell_type::OUTPUT);
    lyt.assign_cell_type(layouts::siqad::to_fiction_coord<layouts::cube::coord_t>(layouts::siqad::coord_t{10, 7, 0}),
                         sidb_technology::cell_type::OUTPUT);

    lyt.assign_cell_type(layouts::siqad::to_fiction_coord<layouts::cube::coord_t>(layouts::siqad::coord_t{10, 9, 1}),
                         sidb_technology::cell_type::NORMAL);
