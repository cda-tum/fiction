                   ...
                   (cell_level_layout<sidb_technology, clocked_layout<cartesian_layout<siqad::coord_t>>>))
{
    ...
    const quickexact_params<TestType> params{sidb_simulation_parameters{2, -0.32_eV}};
    ...
    "[ExGS]", (sidb_surface<cell_level_layout<sidb_technology, clocked_layout<cartesian_layout<siqad::coord_t>>>>))
{
    TestType lyt{{20, 10}};
    lyt.assign_cell_type({1, 3, 0}, TestType::cell_type::NORMAL);
    const quickexact_params<TestType> params{sidb_simulation_parameters{2, -0.25_eV}};
    lyt.assign_sidb_defect({1, 2, 0}, sidb_defect{sidb_defect_type::UNKNOWN, -1_e, params.physical_parameters.epsilon_r,
...
TEMPLATE_TEST_CASE(
    "Single SiDB QuickExact simulation with one negatively charge defect (changed lambda_tf) in proximity", "[ExGS]",
    (sidb_surface<cell_level_layout<sidb_technology, clocked_layout<cartesian_layout<siqad::coord_t>>>>))
{
    ...
    lyt.assign_sidb_defect({1, 2, 0},
                           sidb_defect{sidb_defect_type::UNKNOWN, -1_e, params.physical_parameters.epsilon_r, 2_nm});
    const auto simulation_results = quickexact<TestType>(lyt, params);
...
TEMPLATE_TEST_CASE(
    "Single SiDB QuickExact simulation with one negatively charge defect (changed epsilon_r) in proximity", "[ExGS]",
    (sidb_surface<cell_level_layout<sidb_technology, clocked_layout<cartesian_layout<siqad::coord_t>>>>))
{
    TestType lyt{{20, 10}};
    lyt.assign_cell_type({1, 3, 0}, TestType::cell_type::NORMAL);
    ...
    lyt.assign_sidb_defect({1, 2, 0},
                           sidb_defect{sidb_defect_type::UNKNOWN, -1_e, 0.3, params.physical_parameters.lambda_tf});
    ...
    "[ExGS]", (sidb_surface<cell_level_layout<sidb_technology, clocked_layout<cartesian_layout<siqad::coord_t>>>>))
{
    ...
    const quickexact_params<TestType> params{sidb_simulation_parameters{2, -0.1_eV}};
                   ...
                   (cell_level_layout<sidb_technology, clocked_layout<cartesian_layout<siqad::coord_t>>>))
{
    ...
    params.local_external_potential.insert({{0, 0, 0}, -0.5_V});
                   ...
                   (cell_level_layout<sidb_technology, clocked_layout<cartesian_layout<siqad::coord_t>>>))
{
    ...
    params.local_external_potential.insert({{{0, 0, 0}, -1_V}});
    const auto simulation_results = quickexact<TestType>(lyt, params);
                   ...
                   (cell_level_layout<sidb_technology, clocked_layout<cartesian_layout<siqad::coord_t>>>))
{
    ...
    const quickexact_params<TestType> params{sidb_simulation_parameters{3, -0.25_eV}};
                   ...
                   (cell_level_layout<sidb_technology, clocked_layout<cartesian_layout<siqad::coord_t>>>))
{
    ...
    const quickexact_params<TestType> params{sidb_simulation_parameters{3, -0.32_eV}};
                   ...
                   (cell_level_layout<sidb_technology, clocked_layout<cartesian_layout<siqad::coord_t>>>))
{
    ...
    const quickexact_params<TestType> sim_params{sidb_simulation_parameters{3, -0.32_eV}};
                   ...
                   (cell_level_layout<sidb_technology, clocked_layout<cartesian_layout<siqad::coord_t>>>))
{
    ...
    const quickexact_params<TestType> sim_params{sidb_simulation_parameters{2, -0.28_eV}};
...
TEMPLATE_TEST_CASE(
    "QuickExact simulation of a Y-shape SiDB OR gate with input 01 and local external potential at perturber", "[ExGS]",
    (cell_level_layout<sidb_technology, clocked_layout<cartesian_layout<siqad::coord_t>>>))
{
    TestType lyt{{20, 10}};
    ...
    quickexact_params<TestType> params{sidb_simulation_parameters{3, -0.28_eV}};
    params.local_external_potential.insert({{{6, 2, 0}, -0.5_V}});
                   ...
                   (cell_level_layout<sidb_technology, clocked_layout<cartesian_layout<siqad::coord_t>>>))
{
    ...
    const quickexact_params<TestType> params{sidb_simulation_parameters{3, -0.28_eV}};
                   ...
                   (sidb_surface<cell_level_layout<sidb_technology, clocked_layout<cartesian_layout<siqad::coord_t>>>>))
{
    ...
    const quickexact_params<TestType> params{sidb_simulation_parameters{3, -0.28_eV}};
    lyt.assign_sidb_defect({1, 0, 0}, sidb_defect{sidb_defect_type::UNKNOWN, -1_e, params.physical_parameters.epsilon_r,
                                                  params.physical_parameters.lambda_tf});
    const auto simulation_results = quickexact<TestType>(lyt, params);
                   ...
                   (sidb_surface<cell_level_layout<sidb_technology, clocked_layout<cartesian_layout<siqad::coord_t>>>>))
{
    ...
    lyt.assign_sidb_defect({31, 0, 0},
                           sidb_defect{sidb_defect_type::UNKNOWN, -1_e, params.physical_parameters.epsilon_r,
                                       params.physical_parameters.lambda_tf});
                   ...
                   (cell_level_layout<sidb_technology, clocked_layout<cartesian_layout<siqad::coord_t>>>))
{
    ...
    {
        if (layout.get_system_energy().value() < energy_min)
        {
            energy_min = layout.get_system_energy().value();
        }
    }

    for (const auto& layout : simulation_results.charge_distributions)
    {
        if (std::abs(layout.get_system_energy().value() - energy_min) < POP_STABILITY_ERR)
        {
                   ...
                   (cell_level_layout<sidb_technology, clocked_layout<cartesian_layout<siqad::coord_t>>>))
{
    ...
    const quickexact_params<TestType> params{sidb_simulation_parameters{2, -0.8_eV}};
                   ...
                   (cell_level_layout<sidb_technology, clocked_layout<cartesian_layout<siqad::coord_t>>>))
{
    ...
    REQUIRE(simulation_results.charge_distributions.size() == 3);
    const auto& charge_lyt_first = simulation_results.charge_distributions.front();
    CHECK(charge_lyt_first.get_system_energy() < 0.08_eV);
    CHECK(charge_lyt_first.get_system_energy() > -2.74_eV);
}
                   ...
                   (cell_level_layout<sidb_technology, clocked_layout<cartesian_layout<siqad::coord_t>>>))
{
    ...
    const quickexact_params<TestType> params{sidb_simulation_parameters{3, -0.1_eV}};
                   ...
                   (cell_level_layout<sidb_technology, clocked_layout<cartesian_layout<siqad::coord_t>>>))
{
    ...
    for (const auto& layout : simulation_results.charge_distributions)
    {
        CHECK(round_to_n_decimal_places(layout.get_system_energy(), 1) <= 0_eV);
    }
}
                   ...
                   (cell_level_layout<sidb_technology, clocked_layout<cartesian_layout<siqad::coord_t>>>))
{
    ...
    const quickexact_params<TestType> params_new{sidb_simulation_parameters{3, -0.32_eV},
