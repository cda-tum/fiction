...
//
//    lyt.assign_sidb_defect({0, 0, 1}, sidb_defect{sidb_defect_type::UNKNOWN, -1,
//    params.simulation_parameters.epsilon_r,
//                                                  params.simulation_parameters.lambda_tf});
//
//    const auto simulation_results = quickexact<TestType>(lyt, params);
...
//}
//
// TEMPLATE_TEST_CASE("Single SiDB QuickExact simulation with global external potential (high, positive)",
// "[quickexact]",
//                   (sidb_100_cell_clk_lyt_siqad), (cds_sidb_100_cell_clk_lyt_siqad))
//{
//    TestType lyt{};
...
//
//    const quickexact_params<sidb_100_cell_clk_lyt_siqad> sim_params{sidb_simulation_parameters{3, -0.32}};
//
...
//    TestType::cell_type::NORMAL); lyt.assign_cell_type(siqad::to_fiction_coord<cube::coord_t>(siqad::coord_t{6, 2,
//    0}), TestType::cell_type::NORMAL); lyt.assign_cell_type(siqad::to_fiction_coord<cube::coord_t>(siqad::coord_t{14,
//    2, 0}), TestType::cell_type::NORMAL);
//
//    lyt.assign_cell_type(siqad::to_fiction_coord<cube::coord_t>(siqad::coord_t{8, 3, 0}),
//    TestType::cell_type::NORMAL); lyt.assign_cell_type(siqad::to_fiction_coord<cube::coord_t>(siqad::coord_t{12, 3,
//    0}), TestType::cell_type::NORMAL);
//
//    lyt.assign_cell_type(siqad::to_fiction_coord<cube::coord_t>(siqad::coord_t{10, 5, 0}),
//    TestType::cell_type::NORMAL); lyt.assign_cell_type(siqad::to_fiction_coord<cube::coord_t>(siqad::coord_t{10, 6,
//    1}), TestType::cell_type::NORMAL);
//
...
//    TestType::cell_type::NORMAL); lyt.assign_cell_type(siqad::to_fiction_coord<cube::coord_t>(siqad::coord_t{8, 3,
//    0}), TestType::cell_type::NORMAL); lyt.assign_cell_type(siqad::to_fiction_coord<cube::coord_t>(siqad::coord_t{12,
//    3, 0}), TestType::cell_type::NORMAL);
//
//    lyt.assign_cell_type(siqad::to_fiction_coord<cube::coord_t>(siqad::coord_t{14, 2, 0}),
//    TestType::cell_type::NORMAL); lyt.assign_cell_type(siqad::to_fiction_coord<cube::coord_t>(siqad::coord_t{10, 5,
//    0}), TestType::cell_type::NORMAL);
//
//    lyt.assign_cell_type(siqad::to_fiction_coord<cube::coord_t>(siqad::coord_t{10, 6, 1}),
//    TestType::cell_type::NORMAL); lyt.assign_cell_type(siqad::to_fiction_coord<cube::coord_t>(siqad::coord_t{10, 8,
//    1}), TestType::cell_type::NORMAL); lyt.assign_cell_type(siqad::to_fiction_coord<cube::coord_t>(siqad::coord_t{16,
//    1, 0}), TestType::cell_type::NORMAL);
//
//    quickexact_params<TestType> params{sidb_simulation_parameters{3, -0.28}};
...
//}
//
// TEMPLATE_TEST_CASE("QuickExact simulation  of four SiDBs (far away) with one negatively charged defects in
// proximity",
//                   "[quickexact]", (sidb_defect_surface<sidb_100_cell_clk_lyt_siqad>),
//                   (charge_distribution_surface<sidb_defect_surface<sidb_100_cell_clk_lyt_siqad>>))
//{
...
//
//    const quickexact_params<TestType> params{sidb_simulation_parameters{3, -0.28}};
//    lyt.assign_sidb_defect({1, 0, 0}, sidb_defect{sidb_defect_type::UNKNOWN, -1,
//    params.simulation_parameters.epsilon_r,
//                                                  params.simulation_parameters.lambda_tf});
//    const auto simulation_results = quickexact<TestType>(lyt, params);
//
...
//}
//
// TEMPLATE_TEST_CASE("Seven randomly distributed DBs, test if dependent cell calculation works correctly",
// "[quickexact]",
//                   (sidb_100_cell_clk_lyt_siqad), (cds_sidb_100_cell_clk_lyt_siqad))
//{
//    TestType lyt{};
